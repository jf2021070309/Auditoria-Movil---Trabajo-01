...
public final class g extends com.amazon.aps.iva.yb0.l implements com.amazon.aps.iva.xb0.l<Throwable, com.amazon.aps.iva.kb0.q> {
    public final /* synthetic */ com.amazon.aps.iva.ez.g<Panel> h;
    public final /* synthetic */ h i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(com.amazon.aps.iva.ez.g<Panel> gVar, h hVar) {
        super(1);
        this.h = gVar;
        this.i = hVar;
    }
    ...
    public final com.amazon.aps.iva.kb0.q invoke(Throwable th) {
        ...
        h hVar = this.i;
        view = hVar.getView();
        view.Jc(new com.amazon.aps.iva.b60.j(panel.getId(), WatchlistStatus.NOT_IN_WATCHLIST));
        view2 = hVar.getView();
        view2.showSnackbar(new b(f0.d(panel)));
        hVar.c.d(panel, th2);
