...
import com.amazon.aps.iva.gm.d0;
...
public final class g extends l implements p<com.amazon.aps.iva.o0.i, Integer, q> {
    ...
    public g(Context context, com.amazon.aps.iva.ui.c<c> cVar) {
        super(2);
        this.h = context;
        this.i = cVar;
    }
    ...
    public final q invoke(com.amazon.aps.iva.o0.i iVar, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && iVar2.h()) {
            ...
            if (fVar != null) {
                ...
                x.a(R.string.multiple_profiles_edit_background, d0Var, new com.amazon.aps.iva.gm.c(b0Var, assetType, cVar), iVar2, 48);
            } else {
