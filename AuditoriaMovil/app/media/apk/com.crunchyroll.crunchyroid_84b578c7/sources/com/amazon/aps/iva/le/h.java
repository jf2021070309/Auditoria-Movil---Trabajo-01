...
public final class h {
    ...
    public static final void a(com.amazon.aps.iva.ri.b<e> bVar, com.amazon.aps.iva.o0.i iVar, int i) {
        ...
        com.amazon.aps.iva.o0.j g = iVar.g(1790942018);
        if ((i & 14) == 0) {
            if (g.H(bVar)) {
                i3 = 4;
            } else {
        ...
        if ((i2 & 11) == 2 && g.h()) {
            ...
            e0.b bVar2 = e0.a;
            e eVar = (e) bVar.a(g);
            com.amazon.aps.iva.le.b.a((i) com.amazon.aps.iva.j5.b.b(eVar.getState(), g).getValue(), null, new a(eVar), g, 0, 2);
        }
        j2 X = g.X();
        if (X != null) {
            X.d = new b(bVar, i);
