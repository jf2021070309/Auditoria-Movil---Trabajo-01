...
public abstract class i {
        ...
        */
        public final int A() throws java.io.IOException {
            ...
            L70:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.aps.iva.v4.i.a.A():int");
        }
        ...
        @Override // com.amazon.aps.iva.v4.i
        ...
        @Override // com.amazon.aps.iva.v4.i
        public final h.f g() throws IOException {
            byte[] bArr;
            int A = A();
            byte[] bArr2 = this.e;
            if (A > 0) {
        ...
        public final String s() throws IOException {
            ...
            if (A > 0) {
                ...
                int i2 = this.h;
                if (A <= i - i2) {
                    String str = new String(this.e, i2, A, y.b);
                    this.h += A;
                    return str;
                }
            }
        ...
        */
        public final int D() throws java.io.IOException {
            ...
            L70:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.aps.iva.v4.i.b.D():int");
        }
        ...
        public final String s() throws IOException {
            ...
            if (D > 0) {
                ...
                int i2 = this.i;
                if (D <= i - i2) {
                    String str = new String(bArr, i2, D, y.b);
                    this.i += D;
                    return str;
                }
            }
            ...
            if (D <= this.g) {
                H(D);
                String str2 = new String(bArr, this.i, D, y.b);
                this.i += D;
                return str2;
            }
            return new String(y(D), y.b);
        }
    ...
    public abstract int e(int i) throws z;

    public abstract boolean f() throws IOException;

    public abstract h.f g() throws IOException;
