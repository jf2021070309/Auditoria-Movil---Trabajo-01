...
public final class c extends com.amazon.aps.iva.yb0.l implements p<com.amazon.aps.iva.o0.i, Integer, q> {
    ...
    public c(com.amazon.aps.iva.z70.a aVar, i iVar) {
        super(2);
        this.h = aVar;
        this.i = iVar;
    }
        ...
        if ((num.intValue() & 11) == 2 && iVar2.h()) {
            ...
            if (aVar.getBindingAdapterPosition() >= 0) {
                ...
                if (itemViewType != 301) {
                    ...
                    k.b(a, x.m0(iVar3.c.a(lVar)), new a(iVar3, lVar), new b(iVar3, lVar, aVar), lVar.c, null, p0, iVar2, LabelUiModel.$stable | Image.$stable | 0, 32);
                    iVar2.G();
                }
            }
        }
