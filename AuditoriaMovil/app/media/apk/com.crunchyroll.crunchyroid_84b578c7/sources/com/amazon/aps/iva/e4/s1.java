...
public final class s1 {
    ...
    public static class a {
        public static void a(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws a0 {
            if (!c(b2)) {
        ...
        public static void b(byte b, byte b2, byte b3, char[] cArr, int i) throws a0 {
    ...
    public static abstract class b {
        public abstract String a(byte[] bArr, int i, int i2) throws a0;
    ...
    public static final class c extends b {
        @Override // com.amazon.aps.iva.e4.s1.b
        public final String a(byte[] bArr, int i, int i2) throws a0 {
            boolean z;
            boolean z2;
            boolean z3;
            boolean z4;
        ...
        */
        public final int b(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.aps.iva.e4.s1.c.b(java.lang.CharSequence, byte[], int, int):int");
        }
    ...
    public static final class e extends b {
        public static int d(byte[] bArr, int i, long j, int i2) {
            if (i2 != 0) {
                if (i2 != 1) {
                    if (i2 == 2) {
                        return s1.d(i, r1.g(bArr, j), r1.g(bArr, j + 1));
                    }
                    throw new AssertionError();
                }
                return s1.c(i, r1.g(bArr, j));
            }
            b bVar = s1.a;
            if (i > -12) {
                return -1;
                ...
                while (i < i3) {
                    ...
                    if (z) {
                        ...
                        if (z3) {
                            if (i6 < i3) {
                                int i8 = i6 + 1;
                                byte g4 = r1.g(bArr, i6);
                                int i9 = i5 + 1;
                                if (g2 >= -62 && !a.c(g4)) {
                                    cArr[i5] = (char) (((g2 & Ascii.US) << 6) | (g4 & 63));
                                    i = i8;
                                    i5 = i9;
                                } else {
                                    throw a0.a();
                            ...
                            if (z4) {
                                if (i6 < i3 - 1) {
                                    int i10 = i6 + 1;
                                    a.b(g2, r1.g(bArr, i6), r1.g(bArr, i10), cArr, i5);
                                    i = i10 + 1;
                                    i5++;
                                } else {
                                    throw a0.a();
                                ...
                                int i11 = i6 + 1;
                                int i12 = i11 + 1;
                                a.a(g2, r1.g(bArr, i6), r1.g(bArr, i11), r1.g(bArr, i12), cArr, i5);
                                i5 = i5 + 1 + 1;
                                i = i12 + 1;
                            } else {
                                throw a0.a();
        ...
        public final int b(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            if (length <= i2 && bArr.length - i2 >= i) {
                ...
                while (i4 < length) {
                    ...
                    if (charAt2 < c && j4 < j5) {
                        long j6 = j4 + j;
                        r1.p(bArr, j4, (byte) charAt2);
                        j3 = j;
                        j2 = j6;
                        c2 = c;
                    } else if (charAt2 < 2048 && j4 <= j5 - 2) {
                        long j7 = j4 + j;
                        r1.p(bArr, j4, (byte) ((charAt2 >>> 6) | 960));
                        long j8 = j7 + j;
                        r1.p(bArr, j7, (byte) ((charAt2 & '?') | 128));
                        long j9 = j;
                        c2 = 128;
                        j2 = j8;
                        j3 = j9;
                        ...
                        long j10 = j4 + j;
                        r1.p(bArr, j4, (byte) ((charAt2 >>> '\f') | 480));
                        long j11 = j10 + j;
                        r1.p(bArr, j10, (byte) (((charAt2 >>> 6) & 63) | 128));
                        r1.p(bArr, j11, (byte) ((charAt2 & '?') | 128));
                        j2 = j11 + 1;
                        j3 = 1;
                        c2 = 128;
                    } else if (j4 <= j5 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                long j12 = j4 + 1;
                                r1.p(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                long j13 = j12 + 1;
                                c2 = 128;
                                r1.p(bArr, j12, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j14 = j13 + 1;
                                r1.p(bArr, j13, (byte) (((codePoint >>> 6) & 63) | 128));
                                j3 = 1;
                                j2 = j14 + 1;
                                r1.p(bArr, j14, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
            ...
            if ((i | i2 | (bArr.length - i2)) >= 0) {
                ...
                while (true) {
                    ...
                    if (b < -32) {
                        ...
                        i5 = i6 - 3;
                        long j8 = j5 + 1;
                        byte g2 = r1.g(bArr, j5);
                        if (g2 > -65) {
                            break;
                        }
                        if ((((g2 + 112) + (b << Ascii.FS)) >> 30) != 0) {
                            break;
                        }
                        long j9 = j8 + 1;
                        if (r1.g(bArr, j8) > -65) {
