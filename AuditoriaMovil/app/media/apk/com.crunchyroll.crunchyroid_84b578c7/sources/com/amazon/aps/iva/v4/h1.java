...
public class h1<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final int b;
    public boolean e;
    public volatile h1<K, V>.f f;
    public volatile h1<K, V>.b h;
    public List<h1<K, V>.d> c = Collections.emptyList();
    ...
    public class a implements Iterator<Map.Entry<K, V>> {
        ...
        public a() {
            this.b = h1.this.c.size();
        }

        public final Iterator<Map.Entry<K, V>> a() {
            if (this.c == null) {
                this.c = h1.this.g.entrySet().iterator();
            }
            return this.c;
        }
        ...
        public final boolean hasNext() {
            int i = this.b;
            if ((i > 0 && i <= h1.this.c.size()) || a().hasNext()) {
                return true;
            }
            return false;
        }
    ...
    /* compiled from: SmallSortedMap.java */
    /* loaded from: classes.dex */
    public class b extends h1<K, V>.f {
        public b() {
            super();
        }

        @Override // com.amazon.aps.iva.v4.h1.f, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
    ...
    /* compiled from: SmallSortedMap.java */
    /* loaded from: classes.dex */
    public class d implements Map.Entry<K, V>, Comparable<h1<K, V>.d> {
        public final K b;
        public V c;
    ...
    public class e implements Iterator<Map.Entry<K, V>> {
        ...
        public final Iterator<Map.Entry<K, V>> a() {
            if (this.d == null) {
                this.d = h1.this.d.entrySet().iterator();
            }
            return this.d;
        }
    ...
    public class f extends AbstractSet<Map.Entry<K, V>> {
        ...
        public final boolean add(Object obj) {
            ...
            if (!contains(entry)) {
                Object value = entry.getValue();
                h1.this.put((Comparable) entry.getKey(), value);
                return true;
            }
            return false;
        }
    ...
    public final V put(K k, V v) {
        ...
        if (this.c.size() == i2) {
            h1<K, V>.d remove = this.c.remove(i2 - 1);
