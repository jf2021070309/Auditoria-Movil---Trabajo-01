...
public final class c0 {
    ...
    public static final void a(com.amazon.aps.iva.p4.n nVar, com.amazon.aps.iva.o0.i iVar, int i, int i2) {
        int i3;
        int i4;
        com.amazon.aps.iva.o0.j g = iVar.g(-1518326455);
        int i5 = i2 & 1;
        if (i5 != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
        ...
        if ((i3 & 11) == 2 && g.h()) {
            ...
            com.amazon.aps.iva.y4.b.a(com.amazon.aps.iva.ff0.b.m(nVar, new com.amazon.aps.iva.p4.a(R.drawable.background_widget_gradient)), null, g.b, g, 384, 2);
        }
        j2 X = g.X();
        if (X != null) {
            X.d = new a(nVar, i, i2);
