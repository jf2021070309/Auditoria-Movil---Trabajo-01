...
/* compiled from: CrunchylistSearchLoadingCard.kt */
...
public final class d {
    ...
    public static final class a extends l implements p<i, Integer, q> {
        ...
        public final q invoke(i iVar, Integer num) {
            ...
            if ((num.intValue() & 11) == 2 && iVar2.h()) {
                ...
                f.a aVar = f.a.c;
                float f = this.h;
                b = androidx.compose.foundation.c.b(e.e(e.f(aVar, f)), x.b, p0.a);
                b.C0098b c0098b = a.C0097a.k;
                iVar2.s(693286680);
                d0 a = v1.a(com.amazon.aps.iva.d0.a.a, c0098b, iVar2);
                iVar2.s(-1323940314);
                ...
                if (iVar2.j() instanceof com.amazon.aps.iva.o0.d) {
                    ...
                    e.a.b bVar2 = e.a.e;
                    com.amazon.aps.iva.cq.b.k0(iVar2, a, bVar2);
                    e.a.d dVar = e.a.d;
                    ...
                    f i = androidx.compose.foundation.layout.d.i(androidx.compose.foundation.layout.e.l(androidx.compose.foundation.layout.e.f(aVar, f), this.i), 0.0f, 0.0f, 12, 0.0f, 11);
                    long j = com.amazon.aps.iva.ao.a.v;
                    b2 = androidx.compose.foundation.c.b(i, j, p0.a);
                    com.amazon.aps.iva.d0.f.a(b2, iVar2, 0);
                    f d = androidx.compose.foundation.layout.e.d(aVar);
                    j.f(d, "<this>");
                    f o = d.o(new VerticalAlignElement(c0098b));
                    a.b bVar3 = com.amazon.aps.iva.d0.a.e;
                    iVar2.s(-483455358);
                    d0 a3 = m.a(bVar3, a.C0097a.m, iVar2);
                    iVar2.s(-1323940314);
                    ...
                    if (iVar2.j() instanceof com.amazon.aps.iva.o0.d) {
                        ...
                        b3 = androidx.compose.foundation.c.b(androidx.compose.foundation.layout.d.i(androidx.compose.foundation.layout.e.f(androidx.compose.foundation.layout.e.l(aVar, this.j), 24), 0.0f, 0.0f, 0.0f, 8, 7), j, p0.a);
                        com.amazon.aps.iva.d0.f.a(b3, iVar2, 0);
                        b4 = androidx.compose.foundation.c.b(androidx.compose.foundation.layout.e.f(androidx.compose.foundation.layout.e.l(aVar, 100), 16), j, p0.a);
    ...
    public static final class b extends l implements p<i, Integer, q> {
        ...
        public final q invoke(i iVar, Integer num) {
            num.intValue();
            d.a(iVar, com.amazon.aps.iva.ff0.b.I(this.h | 1));
            return q.a;
        }
    }
    ...
    public static final void a(i iVar, int i) {
        float f;
        int i2;
        com.amazon.aps.iva.o0.j g = iVar.g(1815974763);
        if (i == 0 && g.h()) {
            g.A();
        } else {
            e0.b bVar = e0.a;
            boolean c = k.n((Context) g.i(androidx.compose.ui.platform.d.b)).c();
            int i3 = 90;
            if (c) {
                f = 90;
            } else {
            ...
            com.amazon.aps.iva.zn.p.a(48, 1, g, null, com.amazon.aps.iva.v0.b.b(g, -1653670698, new a(f, f2, i2)));
        }
        j2 X = g.X();
        if (X != null) {
            X.d = new b(i);
