...
public class BottomSheetDialog extends o {
    ...
    public static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        public void setWindow(Window window) {
            ...
            this.window = window;
            if (window != null) {
                this.lightStatusBar = new y0(window, window.getDecorView()).a.c();
            }
        }

        private EdgeToEdgeCallback(View view, w0 w0Var) {
            ColorStateList g;
            this.insetsCompat = w0Var;
            ...
            if (g != null) {
                this.lightBottomSheet = Boolean.valueOf(MaterialColors.isColorLight(g.getDefaultColor()));
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
            ...
            u uVar = new u() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.1
                ...
                public w0 onApplyWindowInsets(View view2, w0 w0Var) {
                    ...
                    if (w0Var != null) {
                        ...
                        bottomSheetDialog.edgeToEdgeCallback = new EdgeToEdgeCallback(bottomSheetDialog.bottomSheet, w0Var);
        ...
        g0.n(this.bottomSheet, new a() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.3
