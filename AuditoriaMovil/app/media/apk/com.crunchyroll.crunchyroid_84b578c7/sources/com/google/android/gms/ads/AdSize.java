...
public final class AdSize {
    ...
    public static final AdSize WIDE_SKYSCRAPER = new AdSize(160, MediaError.DetailedErrorCode.TEXT_UNKNOWN, "160x600_as");
    @Deprecated
    ...
    */
    ...
    public static AdSize getCurrentOrientationInterscrollerAdSize(Context context, int i) {
        return zzj(i, zzbzh.zza(context, 0));
    }
    ...
    public static AdSize getInlineAdaptiveBannerAdSize(int i, int i2) {
        ...
        adSize.zzf = true;
        if (i2 < 32) {
            zzbzo.zzj("The maximum height set for the inline adaptive ad size was " + i2 + " dp, which is below the minimum recommended value of 32 dp.");
        }
        return adSize;
    }

    public static AdSize getLandscapeAnchoredAdaptiveBannerAdSize(Context context, int i) {
        AdSize zzc = zzbzh.zzc(context, i, 50, 2);
        zzc.zze = true;
        return zzc;
    }

    public static AdSize getLandscapeInlineAdaptiveBannerAdSize(Context context, int i) {
        int zza2 = zzbzh.zza(context, 2);
        AdSize adSize = new AdSize(i, 0);
        if (zza2 == -1) {
            return INVALID;
        }
    ...
    public static AdSize getPortraitInterscrollerAdSize(Context context, int i) {
        return zzj(i, zzbzh.zza(context, 1));
    }
    ...
    public int getHeightInPixels(Context context) {
        ...
        if (i != -4 && i != -3) {
            if (i != -2) {
                zzay.zzb();
                return zzbzh.zzx(context, this.zzc);
            }
    ...
    public int getWidthInPixels(Context context) {
        ...
        if (i != -1) {
            zzay.zzb();
            return zzbzh.zzx(context, this.zzb);
        }
    ...
    public AdSize(int i, int i2, String str) {
        if (i < 0 && i != -1 && i != -3) {
            throw new IllegalArgumentException(c0.a("Invalid width for AdSize: ", i));
        }
        if (i2 < 0 && i2 != -2 && i2 != -4) {
            throw new IllegalArgumentException(c0.a("Invalid height for AdSize: ", i2));
        }
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
