...
public final class zzsh extends AbstractMap implements Serializable, zzrt {
    ...
    public final int zzb(Object obj, int i, int[] iArr, int[] iArr2, Object[] objArr) {
        int i2 = iArr[zzo(i)];
        while (i2 != -1) {
    ...
    public final int zzc(Object obj, int i) {
        return zzb(obj, i, this.zze, this.zzg, this.zza);
    }

    public final int zzd(Object obj, int i) {
    ...
    public final Object zzg(Object obj, Object obj2, boolean z) {
        ...
        zzrm.zzf(z2, "Value already present: %s", obj2);
        zzr(this.zzc + 1);
        Object[] objArr = this.zza;
        int i = this.zzc;
        objArr[i] = obj;
    ...
    public final Object zzh(Object obj, Object obj2, boolean z) {
        ...
        zzrm.zzf(z2, "Key already present: %s", obj2);
        zzr(this.zzc + 1);
        Object[] objArr = this.zza;
        int i3 = this.zzc;
        objArr[i3] = obj2;
