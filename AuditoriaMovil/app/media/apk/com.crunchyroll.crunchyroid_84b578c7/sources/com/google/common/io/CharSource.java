...
public abstract class CharSource {
    ...
    public final class AsByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return l1.b(valueOf.length() + e.a(obj, 15), obj, ".asByteSource(", valueOf, ")");
        }
    }
    ...
    public static class CharSequenceCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return a.b(e.a(truncate, 17), "CharSource.wrap(", truncate, ")");
        }
    ...
    public static final class ConcatenatedCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return a.b(valueOf.length() + 19, "CharSource.concat(", valueOf, ")");
        }
    }
