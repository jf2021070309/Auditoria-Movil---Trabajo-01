...
public interface zzbuu extends IInterface {
    ...
    void zzg(zzbuy zzbuyVar) throws RemoteException;
    ...
    void zzl(zzby zzbyVar) throws RemoteException;

    void zzm(String str) throws RemoteException;

    void zzn(boolean z) throws RemoteException;

    void zzo(zzbux zzbuxVar) throws RemoteException;
    ...
    void zzu(zzbus zzbusVar) throws RemoteException;
}
