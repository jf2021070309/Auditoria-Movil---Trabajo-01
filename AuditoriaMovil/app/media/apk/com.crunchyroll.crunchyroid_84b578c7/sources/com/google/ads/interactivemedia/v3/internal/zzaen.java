...
abstract class zzaen {
    ...
    public static zzaef zzb(Class cls) {
        ...
        if (cls.equals(zzaef.class)) {
            format = zzb;
        } else if (cls.getPackage().equals(zzaen.class.getPackage())) {
        ...
        try {
            try {
                try {
                    return (zzaef) cls.cast(((zzaen) Class.forName(format, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
