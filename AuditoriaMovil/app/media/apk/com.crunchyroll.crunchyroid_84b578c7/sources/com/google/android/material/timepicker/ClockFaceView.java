...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    private final com.amazon.aps.iva.p3.a valueAccessibilityDelegate;
    ...
    private void updateTextViews(int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.values.length, size); i2++) {
            ...
            if (i2 >= this.values.length) {
                ...
                g0.n(textView, this.valueAccessibilityDelegate);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) l.f.a(1, this.values.length, 1, false).a);
    }
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        int defaultColor = com.amazon.aps.iva.d3.a.getColorStateList(context, R.color.material_timepicker_clockface).getDefaultColor();
        ...
        this.valueAccessibilityDelegate = new com.amazon.aps.iva.p3.a() { // from class: com.google.android.material.timepicker.ClockFaceView.2
            @Override // com.amazon.aps.iva.p3.a
            public void onInitializeAccessibilityNodeInfo(View view, l lVar) {
                super.onInitializeAccessibilityNodeInfo(view, lVar);
                int intValue = ((Integer) view.getTag(R.id.material_value_index)).intValue();
                if (intValue > 0) {
                    lVar.a.setTraversalAfter((View) ClockFaceView.this.textViewPool.get(intValue - 1));
                }
                lVar.j(l.g.a(0, 1, intValue, 1, false, view.isSelected()));
