...
public final class ImmutableNetwork<N, E> extends StandardNetwork<N, E> {
    ...
    private static <N, E> Function<E, N> adjacentNodeFn(final Network<N, E> network, final N n) {
        return new Function() { // from class: com.amazon.aps.iva.g90.b
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                Object lambda$adjacentNodeFn$2;
                lambda$adjacentNodeFn$2 = ImmutableNetwork.lambda$adjacentNodeFn$2(Network.this, n, obj);
    ...
    private static <N, E> Function<E, N> sourceNodeFn(final Network<N, E> network) {
        return new Function() { // from class: com.amazon.aps.iva.g90.a
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
    ...
    private static <N, E> Function<E, N> targetNodeFn(Network<N, E> network) {
        return new com.amazon.aps.iva.f90.a(network, 1);
    }
