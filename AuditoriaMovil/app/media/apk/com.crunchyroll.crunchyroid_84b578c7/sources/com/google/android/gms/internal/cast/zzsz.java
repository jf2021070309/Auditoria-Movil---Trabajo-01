...
public final class zzsz extends zztc {
    private final byte[] zzc;
    private final int zzd;
    private int zze;

    public zzsz(byte[] bArr, int i, int i2) {
        super(null);
    ...
    @Override // com.google.android.gms.internal.cast.zztc
    public final void zze(int i, zzsu zzsuVar) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzsuVar.zzd());
        zzsuVar.zzh(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzx2 == zzx) {
                int i2 = i + zzx2;
                this.zze = i2;
                int zzb = zzwn.zzb(str, this.zzc, i2, this.zzd - i2);
                this.zze = i;
                zzq((zzb - i) - zzx2);
                this.zze = zzb;
                return;
            ...
            byte[] bArr = this.zzc;
            int i3 = this.zze;
            this.zze = zzwn.zzb(str, bArr, i3, this.zzd - i3);
        } catch (zzwm e) {
            this.zze = i;
            zzB(str, e);
