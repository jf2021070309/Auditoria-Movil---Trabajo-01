...
public class DefaultSettingsSpiCall implements SettingsSpiCall {
    ...
    private c getJsonObjectFrom(String str) {
        try {
            return new c(str);
        } catch (Exception e) {
    ...
    public c handleResponse(HttpResponse httpResponse) {
        ...
        Logger logger2 = this.logger;
        StringBuilder d = e.d("Settings request failed; (status: ", code, ") from ");
        d.append(this.url);
        logger2.e(d.toString());
        return null;
    }

    @Override // com.google.firebase.crashlytics.internal.settings.network.SettingsSpiCall
    public c invoke(SettingsRequest settingsRequest, boolean z) {
        if (z) {
            try {
