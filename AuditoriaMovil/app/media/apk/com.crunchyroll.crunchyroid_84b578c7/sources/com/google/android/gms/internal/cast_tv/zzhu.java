...
public final class zzhu extends zzge implements RandomAccess, zzhy, zzjj {
    private static final zzhu zza = new zzhu(new int[0], 0, false);
    private int[] zzb;
    private int zzc;
    ...
    /* renamed from: zzg */
    public final zzhy zzd(int i) {
        if (i >= this.zzc) {
            return new zzhu(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    @Override // com.google.android.gms.internal.cast_tv.zzhy
    ...
    private zzhu(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }
