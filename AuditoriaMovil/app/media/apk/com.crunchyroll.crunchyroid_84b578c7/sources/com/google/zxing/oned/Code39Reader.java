...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, MediaError.DetailedErrorCode.DASH_NO_INIT, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, MediaError.DetailedErrorCode.MANIFEST_UNKNOWN, 208, 133, 388, 196, 168, 162, 138, 42};
            ...
            if (narrowWidePattern >= 0) {
                ...
                if (patternToChar == '*') {
                    ...
                    if (sb2.length() != 0) {
                        ...
                        float f = i;
                        Result result = new Result(sb, null, new ResultPoint[]{new ResultPoint((findAsteriskPattern[1] + findAsteriskPattern[0]) / 2.0f, f), new ResultPoint((i4 / 2.0f) + nextSet, f)}, BarcodeFormat.CODE_39);
