...
public final class Component<T> {
    ...
    public static <T> Component<T> intoSet(T t, Class<T> cls) {
        return intoSetBuilder(cls).factory(new com.amazon.aps.iva.l90.b(t, 0)).build();
    }
    ...
    public static <T> Component<T> of(Class<T> cls, T t) {
        return builder(cls).factory(new com.amazon.aps.iva.l90.c(t, 0)).build();
    }
    ...
    public static <T> Component<T> of(final T t, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new ComponentFactory() { // from class: com.amazon.aps.iva.l90.a
