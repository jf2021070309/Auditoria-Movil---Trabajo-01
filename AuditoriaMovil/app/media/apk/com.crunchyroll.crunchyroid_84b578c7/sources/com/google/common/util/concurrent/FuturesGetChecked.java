...
public final class FuturesGetChecked {
    ...
    private static <X extends Exception> X newWithCause(Class<X> cls, Throwable th) {
        ...
        throw new IllegalArgumentException(com.amazon.aps.iva.d90.a.b(valueOf.length() + 82, "No appropriate constructor for exception of type ", valueOf, " in response to chained exception"), th);
    }
