...
final class zzko {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.cast_tv.zzko.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzkn zzknVar = zzf;
        long j2 = (-4) & j;
        int i = zzknVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzknVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzknVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzknVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzkk());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzko.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
