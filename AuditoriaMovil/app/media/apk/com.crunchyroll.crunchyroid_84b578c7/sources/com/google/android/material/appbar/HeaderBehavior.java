...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    */
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i2, int i3) {
        ...
        if (i2 == 0 || topAndBottomOffset < i2 || topAndBottomOffset > i3 || topAndBottomOffset == (q = w.q(i, i2, i3))) {
            return 0;
        }
        setTopAndBottomOffset(q);
        return topAndBottomOffset - q;
    }
