...
class RsaKem {
    ...
    public static void validateRsaModulus(BigInteger bigInteger) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(String.format("RSA key must be of at least size %d bits, but got %d", Integer.valueOf((int) MIN_RSA_KEY_LENGTH_BITS), Integer.valueOf(bigInteger.bitLength())));
    }
}
