...
public final class CCTDestination implements EncodedDestination {
    ...
    public static String decodeExtras(byte[] bArr) {
        return new String(bArr, Charset.forName(Hex.DEFAULT_CHARSET_NAME));
    }

    public static byte[] encodeString(String str) {
        return str.getBytes(Charset.forName(Hex.DEFAULT_CHARSET_NAME));
    }

    public static CCTDestination fromByteArray(byte[] bArr) {
        String str = new String(bArr, Charset.forName(Hex.DEFAULT_CHARSET_NAME));
    ...
    public byte[] asByteArray() {
        ...
        objArr[3] = str;
        return String.format("%s%s%s%s", objArr).getBytes(Charset.forName(Hex.DEFAULT_CHARSET_NAME));
    }
