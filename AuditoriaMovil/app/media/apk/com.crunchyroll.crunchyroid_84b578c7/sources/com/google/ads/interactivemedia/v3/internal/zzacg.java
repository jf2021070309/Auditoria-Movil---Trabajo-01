...
public final class zzacg {
    ...
    public static String zzd(Field field) {
        return q.b(field.getDeclaringClass().getName(), "#", field.getName());
    }

    public static String zze(AccessibleObject accessibleObject, boolean z) {
        String concat;
        if (accessibleObject instanceof Field) {
            concat = e.e("field '", zzd((Field) accessibleObject), "'");
        } else if (accessibleObject instanceof Method) {
            Method method = (Method) accessibleObject;
            StringBuilder sb = new StringBuilder(method.getName());
            zzk(method, sb);
            concat = e.b("method '", method.getDeclaringClass().getName(), "#", sb.toString(), "'");
        } else if (accessibleObject instanceof Constructor) {
            concat = e.e("constructor '", zzc((Constructor) accessibleObject), "'");
        } else {
    ...
    public static void zzh(AccessibleObject accessibleObject) throws zzws {
        try {
            ...
            throw new zzws(e.e("Failed making ", zze(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type."), e);
        }
    }
