...
public class NotificationOptions extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getNotificationActionsProviderAsBinder", id = Encoder.DEFAULT_EC_PERCENT, type = "android.os.IBinder")
    ...
    @SafeParcelable.Field(getter = "getPlayTitleResId", id = ConnectionResult.API_DISABLED)
    ...
    public static final class Builder {
        ...
        public NotificationOptions build() {
            ...
            if (notificationActionsProvider == null) {
                ...
                zza = notificationActionsProvider.zza();
            }
            return new NotificationOptions(this.zzb, this.zzd, this.zzr, this.zza, this.zze, this.zzf, this.zzg, this.zzh, this.zzi, this.zzj, this.zzk, this.zzl, this.zzm, this.zzn, this.zzo, this.zzp, this.zzq, zza("notificationImageSizeDimenResId"), zza("castingToDeviceStringResId"), zza("stopLiveStreamStringResId"), zza("pauseStringResId"), zza("playStringResId"), zza("skipNextStringResId"), zza("skipPrevStringResId"), zza("forwardStringResId"), zza("forward10StringResId"), zza("forward30StringResId"), zza("rewindStringResId"), zza("rewind10StringResId"), zza("rewind30StringResId"), zza("disconnectStringResId"), zza, this.zzs, this.zzt);
        }
        ...
        public Builder setSkipStepMs(long j) {
            ...
            Preconditions.checkArgument(z, "skipStepMs must be positive.");
            this.zzr = j;
            return this;
        }
