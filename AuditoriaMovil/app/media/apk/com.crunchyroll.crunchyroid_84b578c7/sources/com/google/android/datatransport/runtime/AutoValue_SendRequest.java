    ...
    public static final class Builder extends SendRequest.Builder {
        ...
        public SendRequest build() {
            ...
            if (this.transportName == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " transportName");
            }
            if (this.event == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " event");
            }
            if (this.transformer == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " transformer");
            }
            if (this.encoding == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " encoding");
            }
            if (str.isEmpty()) {
