...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzq = zza2.zzd("measurement.upload.realtime_upload_interval", NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
        ...
        zzB = zza2.zzd("measurement.upload.max_bundle_size", MediaStatus.COMMAND_FOLLOW);
        ...
        zzK = zza2.zzd("measurement.upload.max_batch_size", MediaStatus.COMMAND_FOLLOW);
