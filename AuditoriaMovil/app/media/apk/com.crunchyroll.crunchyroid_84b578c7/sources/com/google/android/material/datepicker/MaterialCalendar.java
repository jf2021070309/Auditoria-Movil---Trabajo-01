...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        g0.n(materialButton, new com.amazon.aps.iva.p3.a() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.u() { // from class: com.google.android.material.datepicker.MaterialCalendar.7
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (c<Long, Long> cVar : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        ...
                        if (l2 != null && (l = cVar.b) != null) {
                            ...
                            this.endItem.setTimeInMillis(l.longValue());
                            ...
                            for (int i5 = i3; i5 <= i4; i5++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    if (i5 == i3 && findViewByPosition != null) {
                                        i = (findViewByPosition.getWidth() / 2) + findViewByPosition.getLeft();
                                    } else {
                                        i = 0;
                                    }
                                    if (i5 == i4 && findViewByPosition2 != null) {
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        return i2 + (resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_month_vertical_padding) * (i - 1)) + (resources.getDimensionPixelSize(R.dimen.mtrl_calendar_day_height) * i) + resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_bottom_padding);
    }
    ...
    private void setUpForAccessibility() {
        g0.n(this.recyclerView, new com.amazon.aps.iva.p3.a() { // from class: com.google.android.material.datepicker.MaterialCalendar.4
            @Override // com.amazon.aps.iva.p3.a
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        g0.n(gridView, new com.amazon.aps.iva.p3.a() { // from class: com.google.android.material.datepicker.MaterialCalendar.1
            @Override // com.amazon.aps.iva.p3.a
            public void onInitializeAccessibilityNodeInfo(View view, l lVar) {
                super.onInitializeAccessibilityNodeInfo(view, lVar);
                lVar.i(null);
        ...
        if (recyclerView != null) {
            ...
            this.yearSelector.setLayoutManager(new GridLayoutManager(contextThemeWrapper, integer, 0));
        ...
        if (!MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            new b0().attachToRecyclerView(this.recyclerView);
        }
