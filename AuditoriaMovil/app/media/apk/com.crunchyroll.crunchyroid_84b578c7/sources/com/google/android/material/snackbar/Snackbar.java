...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public int getDuration() {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            recommendedTimeoutMillis = this.accessibilityManager.getRecommendedTimeoutMillis(duration, i | 1 | 2);
    ...
    public Snackbar setAction(CharSequence charSequence, View.OnClickListener onClickListener) {
        ...
        if (!TextUtils.isEmpty(charSequence) && onClickListener != null) {
            ...
            actionView.setOnClickListener(new b(5, this, onClickListener));
        } else {
