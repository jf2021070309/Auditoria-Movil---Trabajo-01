...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public final ConnectionResult getConnectionResult(Api<?> api) {
        ...
        try {
            ...
            String zad2 = api.zad();
            throw new IllegalArgumentException(zad2 + " was never registered with GoogleApiClient");
        } finally {
            this.zaj.unlock();
        }
    }
    ...
    */
    public final void zap(com.google.android.gms.common.api.internal.zada r2) {
        /*
            ...
            r0.lock()
            java.util.Set r0 = r1.zah     // Catch: java.lang.Throwable -> L4b
            if (r0 != 0) goto Lf
        ...
        Lf:
            ...
            goto L3e
        L1b:
            java.util.concurrent.locks.Lock r2 = r1.zaj     // Catch: java.lang.Throwable -> L4b
            r2.lock()     // Catch: java.lang.Throwable -> L4b
            java.util.Set r2 = r1.zah     // Catch: java.lang.Throwable -> L44
            if (r2 != 0) goto L2a
            java.util.concurrent.locks.Lock r2 = r1.zaj     // Catch: java.lang.Throwable -> L4b
        ...
        L2a:
            ...
            r2 = r2 ^ 1
            java.util.concurrent.locks.Lock r0 = r1.zaj     // Catch: java.lang.Throwable -> L4b
            r0.unlock()     // Catch: java.lang.Throwable -> L4b
            if (r2 != 0) goto L3e
        L37:
            com.google.android.gms.common.api.internal.zaca r2 = r1.zal     // Catch: java.lang.Throwable -> L4b
            if (r2 == 0) goto L3e
            r2.zat()     // Catch: java.lang.Throwable -> L4b
        L3e:
