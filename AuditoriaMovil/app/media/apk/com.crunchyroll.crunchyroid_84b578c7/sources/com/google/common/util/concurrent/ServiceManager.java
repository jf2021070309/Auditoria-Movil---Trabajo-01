...
public final class ServiceManager implements ServiceManagerBridge {
        ...
        public void failed(Service.State state, Throwable th) {
            ...
            if (serviceManagerState != null) {
                if (!(this.service instanceof NoOpService)) {
                    ...
                    StringBuilder b = com.amazon.aps.iva.ab.f.b(valueOf2.length() + valueOf.length() + 34, "Service ", valueOf, " has failed in the ", valueOf2);
                    b.append(" state.");
    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger2.log(level, com.amazon.aps.iva.d90.b.a(valueOf.length() + 24, "Unable to start Service ", valueOf), (Throwable) e);
            }
        }
        return this;
    }
    ...
    public static final class ServiceManagerState {
        ...
        public void checkHealthy() {
            ...
            throw new IllegalStateException(com.amazon.aps.iva.d90.b.a(valueOf.length() + 79, "Expected to be healthy after starting. The following services are not running: ", valueOf));
        }
        ...
        public void enqueueFailedEvent(final Service service) {
            this.listeners.enqueue(new ListenerCallQueue.Event<Listener>(this) { // from class: com.google.common.util.concurrent.ServiceManager.ServiceManagerState.2
                public String toString() {
                    ...
                    return com.amazon.aps.iva.d90.a.b(valueOf.length() + 18, "failed({service=", valueOf, "})");
                }
