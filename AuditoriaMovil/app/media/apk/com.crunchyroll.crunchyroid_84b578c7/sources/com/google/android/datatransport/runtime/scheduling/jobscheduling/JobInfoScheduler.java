...
public class JobInfoScheduler implements WorkScheduler {
    ...
    public int getJobId(TransportContext transportContext) {
        ...
        adler32.update(this.context.getPackageName().getBytes(Charset.forName(Hex.DEFAULT_CHARSET_NAME)));
        adler32.update(transportContext.getBackendName().getBytes(Charset.forName(Hex.DEFAULT_CHARSET_NAME)));
