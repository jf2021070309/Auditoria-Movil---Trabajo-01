...
public class zzafe extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((zzaey) this.zzb.get(size)).zza());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzaey) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzaey) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zzafeVar.zzb()) {
            for (int i = 0; i < zzb; i++) {
                if (!zzg(i).equals(zzafeVar.zzg(i))) {
                    return false;
                }
            }
            if (zzb == size) {
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzaey) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb; i2++) {
            i += ((zzaey) this.zzb.get(i2)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzaey zzaeyVar = (zzaey) this.zzb.remove(i2 - 1);
            zzm().put(zzaeyVar.zza(), zzaeyVar.getValue());
        }
        this.zzb.add(i, new zzaey(this, comparable, obj));
        return null;
    }
