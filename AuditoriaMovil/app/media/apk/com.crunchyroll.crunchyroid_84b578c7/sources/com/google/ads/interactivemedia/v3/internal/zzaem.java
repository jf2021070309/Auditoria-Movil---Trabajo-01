...
final class zzaem extends zzadc implements RandomAccess, zzagg {
    ...
    public final /* bridge */ /* synthetic */ zzaez zzd(int i) {
        if (i >= this.zzc) {
            return new zzaem(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzaem(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
