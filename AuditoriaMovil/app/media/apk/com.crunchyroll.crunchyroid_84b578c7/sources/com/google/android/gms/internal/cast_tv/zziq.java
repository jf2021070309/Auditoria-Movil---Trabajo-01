...
final class zziq extends zzge implements RandomAccess, zzjj {
    private static final zziq zza = new zziq(new long[0], 0, false);
    private long[] zzb;
    private int zzc;
    ...
    private zziq(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
