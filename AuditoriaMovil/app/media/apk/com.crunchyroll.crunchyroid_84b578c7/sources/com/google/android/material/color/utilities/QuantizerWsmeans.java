        ...
        while (true) {
            if (i15 < 10) {
                ...
                while (i20 < i4) {
                    ...
                    int i22 = iArr6[i20];
                    double distance4 = pointProviderLab.distance(dArr3, dArr2[i22]);
                    int[][] iArr12 = iArr7;
                    int[] iArr13 = iArr5;
                    double d = distance4;
                    int i23 = -1;
                    ...
                    while (i24 < min) {
                        ...
                        int i25 = i4;
                        if (distanceArr[i22][i24].distance < 4.0d * distance4) {
                            double distance5 = pointProviderLab.distance(dArr3, dArr2[i24]);
                            if (distance5 < d) {
                                i23 = i24;
                                d = distance5;
                            }
                    ...
                    int i26 = i4;
                    if (i23 != -1 && Math.abs(Math.sqrt(d) - Math.sqrt(distance4)) > 3.0d) {
                        i21++;
                        iArr6[i20] = i23;
                    }
                    i20++;
                ...
                while (true) {
                    ...
                    double d2 = i30;
                    dArr4[i29] = (dArr7[c] * d2) + dArr4[i29];
                    dArr5[i29] = (dArr7[1] * d2) + dArr5[i29];
                    dArr6[i29] = (dArr7[2] * d2) + dArr6[i29];
                    i28++;
                    i15 = i15;
                    i27 = i3;
                    c = 0;
