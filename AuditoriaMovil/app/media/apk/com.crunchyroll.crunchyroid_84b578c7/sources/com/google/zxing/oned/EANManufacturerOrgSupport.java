...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        ...
        add(new int[]{385}, "HR");
        add(new int[]{387}, "BA");
        add(new int[]{MediaError.DetailedErrorCode.MANIFEST_UNKNOWN, 440}, "DE");
        ...
        add(new int[]{MediaError.DetailedErrorCode.SEGMENT_UNKNOWN, 509}, "GB");
        add(new int[]{520}, "GR");
        ...
        add(new int[]{594}, "RO");
        add(new int[]{599}, "HU");
        add(new int[]{MediaError.DetailedErrorCode.TEXT_UNKNOWN, 601}, "ZA");
        add(new int[]{603}, "GH");
        add(new int[]{608}, "BH");
        add(new int[]{609}, "MU");
        ...
        add(new int[]{896}, "PK");
        add(new int[]{899}, "ID");
        add(new int[]{MediaError.DetailedErrorCode.APP, 919}, "AT");
