...
public final class TabLayoutMediator {
    ...
    public void attach() {
        if (!this.attached) {
            ...
            if (adapter != null) {
                ...
                this.viewPager.d.a.add(tabLayoutOnPageChangeCallback);
    ...
    public void detach() {
        ...
        this.viewPager.d.a.remove(this.onPageChangeCallback);
    ...
    public static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(TabLayout.Tab tab) {
            this.viewPager.b(tab.getPosition(), this.smoothScroll);
        }
