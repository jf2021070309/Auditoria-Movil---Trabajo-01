...
public final class zzno extends zztp implements zzuy {
    ...
    public static /* synthetic */ void zzf(zzno zznoVar, int i) {
        zznoVar.zzd |= Integer.MIN_VALUE;
        zznoVar.zzQ = i;
    }

    public static /* synthetic */ void zzg(zzno zznoVar, zzng zzngVar) {
        zzngVar.getClass();
        zznoVar.zzS = zzngVar;
        zznoVar.zze |= 2;
    }

    public static /* synthetic */ void zzh(zzno zznoVar, zznu zznuVar) {
        zznuVar.getClass();
        zznoVar.zzT = zznuVar;
        zznoVar.zze |= 4;
    }

    public static /* synthetic */ void zzi(zzno zznoVar, zzne zzneVar) {
        zzneVar.getClass();
    ...
    public static /* synthetic */ void zzj(zzno zznoVar, zzmy zzmyVar) {
        zzmyVar.getClass();
        zznoVar.zzaf = zzmyVar;
        zznoVar.zze |= 4096;
    }

    public static /* synthetic */ void zzk(zzno zznoVar, long j) {
        zznoVar.zzd |= 2;
        zznoVar.zzg = j;
    }

    public static /* synthetic */ void zzl(zzno zznoVar, String str) {
        zznoVar.zzd |= 2048;
        zznoVar.zzq = str;
    }

    public static /* synthetic */ void zzm(zzno zznoVar, String str) {
        str.getClass();
        zznoVar.zzd |= Http2.INITIAL_MAX_FRAME_SIZE;
        zznoVar.zzt = str;
    }

    public static /* synthetic */ void zzn(zzno zznoVar, String str) {
        str.getClass();
        zznoVar.zzd |= 32768;
        zznoVar.zzu = str;
    }

    public static /* synthetic */ void zzo(zzno zznoVar, int i) {
        zznoVar.zzd |= Cast.MAX_MESSAGE_LENGTH;
        zznoVar.zzv = i;
    }

    public static /* synthetic */ void zzp(zzno zznoVar, String str) {
        zznoVar.zzd |= 262144;
        zznoVar.zzx = str;
    }
