...
public class RadialViewGroup extends ConstraintLayout {
    ...
    private void addConstraints(List<View> list, androidx.constraintlayout.widget.c cVar, int i) {
        float f = 0.0f;
        for (View view : list) {
            int id = view.getId();
            int i2 = R.id.circle_center;
            c.b bVar = cVar.k(id).e;
            bVar.A = i2;
            bVar.B = i;
            bVar.C = f;
            f += 360.0f / list.size();
    ...
    public void updateLayoutParams() {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            addConstraints((List) entry.getValue(), cVar, getLeveledRadius(((Integer) entry.getKey()).intValue()));
        }
        cVar.b(this);
    }
