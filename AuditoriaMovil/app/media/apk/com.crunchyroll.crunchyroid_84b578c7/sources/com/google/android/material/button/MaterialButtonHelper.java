...
public class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        a.b.h(rippleDrawableCompat, RippleUtils.sanitizeRippleDrawableColor(this.rippleColor));
    ...
    private void setVerticalInsets(int i, int i2) {
        ...
        int e = g0.e.e(this.materialButton);
        ...
        g0.e.k(this.materialButton, f, (paddingTop + i) - i3, e, (paddingBottom + i2) - i4);
    }
    ...
    private void updateButtonShape(ShapeAppearanceModel shapeAppearanceModel) {
        if (IS_LOLLIPOP && !this.backgroundOverwritten) {
            ...
            int paddingBottom = this.materialButton.getPaddingBottom();
            updateBackground();
            g0.e.k(this.materialButton, f, paddingTop, e, paddingBottom);
            return;
        }
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        ...
        g0.e.k(this.materialButton, f + this.insetLeft, paddingTop + this.insetTop, e + this.insetRight, paddingBottom + this.insetBottom);
    }
    ...
    public void setSupportBackgroundTintList(ColorStateList colorStateList) {
        if (this.backgroundTint != colorStateList) {
            ...
            if (getMaterialShapeDrawable() != null) {
                a.b.h(getMaterialShapeDrawable(), this.backgroundTint);
            }
        }
    }
    ...
    public void setSupportBackgroundTintMode(PorterDuff.Mode mode) {
        if (this.backgroundTintMode != mode) {
            ...
            if (getMaterialShapeDrawable() != null && this.backgroundTintMode != null) {
                a.b.i(getMaterialShapeDrawable(), this.backgroundTintMode);
            }
        }
    }
