...
public final class ColorResourcesTableCreator {
    ...
    private static final PackageInfo ANDROID_PACKAGE_INFO = new PackageInfo(1, CredentialsData.CREDENTIALS_TYPE_ANDROID);
    ...
    public static byte[] stringToByteArrayUtf8(String str) {
        byte[] bytes = str.getBytes(Charset.forName(Hex.DEFAULT_CHARSET_NAME));
