    ...
    public static class WrappedPublicKeySign implements PublicKeySign {
        ...
        public WrappedPublicKeySign(PrimitiveSet<PublicKeySign> primitiveSet) {
            ...
            if (primitiveSet.hasAnnotations()) {
                this.logger = MutableMonitoringRegistry.globalInstance().getMonitoringClient().createLogger(MonitoringUtil.getMonitoringKeysetInfo(primitiveSet), "public_key_sign", MediaTrack.ROLE_SIGN);
            } else {
