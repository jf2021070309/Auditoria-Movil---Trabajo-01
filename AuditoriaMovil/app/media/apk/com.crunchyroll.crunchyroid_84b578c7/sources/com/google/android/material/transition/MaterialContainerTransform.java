...
import com.amazon.aps.iva.a9.j;
...
public final class MaterialContainerTransform extends n {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float lerp2 = TransitionUtils.lerp(0.0f, 1.0f, floatValue2, floatValue3, f);
            if (!shouldMaskStartBounds) {
                lerp2 = 1.0f - lerp2;
            }
            ...
            valueOf6.getClass();
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f, floatValue4, valueOf6.floatValue(), 0.35f);
        ...
        private TransitionDrawable(j jVar, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f2, int i, int i2, int i3, int i4, boolean z, boolean z2, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z3) {
            ...
            PathMeasure pathMeasure = new PathMeasure(jVar.getPath(motionPathPoint.x, motionPathPoint.y, motionPathPoint2.x, motionPathPoint2.y), false);
    ...
    private static void captureValues(u uVar, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        RectF locationOnScreen;
        if (i != -1) {
            uVar.b = TransitionUtils.findDescendantOrAncestorById(uVar.b, i);
        } else if (view != null) {
            uVar.b = view;
        } else if (uVar.b.getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            uVar.b.setTag(R.id.mtrl_motion_snapshot_view, null);
            uVar.b = (View) uVar.b.getTag(R.id.mtrl_motion_snapshot_view);
        }
        View view2 = uVar.b;
        WeakHashMap<View, r0> weakHashMap = g0.a;
        if (g0.g.c(view2) || view2.getWidth() != 0 || view2.getHeight() != 0) {
            ...
            hashMap.put(PROP_BOUNDS, locationOnScreen);
            hashMap.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view2, locationOnScreen, shapeAppearanceModel));
        }
    }
        ...
        if (uVar != null && uVar2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                if (rectF2 != null && shapeAppearanceModel2 != null) {
                    final View view3 = uVar.b;
                    final View view4 = uVar2.b;
                    ...
                    addListener(new TransitionListenerAdapter() { // from class: com.google.android.material.transition.MaterialContainerTransform.2
                        @Override // com.google.android.material.transition.TransitionListenerAdapter, com.amazon.aps.iva.a9.n.g
