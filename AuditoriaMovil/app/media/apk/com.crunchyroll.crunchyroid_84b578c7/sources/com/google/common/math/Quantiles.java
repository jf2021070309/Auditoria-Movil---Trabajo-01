...
public final class Quantiles {
            ...
            while (true) {
                ...
                if (i < iArr7.length) {
                    ...
                    if (i6 == 0) {
                        ...
                        linkedHashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr[i5], dArr[i5 + 1], i6, this.scale)));
                    }
                    i++;
                } else {
    ...
    public static void checkIndex(int i, int i2) {
        ...
        throw new IllegalArgumentException(j0.c(70, "Quantile indexes must be between 0 and the scale, which is ", i2));
    }
