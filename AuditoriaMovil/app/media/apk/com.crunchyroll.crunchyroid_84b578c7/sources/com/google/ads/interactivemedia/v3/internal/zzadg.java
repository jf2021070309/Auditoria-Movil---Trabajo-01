...
final class zzadg extends zzadc implements RandomAccess, zzagg {
    ...
    public final /* bridge */ /* synthetic */ zzaez zzd(int i) {
        if (i >= this.zzc) {
            return new zzadg(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzadg(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
