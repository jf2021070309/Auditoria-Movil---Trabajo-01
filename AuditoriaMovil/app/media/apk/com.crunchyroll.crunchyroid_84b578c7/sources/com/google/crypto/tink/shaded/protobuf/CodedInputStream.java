...
public abstract class CodedInputStream {
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        private boolean tryRefillBuffer(int i) throws IOException {
            ...
            throw new IllegalStateException(a.d("refillBuffer() called when ", i, " bytes were already available in buffer"));
        }
    ...
    public final int setRecursionLimit(int i) {
        ...
        throw new IllegalArgumentException(c0.a("Recursion limit cannot be negative: ", i));
    }
    ...
    public final int setSizeLimit(int i) {
        ...
        throw new IllegalArgumentException(c0.a("Size limit cannot be negative: ", i));
    }
