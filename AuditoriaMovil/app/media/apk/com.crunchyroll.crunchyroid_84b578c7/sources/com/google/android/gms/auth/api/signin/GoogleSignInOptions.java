...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    public static GoogleSignInOptions zab(String str) throws b {
        String str2;
        Account account;
        String str3;
        String str4 = null;
        ...
        a jSONArray = cVar.getJSONArray("scopes");
        int e = jSONArray.e();
        for (int i = 0; i < e; i++) {
            hashSet.add(new Scope(jSONArray.d(i)));
        }
        if (cVar.has("accountName")) {
            str2 = cVar.optString("accountName");
        } else {
            str2 = null;
        }
        ...
        boolean z = cVar.getBoolean("idTokenRequested");
        boolean z2 = cVar.getBoolean("serverAuthRequested");
        boolean z3 = cVar.getBoolean("forceCodeForRefreshToken");
        if (cVar.has("serverClientId")) {
            str3 = cVar.optString("serverClientId");
        } else {
            str3 = null;
        }
        if (cVar.has("hostedDomain")) {
            str4 = cVar.optString("hostedDomain");
        }
    ...
    */
    ...
    public final String zaf() {
        ...
        try {
            ...
            cVar.put("scopes", aVar);
            Account account = this.zai;
            if (account != null) {
                cVar.put("accountName", account.name);
            }
            cVar.put("idTokenRequested", this.zaj);
            cVar.put("forceCodeForRefreshToken", this.zal);
            cVar.put("serverAuthRequested", this.zak);
            if (!TextUtils.isEmpty(this.zam)) {
                cVar.put("serverClientId", this.zam);
            }
            if (!TextUtils.isEmpty(this.zan)) {
                cVar.put("hostedDomain", this.zan);
            }
