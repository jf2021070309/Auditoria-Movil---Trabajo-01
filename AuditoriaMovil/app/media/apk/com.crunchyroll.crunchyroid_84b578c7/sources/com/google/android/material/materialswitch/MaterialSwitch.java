...
public class MaterialSwitch extends SwitchCompat {
    ...
    private static void setInterpolatedDrawableTintIfPossible(Drawable drawable, ColorStateList colorStateList, int[] iArr, int[] iArr2, float f) {
        if (drawable != null && colorStateList != null) {
            a.b.g(drawable, e.c(colorStateList.getColorForState(iArr, 0), colorStateList.getColorForState(iArr2, 0), f));
        }
    }
    ...
    public void setThumbIconResource(int i) {
        setThumbIconDrawable(com.amazon.aps.iva.l.a.a(getContext(), i));
    }
    ...
    public void setTrackDecorationResource(int i) {
        setTrackDecorationDrawable(com.amazon.aps.iva.l.a.a(getContext(), i));
    }
    ...
    */
    public MaterialSwitch(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            r1 = r9
            r3 = r10
            com.amazon.aps.iva.q.d1 r9 = com.google.android.material.internal.ThemeEnforcement.obtainTintedStyledAttributes(r0, r1, r2, r3, r4, r5)
