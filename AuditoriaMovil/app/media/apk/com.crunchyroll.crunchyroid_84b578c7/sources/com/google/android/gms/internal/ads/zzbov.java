...
public final class zzbov implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void onAdClicked(MediationBannerAdapter mediationBannerAdapter) {
        ...
        zzbzo.zze("Adapter called onAdClicked.");
        try {
            this.zza.zze();
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, int i) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onAdFailedToLoad with error. " + i);
        try {
            this.zza.zzg(i);
        } catch (RemoteException e) {
            zzbzo.zzl("#007 Could not call remote method.", e);
    ...
    public final void onAdImpression(MediationNativeAdapter mediationNativeAdapter) {
        ...
        if (this.zzc == null) {
            if (unifiedNativeAdMapper == null) {
                ...
                zzbzo.zze("Could not call onAdImpression since setOverrideImpressionRecording is not set to true");
                return;
            }
        }
        zzbzo.zze("Adapter called onAdImpression.");
        try {
            this.zza.zzm();
        } catch (RemoteException e) {
            zzbzo.zzl("#007 Could not call remote method.", e);
    ...
    public final void onAdLeftApplication(MediationBannerAdapter mediationBannerAdapter) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onAdLeftApplication.");
        try {
            this.zza.zzn();
        } catch (RemoteException e) {
            zzbzo.zzl("#007 Could not call remote method.", e);
    ...
    public final void onVideoEnd(MediationNativeAdapter mediationNativeAdapter) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onVideoEnd.");
        try {
            this.zza.zzv();
        } catch (RemoteException e) {
            zzbzo.zzl("#007 Could not call remote method.", e);
    ...
    public final void zzc(MediationNativeAdapter mediationNativeAdapter, NativeCustomTemplateAd nativeCustomTemplateAd) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(nativeCustomTemplateAd.getCustomTemplateId())));
    ...
    public final void zzd(MediationBannerAdapter mediationBannerAdapter, String str, String str2) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onAppEvent.");
        try {
    ...
    public final void zze(MediationNativeAdapter mediationNativeAdapter, NativeCustomTemplateAd nativeCustomTemplateAd, String str) {
        if (nativeCustomTemplateAd instanceof zzbfg) {
            try {
                this.zza.zzr(((zzbfg) nativeCustomTemplateAd).zza(), str);
                return;
            } catch (RemoteException e) {
                zzbzo.zzl("#007 Could not call remote method.", e);
                return;
        ...
        zzbzo.zzj("Unexpected native custom template ad type.");
    }
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, AdError adError) {
        ...
        zzbzo.zze("Adapter called onAdFailedToLoad with error. ErrorCode: " + code + ". ErrorMessage: " + message + ". ErrorDomain: " + domain);
        try {
    ...
    public final void onAdClicked(MediationNativeAdapter mediationNativeAdapter) {
        ...
        if (this.zzc == null) {
            if (unifiedNativeAdMapper == null) {
                ...
                zzbzo.zze("Could not call onAdClicked since setOverrideClickHandling is not set to true");
                return;
            }
        }
        zzbzo.zze("Adapter called onAdClicked.");
