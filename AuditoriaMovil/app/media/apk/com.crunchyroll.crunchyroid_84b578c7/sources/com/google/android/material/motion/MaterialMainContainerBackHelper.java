...
public class MaterialMainContainerBackHelper extends MaterialBackAnimationHelper<View> {
    ...
    private ValueAnimator createCornerAnimator(final ClippableRoundedCornerLayout clippableRoundedCornerLayout) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.amazon.aps.iva.x80.b
    ...
    public void startBackProgress(b bVar, View view) {
        ...
        startBackProgress(bVar.b, view);
    }

    public void updateBackProgress(b bVar, View view, float f) {
        ...
        updateBackProgress(bVar.c, bVar.d == 0, bVar.b, f);
    }
    ...
    public void updateBackProgress(float f, boolean z, float f2, float f3) {
        ...
        float lerp2 = AnimationUtils.lerp(0.0f, Math.max(0.0f, ((width - (MIN_SCALE * width)) / 2.0f) - this.minEdgeGap), f) * (z ? 1 : -1);
        ...
        V v = this.view;
        if (v instanceof ClippableRoundedCornerLayout) {
            ((ClippableRoundedCornerLayout) v).updateCornerRadius(AnimationUtils.lerp(getExpandedCornerSize(), f3, f));
        }
    }
}
