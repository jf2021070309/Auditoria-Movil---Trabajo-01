...
public final class Collections2 {
    ...
    public static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            ...
            return com.amazon.aps.iva.d90.a.b(valueOf.length() + 30, "orderedPermutationCollection(", valueOf, ")");
        }
    }
    ...
    public static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            String valueOf = String.valueOf(this.inputList);
            return com.amazon.aps.iva.d90.a.b(valueOf.length() + 14, "permutations(", valueOf, ")");
        }
    }
