...
public class FirebaseApp {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.amazon.aps.iva.k90.a
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.amazon.aps.iva.k90.b
