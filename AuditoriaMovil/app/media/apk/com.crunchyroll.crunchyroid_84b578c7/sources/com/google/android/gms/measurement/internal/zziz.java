...
public final class zziz extends zzf {
    ...
    public final void zzA(zzir zzirVar, zzir zzirVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z2) {
            ...
            if (zzirVar.zze) {
                ...
                if (j5 != 0) {
                    j3 = j5;
                    this.zzt.zzq().zzH(str4, "_vs", j3, bundle3);
                }
            } else {
                j2 = currentTimeMillis;
            }
    ...
    public final void zzB(zzir zzirVar, boolean z, long j) {
        ...
        if (this.zzt.zzu().zzb.zzd(z2, z, j) && zzirVar != null) {
            zzirVar.zzd = false;
        }
    }
    ...
    private final void zzz(Activity activity, zzir zzirVar, boolean z) {
        ...
        this.zzc = this.zzb;
        this.zzb = zzirVar3;
        this.zzt.zzaB().zzp(new zziu(this, zzirVar3, zzirVar4, this.zzt.zzax().elapsedRealtime(), z));
    }
    ...
    public final void zzr(Activity activity, Bundle bundle) {
        ...
        this.zzd.put(activity, new zzir(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong("id")));
    }
