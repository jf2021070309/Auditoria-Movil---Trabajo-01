...
public class ShadowDrawableWrapper extends a {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = com.amazon.aps.iva.d3.a.getColor(context, R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = com.amazon.aps.iva.d3.a.getColor(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = com.amazon.aps.iva.d3.a.getColor(context, R.color.design_fab_shadow_end_color);
