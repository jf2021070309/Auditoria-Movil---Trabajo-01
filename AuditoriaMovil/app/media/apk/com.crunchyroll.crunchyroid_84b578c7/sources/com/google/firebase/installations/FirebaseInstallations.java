...
import com.amazon.aps.iva.c6.h;
...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    */
    ...
    public final void lambda$getToken$1(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.amazon.aps.iva.s90.a
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.amazon.aps.iva.s90.b
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new p(this, 10));
    ...
    public Task<InstallationTokenResult> getToken(boolean z) {
        ...
        this.backgroundExecutor.execute(new h(1, this, z));
