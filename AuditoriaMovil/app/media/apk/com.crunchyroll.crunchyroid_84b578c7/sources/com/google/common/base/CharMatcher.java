...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class And extends CharMatcher {
        ...
        public String toString() {
            ...
            StringBuilder b = f.b(valueOf2.length() + valueOf.length() + 19, "CharMatcher.and(", valueOf, ", ", valueOf2);
            b.append(")");
            return b.toString();
        }
    }
    ...
    public static final class ForPredicate extends CharMatcher {
        ...
        public String toString() {
            ...
            return a.b(valueOf.length() + 26, "CharMatcher.forPredicate(", valueOf, ")");
        }
    ...
    public static final class InRange extends FastMatcher {
        ...
        public String toString() {
            ...
            StringBuilder b = f.b(e.a(showCharacter2, e.a(showCharacter, 27)), "CharMatcher.inRange('", showCharacter, "', '", showCharacter2);
            b.append("')");
            return b.toString();
        }
    }
    ...
    public static final class Is extends FastMatcher {
        ...
        public String toString() {
            ...
            return a.b(e.a(showCharacter, 18), "CharMatcher.is('", showCharacter, "')");
        }
    }
    ...
    public static final class IsEither extends FastMatcher {
        ...
        public String toString() {
            ...
            return l1.b(e.a(showCharacter2, e.a(showCharacter, 21)), "CharMatcher.anyOf(\"", showCharacter, showCharacter2, "\")");
        }
    }
    ...
    public static final class IsNot extends FastMatcher {
        ...
        public String toString() {
            String showCharacter = CharMatcher.showCharacter(this.match);
            return a.b(e.a(showCharacter, 21), "CharMatcher.isNot('", showCharacter, "')");
        }
    }
    ...
    public static final class Or extends CharMatcher {
        ...
        public String toString() {
            String valueOf = String.valueOf(this.first);
            String valueOf2 = String.valueOf(this.second);
            StringBuilder b = f.b(valueOf2.length() + valueOf.length() + 18, "CharMatcher.or(", valueOf, ", ", valueOf2);
            b.append(")");
            return b.toString();
        }
    }
    ...
    @GwtIncompatible
    public void setBits(BitSet bitSet) {
        for (int i = Settings.DEFAULT_INITIAL_WINDOW_SIZE; i >= 0; i--) {
            if (matches((char) i)) {
                bitSet.set(i);
            }
        }
    ...
    public String replaceFrom(CharSequence charSequence, CharSequence charSequence2) {
        ...
        StringBuilder sb = new StringBuilder(e.a(length2, 3, 2, 16));
        do {
