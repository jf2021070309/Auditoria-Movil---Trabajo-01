...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    public static final class EntryForValue<K, V> extends AbstractMapEntry<V, K> {
        ...
        public K getValue() {
            ...
            return (K) NullnessCasts.uncheckedCastNullableTToT(this.biMap.keys[i]);
        }
    ...
    private void deleteFromTableKToV(int i, int i2) {
        ...
        throw new AssertionError(com.amazon.aps.iva.d90.b.a(valueOf.length() + 32, "Expected to find entry with key ", valueOf));
    }
    ...
    private void deleteFromTableVToK(int i, int i2) {
        ...
        throw new AssertionError(com.amazon.aps.iva.d90.b.a(valueOf.length() + 34, "Expected to find entry with value ", valueOf));
    }
    ...
    public void replaceKeyInEntry(int i, @ParametricNullness K k, boolean z) {
        ...
        if (findEntryByKey != -1) {
            if (z) {
                ...
                throw new IllegalArgumentException(com.amazon.aps.iva.d90.b.a(valueOf.length() + 28, "Key already present in map: ", valueOf));
            }
        } else {
            i2 = -2;
        }
    ...
    public void replaceValueInEntry(int i, @ParametricNullness V v, boolean z) {
        ...
        if (findEntryByValue != -1) {
            if (z) {
                ...
                throw new IllegalArgumentException(com.amazon.aps.iva.d90.b.a(valueOf.length() + 30, "Value already present in map: ", valueOf));
            }
        }
