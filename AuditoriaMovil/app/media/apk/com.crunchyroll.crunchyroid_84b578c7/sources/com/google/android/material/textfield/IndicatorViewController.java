...
public final class IndicatorViewController {
    ...
    private boolean shouldAnimateCaptionView(TextView textView, CharSequence charSequence) {
        ...
        if (g0.g.c(textInputLayout) && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || textView == null || !TextUtils.equals(textView.getText(), charSequence))) {
            return true;
        }
        return false;
    }
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            ...
            WeakHashMap<View, r0> weakHashMap = g0.a;
            g0.e.k(linearLayout, getIndicatorPadding(isFontScaleAtLeast1_3, i, g0.e.f(editText)), getIndicatorPadding(isFontScaleAtLeast1_3, R.dimen.material_helper_text_font_1_3_padding_top, this.context.getResources().getDimensionPixelSize(R.dimen.material_helper_text_default_padding_top)), getIndicatorPadding(isFontScaleAtLeast1_3, R.dimen.material_helper_text_font_1_3_padding_horizontal, g0.e.e(editText)), 0);
        }
    }
