...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    public static long fingerprint(byte[] bArr, int i, int i2) {
        ...
        long j2 = K0;
        if (i2 >= 8) {
            j = LittleEndianByteArray.load64(bArr, i);
        } else {
        ...
        long hash128to64 = hash128to64(fullFingerprint + j2, j);
    ...
    private static long fullFingerprint(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            weakHashLength32WithSeeds(bArr, i4 + 32, rotateRight5 + jArr2[1], j3, jArr2);
            i4 += 64;
            i5 -= 64;
            if (i5 == 0) {
                return hash128to64((shiftMix(j3) * K1) + hash128to64(jArr[0], jArr2[0]) + j2, hash128to64(jArr[1], jArr2[1]) + rotateRight5);
            }
            shiftMix = j2;
            rotateRight2 = j3;
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        int i3 = i + i2;
        int i4 = i3 - 16;
        long load642 = ((i2 + LittleEndianByteArray.load64(bArr, i4)) * K0) + LittleEndianByteArray.load64(bArr, i);
        ...
        return shiftMix((shiftMix(((load648 + load646 + rotateRight4) * K0) + ((Long.rotateRight(load648, 31) + rotateRight5 + Long.rotateRight(load647, 7) + rotateRight6 + j) * K2)) * K0) + rotateRight4) * K2;
    }
    ...
    private static void weakHashLength32WithSeeds(byte[] bArr, int i, long j, long j2, long[] jArr) {
        ...
        jArr[0] = j4 + load644;
        jArr[1] = Long.rotateRight(j4, 23) + rotateRight + j3;
    }
