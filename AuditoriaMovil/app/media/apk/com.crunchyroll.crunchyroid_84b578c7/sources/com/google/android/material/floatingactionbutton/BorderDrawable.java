...
public class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, rect.top, 0.0f, rect.bottom, new int[]{e.g(this.topOuterStrokeColor, this.currentBorderTintColor), e.g(this.topInnerStrokeColor, this.currentBorderTintColor), e.g(e.h(this.topInnerStrokeColor, 0), this.currentBorderTintColor), e.g(e.h(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), e.g(this.bottomInnerStrokeColor, this.currentBorderTintColor), e.g(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
