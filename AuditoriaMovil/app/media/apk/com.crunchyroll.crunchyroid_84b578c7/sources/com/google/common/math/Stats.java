...
public final class Stats implements Serializable {
    ...
    public static Stats fromByteArray(byte[] bArr) {
        ...
        Preconditions.checkArgument(z, "Expected Stats.BYTES = %s remaining , got %s", (int) BYTES, bArr.length);
    ...
    public static Stats readFrom(ByteBuffer byteBuffer) {
        ...
        Preconditions.checkArgument(z, "Expected at least Stats.BYTES = %s remaining , got %s", (int) BYTES, byteBuffer.remaining());
