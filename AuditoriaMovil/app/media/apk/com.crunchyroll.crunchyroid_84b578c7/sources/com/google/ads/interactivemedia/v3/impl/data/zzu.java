...
final class zzu implements zzaz {
    ...
    public zzaz adTagParameters(Map<String, String> map) {
        zzsr<String, String> zzc;
        if (map == null) {
            zzc = null;
        } else {
            zzc = zzsr.zzc(map);
        }
        this.adTagParameters = zzc;
        return this;
    }
