...
public class SearchBar extends Toolbar {
    ...
    private void initTextView(int i, String str, String str2) {
        ...
        setHint(str2);
        if (getNavigationIcon() == null) {
            com.amazon.aps.iva.p3.h.h((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
        ...
        if (accessibilityManager != null) {
            ...
            addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.google.android.material.search.SearchBar.1
                ...
                public void onViewAttachedToWindow(View view) {
                    com.amazon.aps.iva.q3.c.a(SearchBar.this.accessibilityManager, SearchBar.this.touchExplorationStateChangeListener);
                }

                @Override // android.view.View.OnAttachStateChangeListener
                public void onViewDetachedFromWindow(View view) {
                    com.amazon.aps.iva.q3.c.b(SearchBar.this.accessibilityManager, SearchBar.this.touchExplorationStateChangeListener);
                }
            });
        }
    }
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_APP, "title") == null) {
            if (attributeSet.getAttributeValue(NAMESPACE_APP, MediaTrack.ROLE_SUBTITLE) == null) {
                return;
            }
    ...
    public void inflateMenu(int i) {
        Menu menu = getMenu();
        boolean z = menu instanceof androidx.appcompat.view.menu.f;
        if (z) {
            ((androidx.appcompat.view.menu.f) menu).stopDispatchingItemsChanged();
        }
        super.inflateMenu(i);
        this.menuResId = i;
        if (z) {
    ...
    public void startOnLoadAnimation() {
        post(new Runnable() { // from class: com.amazon.aps.iva.z80.a
    ...
    */
    public SearchBar(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            r11 = -1
            r10.menuResId = r11
            com.amazon.aps.iva.a6.i0 r0 = new com.amazon.aps.iva.a6.i0
            r1 = 7
            r0.<init>(r10, r1)
            ...
            android.graphics.drawable.Drawable r0 = com.amazon.aps.iva.l.a.a(r7, r0)
        ...
        Lb1:
            ...
            r10.textView = r12
            java.util.WeakHashMap<android.view.View, com.amazon.aps.iva.p3.r0> r12 = com.amazon.aps.iva.p3.g0.a
            com.amazon.aps.iva.p3.g0.i.s(r10, r4)
