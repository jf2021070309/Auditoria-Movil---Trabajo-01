...
import com.amazon.aps.iva.a9.k;
import com.amazon.aps.iva.a9.n;
import com.amazon.aps.iva.a9.r;
...
class TransitionUtils {
    ...
    public static View findAncestorById(View view, int i) {
        ...
        throw new IllegalArgumentException(com.amazon.aps.iva.c80.a.f(resourceName, " is not a valid ancestor"));
    }
    ...
    public static float lerp(float f, float f2, float f3) {
        return t0.a(f2, f, f3, f);
    }

    public static void maybeAddTransition(r rVar, n nVar) {
        if (nVar != null) {
            rVar.a(nVar);
        }
    }

    public static boolean maybeApplyThemeDuration(n nVar, Context context, int i) {
        int resolveThemeDuration;
        if (i != 0 && nVar.getDuration() == -1 && (resolveThemeDuration = MotionUtils.resolveThemeDuration(context, i, -1)) != -1) {
    ...
    public static boolean maybeApplyThemeInterpolator(n nVar, Context context, int i, TimeInterpolator timeInterpolator) {
        if (i != 0 && nVar.getInterpolator() == null) {
            nVar.setInterpolator(MotionUtils.resolveThemeInterpolator(context, i, timeInterpolator));
            return true;
        }
        return false;
    }

    public static boolean maybeApplyThemePath(n nVar, Context context, int i) {
        j resolveThemePath;
        if (i != 0 && (resolveThemePath = resolveThemePath(context, i)) != null) {
            nVar.setPathMotion(resolveThemePath);
            return true;
        }
        return false;
    }

    public static void maybeRemoveTransition(r rVar, n nVar) {
        if (nVar != null) {
            rVar.b(nVar);
        }
    }

    public static j resolveThemePath(Context context, int i) {
        ...
        if (i2 == 16) {
            ...
            throw new IllegalArgumentException(c0.a("Invalid motion path type: ", i3));
        } else if (i2 == 3) {
            return new k(h.d(String.valueOf(typedValue.string)));
        } else {
