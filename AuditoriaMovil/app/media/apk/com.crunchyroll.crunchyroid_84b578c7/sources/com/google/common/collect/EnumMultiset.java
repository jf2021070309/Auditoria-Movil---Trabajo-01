...
public final class EnumMultiset<E extends Enum<E>> extends AbstractMultiset<E> implements Serializable {
    ...
    public abstract class Itr<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            if (EnumMultiset.this.counts[this.toRemove] > 0) {
                ...
                EnumMultiset.access$322(EnumMultiset.this, enumMultiset.counts[this.toRemove]);
    ...
    private void checkIsE(Object obj) {
        ...
        throw new ClassCastException(l1.b(valueOf2.length() + valueOf.length() + 21, "Expected an ", valueOf, " but got ", valueOf2));
    }
