...
final class JwtNames {
    ...
    public static boolean isRegisteredName(String str) {
        if (!str.equals(CLAIM_ISSUER) && !str.equals(CLAIM_SUBJECT) && !str.equals(CLAIM_AUDIENCE) && !str.equals(CLAIM_EXPIRATION) && !str.equals(CLAIM_NOT_BEFORE) && !str.equals(CLAIM_ISSUED_AT) && !str.equals(CLAIM_JWT_ID)) {
            return false;
        }
        return true;
    }
