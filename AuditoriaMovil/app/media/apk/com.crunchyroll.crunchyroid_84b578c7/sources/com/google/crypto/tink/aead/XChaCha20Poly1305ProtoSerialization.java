...
public final class XChaCha20Poly1305ProtoSerialization {
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new h(), XChaCha20Poly1305Parameters.class, ProtoParametersSerialization.class);
        PARAMETERS_PARSER = ParametersParser.create(new i(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_SERIALIZER = KeySerializer.create(new a(), XChaCha20Poly1305Key.class, ProtoKeySerialization.class);
        KEY_PARSER = KeyParser.create(new b(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
    ...
    public static XChaCha20Poly1305Key parseKey(ProtoKeySerialization protoKeySerialization, SecretKeyAccess secretKeyAccess) throws GeneralSecurityException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static ProtoKeySerialization serializeKey(XChaCha20Poly1305Key xChaCha20Poly1305Key, SecretKeyAccess secretKeyAccess) throws GeneralSecurityException {
