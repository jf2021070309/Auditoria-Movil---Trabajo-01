...
final class zzgi extends zzge implements RandomAccess, zzjj {
    private static final zzgi zza = new zzgi(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgiVar.zzb, 0, this.zzb, this.zzc, zzgiVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgiVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgiVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzib zzd(int i) {
        if (i >= this.zzc) {
            return new zzgi(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzgi(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
