...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                sVar.E.icon = context.getApplicationInfo().icon;
                sVar.j = 2;
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, c<g> cVar, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa(activity, i, null, onCancelListener, new zac(this, activity, i, cVar));
        if (zaa2 == null) {
            return false;
        }
        zad(activity, zaa2, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
