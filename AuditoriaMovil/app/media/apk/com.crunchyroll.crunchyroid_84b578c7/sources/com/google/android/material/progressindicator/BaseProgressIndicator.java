...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.switchIndeterminateModeCallback = new b() { // from class: com.google.android.material.progressindicator.BaseProgressIndicator.3
            @Override // com.amazon.aps.iva.b9.b
        ...
        this.minHideDelay = Math.min(obtainStyledAttributes.getInt(R.styleable.BaseProgressIndicator_minHideDelay, -1), (int) MAX_HIDE_DELAY);
    ...
    public boolean visibleToUser() {
        ...
        if (g0.g.b(this) && getWindowVisibility() == 0 && isEffectivelyVisible()) {
            return true;
        }
        return false;
    }
