...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
            ...
            for (int i2 = 0; i2 < readInt; i2++) {
                ...
                if (readInt2 > 0) {
                    ...
                    if (build.size() == readInt2) {
                        ...
                        throw new InvalidObjectException(com.amazon.aps.iva.d90.b.a(valueOf.length() + 40, "Duplicate key-value pairs exist for key ", valueOf));
                    }
                } else {
                    throw new InvalidObjectException(j0.c(31, "Invalid value count ", readInt2));
                }
            }
            try {
        ...
        throw new InvalidObjectException(j0.c(29, "Invalid key count ", readInt));
    }
