...
interface zzagk {
    ...
    @Deprecated
    void zzC(List list, zzags zzagsVar, zzaef zzaefVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzags zzagsVar, zzaef zzaefVar) throws IOException;
    ...
    zzadr zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzags zzagsVar, zzaef zzaefVar) throws IOException;

    void zzu(Object obj, zzags zzagsVar, zzaef zzaefVar) throws IOException;
