...
public class zzjq extends zzjm {
    ...
    public zzjq(Context context, String str, boolean z) {
        super(context);
        this.zzu = false;
    ...
    public static zzkt zzj(Context context, boolean z) {
        if (zzjm.zza == null) {
            synchronized (zzs) {
                if (zzjm.zza == null) {
    ...
    public static zzkv zzm(zzkt zzktVar, MotionEvent motionEvent, DisplayMetrics displayMetrics) throws zzkj {
    ...
    private final synchronized void zzu(zzkt zzktVar, zzaf zzafVar) {
        ...
        try {
            ...
            Long l2 = zzm.zza;
            if (l2 != null) {
                zzafVar.zzN(l2.longValue());
            }
            Long l3 = zzm.zzb;
            if (l3 != null) {
                zzafVar.zzO(l3.longValue());
            }
            Long l4 = zzm.zzc;
            if (l4 != null) {
                zzafVar.zzL(l4.longValue());
            }
            if (this.zzp) {
                Long l5 = zzm.zzd;
                if (l5 != null) {
                    zzafVar.zzK(l5.longValue());
                }
                Long l6 = zzm.zze;
                if (l6 != null) {
                    zzafVar.zzH(l6.longValue());
                }
            }
        } catch (zzkj unused) {
        }
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    zzkv zzm2 = zzm(zzjm.zza, (MotionEvent) this.zzc.get(i3), this.zzq);
                    zzay zza4 = zzaz.zza();
    ...
    public final void zzp(zzkt zzktVar, zzaf zzafVar, View view, Activity activity, boolean z, Context context) {
        List list;
        if (!zzktVar.zzr()) {
            zzafVar.zzD(16384L);
