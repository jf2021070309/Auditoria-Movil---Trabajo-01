...
final class AutoValue_EventStoreConfig extends EventStoreConfig {
    ...
    public static final class Builder extends EventStoreConfig.Builder {
        ...
        public EventStoreConfig build() {
            ...
            if (this.loadBatchSize == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " loadBatchSize");
            }
            if (this.criticalSectionEnterTimeoutMs == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " criticalSectionEnterTimeoutMs");
            }
            if (this.eventCleanUpAge == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " eventCleanUpAge");
            }
            if (this.maxBlobByteSizePerRow == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " maxBlobByteSizePerRow");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        ...
        return defpackage.e.f(sb, this.maxBlobByteSizePerRow, "}");
    }
