...
final class zzacj extends zzabj implements RandomAccess, zzaem {
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzadg.zzc(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzadf zzd(int i) {
        if (i >= this.zzc) {
            return new zzacj(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzacj(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
