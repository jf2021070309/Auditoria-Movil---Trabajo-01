...
public final class ThemeEnforcement {
    ...
    private static void checkTheme(Context context, int[] iArr, String str) {
        ...
        throw new IllegalArgumentException(e.e("The style on this component requires your app theme to be ", str, " (or a descendant)."));
    }
    ...
    public static d1 obtainTintedStyledAttributes(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        checkCompatibleTheme(context, attributeSet, i, i2);
        checkTextAppearance(context, attributeSet, iArr, i, i2, iArr2);
