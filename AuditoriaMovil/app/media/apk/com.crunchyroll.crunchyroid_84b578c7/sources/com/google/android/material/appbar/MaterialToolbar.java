...
public class MaterialToolbar extends Toolbar {
    ...
    private void initBackground(Context context) {
        ...
        materialShapeDrawable.setElevation(g0.i.i(this));
    ...
    private void layoutTitleCenteredHorizontally(View view, Pair<Integer, Integer> pair) {
        ...
        if (max > 0) {
            i += max;
            i2 -= max;
            view.measure(View.MeasureSpec.makeMeasureSpec(i2 - i, Ints.MAX_POWER_OF_TWO), view.getMeasuredHeightAndState());
        }
    ...
    public void clearNavigationIconTint() {
        ...
        if (navigationIcon != null) {
            a.b.h(navigationIcon.mutate(), null);
    ...
    public void inflateMenu(int i) {
        ...
        if (z) {
            ((f) menu).stopDispatchingItemsChanged();
        }
        super.inflateMenu(i);
        if (z) {
            ((f) menu).startDispatchingItemsChanged();
        }
    }
