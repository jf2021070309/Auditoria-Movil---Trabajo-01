    ...
    static {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    ...
                    if (i2 == 1 || i2 == 2) {
                        ...
                        if (nextInt == 0) {
                            ...
                            StringBuilder d = e.d("Invalid bitset value ", nextInt, ", expected 0 or 1; at path ");
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder d = e.d("Lossy conversion from ", nextInt, " to byte; at path ");
                    d.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(d.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder d = e.d("Lossy conversion from ", nextInt, " to short; at path ");
                    d.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(d.toString());
                } catch (NumberFormatException e) {
                    throw new JsonSyntaxException(e);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                StringBuilder c = q.c("Expecting character, got: ", nextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder c = q.c("Failed parsing '", nextString, "' as BigDecimal; at path ");
                    c.append(jsonReader.getPreviousPath());
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder c = q.c("Failed parsing '", nextString, "' as BigInteger; at path ");
                    c.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(c.toString(), e);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder c = q.c("Failed parsing '", nextString, "' as UUID; at path ");
                    c.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(c.toString(), e);
                }
            }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder c = q.c("Failed parsing '", nextString, "' as Currency; at path ");
                    c.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(c.toString(), e);
                }
            }
