    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                aVar.put(api2, Boolean.valueOf(z));
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        throw new IllegalStateException(q.b(api2.zad(), " cannot be used with ", api.zad()));
                    }
                }
            }
            if (api != null) {
                if (!z3) {
                    ...
                    throw new IllegalStateException(e.e("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
        ...
        @CanIgnoreReturnValue
        public Builder enableAutoManage(h hVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        @CanIgnoreReturnValue
        public Builder enableAutoManage(h hVar, OnConnectionFailedListener onConnectionFailedListener) {
