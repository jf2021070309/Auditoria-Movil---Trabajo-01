...
public abstract class ByteSource {
    ...
    public class AsCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return l1.b(valueOf.length() + e.a(obj, 15), obj, ".asCharSource(", valueOf, ")");
        }
    }
    ...
    public static class ByteArrayByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return a.b(e.a(truncate, 17), "ByteSource.wrap(", truncate, ")");
        }
    ...
    public static final class ConcatenatedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return a.b(valueOf.length() + 19, "ByteSource.concat(", valueOf, ")");
        }
    }
    ...
    public final class SlicedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            long j = this.offset;
            long j2 = this.length;
            StringBuilder sb = new StringBuilder(e.a(obj, 50));
            sb.append(obj);
            sb.append(".slice(");
            sb.append(j);
            sb.append(", ");
