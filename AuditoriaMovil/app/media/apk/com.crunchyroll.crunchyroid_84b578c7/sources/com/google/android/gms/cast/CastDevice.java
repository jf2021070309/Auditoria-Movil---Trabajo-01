...
public class CastDevice extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public WebImage getIcon(int i, int i2) {
        ...
        if (i > 0 && i2 > 0) {
            ...
            for (WebImage webImage3 : this.zzh) {
                ...
                } else if (width < i && height < i2 && (webImage2 == null || (webImage2.getWidth() < width && webImage2.getHeight() < height))) {
                    webImage2 = webImage3;
                }
            }
            if (webImage == null) {
    ...
    public boolean isOnLocalNetwork() {
        if (!this.zzb.startsWith("__cast_nearby__") && !this.zzq) {
            return true;
        }
        return false;
    }
