...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private final com.amazon.aps.iva.q3.d touchExplorationStateChangeListener;
    ...
    public DropdownMenuEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.touchExplorationStateChangeListener = new com.amazon.aps.iva.q3.d() { // from class: com.google.android.material.textfield.h
    ...
    private void initAnimators() {
        ...
        alphaAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.1
            {
                DropdownMenuEndIconDelegate.this = this;
            }
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.j
    ...
    @Override // com.google.android.material.textfield.EndIconDelegate
    public com.amazon.aps.iva.q3.d getTouchExplorationStateChangeListener() {
    ...
    public void onInitializeAccessibilityNodeInfo(View view, l lVar) {
        ...
        if (lVar.a.isShowingHintText()) {
            lVar.a.setHintText(null);
        }
    }
