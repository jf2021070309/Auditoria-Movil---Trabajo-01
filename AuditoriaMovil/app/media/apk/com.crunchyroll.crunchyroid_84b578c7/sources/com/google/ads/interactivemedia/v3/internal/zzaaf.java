...
final class zzaaf extends zzaac {
    ...
    public zzaaf(Class cls, Map map, boolean z) {
        super(map);
    ...
    @Override // com.google.ads.interactivemedia.v3.internal.zzaac
    public final /* bridge */ /* synthetic */ void zzc(Object obj, zzacv zzacvVar, zzaad zzaadVar) throws IllegalAccessException, IOException {
    ...
    public final Object zzb(Object[] objArr) {
        try {
            ...
            e = e2;
            throw new RuntimeException(b.a("Failed to invoke constructor '", zzacg.zzc(this.zzc), "' with args ", Arrays.toString(objArr)), e);
        } catch (InstantiationException e3) {
            e = e3;
            throw new RuntimeException(b.a("Failed to invoke constructor '", zzacg.zzc(this.zzc), "' with args ", Arrays.toString(objArr)), e);
        } catch (InvocationTargetException e4) {
            throw new RuntimeException(b.a("Failed to invoke constructor '", zzacg.zzc(this.zzc), "' with args ", Arrays.toString(objArr)), e4.getCause());
        }
    }
}
