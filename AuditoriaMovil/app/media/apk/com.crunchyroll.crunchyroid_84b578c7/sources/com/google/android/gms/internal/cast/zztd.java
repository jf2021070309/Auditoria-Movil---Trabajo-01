...
final class zztd implements zzwq {
    ...
    public final void zzA(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zztc.zzx((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
                zztc zztcVar = this.zza;
                int intValue2 = ((Integer) list.get(i2)).intValue();
                zztcVar.zzq((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zztcVar2.zzp(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zztc.zzy((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
                zztc zztcVar = this.zza;
                long longValue2 = ((Long) list.get(i2)).longValue();
                zztcVar.zzs((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zztcVar2.zzr(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    @Override // com.google.android.gms.internal.cast.zzwq
    public final void zzd(int i, zzsu zzsuVar) throws IOException {
    ...
    @Override // com.google.android.gms.internal.cast.zzwq
    public final void zzp(int i, Object obj, zzvi zzviVar) throws IOException {
        zztc zztcVar = this.zza;
        zztcVar.zzo(i, 3);
    ...
    @Override // com.google.android.gms.internal.cast.zzwq
    public final void zzu(int i, Object obj, zzvi zzviVar) throws IOException {
