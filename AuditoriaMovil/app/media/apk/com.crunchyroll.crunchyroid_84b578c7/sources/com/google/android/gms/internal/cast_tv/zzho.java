...
final class zzho extends zzge implements RandomAccess, zzjj {
    private static final zzho zza = new zzho(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzhoVar.zzb, 0, this.zzb, this.zzc, zzhoVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzhoVar.zzc) {
            return false;
        }
        float[] fArr = zzhoVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzib zzd(int i) {
        if (i >= this.zzc) {
            return new zzho(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzho(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
