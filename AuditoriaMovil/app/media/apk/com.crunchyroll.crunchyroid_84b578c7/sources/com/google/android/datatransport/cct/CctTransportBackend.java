...
public final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        try {
            ...
            return new HttpResponse(MediaError.DetailedErrorCode.MANIFEST_UNKNOWN, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.e(LOG_TAG, "Couldn't open connection, returning with 500", e);
            return new HttpResponse(MediaError.DetailedErrorCode.SEGMENT_UNKNOWN, null, 0L);
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.of("proto"))) {
                    ...
                    protoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName(Hex.DEFAULT_CHARSET_NAME)));
                } else {
    ...
    private static InputStream maybeUnGzip(InputStream inputStream, String str) throws IOException {
        if (GZIP_CONTENT_ENCODING.equals(str)) {
    ...
    private static URL parseUrlOrThrow(String str) {
        try {
            ...
            throw new IllegalArgumentException(com.amazon.aps.iva.oa.a.a("Invalid url: ", str), e);
        }
    }
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url, requestBody, str), new Function() { // from class: com.google.android.datatransport.cct.a
