...
public final class ChaCha20Poly1305ProtoSerialization {
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new d(), ChaCha20Poly1305Parameters.class, ProtoParametersSerialization.class);
        PARAMETERS_PARSER = ParametersParser.create(new e(), bytesFromPrintableAscii, ProtoParametersSerialization.class);
        KEY_SERIALIZER = KeySerializer.create(new f(), ChaCha20Poly1305Key.class, ProtoKeySerialization.class);
        KEY_PARSER = KeyParser.create(new g(), bytesFromPrintableAscii, ProtoKeySerialization.class);
    }
    ...
    public static ChaCha20Poly1305Key parseKey(ProtoKeySerialization protoKeySerialization, SecretKeyAccess secretKeyAccess) throws GeneralSecurityException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static ProtoKeySerialization serializeKey(ChaCha20Poly1305Key chaCha20Poly1305Key, SecretKeyAccess secretKeyAccess) throws GeneralSecurityException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static ProtoParametersSerialization serializeParameters(ChaCha20Poly1305Parameters chaCha20Poly1305Parameters) throws GeneralSecurityException {
