...
public final class zzbok implements MediationBannerAdCallback, MediationInterstitialAdCallback, MediationNativeAdCallback, MediationAppOpenAdCallback {
    private final zzbnz zza;

    public zzbok(zzbnz zzbnzVar) {
        this.zza = zzbnzVar;
    }
    ...
    public final void onVideoPause() {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onVideoPause.");
        try {
            this.zza.zzw();
        } catch (RemoteException e) {
            zzbzo.zzl("#007 Could not call remote method.", e);
    ...
    public final void onVideoPlay() {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzbzo.zze("Adapter called onVideoPlay.");
        try {
            this.zza.zzx();
        } catch (RemoteException e) {
            zzbzo.zzl("#007 Could not call remote method.", e);
