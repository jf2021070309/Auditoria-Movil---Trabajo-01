...
import com.amazon.aps.iva.h90.a;
import com.amazon.aps.iva.h90.b;
...
public final class MediaType {
    ...
    public static final MediaType AAC_AUDIO = createConstant(AUDIO_TYPE, HlsSegmentFormat.AAC);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues((ListMultimap) this.parameters, (Function) new b()).entries());
        }
        return sb.toString();
    }
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(com.amazon.aps.iva.d90.a.b(e.a(str, 18), "Could not parse '", str, "'"), e);
        }
    }
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException(l1.b(e.a(next, str.length() + 35), "Multiple charset values defined: ", str, ", ", next));
                }
            }
    ...
    public boolean is(MediaType mediaType) {
        if ((mediaType.type.equals(WILDCARD) || mediaType.type.equals(this.type)) && ((mediaType.subtype.equals(WILDCARD) || mediaType.subtype.equals(this.subtype)) && this.parameters.entries().containsAll(mediaType.parameters.entries()))) {
            return true;
        }
        return false;
    }
