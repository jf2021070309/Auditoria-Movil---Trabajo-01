...
public final class zzjl extends zzge implements RandomAccess {
    private static final zzjl zza = new zzjl(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzib zzd(int i) {
        if (i >= this.zzc) {
            return new zzjl(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzjl(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }
