...
import com.amazon.aps.iva.o3.b;
...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            w0 w0Var = collapsingToolbarLayout.lastInsets;
            if (w0Var != null) {
                i2 = w0Var.e();
            } else {
                i2 = 0;
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (i4 != 1) {
                    ...
                    viewOffsetHelper.setTopAndBottomOffset(w.q(-i, 0, CollapsingToolbarLayout.this.getMaxOffsetForPinChild(childAt)));
                }
            }
            ...
            if (collapsingToolbarLayout2.statusBarScrim != null && i2 > 0) {
                ...
                g0.d.k(collapsingToolbarLayout2);
            }
            int height = CollapsingToolbarLayout.this.getHeight();
            CollapsingToolbarLayout collapsingToolbarLayout3 = CollapsingToolbarLayout.this;
            WeakHashMap<View, r0> weakHashMap2 = g0.a;
            int d = (height - g0.d.d(collapsingToolbarLayout3)) - i2;
            float f = d;
            ...
            collapsingToolbarLayout4.collapsingTextHelper.setCurrentOffsetY(collapsingToolbarLayout4.currentOffset + d);
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        int i7 = i6 + i5;
        int i8 = rect.top + maxOffsetForPinChild + i4;
        int i9 = rect.right;
        if (!z) {
            i = i3;
        }
        collapsingTextHelper.setCollapsedBounds(i7, i8, i9 - i, (rect.bottom + maxOffsetForPinChild) - i2);
    }
    ...
    private void updateTextBounds(int i, int i2, int i3, int i4, boolean z) {
        ...
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            WeakHashMap<View, r0> weakHashMap = g0.a;
            boolean z3 = false;
            if (g0.g.b(view) && this.dummyView.getVisibility() == 0) {
                z2 = true;
            } else {
                z2 = false;
            }
            ...
            if (z2 || z) {
                ...
                collapsingTextHelper.setExpandedBounds(i5, i7, i8 - i6, (i4 - i2) - this.expandedMarginBottom);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (w0Var != null) {
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                WeakHashMap<View, r0> weakHashMap = g0.a;
                if (!g0.d.b(childAt) && childAt.getTop() < e) {
    ...
    public void setContentScrimResource(int i) {
        setContentScrim(a.getDrawable(getContext(), i));
    }
    ...
    public void setScrimsShown(boolean z) {
        WeakHashMap<View, r0> weakHashMap = g0.a;
        setScrimsShown(z, g0.g.c(this) && !isInEditMode());
    }
    ...
    public void setStatusBarScrimResource(int i) {
        setStatusBarScrim(com.amazon.aps.iva.d3.a.getDrawable(getContext(), i));
    }
