...
final class zzabn extends zzabj implements RandomAccess, zzaem {
    ...
    public final /* bridge */ /* synthetic */ zzadf zzd(int i) {
        if (i >= this.zzc) {
            return new zzabn(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzabn(boolean[] zArr, int i) {
        this.zzb = zArr;
        this.zzc = i;
    }
