...
import com.amazon.aps.iva.p3.f;
...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        return w.q((int) (overlapRatioForOffset * i), 0, i);
    }
    ...
    public void layoutChild(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (findFirstDependency != null) {
            ...
            f.b(resolveGravity(fVar.c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i);
    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        if ((i6 == -1 || i6 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            ...
            if (size > 0) {
                WeakHashMap<View, r0> weakHashMap = g0.a;
                if (g0.d.b(findFirstDependency) && (lastWindowInsets = coordinatorLayout.getLastWindowInsets()) != null) {
