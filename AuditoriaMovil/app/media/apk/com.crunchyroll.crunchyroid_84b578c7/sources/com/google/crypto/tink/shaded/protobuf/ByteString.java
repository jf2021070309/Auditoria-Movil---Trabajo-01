...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder c = q.c("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
    ...
    public static ByteString fromHex(@CompileTimeConstant String str) {
        ...
        StringBuilder c = q.c("Invalid hexString ", str, " of length ");
        c.append(str.length());
        c.append(" must be even.");
        throw new NumberFormatException(c.toString());
    }
    ...
    private String truncateAndEscapeForDisplay() {
        ...
        return b.c(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), "...");
    }
