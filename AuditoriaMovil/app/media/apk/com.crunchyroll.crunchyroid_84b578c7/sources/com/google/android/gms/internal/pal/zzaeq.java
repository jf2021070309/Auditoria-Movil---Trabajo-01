...
interface zzaeq {
    ...
    @Deprecated
    void zzC(List list, zzaer zzaerVar, zzacm zzacmVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzaer zzaerVar, zzacm zzacmVar) throws IOException;
    ...
    zzaby zzp() throws IOException;

    @Deprecated
    Object zzr(zzaer zzaerVar, zzacm zzacmVar) throws IOException;

    Object zzs(zzaer zzaerVar, zzacm zzacmVar) throws IOException;
