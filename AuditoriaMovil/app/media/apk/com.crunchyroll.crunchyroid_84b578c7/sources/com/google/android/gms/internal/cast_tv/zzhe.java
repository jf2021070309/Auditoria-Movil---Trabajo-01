...
final class zzhe extends zzge implements RandomAccess, zzjj {
    private static final zzhe zza = new zzhe(new double[0], 0, false);
    private double[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzic.zzd;
        collection.getClass();
        if (!(collection instanceof zzhe)) {
            return super.addAll(collection);
        }
        zzhe zzheVar = (zzhe) collection;
        int i = zzheVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzheVar.zzb, 0, this.zzb, this.zzc, zzheVar.zzc);
            this.zzc = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    @Override // com.google.android.gms.internal.cast_tv.zzge, java.util.AbstractList, java.util.Collection, java.util.List
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzheVar.zzc) {
            return false;
        }
        double[] dArr = zzheVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzib zzd(int i) {
        if (i >= this.zzc) {
            return new zzhe(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzhe(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
