...
public abstract class zziz extends zziw implements List, RandomAccess {
    ...
    public zziz subList(int i, int i2) {
        ...
        return new zziy(this, i, i3);
    }

    @Override // java.util.List
    /* renamed from: zzh */
    public final zzjm listIterator(int i) {
        zzip.zzb(i, size(), FirebaseAnalytics.Param.INDEX);
        if (isEmpty()) {
            return zza;
        }
