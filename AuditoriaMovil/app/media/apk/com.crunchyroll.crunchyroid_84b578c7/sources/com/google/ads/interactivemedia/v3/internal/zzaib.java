...
interface zzaib {
    ...
    void zzd(int i, zzadr zzadrVar) throws IOException;
    ...
    @Deprecated
    void zzq(int i, Object obj, zzags zzagsVar) throws IOException;
    ...
    void zzv(int i, Object obj, zzags zzagsVar) throws IOException;
