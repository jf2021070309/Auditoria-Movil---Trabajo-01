...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(h hVar) {
        ...
        try {
            zzd zzdVar2 = (zzd) hVar.getSupportFragmentManager().C("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                FragmentManager supportFragmentManager = hVar.getSupportFragmentManager();
                androidx.fragment.app.a a = b.a(supportFragmentManager, supportFragmentManager);
                a.d(0, zzdVar2, "SupportLifecycleFragmentImpl", 1);
                a.i();
            }
            weakHashMap.put(hVar, new WeakReference(zzdVar2));
            return zzdVar2;
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(e.e("LifecycleCallback with tag ", str, " already added to this fragment."));
    }
