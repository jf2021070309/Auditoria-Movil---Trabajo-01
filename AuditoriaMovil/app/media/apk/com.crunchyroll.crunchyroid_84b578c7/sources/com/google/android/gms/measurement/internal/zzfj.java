...
final class zzfj implements Runnable {
    ...
    public final void run() {
        ...
        if (bundle != null) {
            ...
            if (j == 0) {
                e.e(zzflVar.zza, "Service response is missing Install Referrer install timestamp");
            } else {
                ...
                if (string != null && !string.isEmpty()) {
                    ...
                    if (zzs == null) {
                        a.a(zzflVar.zza, "No campaign params defined in Install Referrer result");
                    } else {
                        ...
                        if (string2 != null && !"(not set)".equalsIgnoreCase(string2) && !"organic".equalsIgnoreCase(string2)) {
                            ...
                            if (j2 == 0) {
                                a.a(zzflVar.zza, "Install Referrer is missing click timestamp for ad campaign");
                            } else {
                                zzs.putLong("click_timestamp", j2);
                            }
                        }
                        if (j == zzflVar.zza.zzm().zzd.zza()) {
                            p.e(zzflVar.zza, "Logging Install Referrer campaign from module while it may have already been logged.");
                        }
                        if (zzflVar.zza.zzJ()) {
                    ...
                    a.a(zzflVar.zza, "No referrer defined in Install Referrer response");
                }
            }
        }
