...
final class zzadu extends zzabj implements RandomAccess, zzaem {
    ...
    public final /* bridge */ /* synthetic */ zzadf zzd(int i) {
        if (i >= this.zzc) {
            return new zzadu(Arrays.copyOf(this.zzb, i), this.zzc);
        }
