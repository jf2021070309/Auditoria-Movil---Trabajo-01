...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public static final class DuplicateKey {
            ...
            public IllegalArgumentException exception() {
                ...
                return new IllegalArgumentException(f.a(f.b(valueOf4.length() + valueOf3.length() + valueOf2.length() + valueOf.length() + 39, "Multiple entries with same key: ", valueOf, "=", valueOf2), " and ", valueOf3, "=", valueOf4));
            }
        }
    ...
    public static IllegalArgumentException conflictException(String str, Object obj, Object obj2) {
        ...
        return new IllegalArgumentException(defpackage.b.c(f.b(valueOf2.length() + valueOf.length() + e.a(str, 34), "Multiple entries with same ", str, ": ", valueOf), " and ", valueOf2));
    }
