...
public final class ClassPath {
    ...
    public static final class LocationInfo {
        ...
        private void scan(File file, Set<File> set, ImmutableSet.Builder<ResourceInfo> builder) throws IOException {
            try {
                ...
                logger.warning(l1.b(valueOf2.length() + valueOf.length() + 16, "Cannot access ", valueOf, ": ", valueOf2));
            }
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        scanDirectory(canonicalFile, com.amazon.aps.iva.d90.a.b(e.a(name, e.a(str, 1)), str, name, "/"), set, builder);
    ...
    public ImmutableSet<ClassInfo> getTopLevelClasses() {
        return FluentIterable.from(this.resources).filter(ClassInfo.class).filter(new com.amazon.aps.iva.i90.a()).toSet();
    }
