...
public abstract class AbstractService implements Service {
    ...
    private void checkCurrentState(Service.State state) {
        ...
        if (state2 != state) {
            if (state2 == Service.State.FAILED) {
                ...
                StringBuilder b = com.amazon.aps.iva.ab.f.b(valueOf2.length() + valueOf.length() + 56, "Expected the service ", valueOf, " to be ", valueOf2);
            ...
            throw new IllegalStateException(defpackage.b.c(com.amazon.aps.iva.ab.f.b(valueOf5.length() + valueOf4.length() + valueOf3.length() + 38, "Expected the service ", valueOf3, " to be ", valueOf4), ", but was ", valueOf5));
        }
    }
    ...
    private void enqueueFailedEvent(final Service.State state, final Throwable th) {
        this.listeners.enqueue(new ListenerCallQueue.Event<Service.Listener>(this) { // from class: com.google.common.util.concurrent.AbstractService.5
            public String toString() {
                ...
                StringBuilder b = com.amazon.aps.iva.ab.f.b(valueOf2.length() + valueOf.length() + 27, "failed({from = ", valueOf, ", cause = ", valueOf2);
                b.append("})");
                return b.toString();
            }
    ...
    private static ListenerCallQueue.Event<Service.Listener> stoppingEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.Listener>() { // from class: com.google.common.util.concurrent.AbstractService.4
            public String toString() {
                ...
                return com.amazon.aps.iva.d90.a.b(valueOf.length() + 19, "stopping({from = ", valueOf, "})");
            }
    ...
    private static ListenerCallQueue.Event<Service.Listener> terminatedEvent(final Service.State state) {
        return new ListenerCallQueue.Event<Service.Listener>() { // from class: com.google.common.util.concurrent.AbstractService.3
            public String toString() {
                String valueOf = String.valueOf(Service.State.this);
                return com.amazon.aps.iva.d90.a.b(valueOf.length() + 21, "terminated({from = ", valueOf, "})");
            }
    ...
    public final Service startAsync() {
        ...
        String valueOf = String.valueOf(this);
        throw new IllegalStateException(com.amazon.aps.iva.d90.a.b(valueOf.length() + 33, "Service ", valueOf, " has already been started"));
    }
    ...
    public String toString() {
        ...
        String valueOf = String.valueOf(state());
        return l1.b(valueOf.length() + simpleName.length() + 3, simpleName, " [", valueOf, "]");
    }
    ...
    public final void awaitRunning(long j, TimeUnit timeUnit) throws TimeoutException {
        ...
        String valueOf = String.valueOf(this);
        throw new TimeoutException(com.amazon.aps.iva.d90.a.b(valueOf.length() + 50, "Timed out waiting for ", valueOf, " to reach the RUNNING state."));
    }
    ...
    public final void awaitTerminated(long j, TimeUnit timeUnit) throws TimeoutException {
        ...
        String valueOf = String.valueOf(this);
        String valueOf2 = String.valueOf(state());
        throw new TimeoutException(l1.b(valueOf2.length() + valueOf.length() + 65, "Timed out waiting for ", valueOf, " to reach a terminal state. Current state: ", valueOf2));
    }
