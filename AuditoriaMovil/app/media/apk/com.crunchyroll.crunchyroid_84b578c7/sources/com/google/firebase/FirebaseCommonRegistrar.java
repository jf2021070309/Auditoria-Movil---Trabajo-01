...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new n(12)));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new z(12)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new a0(9)));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new m(14)));
