                ...
                if (finderPattern2 != null) {
                    for (int i2 = i + 1; i2 < size - 1; i2++) {
                        ...
                        if (finderPattern3 != null) {
                            ...
                            float abs = Math.abs(finderPattern2.getEstimatedModuleSize() - finderPattern3.getEstimatedModuleSize());
                            ...
                            if (i3 <= 0 || estimatedModuleSize < DIFF_MODSIZE_CUTOFF_PERCENT) {
                                int i4 = i2 + 1;
                                while (i4 < size) {
                                    FinderPattern finderPattern4 = (FinderPattern) arrayList.get(i4);
