...
public class ElevationOverlayProvider {
    ...
    private boolean isThemeSurfaceColor(int i) {
        if (e.h(i, 255) == this.colorSurface) {
            return true;
        }
        return false;
    }
    ...
    public int compositeOverlay(int i, float f) {
        ...
        int layer = MaterialColors.layer(e.h(i, 255), this.elevationOverlayColor, calculateOverlayAlphaFraction);
        if (calculateOverlayAlphaFraction > 0.0f && (i2 = this.elevationOverlayAccentColor) != 0) {
            layer = MaterialColors.layer(layer, e.h(i2, OVERLAY_ACCENT_COLOR_ALPHA));
        }
        return e.h(layer, alpha);
    }
