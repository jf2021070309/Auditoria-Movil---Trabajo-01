...
public final class MaterialDatePicker<S> extends g {
    ...
    public static /* synthetic */ void ci(MaterialDatePicker materialDatePicker, View view) {
        materialDatePicker.lambda$initHeaderToggle$0(view);
    }

    private static Drawable createHeaderToggleDrawable(Context context) {
        StateListDrawable stateListDrawable = new StateListDrawable();
        stateListDrawable.addState(new int[]{16842912}, com.amazon.aps.iva.l.a.a(context, R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], com.amazon.aps.iva.l.a.a(context, R.drawable.material_ic_edit_black_24dp));
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        u uVar = new u() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            {
    ...
    private void initHeaderToggle(Context context) {
        ...
        g0.n(this.headerToggleButton, null);
        updateToggleContentDescription(this.headerToggleButton);
        this.headerToggleButton.setOnClickListener(new f(this, 20));
    }
    ...
    private void startPickerFragment() {
        ...
        e eVar = newInstance;
        if (this.inputMode == 1) {
            eVar = MaterialTextInputPicker.newInstance(getDateSelector(), themeResId, this.calendarConstraints);
        }
        this.pickerFragment = (PickerFragment<S>) eVar;
        updateTitle();
        updateHeader(getHeaderText());
        FragmentManager childFragmentManager = getChildFragmentManager();
        childFragmentManager.getClass();
        androidx.fragment.app.a aVar = new androidx.fragment.app.a(childFragmentManager);
        aVar.e(R.id.mtrl_calendar_frame, this.pickerFragment, null);
        aVar.k();
