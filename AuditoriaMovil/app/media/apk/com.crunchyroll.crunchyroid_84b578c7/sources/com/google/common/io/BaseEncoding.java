...
public abstract class BaseEncoding {
    ...
    public static final class Alphabet {
        ...
        public Alphabet(String str, char[] cArr) {
            ...
            try {
                ...
                throw new IllegalArgumentException(j0.c(35, "Illegal alphabet length ", cArr.length), e2);
            }
        }
    ...
    public static final class Base16Encoding extends StandardBaseEncoding {
        ...
        public int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            throw new DecodingException(j0.c(32, "Invalid input length ", charSequence.length()));
        }
    ...
    public static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            throw new DecodingException(j0.c(32, "Invalid input length ", trimTrailingPadding.length()));
        }
    ...
    public static final class SeparatedBaseEncoding extends BaseEncoding {
        ...
        public String toString() {
            ...
            return e.f(f.b(e.a(str, valueOf.length() + 31), valueOf, ".withSeparator(\"", str, "\", "), this.afterEveryChars, ")");
        }
                ...
                public int read() throws IOException {
                    ...
                    while (true) {
                        ...
                        if (read == -1) {
                            ...
                            throw new DecodingException(j0.c(32, "Invalid input length ", this.readChars));
                        }
                        this.readChars++;
                        char c = (char) read;
                    ...
                    throw new DecodingException(j0.c(41, "Padding cannot start at index ", this.readChars));
                }
