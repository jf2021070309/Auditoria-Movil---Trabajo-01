...
final class AutoValue_EventInternal extends EventInternal {
    ...
    public static final class Builder extends EventInternal.Builder {
        ...
        public EventInternal build() {
            ...
            if (this.encodedPayload == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " encodedPayload");
            }
            if (this.eventMillis == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " eventMillis");
            }
            if (this.uptimeMillis == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " uptimeMillis");
            }
            if (this.autoMetadata == null) {
                str = com.amazon.aps.iva.c80.a.f(str, " autoMetadata");
            }
            if (str.isEmpty()) {
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode2 ^ hashCode) * 1000003) ^ this.encodedPayload.hashCode()) * 1000003) ^ ((int) (j ^ (j >>> 32)))) * 1000003) ^ ((int) (j2 ^ (j2 >>> 32)))) * 1000003) ^ this.autoMetadata.hashCode();
    }
