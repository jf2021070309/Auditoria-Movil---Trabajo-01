        ...
        */
        ...
        public String toString() {
            ...
            if (runnable != null) {
                ...
                return com.amazon.aps.iva.d90.a.b(valueOf.length() + 34, "SequentialExecutorWorker{running=", valueOf, "}");
            }
            String valueOf2 = String.valueOf(SequentialExecutor.this.workerRunningState);
            return com.amazon.aps.iva.d90.a.b(valueOf2.length() + 32, "SequentialExecutorWorker{state=", valueOf2, "}");
        }
    }
