...
public final class zzae implements Iterable, zzap, zzal {
    ...
    public final zzap zze(int i) {
        zzap zzapVar;
        if (i < zzc()) {
            if (zzs(i) && (zzapVar = (zzap) this.zza.get(Integer.valueOf(i))) != null) {
                return zzapVar;
            }
            return zzap.zzf;
        }
    ...
    public final void zzo(int i, zzap zzapVar) {
        ...
        throw new IllegalArgumentException(c0.a("Invalid value index: ", i));
    }
    ...
    public final void zzq(int i, zzap zzapVar) {
        if (i <= 32468) {
            ...
            throw new IndexOutOfBoundsException(c0.a("Out of bounds index: ", i));
        }
