...
public final class Code39Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            while (true) {
                if (i >= length) {
                    ...
                    length = str.length();
                    if (length > 80) {
                        throw new IllegalArgumentException(a.d("Requested contents should be less than 80 digits long, but got ", length, " (extended full ASCII mode)"));
                    }
                } else {
                    i++;
                }
        ...
        throw new IllegalArgumentException(c0.a("Requested contents should be less than 80 digits long, but got ", length));
    }
