...
public final class AnyOfValidator implements SchemaValidator {
    ...
    public SchemaValidatorInstance createInstance(int i) {
        return new AnyOfValidatorInstance(i, this.validations);
    }
