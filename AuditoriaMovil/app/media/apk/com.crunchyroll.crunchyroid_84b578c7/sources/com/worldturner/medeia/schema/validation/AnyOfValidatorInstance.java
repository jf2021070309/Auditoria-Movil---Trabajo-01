...
public final class AnyOfValidatorInstance implements SchemaValidatorInstance {
    ...
    public AnyOfValidatorInstance(int i, List<? extends SchemaValidator> list) {
    ...
    public ValidationResult validate(JsonTokenData jsonTokenData, JsonTokenLocation jsonTokenLocation) {
        ...
        if (jsonTokenLocation.getLevel() == this.startLevel && jsonTokenData.getType().getLastToken()) {
            return new FailedValidationResult("anyOf", (String) null, "None of the anyOf validations succeeded", jsonTokenLocation, (Collection) null, 18, (e) null);
        }
        return null;
    }
}
