...
public final class NumberType extends SingleType {
    ...
    public void write(Object obj, JsonTokenDataConsumer jsonTokenDataConsumer) {
        ...
        jsonTokenDataConsumer.consume(ConvertTypeKt.convertType(obj, JsonTokenType.VALUE_NUMBER));
    }

    @Override // com.worldturner.medeia.parser.type.MapperType
    public Number createObject(JsonTokenData jsonTokenData, JsonTokenLocation jsonTokenLocation) {
        j.g(jsonTokenData, "token");
