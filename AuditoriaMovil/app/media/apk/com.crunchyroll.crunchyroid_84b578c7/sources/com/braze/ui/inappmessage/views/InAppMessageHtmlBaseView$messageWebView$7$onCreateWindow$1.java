...
public final class InAppMessageHtmlBaseView$messageWebView$7$onCreateWindow$1 extends l implements a<String> {
    ...
    public InAppMessageHtmlBaseView$messageWebView$7$onCreateWindow$1() {
        super(0);
    }
