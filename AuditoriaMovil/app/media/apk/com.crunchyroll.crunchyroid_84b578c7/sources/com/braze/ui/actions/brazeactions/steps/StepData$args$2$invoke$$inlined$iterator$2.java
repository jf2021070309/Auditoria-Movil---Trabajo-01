...
public final class StepData$args$2$invoke$$inlined$iterator$2 extends l implements com.amazon.aps.iva.xb0.l<Integer, Object> {
    final /* synthetic */ a $this_iterator;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StepData$args$2$invoke$$inlined$iterator$2(a aVar) {
        super(1);
        this.$this_iterator = aVar;
    }

    public final Object invoke(int i) {
        return this.$this_iterator.get(i);
    }
