...
public final class BackgroundInAppMessagePreparer$prepareInAppMessageWithHtml$2 extends l implements a<String> {
    ...
    public BackgroundInAppMessagePreparer$prepareInAppMessageWithHtml$2() {
        super(0);
    }
