...
public final class DefaultInAppMessageWebViewClientListener$onCustomEventAction$1 extends l implements a<String> {
    ...
    public DefaultInAppMessageWebViewClientListener$onCustomEventAction$1() {
        super(0);
    }
