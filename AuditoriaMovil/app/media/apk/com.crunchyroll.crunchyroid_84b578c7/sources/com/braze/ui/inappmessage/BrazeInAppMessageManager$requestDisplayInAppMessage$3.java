...
public final class BrazeInAppMessageManager$requestDisplayInAppMessage$3 extends l implements a<String> {
    ...
    public BrazeInAppMessageManager$requestDisplayInAppMessage$3() {
        super(0);
    }
