...
public final class BrazeInAppMessageManager$verifyOrientationStatus$2 extends l implements a<String> {
    ...
    public BrazeInAppMessageManager$verifyOrientationStatus$2() {
        super(0);
    }
