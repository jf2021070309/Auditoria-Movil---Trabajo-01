...
public final class BrazePushReceiver$Companion$handlePushNotificationPayload$1 extends l implements a<String> {
    ...
    public BrazePushReceiver$Companion$handlePushNotificationPayload$1() {
        super(0);
    }
