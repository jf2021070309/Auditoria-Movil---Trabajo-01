...
public final class UserRatingBarPresenterImpl$onActionUp$1 extends l implements a<q> {
    ...
    public UserRatingBarPresenterImpl$onActionUp$1(UserRatingBarPresenterImpl userRatingBarPresenterImpl, float f, int i) {
        super(0);
    ...
    public final void invoke2() {
        ...
        userRatingBarPresenterImpl.onRatingStarSelected(userRatingBarPresenterImpl.calculateStartIdFromPosition(this.$eventX, this.$measuredWidth));
    }
}
