...
public final class EtpContentServiceDecorator$getPlayheads$2$jobs$1$1 extends i implements p<g0, d<? super ContentApiResponse<Playhead, EmptyMeta>>, Object> {
    ...
    public final Object invoke(g0 g0Var, d<? super ContentApiResponse<Playhead, EmptyMeta>> dVar) {
        return ((EtpContentServiceDecorator$getPlayheads$2$jobs$1$1) create(g0Var, dVar)).invokeSuspend(q.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            obj = etpContentService.getPlayheads(B0, this);
            if (obj == aVar) {
                return aVar;
            }
        }
