...
public final class EtpContentServiceDecorator$getPlayheads$2 extends i implements p<g0, d<? super ContentApiResponse<Playhead, EmptyMeta>>, Object> {
    ...
    public final Object invoke(g0 g0Var, d<? super ContentApiResponse<Playhead, EmptyMeta>> dVar) {
        return ((EtpContentServiceDecorator$getPlayheads$2) create(g0Var, dVar)).invokeSuspend(q.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            for (List list : l0) {
                arrayList.add(com.amazon.aps.iva.se0.i.b(g0Var, null, null, new EtpContentServiceDecorator$getPlayheads$2$jobs$1$1(etpContentServiceDecorator, list, null), 3));
            }
            this.label = 1;
