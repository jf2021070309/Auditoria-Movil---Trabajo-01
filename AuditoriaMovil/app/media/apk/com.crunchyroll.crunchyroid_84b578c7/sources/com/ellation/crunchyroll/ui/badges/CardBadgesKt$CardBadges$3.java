...
public final class CardBadgesKt$CardBadges$3 extends l implements p<i, Integer, q> {
    ...
    final /* synthetic */ b<String> $statuses;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CardBadgesKt$CardBadges$3(MaturityRatingType maturityRatingType, LabelContentType labelContentType, b<String> bVar, f fVar, boolean z, boolean z2, boolean z3, boolean z4, int i, int i2) {
        super(2);
    ...
    public final void invoke(i iVar, int i) {
        CardBadgesKt.CardBadges(this.$maturityRating, this.$labelContentType, this.$statuses, this.$modifier, this.$shouldAddMaturityRating, this.$shouldAddNewBadge, this.$shouldAddMovieBadge, this.$shouldAddNowPlayingBadge, iVar, com.amazon.aps.iva.ff0.b.I(this.$$changed | 1), this.$$default);
    }
}
