...
@com.amazon.aps.iva.qb0.e(c = "com.ellation.crunchyroll.downloading.DownloadsManagerImpl$removePanel$1", f = "InternalDownloadsManager.kt", l = {397, 403}, m = "invokeSuspend")
...
public final class p extends com.amazon.aps.iva.qb0.i implements com.amazon.aps.iva.xb0.p<com.amazon.aps.iva.se0.g0, com.amazon.aps.iva.ob0.d<? super com.amazon.aps.iva.kb0.q>, Object> {
    ...
    public static final class b extends com.amazon.aps.iva.yb0.l implements com.amazon.aps.iva.xb0.l<z.a, Boolean> {
        ...
        public final Boolean invoke(z.a aVar) {
            ...
            return Boolean.valueOf(com.amazon.aps.iva.yb0.j.a(aVar2.a, this.h));
        }
    }
    ...
    public static final class e extends com.amazon.aps.iva.yb0.l implements com.amazon.aps.iva.xb0.l<a.C0962a, Boolean> {
        ...
        public final Boolean invoke(a.C0962a c0962a) {
            ...
            return Boolean.valueOf(com.amazon.aps.iva.yb0.j.a(c0962a2.b, this.h));
        }
    }

    /* compiled from: InternalDownloadsManager.kt */
    /* loaded from: classes2.dex */
    public static final class f extends com.amazon.aps.iva.yb0.l implements com.amazon.aps.iva.xb0.l<PlayableAsset, com.amazon.aps.iva.kb0.q> {
    ...
    public static final class g extends com.amazon.aps.iva.yb0.l implements com.amazon.aps.iva.xb0.l<PlayableAsset, com.amazon.aps.iva.kb0.q> {
        ...
        public final com.amazon.aps.iva.kb0.q invoke(PlayableAsset playableAsset) {
            PlayableAsset playableAsset2 = playableAsset;
            com.amazon.aps.iva.yb0.j.f(playableAsset2, "it");
            DownloadsManagerImpl.i(this.h, playableAsset2.getId());
            return com.amazon.aps.iva.kb0.q.a;
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p(DownloadsManagerImpl downloadsManagerImpl, String str, com.amazon.aps.iva.xb0.a<com.amazon.aps.iva.kb0.q> aVar, com.amazon.aps.iva.ob0.d<? super p> dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                if (i2 == 2) {
                    ...
                    downloadsManagerImpl.l.R1(str, new h(downloadsManagerImpl), new i(downloadsManagerImpl));
                    this.l.invoke();
        ...
        this.h = list2;
        this.i = 2;
        if (downloadsManagerImpl.b.c(str, fVar, gVar, this) == aVar) {
            return aVar;
        }
        list = list2;
        downloadsManagerImpl.l.R1(str, new h(downloadsManagerImpl), new i(downloadsManagerImpl));
