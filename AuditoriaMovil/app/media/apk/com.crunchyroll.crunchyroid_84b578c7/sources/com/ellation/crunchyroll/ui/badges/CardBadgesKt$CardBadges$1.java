...
public final class CardBadgesKt$CardBadges$1 extends l implements p<i, Integer, q> {
    ...
    public CardBadgesKt$CardBadges$1(LabelUiModel labelUiModel, f fVar, a<String> aVar, boolean z, boolean z2, boolean z3, boolean z4, int i, int i2) {
        super(2);
    ...
    public final void invoke(i iVar, int i) {
        CardBadgesKt.CardBadges(this.$uiModel, this.$modifier, this.$statuses, this.$shouldAddMaturityRating, this.$shouldAddNewBadge, this.$shouldAddMovieBadge, this.$shouldAddNowPlayingBadge, iVar, b.I(this.$$changed | 1), this.$$default);
    }
}
