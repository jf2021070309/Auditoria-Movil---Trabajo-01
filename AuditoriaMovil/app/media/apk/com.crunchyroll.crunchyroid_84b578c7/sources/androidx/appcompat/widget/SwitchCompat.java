...
import com.amazon.aps.iva.p3.e0;
...
public class SwitchCompat extends CompoundButton {
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    a.b.h(mutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    a.b.i(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    a.b.h(mutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    a.b.i(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private CharSequence doTransformForOnOffText(CharSequence charSequence) {
        ...
        TransformationMethod e = emojiTextViewHelper.b.a.e(this.mSwitchTransformationMethod);
        if (e != null) {
    ...
    private void setupEmojiCompatLoadCallback() {
        if (this.mEmojiCompatInitCallback == null && this.mAppCompatEmojiTextHelper.b() && d.c()) {
            d a2 = d.a();
            int b2 = a2.b();
            if (b2 == 3 || b2 == 0) {
                c cVar = new c(this);
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z) {
            ...
            if (Math.abs(xVelocity) > this.mMinFlingVelocity) {
                if (!m1.a(this) ? xVelocity <= 0.0f : xVelocity >= 0.0f) {
                    z2 = false;
                }
            } else {
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                a.b.f(background, i15, i4, i16, i6);
            }
        }
        super.draw(canvas);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect b2 = j0.b(this.mThumbDrawable);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        L38:
            ...
            r2 = r0
        L3b:
            boolean r0 = com.amazon.aps.iva.q.m1.a(r6)
            if (r0 == 0) goto L42
            float r2 = -r2
        L42:
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        int resourceId;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, com.amazon.aps.iva.j.a.y);
        if (!obtainStyledAttributes.hasValue(3) || (resourceId = obtainStyledAttributes.getResourceId(3, 0)) == 0 || (colorStateList = com.amazon.aps.iva.d3.a.getColorStateList(context, resourceId)) == null) {
        ...
        if (obtainStyledAttributes.getBoolean(14, false)) {
            this.mSwitchTransformationMethod = new com.amazon.aps.iva.n.a(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(com.amazon.aps.iva.l.a.a(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(com.amazon.aps.iva.l.a.a(getContext(), i));
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        int[] iArr = com.amazon.aps.iva.j.a.x;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        d1 d1Var = new d1(context, obtainStyledAttributes);
        g0.m(this, context, iArr, attributeSet, obtainStyledAttributes, i);
        Drawable e = d1Var.e(2);
        this.mThumbDrawable = e;
        if (e != null) {
            e.setCallback(this);
        }
        Drawable e2 = d1Var.e(11);
        ...
        this.mShowText = d1Var.a(3, true);
        this.mThumbTextPadding = d1Var.d(8, 0);
        this.mSwitchMinWidth = d1Var.d(5, 0);
        this.mSwitchPadding = d1Var.d(6, 0);
        this.mSplitTrack = d1Var.a(4, false);
        ColorStateList b2 = d1Var.b(9);
        if (b2 != null) {
            this.mThumbTintList = b2;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode c2 = j0.c(d1Var.h(10, -1), null);
        ...
        ColorStateList b3 = d1Var.b(12);
        if (b3 != null) {
            this.mTrackTintList = b3;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode c3 = j0.c(d1Var.h(13, -1), null);
