...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m140deprecated_get(String str) {
            j.f(str, "mediaType");
            return get(str);
        }

        /* renamed from: -deprecated_parse */
        public final MediaType m141deprecated_parse(String str) {
            j.f(str, "mediaType");
            return parse(str);
        }
                ...
                while (end < str.length()) {
                    ...
                    if (matcher2.lookingAt()) {
                        ...
                        if (group3 == null) {
                            ...
                            } else if (m.h0(group4, "'", false) && m.Y(group4, "'", false) && group4.length() > 2) {
    ...
    public /* synthetic */ MediaType(String str, String str2, String str3, String[] strArr, e eVar) {
    ...
    public final String m138deprecated_subtype() {
        return this.subtype;
    }

    /* renamed from: -deprecated_type */
    public final String m139deprecated_type() {
        return this.type;
    }
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof MediaType) && j.a(((MediaType) obj).mediaType, this.mediaType)) {
            return true;
        }
        return false;
    }
    ...
    public final String parameter(String str) {
        ...
        int i = 0;
        int p = k.p(0, this.parameterNamesAndValues.length - 1, 2);
        if (p >= 0) {
            while (!m.Z(this.parameterNamesAndValues[i], str)) {
                if (i != p) {
                    i += 2;
                } else {
                    return null;
