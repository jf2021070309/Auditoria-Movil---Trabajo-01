...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (findByIssuerAndSignature != null) {
                if (arrayList.size() > 1 || !j.a(x509Certificate, findByIssuerAndSignature)) {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof BasicCertificateChainCleaner) && j.a(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex)) {
            return true;
        }
        return false;
    }
