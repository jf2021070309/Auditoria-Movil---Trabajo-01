...
public final class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers headers) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                if (m.Z(headers.name(i), "Sec-WebSocket-Extensions")) {
                    ...
                    while (i2 < value.length()) {
                        ...
                        if (m.Z(trimSubstring, "permessage-deflate")) {
                            if (z) {
                                z4 = true;
                            }
                            while (i4 < delimiterOffset$default) {
                                ...
                                if (delimiterOffset3 < delimiterOffset2) {
                                    ...
                                    j.f(str, "<this>");
                                    if (str.length() >= "\"".length() + "\"".length() && q.F0(str, "\"") && q.l0(str, "\"")) {
                                ...
                                if (m.Z(trimSubstring2, "client_max_window_bits")) {
                                    if (num != null) {
                                        z4 = true;
                                    }
                                    if (str != null) {
                                    ...
                                    if (m.Z(trimSubstring2, "client_no_context_takeover")) {
                                        if (z2) {
                                            z4 = true;
                                        }
                                        if (str != null) {
                                        ...
                                        z2 = true;
                                    } else if (m.Z(trimSubstring2, "server_max_window_bits")) {
                                        if (num2 != null) {
                                            z4 = true;
                                        }
                                        if (str != null) {
                                        ...
                                        if (m.Z(trimSubstring2, "server_no_context_takeover")) {
                                            if (z3) {
                                                z4 = true;
                                            }
                                            if (str != null) {
    ...
    public String toString() {
        ...
        return a.b(sb, this.unknownValues, ')');
    }
    ...
    public /* synthetic */ WebSocketExtensions(boolean z, Integer num, boolean z2, Integer num2, boolean z3, boolean z4, int i, e eVar) {
