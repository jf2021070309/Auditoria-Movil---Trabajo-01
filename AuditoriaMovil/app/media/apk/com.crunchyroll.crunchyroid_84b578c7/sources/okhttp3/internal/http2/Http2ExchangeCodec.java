    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (j.a(lowerCase, Http2ExchangeCodec.TE) && j.a(headers.value(i), "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(Headers headers, Protocol protocol) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (j.a(name, Header.RESPONSE_STATUS_UTF8)) {
