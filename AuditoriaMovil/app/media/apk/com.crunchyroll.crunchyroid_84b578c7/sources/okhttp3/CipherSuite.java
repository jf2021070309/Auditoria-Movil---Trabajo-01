...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            if (m.h0(str, "TLS_", false)) {
                String substring = str.substring(4);
                j.e(substring, "this as java.lang.String).substring(startIndex)");
                return "SSL_".concat(substring);
            } else if (m.h0(str, "SSL_", false)) {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < min; i++) {
                    ...
                    if (charAt != charAt2) {
                        return j.h(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", MediaError.DetailedErrorCode.MEDIA_NETWORK);
    ...
    public final String m90deprecated_javaName() {
