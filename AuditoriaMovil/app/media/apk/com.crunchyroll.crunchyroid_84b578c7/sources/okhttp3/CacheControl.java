...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public final Builder maxAge(int i, TimeUnit timeUnit) {
            ...
            throw new IllegalArgumentException(c0.a("maxAge < 0: ", i).toString());
        }
        ...
        public final Builder maxStale(int i, TimeUnit timeUnit) {
            ...
            throw new IllegalArgumentException(c0.a("maxStale < 0: ", i).toString());
        }
        ...
        public final Builder minFresh(int i, TimeUnit timeUnit) {
            ...
            throw new IllegalArgumentException(c0.a("minFresh < 0: ", i).toString());
        }
    ...
    public /* synthetic */ CacheControl(boolean z, boolean z2, int i, int i2, boolean z3, boolean z4, boolean z5, int i3, int i4, boolean z6, boolean z7, boolean z8, String str, e eVar) {
    ...
    public final boolean m76deprecated_immutable() {
        return this.immutable;
    }

    /* renamed from: -deprecated_maxAgeSeconds  reason: not valid java name */
    public final int m77deprecated_maxAgeSeconds() {
        return this.maxAgeSeconds;
    }

    /* renamed from: -deprecated_maxStaleSeconds  reason: not valid java name */
    public final int m78deprecated_maxStaleSeconds() {
        return this.maxStaleSeconds;
    }

    /* renamed from: -deprecated_minFreshSeconds  reason: not valid java name */
    public final int m79deprecated_minFreshSeconds() {
        return this.minFreshSeconds;
    }

    /* renamed from: -deprecated_mustRevalidate  reason: not valid java name */
    public final boolean m80deprecated_mustRevalidate() {
        return this.mustRevalidate;
    }

    /* renamed from: -deprecated_noCache  reason: not valid java name */
    public final boolean m81deprecated_noCache() {
        return this.noCache;
    }

    /* renamed from: -deprecated_noStore  reason: not valid java name */
    public final boolean m82deprecated_noStore() {
        return this.noStore;
    }

    /* renamed from: -deprecated_noTransform  reason: not valid java name */
    public final boolean m83deprecated_noTransform() {
        return this.noTransform;
    }

    /* renamed from: -deprecated_onlyIfCached  reason: not valid java name */
    public final boolean m84deprecated_onlyIfCached() {
        return this.onlyIfCached;
    }

    /* renamed from: -deprecated_sMaxAgeSeconds  reason: not valid java name */
    public final int m85deprecated_sMaxAgeSeconds() {
