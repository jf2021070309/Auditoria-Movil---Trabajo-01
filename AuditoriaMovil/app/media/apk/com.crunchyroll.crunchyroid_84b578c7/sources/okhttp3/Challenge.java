...
public final class Challenge {
    ...
    public final Map<String, String> m86deprecated_authParams() {
        return this.authParams;
    }

    /* renamed from: -deprecated_charset  reason: not valid java name */
    public final Charset m87deprecated_charset() {
        return charset();
    }

    /* renamed from: -deprecated_realm  reason: not valid java name */
    public final String m88deprecated_realm() {
        return realm();
    }

    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m89deprecated_scheme() {
        return this.scheme;
    }
    ...
    public int hashCode() {
        return this.authParams.hashCode() + a.b(this.scheme, 899, 31);
    }
    ...
    public final Challenge withCharset(Charset charset) {
        j.f(charset, "charset");
        LinkedHashMap b0 = i0.b0(this.authParams);
        String name = charset.name();
        j.e(name, "charset.name()");
        b0.put("charset", name);
        return new Challenge(this.scheme, b0);
    }
