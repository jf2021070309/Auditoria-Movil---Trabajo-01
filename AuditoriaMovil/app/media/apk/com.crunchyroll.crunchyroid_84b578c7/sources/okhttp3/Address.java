...
public final class Address {
    ...
    public final CertificatePinner m64deprecated_certificatePinner() {
        return this.certificatePinner;
    }

    /* renamed from: -deprecated_connectionSpecs  reason: not valid java name */
    public final List<ConnectionSpec> m65deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    /* renamed from: -deprecated_dns  reason: not valid java name */
    public final Dns m66deprecated_dns() {
        return this.dns;
    }

    /* renamed from: -deprecated_hostnameVerifier  reason: not valid java name */
    public final HostnameVerifier m67deprecated_hostnameVerifier() {
        return this.hostnameVerifier;
    }

    /* renamed from: -deprecated_protocols  reason: not valid java name */
    public final List<Protocol> m68deprecated_protocols() {
        return this.protocols;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m69deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_proxyAuthenticator  reason: not valid java name */
    public final Authenticator m70deprecated_proxyAuthenticator() {
        return this.proxyAuthenticator;
    }

    /* renamed from: -deprecated_proxySelector  reason: not valid java name */
    public final ProxySelector m71deprecated_proxySelector() {
        return this.proxySelector;
    }

    /* renamed from: -deprecated_socketFactory  reason: not valid java name */
    public final SocketFactory m72deprecated_socketFactory() {
        return this.socketFactory;
    }

    /* renamed from: -deprecated_sslSocketFactory  reason: not valid java name */
    public final SSLSocketFactory m73deprecated_sslSocketFactory() {
        return this.sslSocketFactory;
    }

    /* renamed from: -deprecated_url  reason: not valid java name */
    public final HttpUrl m74deprecated_url() {
        return this.url;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Address) {
            ...
            if (j.a(this.url, address.url) && equalsNonHost$okhttp(address)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean equalsNonHost$okhttp(Address address) {
        j.f(address, "that");
        if (j.a(this.dns, address.dns) && j.a(this.proxyAuthenticator, address.proxyAuthenticator) && j.a(this.protocols, address.protocols) && j.a(this.connectionSpecs, address.connectionSpecs) && j.a(this.proxySelector, address.proxySelector) && j.a(this.proxy, address.proxy) && j.a(this.sslSocketFactory, address.sslSocketFactory) && j.a(this.hostnameVerifier, address.hostnameVerifier) && j.a(this.certificatePinner, address.certificatePinner) && this.url.port() == address.url.port()) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int a = a.a(this.connectionSpecs, a.a(this.protocols, (hashCode2 + ((hashCode + ((this.url.hashCode() + 527) * 31)) * 31)) * 31, 31), 31);
