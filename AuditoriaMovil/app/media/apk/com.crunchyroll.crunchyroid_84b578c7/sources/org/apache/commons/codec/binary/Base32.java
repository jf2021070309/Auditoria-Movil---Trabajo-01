        ...
        if (context.eof && context.modulus >= 2) {
            ...
            switch (context.modulus) {
                ...
                case 4:
                    ...
                    int i14 = context.pos;
                    int i15 = i14 + 1;
                    ensureBufferSize2[i14] = (byte) ((j >> 8) & 255);
                    context.pos = i15 + 1;
                    ensureBufferSize2[i15] = (byte) (j & 255);
                    return;
                case 5:
                    context.lbitWorkArea = context.lbitWorkArea >> 1;
                    int i16 = context.pos;
                    int i17 = i16 + 1;
                    ensureBufferSize2[i16] = (byte) ((j2 >> 16) & 255);
                    int i18 = i17 + 1;
                    ensureBufferSize2[i17] = (byte) ((j2 >> 8) & 255);
                    context.pos = i18 + 1;
                    ensureBufferSize2[i18] = (byte) (j2 & 255);
                    return;
                case 6:
                    context.lbitWorkArea = context.lbitWorkArea >> 6;
                    int i19 = context.pos;
                    int i20 = i19 + 1;
                    ensureBufferSize2[i19] = (byte) ((j3 >> 16) & 255);
                    int i21 = i20 + 1;
                    ensureBufferSize2[i20] = (byte) ((j3 >> 8) & 255);
                    context.pos = i21 + 1;
                    ensureBufferSize2[i21] = (byte) (j3 & 255);
                    return;
                case 7:
                    context.lbitWorkArea = context.lbitWorkArea >> 3;
                    int i22 = context.pos;
                    int i23 = i22 + 1;
                    ensureBufferSize2[i22] = (byte) ((j4 >> 24) & 255);
                    int i24 = i23 + 1;
                    ensureBufferSize2[i23] = (byte) ((j4 >> 16) & 255);
                    int i25 = i24 + 1;
                    ensureBufferSize2[i24] = (byte) ((j4 >> 8) & 255);
                    context.pos = i25 + 1;
                    ensureBufferSize2[i25] = (byte) (j4 & 255);
                    return;
                default:
    ...
    public void encode(byte[] bArr, int i, int i2, BaseNCodec.Context context) {
        ...
        if (i2 >= 0) {
            ...
            while (i6 < i2) {
                ...
                if (i7 == 0) {
                    ...
                    ensureBufferSize[i10] = bArr2[((int) (j >> 35)) & MASK_5BITS];
                    int i12 = i11 + 1;
                    ensureBufferSize[i11] = bArr2[((int) (j >> 30)) & MASK_5BITS];
                    int i13 = i12 + 1;
                    i3 = i8;
                    ensureBufferSize[i12] = bArr2[((int) (j >> 25)) & MASK_5BITS];
                    int i14 = i13 + 1;
                    ensureBufferSize[i13] = bArr2[((int) (j >> 20)) & MASK_5BITS];
                    int i15 = i14 + 1;
                    ensureBufferSize[i14] = bArr2[((int) (j >> 15)) & MASK_5BITS];
                    int i16 = i15 + 1;
                    ensureBufferSize[i15] = bArr2[((int) (j >> 10)) & MASK_5BITS];
                    int i17 = i16 + 1;
                    ensureBufferSize[i16] = bArr2[((int) (j >> 5)) & MASK_5BITS];
                    int i18 = i17 + 1;
                    context.pos = i18;
                    ensureBufferSize[i17] = bArr2[((int) j) & MASK_5BITS];
        ...
        if (i22 != 0) {
            if (i22 == 1) {
                ...
                ensureBufferSize2[i21] = bArr4[((int) (j2 >> 3)) & MASK_5BITS];
                int i24 = i23 + 1;
                ensureBufferSize2[i23] = bArr4[((int) (j2 << 2)) & MASK_5BITS];
                int i25 = i24 + 1;
                byte b = this.pad;
                ...
                ensureBufferSize2[i21] = bArr5[((int) (j3 >> 11)) & MASK_5BITS];
                int i31 = i30 + 1;
                ensureBufferSize2[i30] = bArr5[((int) (j3 >> 6)) & MASK_5BITS];
                int i32 = i31 + 1;
                ensureBufferSize2[i31] = bArr5[((int) (j3 >> 1)) & MASK_5BITS];
                int i33 = i32 + 1;
                ensureBufferSize2[i32] = bArr5[((int) (j3 << 4)) & MASK_5BITS];
                int i34 = i33 + 1;
                byte b2 = this.pad;
                ...
                ensureBufferSize2[i21] = bArr6[((int) (j4 >> 19)) & MASK_5BITS];
                int i38 = i37 + 1;
                ensureBufferSize2[i37] = bArr6[((int) (j4 >> 14)) & MASK_5BITS];
                int i39 = i38 + 1;
                ensureBufferSize2[i38] = bArr6[((int) (j4 >> 9)) & MASK_5BITS];
                int i40 = i39 + 1;
                ensureBufferSize2[i39] = bArr6[((int) (j4 >> 4)) & MASK_5BITS];
                int i41 = i40 + 1;
                ensureBufferSize2[i40] = bArr6[((int) (j4 << 1)) & MASK_5BITS];
                int i42 = i41 + 1;
                byte b3 = this.pad;
                ...
                ensureBufferSize2[i21] = bArr7[((int) (j5 >> 27)) & MASK_5BITS];
                int i45 = i44 + 1;
                ensureBufferSize2[i44] = bArr7[((int) (j5 >> 22)) & MASK_5BITS];
                int i46 = i45 + 1;
                ensureBufferSize2[i45] = bArr7[((int) (j5 >> 17)) & MASK_5BITS];
                int i47 = i46 + 1;
                ensureBufferSize2[i46] = bArr7[((int) (j5 >> 12)) & MASK_5BITS];
                int i48 = i47 + 1;
                ensureBufferSize2[i47] = bArr7[((int) (j5 >> 7)) & MASK_5BITS];
                int i49 = i48 + 1;
                ensureBufferSize2[i48] = bArr7[((int) (j5 >> 2)) & MASK_5BITS];
                int i50 = i49 + 1;
                ensureBufferSize2[i49] = bArr7[((int) (j5 << 3)) & MASK_5BITS];
                context.pos = i50 + 1;
    ...
    public Base32(int i, byte[] bArr, boolean z, byte b) {
        ...
        if (i <= 0) {
            ...
            if (!containsAlphabetOrPad(bArr)) {
                ...
                throw new IllegalArgumentException(e.e("lineSeparator must not contain Base32 characters: [", StringUtils.newStringUtf8(bArr), "]"));
            }
        } else {
            throw new IllegalArgumentException(a.d("lineLength ", i, " > 0, but lineSeparator is null"));
        }
