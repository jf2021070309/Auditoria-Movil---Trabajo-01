...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (JavascriptBridge.MraidHandler.CLOSE_ACTION.equalsIgnoreCase(build.request().header("Connection")) || JavascriptBridge.MraidHandler.CLOSE_ACTION.equalsIgnoreCase(build.header("Connection"))) {
            streamAllocation.noNewStreams();
        }
