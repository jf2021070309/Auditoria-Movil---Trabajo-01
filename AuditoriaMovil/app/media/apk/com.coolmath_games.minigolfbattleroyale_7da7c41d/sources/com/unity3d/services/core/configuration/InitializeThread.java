...
public class InitializeThread extends Thread {
    ...
    public static class InitializeStateError extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            SDKMetrics.getInstance().sendEventWithTags("native_initialization_failed", new HashMap<String, String>() { // from class: com.unity3d.services.core.configuration.InitializeThread.InitializeStateError.1
                {
