...
public class UnityServices {
    ...
    public static void initialize(Context context, String str, IUnityServicesListener iUnityServicesListener, boolean z, boolean z2, IUnityAdsInitializationListener iUnityAdsInitializationListener) {
        boolean isTestMode;
        boolean isPerPlacementLoadEnabled;
        DeviceLog.entered();
        if (SdkProperties.getCurrentInitializationState() != SdkProperties.InitializationState.NOT_INITIALIZED) {
            String str2 = "";
            String gameId = ClientProperties.getGameId();
            if (gameId != null && !gameId.equals("3237327")) {
                str2 = "" + createExpectedParametersString("Game ID", ClientProperties.getGameId(), "3237327");
            }
            ...
            if (SdkProperties.isPerPlacementLoadEnabled() != z2) {
        ...
        if (SdkProperties.getCurrentInitializationState() == SdkProperties.InitializationState.INITIALIZED_SUCCESSFULLY) {
            ...
            ClientProperties.setGameId("3237327");
            ...
            if ("3237327" == 0 || "3237327".length() == 0) {
                ...
                if (z) {
                    DeviceLog.info("Initializing Unity Services " + SdkProperties.getVersionName() + " (" + SdkProperties.getVersionCode() + ") with game id 3237327 in test mode");
                } else {
                    DeviceLog.info("Initializing Unity Services " + SdkProperties.getVersionName() + " (" + SdkProperties.getVersionCode() + ") with game id 3237327 in production mode");
                }
