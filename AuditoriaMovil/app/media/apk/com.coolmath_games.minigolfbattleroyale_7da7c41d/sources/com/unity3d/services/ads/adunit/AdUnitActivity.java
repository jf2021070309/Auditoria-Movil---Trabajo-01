    ...
    */
    ...
    public Map<String, Integer> getViewFrame(String str) {
        ...
        if (str.equals("adunit")) {
            ...
            hashMap.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, Integer.valueOf(this._layout.getWidth()));
            hashMap.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, Integer.valueOf(this._layout.getHeight()));
            return hashMap;
        }
        ...
        if (view != null) {
            ...
            hashMap2.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, Integer.valueOf(view.getWidth()));
            hashMap2.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, Integer.valueOf(view.getHeight()));
            return hashMap2;
        }
        return null;
    }
