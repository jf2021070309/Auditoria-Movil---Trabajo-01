...
public class ReportDBAdapter implements DBAdapter<Report> {
    ...
    public ContentValues toContentValues(Report report) {
        ...
        contentValues.put("ordinal", Integer.valueOf(report.ordinal));
        ...
        contentValues.put(ReportColumns.COLUMN_USER_ACTIONS, this.gson.toJson(new ArrayList(report.userActions), this.userActionsType));
        contentValues.put(ReportColumns.COLUMN_CLICKED_THROUGH, this.gson.toJson(new ArrayList(report.clickedThrough), this.stringType));
        contentValues.put(ReportColumns.COLUMN_ERRORS, this.gson.toJson(new ArrayList(report.errors), this.stringType));
