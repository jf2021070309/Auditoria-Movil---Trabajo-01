...
public class AdvertisementDBAdapter implements DBAdapter<Advertisement> {
    ...
    public ContentValues toContentValues(Advertisement advertisement) {
        ...
        contentValues.put(AdvertisementColumns.COLUMN_AD_CONFIG, this.gson.toJson(advertisement.adConfig));
        contentValues.put(AdvertisementColumns.COLUMN_CHECKPOINTS, this.gson.toJson(advertisement.checkpoints, CHECKPOINT_LIST_TYPE));
        contentValues.put(AdvertisementColumns.COLUMN_DYNAMIC_EVENTS_AND_URLS, this.gson.toJson(advertisement.dynamicEventsAndUrls, DYNAMIC_EVENTS_AND_URLS_TYPE));
        contentValues.put(AdvertisementColumns.COLUMN_TEMPLATE_SETTINGS, this.gson.toJson(advertisement.templateSettings, this.stringMapType));
        contentValues.put(AdvertisementColumns.COLUMN_MRAID_FILES, this.gson.toJson(advertisement.mraidFiles, this.stringMapType));
        contentValues.put(AdvertisementColumns.COLUMN_CACHEABLE_ASSETS, this.gson.toJson(advertisement.cacheableAssets, this.cacheableMapType));
    ...
    public Advertisement fromContentValues(ContentValues contentValues) {
        ...
        advertisement.adConfig = (AdConfig) this.gson.fromJson(contentValues.getAsString(AdvertisementColumns.COLUMN_AD_CONFIG), (Class<Object>) AdConfig.class);
