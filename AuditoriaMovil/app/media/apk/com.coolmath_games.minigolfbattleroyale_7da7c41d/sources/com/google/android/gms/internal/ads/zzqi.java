            ...
            if ("V_MPEG4/ISO/AVC".equals(zzqgVar.zzb) || "V_MPEGH/ISO/HEVC".equals(zzqgVar.zzb)) {
                ...
                while (this.zzW < zze2) {
                    ...
                    if (i14 == 0) {
                        ...
                        ((zznp) zznvVar).zza(zzi, i13 + min, i12 - min, false);
                        if (min > 0) {
                        ...
                        int zzx = zzx(zznvVar, zzoxVar, i14);
                        this.zzW += zzx;
                        this.zzX += zzx;
                        this.zzY -= zzx;
                    }
                ...
                while (true) {
                    ...
                    int zzx2 = zzx(zznvVar, zzoxVar, zze2 - i15);
                    this.zzW += zzx2;
                    this.zzX += zzx2;
                }
            }
        ...
        while (!this.zzK) {
            if (!this.zzag.zzc(zznvVar)) {
                for (int i = 0; i < this.zzh.size(); i++) {
                    zzqg valueAt = this.zzh.valueAt(i);
                    zzqg.zze(valueAt);
