...
public final class zze {
    ...
    final void zzc(Context context, zzcgz zzcgzVar, boolean z, zzcfz zzcfzVar, String str, String str2, Runnable runnable) {
        ...
        if (context == null) {
            ...
            zzbtw zza = zzt.zzp().zzb(this.zza, zzcgzVar).zza("google.afma.config.fetchAppSettings", zzbud.zza, zzbud.zza);
            try {
                ...
                zzfsm zzb = zza.zzb(jSONObject);
                zzfsm zzi = zzfsd.zzi(zzb, zzd.zza, zzchg.zzf);
                if (runnable != null) {
                    zzb.zze(runnable, zzchg.zzf);
                }
