            ...
            if (activity2 != null) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        com.google.android.gms.ads.internal.zzt.zzg().zzk(e, "AppActivityTracker.ActivityListener.onActivityDestroyed");
                        zzcgt.zzg("", e);
                    }
                }
            }
        ...
        synchronized (this.zzc) {
            for (zzaxk zzaxkVar : this.zzg) {
                try {
                    ...
                    com.google.android.gms.ads.internal.zzt.zzg().zzk(e, "AppActivityTracker.ActivityListener.onActivityPaused");
                    zzcgt.zzg("", e);
                }
            }
        }
        ...
        synchronized (this.zzc) {
            for (zzaxk zzaxkVar : this.zzg) {
                try {
                    ...
                    com.google.android.gms.ads.internal.zzt.zzg().zzk(e, "AppActivityTracker.ActivityListener.onActivityResumed");
                    zzcgt.zzg("", e);
                }
            }
            if (z) {
