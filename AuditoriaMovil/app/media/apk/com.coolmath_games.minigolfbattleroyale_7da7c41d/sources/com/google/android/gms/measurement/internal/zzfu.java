...
public final class zzfu implements zzgp {
    ...
    zzfu(zzgw zzgwVar) {
        ...
        com.google.android.gms.internal.measurement.zzht.zzb(this.zze);
        ...
        this.zzn.zzh(new zzft(this, zzgwVar));
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void zza(com.google.android.gms.internal.measurement.zzcl zzclVar) {
        zzaf zzafVar;
        zzav().zzg();
        zzaf zzi = zzd().zzi();
        zzfb zzd2 = zzd();
