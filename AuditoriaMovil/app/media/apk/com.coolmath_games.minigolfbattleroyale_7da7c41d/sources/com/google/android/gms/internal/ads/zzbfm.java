        ...
        switch (i) {
            ...
            case 8:
                ...
                if (readStrongBinder2 != null) {
                    ...
                    if (queryLocalInterface2 instanceof zzbfu) {
                        zzbfuVar = (zzbfu) queryLocalInterface2;
                    } else {
                        zzbfuVar = new zzbfs(readStrongBinder2);
                    }
                }
                zzp(zzbfuVar);
                parcel2.writeNoException();
            ...
            case 20:
                ...
                if (readStrongBinder3 != null) {
                    ...
                    if (queryLocalInterface3 instanceof zzbex) {
                        zzbexVar = (zzbex) queryLocalInterface3;
                    } else {
                        zzbexVar = new zzbev(readStrongBinder3);
                    }
                }
                zzF(zzbexVar);
                parcel2.writeNoException();
            ...
            case 21:
                ...
                if (readStrongBinder4 != null) {
                    ...
                    if (queryLocalInterface4 instanceof zzbfy) {
                        zzbfyVar = (zzbfy) queryLocalInterface4;
                    } else {
                        zzbfyVar = new zzbfy(readStrongBinder4);
                    }
                }
                zzab(zzbfyVar);
                parcel2.writeNoException();
            ...
            case 36:
                ...
                if (readStrongBinder5 != null) {
                    ...
                    if (queryLocalInterface5 instanceof zzbfr) {
                        zzbfrVar = (zzbfr) queryLocalInterface5;
                    } else {
                        zzbfrVar = new zzbfp(readStrongBinder5);
                    }
                }
                zzq(zzbfrVar);
                parcel2.writeNoException();
            ...
            case 42:
                ...
                if (readStrongBinder6 != null) {
                    ...
                    if (queryLocalInterface6 instanceof zzbgw) {
                        zzbgwVar = (zzbgw) queryLocalInterface6;
                    } else {
                        zzbgwVar = new zzbgu(readStrongBinder6);
                    }
                }
                zzX(zzbgwVar);
                parcel2.writeNoException();
            ...
            case 43:
                ...
                if (readStrongBinder7 != null) {
                    ...
                    if (queryLocalInterface7 instanceof zzbfd) {
                        zzbfdVar = (zzbfd) queryLocalInterface7;
                    } else {
                        zzbfdVar = new zzbfb(readStrongBinder7);
                    }
                }
                zzY(zzbdgVar, zzbfdVar);
                parcel2.writeNoException();
                return true;
            case 44:
            ...
            case 45:
                ...
                if (readStrongBinder8 != null) {
                    ...
                    if (queryLocalInterface8 instanceof zzbgb) {
                        zzbgbVar = (zzbgb) queryLocalInterface8;
                    } else {
                        zzbgbVar = new zzbfz(readStrongBinder8);
                    }
                }
                zzaa(zzbgbVar);
                parcel2.writeNoException();
