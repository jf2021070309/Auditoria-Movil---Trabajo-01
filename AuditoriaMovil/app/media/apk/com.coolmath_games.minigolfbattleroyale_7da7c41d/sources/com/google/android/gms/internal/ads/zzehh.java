...
public abstract class zzehh<AdT> implements zzeec<AdT> {
    ...
    public final zzfsm<AdT> zzb(zzfal zzfalVar, zzezz zzezzVar) {
        String optString = zzezzVar.zzv.optString(AbstractAdViewAdapter.AD_UNIT_ID_PARAMETER, "");
        ...
        zzd2.putInt("gw", 1);
        String optString2 = zzezzVar.zzv.optString("mad_hac", null);
        if (optString2 != null) {
            zzd2.putString("mad_hac", optString2);
        }
        String optString3 = zzezzVar.zzv.optString("adJson", null);
        if (optString3 != null) {
