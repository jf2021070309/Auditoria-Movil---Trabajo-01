...
public final class zzby extends zzcg {
    ...
    public zzby(zzbu zzbuVar, GoogleApiClient googleApiClient, String str, int i, int i2, int i3, boolean z) {
    ...
    protected final /* synthetic */ void doExecute(com.google.android.gms.games.internal.zzf zzfVar) throws RemoteException {
        zzfVar.zza(this, this.zzfr, this.zzfs, this.zzft, this.zzfu, this.zzfa);
    }
}
