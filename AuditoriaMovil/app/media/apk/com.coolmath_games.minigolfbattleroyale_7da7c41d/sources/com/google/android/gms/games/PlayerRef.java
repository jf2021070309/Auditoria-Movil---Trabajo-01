...
public final class PlayerRef extends zzh implements Player {
    ...
    private PlayerRef(DataHolder dataHolder, int i, String str) {
        super(dataHolder, i);
        this.zzg = new com.google.android.gms.games.internal.player.zzd(null);
        this.zzby = new com.google.android.gms.games.internal.player.zzb(dataHolder, i, this.zzg);
        this.zzbz = new zzn(dataHolder, i, this.zzg);
        this.zzca = new zzb(dataHolder, i, this.zzg);
        if ((hasNull(this.zzg.zzii) || getLong(this.zzg.zzii) == -1) ? false : true) {
            int integer = getInteger(this.zzg.zzij);
            int integer2 = getInteger(this.zzg.zzim);
            PlayerLevel playerLevel = new PlayerLevel(integer, getLong(this.zzg.zzik), getLong(this.zzg.zzil));
            this.zzbg = new PlayerLevelInfo(getLong(this.zzg.zzii), getLong(this.zzg.zzio), playerLevel, integer != integer2 ? new PlayerLevel(integer2, getLong(this.zzg.zzil), getLong(this.zzg.zzin)) : playerLevel);
            return;
        }
        this.zzbg = null;
    }
