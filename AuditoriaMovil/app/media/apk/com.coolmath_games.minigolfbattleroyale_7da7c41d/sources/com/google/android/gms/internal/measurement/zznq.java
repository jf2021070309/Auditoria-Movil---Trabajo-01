...
public final class zznq implements zznp {
    ...
    static {
        ...
        zza = zzhrVar.zza("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzo = zzhrVar.zza("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzy = zzhrVar.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzH = zzhrVar.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
