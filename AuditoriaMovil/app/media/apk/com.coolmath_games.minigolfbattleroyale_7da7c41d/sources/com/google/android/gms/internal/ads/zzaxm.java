...
public final class zzaxm {
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zzaxl> priorityQueue) {
        ...
        while (true) {
            ...
            zze = ((((((zze + 1073807359) - ((((zzaxi.zza(strArr[i3 - 1]) + 2147483647L) % 1073807359) * zzd) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((zzaxi.zza(strArr[i3 + 5]) + 2147483647L) % 1073807359)) % 1073807359;
            zzb(i, zze, zzc(strArr, i3, 6), length2, priorityQueue);
            i3++;
        }
    }

    static void zzb(int i, long j, String str, int i2, PriorityQueue<zzaxl> priorityQueue) {
    ...
    private static long zze(String[] strArr, int i, int i2) {
        ...
        for (int i3 = 1; i3 < i2; i3++) {
            zza = (((zza * 16785407) % 1073807359) + ((zzaxi.zza(strArr[i3]) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return zza;
    }
}
