...
public interface zzbfn extends IInterface {
    ...
    void zzF(zzbex zzbexVar) throws RemoteException;

    void zzG(boolean z) throws RemoteException;

    boolean zzH() throws RemoteException;

    void zzI(zzccf zzccfVar) throws RemoteException;
    ...
    void zzM(zzbis zzbisVar) throws RemoteException;

    void zzN(zzbhg zzbhgVar) throws RemoteException;

    void zzO(zzbdr zzbdrVar) throws RemoteException;

    void zzP(zzaxz zzaxzVar) throws RemoteException;

    void zzQ(boolean z) throws RemoteException;

    void zzX(zzbgw zzbgwVar) throws RemoteException;

    void zzY(zzbdg zzbdgVar, zzbfd zzbfdVar) throws RemoteException;

    void zzZ(IObjectWrapper iObjectWrapper) throws RemoteException;

    void zzaa(zzbgb zzbgbVar) throws RemoteException;

    void zzab(zzbfy zzbfyVar) throws RemoteException;
    ...
    void zzo(zzbfa zzbfaVar) throws RemoteException;

    void zzp(zzbfu zzbfuVar) throws RemoteException;

    void zzq(zzbfr zzbfrVar) throws RemoteException;
    ...
    void zzw(zzbzz zzbzzVar) throws RemoteException;

    void zzx(zzcac zzcacVar, String str) throws RemoteException;
