...
public final class zzcdv extends AbstractSafeParcelable {
    ...
    public static zzcdv zza(JSONObject jSONObject) throws JSONException {
        return new zzcdv(jSONObject.optString("click_string", ""), jSONObject.optString("report_url", ""), jSONObject.optBoolean("rendered_ad_enabled", false), jSONObject.optBoolean("non_malicious_reporting_enabled", false), com.google.android.gms.ads.internal.util.zzbx.zza(jSONObject.optJSONArray("allowed_headers"), null), jSONObject.optBoolean("protection_enabled", false), jSONObject.optBoolean("malicious_reporting_enabled", false), com.google.android.gms.ads.internal.util.zzbx.zza(jSONObject.optJSONArray("webview_permissions"), null));
    }
