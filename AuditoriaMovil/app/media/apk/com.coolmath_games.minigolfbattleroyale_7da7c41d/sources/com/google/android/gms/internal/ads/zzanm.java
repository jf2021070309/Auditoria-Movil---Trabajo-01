...
public final class zzanm implements Parcelable {
    ...
    public static zzanm zza(String str, String str2, String str3, int i, int i2, int i3, int i4, float f, List<byte[]> list, int i5, float f2, byte[] bArr, int i6, zzavh zzavhVar, zzapk zzapkVar) {
        return new zzanm(str, null, str2, null, -1, i2, i3, i4, -1.0f, i5, f2, bArr, i6, zzavhVar, -1, -1, -1, -1, -1, 0, null, -1, LongCompanionObject.MAX_VALUE, list, zzapkVar, null);
    }
    ...
    public static zzanm zzc(String str, String str2, String str3, int i, int i2, int i3, int i4, int i5, int i6, int i7, List<byte[]> list, zzapk zzapkVar, int i8, String str4, zzaru zzaruVar) {
        return new zzanm(str, null, str2, null, -1, i2, -1, -1, -1.0f, -1, -1.0f, null, -1, null, i3, i4, i5, -1, -1, i8, str4, -1, LongCompanionObject.MAX_VALUE, list, zzapkVar, null);
    }
    ...
    public static zzanm zze(String str, String str2, String str3, int i, List<byte[]> list, String str4, zzapk zzapkVar) {
        return new zzanm(str, null, str2, null, -1, -1, -1, -1, -1.0f, -1, -1.0f, null, -1, null, -1, -1, -1, -1, -1, 0, str4, -1, LongCompanionObject.MAX_VALUE, list, zzapkVar, null);
    }

    public static zzanm zzf(String str, String str2, String str3, int i, zzapk zzapkVar) {
        return new zzanm(str, null, "application/x-camera-motion", null, -1, -1, -1, -1, -1.0f, -1, -1.0f, null, -1, null, -1, -1, -1, -1, -1, 0, null, -1, LongCompanionObject.MAX_VALUE, null, zzapkVar, null);
    }
    ...
    public final MediaFormat zzl() {
        ...
        zzm(mediaFormat, ViewHierarchyConstants.DIMENSION_WIDTH_KEY, this.zzj);
        zzm(mediaFormat, ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, this.zzk);
        float f = this.zzl;
        if (f != -1.0f) {
