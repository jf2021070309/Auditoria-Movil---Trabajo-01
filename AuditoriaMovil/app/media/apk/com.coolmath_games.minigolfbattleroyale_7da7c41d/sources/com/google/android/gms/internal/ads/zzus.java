...
final class zzus implements zzut {
    ...
    public zzus(zznx zznxVar, zzox zzoxVar, zzuw zzuwVar) throws zzaha {
        ...
        this.zzd = zzoxVar;
        this.zze = zzuwVar;
        this.zzi = Math.max(1, zzuwVar.zzc / 10);
        ...
        int zzw = zzamq.zzw(this.zzi, zzp);
        this.zzg = new byte[zzuwVar.zzd * zzw];
        int i3 = this.zzf;
        this.zzh = new zzamf(zzw * (i3 + i3) * i);
        int i4 = ((zzuwVar.zzc * zzuwVar.zzd) * 8) / this.zzf;
        zzaft zzaftVar = new zzaft();
        zzaftVar.zzN("audio/raw");
        zzaftVar.zzI(i4);
        zzaftVar.zzJ(i4);
        int i5 = this.zzi;
        zzaftVar.zzO((i5 + i5) * i);
