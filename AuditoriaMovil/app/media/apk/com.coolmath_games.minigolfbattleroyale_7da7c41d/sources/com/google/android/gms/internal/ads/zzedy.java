...
public final class zzedy extends zzbzd {
    ...
    public final void zzf(IObjectWrapper iObjectWrapper, String str, String str2) {
        ...
        PendingIntent zza = zzfld.zza(context, 0, intent, zzfld.zza | 1073741824, 0);
        Intent intent2 = new Intent();
        intent2.setClass(context, AdService.class);
        intent2.setAction("offline_notification_dismissed");
        intent2.putExtra("offline_notification_action", "offline_notification_dismissed");
        intent2.putExtra("gws_query_id", str2);
        PendingIntent zza2 = zzfld.zza(context, 0, intent2, zzfld.zza | 1073741824, 0);
        Resources zzj = com.google.android.gms.ads.internal.zzt.zzg().zzj();
        ((NotificationManager) context.getSystemService("notification")).notify(str2, 54321, new NotificationCompat.Builder(context, "offline_notification_channel").setContentTitle(zzj == null ? "View the ad you saved when you were offline" : zzj.getString(R.string.offline_notification_title)).setContentText(zzj == null ? "Tap to open ad" : zzj.getString(R.string.offline_notification_text)).setAutoCancel(true).setDeleteIntent(zza2).setContentIntent(zza).setSmallIcon(context.getApplicationInfo().icon).build());
