    ...
    */
    ...
    public static String zzi(ByteBuffer byteBuffer, int i, int i2) throws zzggm {
        ...
        if (byteBuffer.hasArray()) {
            return zzgjaVar.zzc(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (!byteBuffer.isDirect()) {
            return zzgja.zzd(byteBuffer, i, i2);
        } else {
            return zzgjb.zzd(byteBuffer, i, i2);
        }
    }
