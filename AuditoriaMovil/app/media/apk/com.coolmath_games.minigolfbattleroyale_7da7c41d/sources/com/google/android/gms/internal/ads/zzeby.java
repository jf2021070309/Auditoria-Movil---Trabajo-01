...
public final class zzeby implements zzdfx, zzbcv, zzdbw, zzdbg {
    ...
    private final zzffb zzh(String str) {
        ...
        zza.zzi(this.zzd);
        zza.zzc(SDKAnalyticsEvents.PARAMETER_REQUEST_ID, this.zzi);
    ...
    public final void zza(zzbcz zzbczVar) {
        ...
        if (this.zzg) {
            ...
            zzffb zzh = zzh("ifts");
            zzh.zzc(IronSourceConstants.EVENTS_ERROR_REASON, "adapter");
            if (i >= 0) {
                zzh.zzc("arec", String.valueOf(i));
            }
            if (zza != null) {
                zzh.zzc("areec", zza);
            }
    ...
    public final void zzb(zzdkm zzdkmVar) {
        if (this.zzg) {
            zzffb zzh = zzh("ifts");
            zzh.zzc(IronSourceConstants.EVENTS_ERROR_REASON, "exception");
            if (!TextUtils.isEmpty(zzdkmVar.getMessage())) {
                zzh.zzc(NotificationCompat.CATEGORY_MESSAGE, zzdkmVar.getMessage());
            }
            this.zzh.zza(zzh);
        }
    }
    ...
    public final void zzd() {
        if (this.zzg) {
            ...
            zzffb zzh = zzh("ifts");
            zzh.zzc(IronSourceConstants.EVENTS_ERROR_REASON, "blocked");
            zzffcVar.zza(zzh);
        }
    }
