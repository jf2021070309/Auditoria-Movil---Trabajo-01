...
public final class zzfhh extends zzfhe {
    ...
    public final void zzb() {
        super.zzb();
        new Handler().postDelayed(new zzfhg(this), Math.max(4000 - (this.zzb == null ? 4000L : TimeUnit.MILLISECONDS.convert(System.nanoTime() - this.zzb.longValue(), TimeUnit.NANOSECONDS)), (long) AdLoader.RETRY_DELAY));
        this.zza = null;
    }
