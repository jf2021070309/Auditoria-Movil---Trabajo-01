...
public interface zzdu extends IInterface {
    void zza(zzcz zzczVar) throws RemoteException;

    void zza(zzfm zzfmVar) throws RemoteException;

    void zza(zzfq zzfqVar) throws RemoteException;

    void zza(zzfu zzfuVar) throws RemoteException;
    ...
    void zza(zzgj zzgjVar) throws RemoteException;

    void zza(zzgm zzgmVar) throws RemoteException;
