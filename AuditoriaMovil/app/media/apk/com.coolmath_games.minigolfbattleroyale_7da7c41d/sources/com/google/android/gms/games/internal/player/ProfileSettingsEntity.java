...
public class ProfileSettingsEntity extends com.google.android.gms.games.internal.zzb implements Players.zza {
    ...
    public String toString() {
        ...
        char[] cArr = {128, Typography.leftGuillemete, Typography.leftGuillemete, Typography.registered, Typography.paragraph, 133, Typography.plusMinus, 168, 164, 173, Typography.pound, 136, 173, 181, 168, 179, 164, 178};
        for (int i = 0; i < 18; i++) {
            cArr[i] = (char) (cArr[i] - '?');
        }
        ...
        char[] cArr2 = {166, Typography.leftGuillemete, Typography.registered, 161, Typography.nbsp, Typography.leftGuillemete, 158, 165, Typography.plusMinus, 168, 164, 173, Typography.pound, 178, 158, Typography.leftGuillemete, 168, 178, 179, 158, 181, 168, 178, 168, 161, 168, Typography.leftGuillemete, 168, 179, 184};
