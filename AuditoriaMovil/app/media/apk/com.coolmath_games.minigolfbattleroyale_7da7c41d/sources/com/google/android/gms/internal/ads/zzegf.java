...
public final class zzegf implements zzeec<zzdji> {
    ...
    public final /* synthetic */ zzfsm zzc(final zzezz zzezzVar, zzfal zzfalVar, zzdsw zzdswVar, Object obj) throws Exception {
        ...
        final zzdjj zzQ = this.zzc.zzQ(new zzcxv(zzfalVar, zzezzVar, null), new zzdjm(new zzege(this.zza, this.zzf, zzchlVar, zzezzVar, zzb, this.zzd, this.zzh, this.zzg), zzb));
        zzchlVar.zzc(zzQ);
