    ...
    public final boolean zza(zzfjw zzfjwVar) {
        ...
        try {
            try {
                ...
                if (!zzfjvVar.zzf()) {
                    throw new zzfkf((int) GamesStatusCodes.STATUS_SNAPSHOT_NOT_FOUND, "init failed");
                }
                ...
                sb.append("ci: ");
                sb.append(zzh);
                throw new zzfkf((int) GamesStatusCodes.STATUS_SNAPSHOT_CREATION_FAILED, sb.toString());
            } catch (Exception e2) {
                throw new zzfkf((int) IronSourceConstants.IS_CALLBACK_LOAD_SUCCESS, e2);
            }
        } catch (zzfkf e3) {
