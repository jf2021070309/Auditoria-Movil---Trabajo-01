...
public final class zzbhl {
        ...
        try {
            if (this.zzj == null) {
                ...
                if ("search_v2".equals(zzB.zza)) {
                    zzd = new zzbee(zzber.zzb(), context, zzB, this.zzl).zzd(context, false);
                } else {
                    zzd = new zzbec(zzber.zzb(), context, zzB, this.zzl, this.zzb).zzd(context, false);
                }
                this.zzj = zzd;
    ...
    zzbhl(ViewGroup viewGroup, AttributeSet attributeSet, boolean z, zzbdk zzbdkVar, zzbfn zzbfnVar, int i) {
        zzbdl zzbdlVar;
        this.zzb = new zzbvd();
