...
public final class zzee {
    ...
    private final List<Pair<com.google.android.gms.measurement.internal.zzgv, zzdv>> zzf;
    private int zzg;
    private boolean zzh;
    ...
    protected zzee(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        try {
            if (com.google.android.gms.measurement.internal.zzic.zza(context, "google_app_id", com.google.android.gms.measurement.internal.zzfm.zza(context)) != null && !zzR()) {
                this.zzi = null;
                this.zzh = true;
    ...
    public final int zzE(String str) {
        ...
        Integer num = (Integer) zzbz.zze(zzbzVar.zzd(WorkRequest.MIN_BACKOFF_MILLIS), Integer.class);
        if (num == null) {
            return 25;
        }
        return num.intValue();
    ...
    public final void zzd(com.google.android.gms.measurement.internal.zzgu zzguVar) {
    ...
    public final void zzf(com.google.android.gms.measurement.internal.zzgv zzgvVar) {
        Pair<com.google.android.gms.measurement.internal.zzgv, zzdv> pair;
        Preconditions.checkNotNull(zzgvVar);
        synchronized (this.zzf) {
            int i = 0;
            while (true) {
