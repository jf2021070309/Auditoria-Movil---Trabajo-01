        ...
        if (i == 1) {
            ...
            if (readStrongBinder == null) {
                ...
                if (queryLocalInterface instanceof zzbxq) {
                    zzbxoVar = (zzbxq) queryLocalInterface;
                } else {
                    zzbxoVar = new zzbxo(readStrongBinder);
                }
                zzbxqVar = zzbxoVar;
            }
            zze(asInterface, readString, bundle, bundle2, zzbdlVar, zzbxqVar);
            ...
            switch (i) {
                ...
                case 14:
                    ...
                    if (readStrongBinder3 != null) {
                        ...
                        if (queryLocalInterface3 instanceof zzbxe) {
                            zzbxcVar = (zzbxe) queryLocalInterface3;
                        } else {
                            zzbxcVar = new zzbxc(readStrongBinder3);
                        }
                    }
                ...
                case 16:
                    ...
                    if (readStrongBinder4 != null) {
                        ...
                        if (queryLocalInterface4 instanceof zzbxk) {
                            zzbxiVar2 = (zzbxk) queryLocalInterface4;
                        } else {
                            zzbxiVar2 = new zzbxi(readStrongBinder4);
                        }
                    }
                ...
                case 18:
                    ...
                    if (readStrongBinder5 != null) {
                        ...
                        if (queryLocalInterface5 instanceof zzbxh) {
                            zzbxfVar2 = (zzbxh) queryLocalInterface5;
                        } else {
                            zzbxfVar2 = new zzbxf(readStrongBinder5);
                        }
                    }
                ...
                case 20:
                    ...
                    if (readStrongBinder6 != null) {
                        ...
                        if (queryLocalInterface6 instanceof zzbxk) {
                            zzbxiVar = (zzbxk) queryLocalInterface6;
                        } else {
                            zzbxiVar = new zzbxi(readStrongBinder6);
                        }
                    }
                ...
                case 21:
                    ...
                    if (readStrongBinder7 != null) {
                        ...
                        if (queryLocalInterface7 instanceof zzbxb) {
                            zzbwzVar = (zzbxb) queryLocalInterface7;
                        } else {
                            zzbwzVar = new zzbwz(readStrongBinder7);
                        }
                    }
                ...
                case 22:
                    ...
                    if (readStrongBinder8 != null) {
                        ...
                        if (queryLocalInterface8 instanceof zzbxh) {
                            zzbxfVar = (zzbxh) queryLocalInterface8;
                        } else {
                            zzbxfVar = new zzbxf(readStrongBinder8);
                        }
                    }
