...
public final class zzfke {
    ...
    private final zzadi zzk(int i) {
        ...
        try {
            zzgex zzt = zzgex.zzt(Hex.stringToBytes(string));
            if (this.zze) {
                zzb = zzgfm.zza();
            } else {
                zzb = zzgfm.zzb();
            }
            return zzadi.zzh(zzt, zzb);
        } catch (zzggm unused) {
            return null;
    ...
    public final boolean zza(zzadf zzadfVar, zzfkd zzfkdVar) {
        ...
        synchronized (zzf) {
            ...
            if (zzk == null || !zzk.zza().equals(zza)) {
                ...
                File zze = zze(zza);
                if (zze.exists()) {
                    String str = true != zze.isDirectory() ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
                    String str2 = true != zze.isFile() ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
                    ...
                    String str3 = true != zze.canWrite() ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
