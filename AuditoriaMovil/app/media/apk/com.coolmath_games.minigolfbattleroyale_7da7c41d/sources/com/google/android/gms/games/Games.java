...
public final class Games {
    ...
    static final Api.ClientKey<com.google.android.gms.games.internal.zzf> CLIENT_KEY = new Api.ClientKey<>();
    private static final Api.AbstractClientBuilder<com.google.android.gms.games.internal.zzf, GamesOptions> zzaf = new zze();
    private static final Api.AbstractClientBuilder<com.google.android.gms.games.internal.zzf, GamesOptions> zzag = new zzg();
    ...
    public static final Scope zzah = new Scope(FirstPartyScopes.GAMES_1P);
    private static final Api<GamesOptions> zzai = new Api<>("Games.API_1P", zzag, CLIENT_KEY);
    @Deprecated
    public static final GamesMetadata GamesMetadata = new zzba();
    @Deprecated
    public static final Achievements Achievements = new zzo();
    @Deprecated
    public static final Events Events = new zzai();
    @Deprecated
    public static final Leaderboards Leaderboards = new zzbu();
    @Deprecated
    public static final Players Players = new zzcw();
    @Deprecated
    public static final Snapshots Snapshots = new zzdq();
    @Deprecated
    public static final Stats Stats = new zzee();
    @Deprecated
    public static final Videos Videos = new zzeq();
    ...
    public static abstract class zzb<T extends Result> extends BaseImplementation.ApiMethodImpl<T, com.google.android.gms.games.internal.zzf> {
        ...
        public /* bridge */ /* synthetic */ void setResult(Object obj) {
            super.setResult((zzb<T>) ((Result) obj));
        }
    }
