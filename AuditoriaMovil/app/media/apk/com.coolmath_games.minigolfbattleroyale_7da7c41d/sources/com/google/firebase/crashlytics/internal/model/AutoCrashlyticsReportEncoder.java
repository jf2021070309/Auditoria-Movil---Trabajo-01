...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.of(VisionDataDBAdapter.VisionDataColumns.COLUMN_TIMESTAMP);
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        ...
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.of("type");
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.of(IronSourceConstants.EVENTS_ERROR_REASON);
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.of("frames");
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        ...
        private static final FieldDescriptor ORIENTATION_DESCRIPTOR = FieldDescriptor.of(AdUnitActivity.EXTRA_ORIENTATION);
