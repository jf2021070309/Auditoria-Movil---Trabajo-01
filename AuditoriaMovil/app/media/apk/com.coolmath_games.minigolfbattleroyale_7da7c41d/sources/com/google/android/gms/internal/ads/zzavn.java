...
public final class zzavn extends zzari {
    ...
    protected final int zzJ(zzark zzarkVar, zzanm zzanmVar) throws zzarm {
        ...
        if (zzauu.zzb(str)) {
            ...
            if (zzd && zzanmVar.zzj > 0 && zzanmVar.zzk > 0) {
                if (zzave.zza >= 21) {
                    zzd = zza.zze(zzanmVar.zzj, zzanmVar.zzk, zzanmVar.zzl);
                } else {
                    zzd = zzanmVar.zzj * zzanmVar.zzk <= zzarr.zzc();
                    if (!zzd) {
                        int i2 = zzanmVar.zzj;
                        int i3 = zzanmVar.zzk;
    ...
    protected final void zzL(zzarg zzargVar, MediaCodec mediaCodec, zzanm zzanmVar, MediaCrypto mediaCrypto) throws zzarm {
            ...
            if (i2 != -1 && i3 != -1) {
                ...
                if (z && !z) {
                    if (!z) {
                        ...
                        i = zzave.zze(i2, 16) * zzave.zze(i3, 16) * 256;
                        i5 = 2;
                        i4 = (i * 3) / (i5 + i5);
                    }
                }
        ...
        zzavm zzavmVar = new zzavm(i2, i3, i4);
        this.zzh = zzavmVar;
        boolean z2 = this.zze;
        ...
        int i6 = zzavmVar.zzc;
        if (i6 != -1) {
            zzl.setInteger("max-input-size", i6);
        }
        if (z2) {
