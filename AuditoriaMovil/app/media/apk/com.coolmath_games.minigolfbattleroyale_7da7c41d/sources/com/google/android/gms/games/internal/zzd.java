...
public final class zzd {
    ...
    static {
        char[] cArr = {175, Typography.leftGuillemete, Typography.nbsp, 184, 158, 179, Typography.registered, 166, 164, 179, Typography.section, 164, Typography.plusMinus, 158, 165, Typography.plusMinus, 168, 164, 173, Typography.pound, 158, 178, 179, Typography.nbsp, 179, 180, 178};
        for (int i = 0; i < 27; i++) {
            cArr[i] = (char) (cArr[i] - '?');
        }
        zzda = new String(cArr);
        char[] cArr2 = {175, Typography.leftGuillemete, Typography.nbsp, 184, 158, 179, Typography.registered, 166, 164, 179, Typography.section, 164, Typography.plusMinus, 158, 173, 168, Typography.cent, 170, 173, Typography.nbsp, 172, 164};
        for (int i2 = 0; i2 < 22; i2++) {
            cArr2[i2] = (char) (cArr2[i2] - '?');
        }
        zzdb = new String(cArr2);
        char[] cArr3 = {175, Typography.leftGuillemete, Typography.nbsp, 184, 158, 179, Typography.registered, 166, 164, 179, Typography.section, 164, Typography.plusMinus, 158, 168, 173, 181, 168, 179, Typography.nbsp, 179, 168, Typography.registered, 173, 158, 173, 168, Typography.cent, 170, 173, Typography.nbsp, 172, 164};
        ...
        zzde = (String[]) zza.toArray(new String[0]);
        zzdf = (String[]) ((zzfx) ((zzfx) new zzfx().zza(zza2)).zza(zza)).zzct().toArray(new String[0]);
    }
}
