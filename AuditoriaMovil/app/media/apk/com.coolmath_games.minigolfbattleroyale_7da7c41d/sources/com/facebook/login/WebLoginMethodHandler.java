...
public abstract class WebLoginMethodHandler extends LoginMethodHandler {
    ...
    public Bundle getParameters(LoginClient.Request request) {
        ...
        bundle.putString(ServerProtocol.DIALOG_PARAM_IES, FacebookSdk.getAutoLogAppEventsEnabled() ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        return bundle;
    }
    ...
    public Bundle addExtraParameters(Bundle bundle, LoginClient.Request request) {
        ...
        bundle.putString(ServerProtocol.DIALOG_PARAM_CUSTOM_TABS_PREFETCHING, FacebookSdk.hasCustomTabsPrefetching ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        ...
        if (request.getMessengerPageId() != null) {
            ...
            bundle.putString(ServerProtocol.DIALOG_PARAM_RESET_MESSENGER_STATE, request.getResetMessengerState() ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        }
        return bundle;
    }
    ...
    public void onComplete(LoginClient.Request request, Bundle bundle, FacebookException facebookException) {
        ...
        if (bundle != null) {
            ...
            try {
                ...
                createErrorResult = LoginClient.Result.createCompositeTokenResult(this.loginClient.getPendingRequest(), createAccessTokenFromWebBundle, createAuthenticationTokenFromWebBundle(bundle, request.getNonce()));
