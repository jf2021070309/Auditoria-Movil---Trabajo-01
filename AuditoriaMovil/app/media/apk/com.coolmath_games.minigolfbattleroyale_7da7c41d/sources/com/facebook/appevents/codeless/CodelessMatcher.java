...
public final class CodelessMatcher {
    ...
    public static final class ViewMatcher implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Runnable {
        ...
        public void run() {
            ...
            try {
                if (!CrashShieldHandler.isObjectCrashing(this) && (appSettingsWithoutQuery = FetchedAppSettingsManager.getAppSettingsWithoutQuery(FacebookSdk.getApplicationId())) != null && appSettingsWithoutQuery.getCodelessEventsEnabled()) {
        ...
        public static final class Companion {
            ...
            public final List<MatchedView> findViewByPath(EventBinding eventBinding, View view, List<PathComponent> path, int i, int i2, String mapKey) {
                ...
                if (i >= path.size()) {
                    ...
                    if (Intrinsics.areEqual(pathComponent.getClassName(), CodelessMatcher.PARENT_CLASS_NAME)) {
                        ...
                        if (parent instanceof ViewGroup) {
                            ...
                            List<View> findVisibleChildren = companion.findVisibleChildren((ViewGroup) parent);
                            int size = findVisibleChildren.size();
                            for (int i3 = 0; i3 < size; i3++) {
                                arrayList.addAll(companion.findViewByPath(eventBinding, findVisibleChildren.get(i3), path, i + 1, i3, str));
                            }
                        }
                        return arrayList;
                ...
                if (view instanceof ViewGroup) {
                    ...
                    List<View> findVisibleChildren2 = companion2.findVisibleChildren((ViewGroup) view);
                    int size2 = findVisibleChildren2.size();
                    for (int i4 = 0; i4 < size2; i4++) {
                        arrayList.addAll(companion2.findViewByPath(eventBinding, findVisibleChildren2.get(i4), path, i + 1, i4, str));
                    }
                }
                return arrayList;
            }
