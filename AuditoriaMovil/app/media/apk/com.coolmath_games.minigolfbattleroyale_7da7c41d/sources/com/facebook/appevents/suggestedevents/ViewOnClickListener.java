                ...
                public final void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            String textFeature = FeatureExtractor.getTextFeature(str2, ViewOnClickListener.access$getActivityName$p(ViewOnClickListener.this), lowerCase);
                            ...
                            if (!Intrinsics.areEqual(str3, "other")) {
                                ViewOnClickListener.Companion.processPredictedResult(str3, str2, denseFeatures);
                            }
                        } catch (Exception unused) {
                        }
                    } catch (Throwable th) {
                    ...
                    Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.ViewOnClickListener$Companion$queryHistoryAndProcess$1
                        ...
                        public final void run() {
                            ...
                            try {
                                ...
                                ViewOnClickListener.Companion.processPredictedResult(queryEvent, str2, new float[0]);
                            } catch (Throwable th) {
                                CrashShieldHandler.handleThrowable(th, this);
                            }
                        }
