    ...
    public static final boolean isSensitiveUserData(View view) {
        ...
        try {
            if (view instanceof TextView) {
                if (!INSTANCE.isPassword((TextView) view) && !INSTANCE.isCreditCard((TextView) view) && !INSTANCE.isPersonName((TextView) view) && !INSTANCE.isPostalAddress((TextView) view) && !INSTANCE.isPhoneNumber((TextView) view)) {
                    if (!INSTANCE.isEmail((TextView) view)) {
                        return false;
                    }
                }
                return true;
