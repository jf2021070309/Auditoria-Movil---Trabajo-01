...
public final class InAppPurchaseBillingClientWrapper {
            ...
            queryPurchaseHistoryAsync(skuType, new Runnable() { // from class: com.facebook.appevents.iap.InAppPurchaseBillingClientWrapper$queryPurchaseHistory$1
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        InAppPurchaseBillingClientWrapper.access$querySkuDetailsAsync(InAppPurchaseBillingClientWrapper.this, BillingClient.SkuType.INAPP, new ArrayList(InAppPurchaseBillingClientWrapper.access$getHistoryPurchaseSet$p(InAppPurchaseBillingClientWrapper.this)), queryPurchaseHistoryRunnable);
                    } catch (Throwable th) {
    ...
    public final void queryPurchase(String skuType, Runnable querySkuRunnable) {
        ...
        try {
            ...
            List<Object> list = (List) invokeMethod;
            if (list != null) {
                try {
    ...
    /* compiled from: InAppPurchaseBillingClientWrapper.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J.\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u00072\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00040\tH\u0096\u0002¢\u0006\u0002\u0010\n¨\u0006\u000b"}, d2 = {"Lcom/facebook/appevents/iap/InAppPurchaseBillingClientWrapper$BillingClientStateListenerWrapper;", "Ljava/lang/reflect/InvocationHandler;", "()V", "invoke", "", "proxy", InneractiveMediationDefs.GENDER_MALE, "Ljava/lang/reflect/Method;", "args", "", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;", "facebook-core_release"}, k = 1, mv = {1, 5, 1})
    /* loaded from: classes.dex */
    ...
    public final class PurchaseHistoryResponseListenerWrapper implements InvocationHandler {
        ...
        private final void getPurchaseHistoryRecord(List<?> list) {
            ...
            while (it.hasNext()) {
                try {
                    Object invokeMethod = InAppPurchaseUtils.invokeMethod(InAppPurchaseBillingClientWrapper.access$getPurchaseHistoryRecordClazz$p(this.this$0), InAppPurchaseBillingClientWrapper.access$getGetOriginalJsonPurchaseHistoryMethod$p(this.this$0), it.next(), new Object[0]);
    ...
    public final class SkuDetailsResponseListenerWrapper implements InvocationHandler {
        ...
        public final void parseSkuDetails(List<?> skuDetailsObjectList) {
            ...
            while (it.hasNext()) {
                try {
                    Object invokeMethod = InAppPurchaseUtils.invokeMethod(InAppPurchaseBillingClientWrapper.access$getSkuDetailsClazz$p(this.this$0), InAppPurchaseBillingClientWrapper.access$getGetOriginalJsonSkuMethod$p(this.this$0), it.next(), new Object[0]);
                    if (!(invokeMethod instanceof String)) {
                        invokeMethod = null;
                    }
                    String str = (String) invokeMethod;
