...
public class DeviceRequestsHelper {
    ...
    public static Bitmap generateQRCode(String str) {
        ...
        try {
            ...
            try {
                BitMatrix encode = new MultiFormatWriter().encode(str, BarcodeFormat.QR_CODE, Scheduler.MAX_GREEDY_SCHEDULER_LIMIT, Scheduler.MAX_GREEDY_SCHEDULER_LIMIT, enumMap);
