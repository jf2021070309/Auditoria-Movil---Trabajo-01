    ...
    */
    private com.ironsource.sdk.a convertBannerSize(android.app.Activity r10, com.ironsource.mediationsdk.ISBannerSize r11) {
        /*
            ...
            r5 = 1
            switch(r1) {
                case -387072689: goto L38;
                case 72205083: goto L2e;
                case 79011241: goto L24;
    ...
    private void loadAdInternal(String str, String str2, boolean z, boolean z2, boolean z3) {
        ...
        if (str2 != null) {
            C0112f.a();
            hashMap.put("adm", C0112f.c(str2));
            C0112f.a();
            hashMap.putAll(C0112f.b(str2));
        }
    ...
    public void destroyBanner(JSONObject jSONObject) {
        ...
        if (aVar != null) {
            ...
            aVar.a.c.a("destroyBanner", new JSONObject().put("adViewId", aVar.a.a).put("isBNAutoRemove", false).put("isBannerDisplay", aVar.b));
            this.mBannerAdContainer = null;
        }
    }
        ...
        postOnUIThread(new Runnable() { // from class: com.ironsource.adapters.ironsource.IronSourceAdapter.2
            ...
            public void run() {
                try {
                    ...
                    gVar.a(false, ErrorBuilder.buildInitFailedError("Adapter initialization failure - " + IronSourceAdapter.this.getProviderName() + " - " + e.getMessage(), IronSourceConstants.OFFERWALL_AD_UNIT));
                }
            }
        });
    }
    ...
    public void loadBannerForBidding(IronSourceBannerLayout ironSourceBannerLayout, JSONObject jSONObject, BannerSmashListener bannerSmashListener, String str) {
        ...
        try {
            ...
            if (str != null) {
                C0112f.a();
                hashMap.put("adm", C0112f.c(str));
                C0112f.a();
                hashMap.putAll(C0112f.b(str));
                printInstanceExtraParams(hashMap);
            }
