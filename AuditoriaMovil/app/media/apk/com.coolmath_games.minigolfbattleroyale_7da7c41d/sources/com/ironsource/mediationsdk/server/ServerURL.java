...
public class ServerURL {
    ...
    public static String getCPVProvidersURL(Context context, String str, String str2, String str3, String str4, boolean z, Vector<Pair<String, String>> vector) {
        ...
        if (z) {
            vector2.add(new Pair(REWARDED_VIDEO_MANUAL_MODE, z ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO));
        }
        ...
        ConcurrentHashMap<String, List<String>> d = com.ironsource.mediationsdk.c.b.a().d();
        ...
        if (context != null) {
            ...
            if (!TextUtils.isEmpty(k)) {
                vector2.add(new Pair(ISO_COUNTRY_CODE, k));
            }
            String j = h.j(context);
            if (!TextUtils.isEmpty(j)) {
                vector2.add(new Pair(MOBILE_CARRIER, j));
            }
        }
        String c2 = h.c();
        ...
        JSONObject a = j.a(new com.ironsource.environment.d.b().a);
        ...
        IronLog.INTERNAL.info("parameters for url: " + createURLParams);
        return getBaseUrl(IronSourceUtils.getSDKVersion()) + URLEncoder.encode(IronSourceAES.encode(g.a().b(), createURLParams), "UTF-8");
    }
