...
public final class ca extends FilterInputStream {
    ...
    public ca(InputStream inputStream, int[] iArr, int i, byte[] bArr, int i2, int i3) throws IOException {
        ...
        this.onAppOpenAttributionNative = (int) ((s * j2) >> 32);
        this.onAttributionFailureNative = (int) (j >> 32);
        this.onDeepLinkingNative = (int) (j2 + s);
    }
    ...
    private void values() {
        ...
        while (true) {
            ...
            short s = AFInAppEventParameterName;
            i2 -= ((((i4 - i3) * s) + i) ^ ((i << 4) + this.onAttributionFailureNative)) ^ ((i >>> 5) + this.onDeepLinkingNative);
            i -= (((i2 << 4) + this.AFLogger$LogLevel) ^ ((s * (i4 - i3)) + i2)) ^ ((i2 >>> 5) + this.onAppOpenAttributionNative);
            i3++;
        }
    ...
    private int valueOf() throws IOException {
        ...
        if (this.AFKeystoreWrapper == 8) {
            ...
            this.getLevel = read2 < 0 ? 8 - (this.valueOf[7] & UByte.MAX_VALUE) : 8;
        }
