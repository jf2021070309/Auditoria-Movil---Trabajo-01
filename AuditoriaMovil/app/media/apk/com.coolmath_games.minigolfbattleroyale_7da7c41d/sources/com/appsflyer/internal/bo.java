                        ...
                        if (i == -1) {
                            ...
                            try {
                                ...
                                if (build.isReady()) {
                                    ...
                                    bo.this.AFInAppEventType.put(NotificationCompat.CATEGORY_ERROR, "ReferrerClient: InstallReferrer is not ready");
                                }
                            } catch (Throwable th) {
                                AFLogger.init("Failed to get install referrer: " + th.getMessage());
                                bo.this.AFInAppEventType.put(NotificationCompat.CATEGORY_ERROR, th.getMessage());
                            }
                        } else if (i == 1) {
