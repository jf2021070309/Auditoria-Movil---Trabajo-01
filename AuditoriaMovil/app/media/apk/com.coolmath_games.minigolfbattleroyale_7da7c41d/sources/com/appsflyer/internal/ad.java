...
public final class ad implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            hashMap.put(InAppPurchaseMetaData.KEY_SIGNATURE, this.AppsFlyer2dXConversionCallback);
            ...
            if (responseCode == 200) {
                ...
                valueOf(jSONObject2.optBoolean(IronSourceConstants.EVENTS_RESULT), this.init, this.getLevel, this.AFVersionDeclaration, jSONObject2.toString());
            } else {
    ...
    static /* synthetic */ void AFInAppEventParameterName(ad adVar, Map map, Map map2, WeakReference weakReference) {
        if (weakReference.get() != null) {
            ...
            g gVar = (bn) bnVar;
            ae values = ae.values();
            Map<String, Object> values2 = values.values(gVar);
            values2.put("price", adVar.getLevel);
            values2.put("currency", adVar.AFVersionDeclaration);
            values2.put(AppLovinEventParameters.IN_APP_PURCHASE_DATA, map);
            if (map2 != null) {
            ...
            HttpURLConnection httpURLConnection = null;
            try {
                httpURLConnection = AFKeystoreWrapper((bk) gVar.valueOf(values2).AFInAppEventParameterName(obj));
