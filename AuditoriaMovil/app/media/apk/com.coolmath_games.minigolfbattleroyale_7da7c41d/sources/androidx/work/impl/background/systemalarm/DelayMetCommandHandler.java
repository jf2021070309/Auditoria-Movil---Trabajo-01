...
public class DelayMetCommandHandler implements WorkConstraintsCallback, ExecutionListener, WorkTimer.TimeLimitExceededListener {
    ...
    public DelayMetCommandHandler(Context context, int startId, String workSpecId, SystemAlarmDispatcher dispatcher) {
        ...
        this.mWorkConstraintsTracker = new WorkConstraintsTracker(this.mContext, dispatcher.getTaskExecutor(), this);
    }
            ...
            synchronized (this.mLock) {
                if (this.mCurrentState == 0) {
                    ...
                    if (this.mDispatcher.getProcessor().startWork(this.mWorkSpecId)) {
                        this.mDispatcher.getWorkTimer().startTimer(this.mWorkSpecId, AuthenticationTokenClaims.MAX_TIME_SINCE_TOKEN_ISSUED, this);
                    } else {
                        cleanUp();
                    }
                } else {
