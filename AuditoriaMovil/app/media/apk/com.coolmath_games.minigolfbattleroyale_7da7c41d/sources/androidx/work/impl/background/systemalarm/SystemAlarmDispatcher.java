...
public class SystemAlarmDispatcher implements ExecutionListener {
    ...
    SystemAlarmDispatcher(Context context, Processor processor, WorkManagerImpl workManager) {
        ...
        this.mProcessor = processor == null ? workManager.getProcessor() : processor;
    ...
    public boolean add(final Intent intent, final int startId) {
        Logger.get().debug(TAG, String.format("Adding command %s (%s)", intent, Integer.valueOf(startId)), new Throwable[0]);
        assertMainThread();
