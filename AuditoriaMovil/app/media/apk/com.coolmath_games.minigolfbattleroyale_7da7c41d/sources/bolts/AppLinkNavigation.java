...
public class AppLinkNavigation {
    ...
    public NavigationResult navigate(Context context) {
        ...
        while (true) {
            ...
            intent.putExtra(com.facebook.bolts.AppLinks.KEY_NAME_APPLINK_DATA, buildAppLinkDataForNavigation);
        ...
        if (intent != null) {
            ...
            if (webUrl != null) {
                try {
                    intent = new Intent("android.intent.action.VIEW", webUrl.buildUpon().appendQueryParameter(com.facebook.bolts.AppLinks.KEY_NAME_APPLINK_DATA, getJSONForBundle(buildAppLinkDataForNavigation).toString()).build());
