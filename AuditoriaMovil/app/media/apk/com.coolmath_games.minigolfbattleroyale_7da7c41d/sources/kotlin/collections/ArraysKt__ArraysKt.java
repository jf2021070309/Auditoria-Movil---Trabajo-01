        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m567contentEqualskV0jMPg(((UByteArray) t).m109unboximpl(), ((UByteArray) t2).m109unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m564contentEqualsFGO6Aew(((UShortArray) t).m369unboximpl(), ((UShortArray) t2).m369unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m565contentEqualsKJPZfPQ(((UIntArray) t).m187unboximpl(), ((UIntArray) t2).m187unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m569contentEqualslec5QzE(((ULongArray) t).m265unboximpl(), ((ULongArray) t2).m265unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m581contentToString2csIQuQ(uByteArray != null ? uByteArray.m109unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m585contentToStringd6D3K8(uShortArray != null ? uShortArray.m369unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m584contentToStringXUkPCBk(uIntArray != null ? uIntArray.m187unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m587contentToStringuLth9ew(uLongArray != null ? uLongArray.m265unboximpl() : null));
            } else {
