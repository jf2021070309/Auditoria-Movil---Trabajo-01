...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m171boximpl(int[] v) {
        Intrinsics.checkNotNullParameter(v, "v");
        return new UIntArray(v);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int[] m173constructorimpl(int[] storage) {
    ...
    public static boolean m176equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).m187unboximpl());
    }
    ...
    public static final int m178getpVg5ArA(int[] iArr, int i) {
        return UInt.m119constructorimpl(iArr[i]);
    }
    ...
    public static final class Iterator extends UIntIterator {
        ...
        public int mo188nextUIntpVg5ArA() {
            int i = this.index;
            int[] iArr = this.array;
            if (i < iArr.length) {
                this.index = i + 1;
    ...
    public static boolean m175containsAllimpl(int[] iArr, Collection<UInt> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UInt> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UInt) && ArraysKt.contains(iArr, ((UInt) obj).m170unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
