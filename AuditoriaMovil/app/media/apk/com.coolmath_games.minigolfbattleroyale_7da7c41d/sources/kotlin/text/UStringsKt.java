...
public final class UStringsKt {
    ...
    public static final String m1297toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1299toStringolVBNx4(short s, int i) {
    ...
    public static final String m1298toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1296toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m92unboximpl();
        }
    ...
    public static final long toULong(String toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m248unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m170unboximpl = uIntOrNull.m170unboximpl();
            if (UnsignedKt.uintCompare(m170unboximpl, UInt.m119constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m37boximpl(UByte.m43constructorimpl((byte) m170unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m170unboximpl = uIntOrNull.m170unboximpl();
            if (UnsignedKt.uintCompare(m170unboximpl, UInt.m119constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m297boximpl(UShort.m303constructorimpl((short) m170unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int m119constructorimpl = UInt.m119constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m372uintDivideJ1ME1BU(-1, m119constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m119constructorimpl2 = UInt.m119constructorimpl(i2 * m119constructorimpl);
            int m119constructorimpl3 = UInt.m119constructorimpl(UInt.m119constructorimpl(digitOf) + m119constructorimpl2);
            if (UnsignedKt.uintCompare(m119constructorimpl3, m119constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m119constructorimpl3;
        }
        return UInt.m113boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long m197constructorimpl = ULong.m197constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m374ulongDivideeb3DHEI(j, m197constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m197constructorimpl2 = ULong.m197constructorimpl(j2 * m197constructorimpl);
            long m197constructorimpl3 = ULong.m197constructorimpl(ULong.m197constructorimpl(UInt.m119constructorimpl(digitOf) & 4294967295L) + m197constructorimpl2);
            if (UnsignedKt.ulongCompare(m197constructorimpl3, m197constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m197constructorimpl3;
            j = -1;
        }
        return ULong.m191boximpl(j2);
    }
}
