...
final class a {
    ...
    private static String a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            ...
            int i4 = i3 + 1;
            bArr3[i3] = bArr2[((bArr[i2] & 3) << 4) | ((bArr[i2 + 1] & Constants.UNKNOWN) >> 4)];
            int i5 = i4 + 1;
            bArr3[i4] = bArr2[((bArr[i2 + 1] & cv.m) << 2) | ((bArr[i2 + 2] & Constants.UNKNOWN) >> 6)];
            i = i5 + 1;
        ...
        switch (bArr.length % 3) {
            ...
            case 2:
                ...
                bArr3[i] = bArr2[(bArr[length] & Constants.UNKNOWN) >> 2];
                int i11 = i10 + 1;
                bArr3[i10] = bArr2[((bArr[length] & 3) << 4) | ((bArr[length + 1] & Constants.UNKNOWN) >> 4)];
                int i12 = i11 + 1;
                bArr3[i11] = bArr2[(bArr[length + 1] & cv.m) << 2];
                int i13 = i12 + 1;
                bArr3[i12] = 61;
                break;
        }
