...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context) {
        ...
        boolean nestedScrollingEnabled = Build.VERSION.SDK_INT >= 21 ? true : true;
    ...
    */
    boolean scrollByInternal(int r21, int r22, android.view.MotionEvent r23, int r24) {
        /*
    ...
    */
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, DisplayUtils.getIns().dip2px(8.0f), DisplayUtils.getIns().dip2px(50.0f), DisplayUtils.getIns().dip2px(0.0f));
    }
