...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context) {
        ...
        ColorStateList backgroundColor = new ColorStateList(new int[][]{new int[0]}, new int[]{-1});
        ...
        IMPL.initialize(cardViewDelegate, context, backgroundColor, 0.0f, 0.0f, maxElevation);
    }
