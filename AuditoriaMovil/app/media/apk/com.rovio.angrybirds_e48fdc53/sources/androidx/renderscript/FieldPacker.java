...
public class FieldPacker {
    ...
    public short subI16() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        short v = (short) ((bArr[i] & Constants.UNKNOWN) << 8);
        int i2 = i - 1;
        this.mPos = i2;
        return (short) (((short) (bArr[i2] & Constants.UNKNOWN)) | v);
    }
    ...
    public int subI32() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        int v = (bArr[i] & Constants.UNKNOWN) << 24;
        int i2 = i - 1;
        this.mPos = i2;
        int i3 = i2 - 1;
        this.mPos = i3;
        int i4 = i3 - 1;
        this.mPos = i4;
        return v | ((bArr[i2] & Constants.UNKNOWN) << 16) | ((bArr[i3] & Constants.UNKNOWN) << 8) | (bArr[i4] & Constants.UNKNOWN);
    }
