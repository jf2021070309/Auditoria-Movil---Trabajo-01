...
public class ViewCompat {
    ...
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {ID_KEY.accessibility_custom_action_0, ID_KEY.accessibility_custom_action_1, ID_KEY.accessibility_custom_action_2, ID_KEY.accessibility_custom_action_3, ID_KEY.accessibility_custom_action_4, ID_KEY.accessibility_custom_action_5, ID_KEY.accessibility_custom_action_6, ID_KEY.accessibility_custom_action_7, ID_KEY.accessibility_custom_action_8, ID_KEY.accessibility_custom_action_9, ID_KEY.accessibility_custom_action_10, ID_KEY.accessibility_custom_action_11, ID_KEY.accessibility_custom_action_12, ID_KEY.accessibility_custom_action_13, ID_KEY.accessibility_custom_action_14, ID_KEY.accessibility_custom_action_15, ID_KEY.accessibility_custom_action_16, ID_KEY.accessibility_custom_action_17, ID_KEY.accessibility_custom_action_18, ID_KEY.accessibility_custom_action_19, ID_KEY.accessibility_custom_action_20, ID_KEY.accessibility_custom_action_21, ID_KEY.accessibility_custom_action_22, ID_KEY.accessibility_custom_action_23, ID_KEY.accessibility_custom_action_24, ID_KEY.accessibility_custom_action_25, ID_KEY.accessibility_custom_action_26, ID_KEY.accessibility_custom_action_27, ID_KEY.accessibility_custom_action_28, ID_KEY.accessibility_custom_action_29, ID_KEY.accessibility_custom_action_30, ID_KEY.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(ID_KEY.tag_accessibility_actions);
        if (actions == null) {
            ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
            view.setTag(ID_KEY.tag_accessibility_actions, actions2);
            return actions2;
        }
        return actions;
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] mimeTypes, OnReceiveContentListener listener) {
        ...
        view.setTag(ID_KEY.tag_on_receive_content_mime_types, mimeTypes2);
        view.setTag(ID_KEY.tag_on_receive_content_listener, listener);
    }

    public static String[] getOnReceiveContentMimeTypes(View view) {
        return (String[]) view.getTag(ID_KEY.tag_on_receive_content_mime_types);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat payload) {
        ...
        OnReceiveContentListener listener = (OnReceiveContentListener) view.getTag(ID_KEY.tag_on_receive_content_listener);
        if (listener != null) {
    ...
    static class CompatImplApi28 {
        ...
        static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(ID_KEY.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(ID_KEY.tag_unhandled_key_listeners, viewListeners);
            }
    ...
    public static void addOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(ID_KEY.tag_unhandled_key_listeners);
        if (viewListeners == null) {
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(ID_KEY.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.2
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(ID_KEY.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(ID_KEY.tag_state_description, CharSequence.class, 64, 30) { // from class: androidx.core.view.ViewCompat.4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(ID_KEY.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.5
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(ID_KEY.tag_unhandled_key_event_manager);
            if (manager == null) {
                UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
                root.setTag(ID_KEY.tag_unhandled_key_event_manager, manager2);
                return manager2;
            }
            return manager;
        }
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View v, final OnApplyWindowInsetsListener listener) {
            if (Build.VERSION.SDK_INT < 30) {
                v.setTag(ID_KEY.tag_on_apply_window_listener, listener);
            }
            if (listener == null) {
                View.OnApplyWindowInsetsListener compatInsetsAnimationCallback = (View.OnApplyWindowInsetsListener) v.getTag(ID_KEY.tag_window_insets_animation_callback);
        ...
        static void callCompatInsetAnimationCallback(WindowInsets insets, View v) {
            View.OnApplyWindowInsetsListener insetsAnimationCallback = (View.OnApplyWindowInsetsListener) v.getTag(ID_KEY.tag_window_insets_animation_callback);
