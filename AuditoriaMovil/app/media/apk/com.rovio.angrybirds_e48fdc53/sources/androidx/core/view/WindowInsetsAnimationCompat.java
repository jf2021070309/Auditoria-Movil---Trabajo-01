...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object userListener = view.getTag(ID_KEY.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(ID_KEY.tag_window_insets_animation_callback, null);
            ...
            view.setTag(ID_KEY.tag_window_insets_animation_callback, proxyListener);
            if (userListener == null) {
        ...
        static WindowInsets forwardToViewIfNeeded(View v, WindowInsets insets) {
            if (v.getTag(ID_KEY.tag_on_apply_window_listener) != null) {
                return insets;
            }
        ...
        static Callback getCallback(View child) {
            Object listener = child.getTag(ID_KEY.tag_window_insets_animation_callback);
