...
public class Glide implements ComponentCallbacks2 {
    ...
    /* JADX WARN: Type inference failed for: r16v4, types: [com.bumptech.glide.load.resource.bitmap.ByteBufferBitmapImageDecoderResourceDecoder] */
    public Glide(Context context, Engine engine, MemoryCache memoryCache, BitmapPool bitmapPool, ArrayPool arrayPool, RequestManagerRetriever requestManagerRetriever, ConnectivityMonitorFactory connectivityMonitorFactory, int logLevel, RequestOptionsFactory defaultRequestOptionsFactory, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, GlideExperiments experiments) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && experiments.isEnabled(GlideBuilder.EnableImageDecoderForBitmaps.class)) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && experiments.isEnabled(GlideBuilder.EnableImageDecoderForAnimatedWebp.class)) {
        ...
        ByteBufferBitmapDecoder byteBufferBitmapDecoder3 = byteBufferBitmapDecoder;
        registry.append(ByteBuffer.class, new ByteBufferEncoder()).append(InputStream.class, new StreamEncoder(arrayPool)).append(Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, byteBufferBitmapDecoder3).append(Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, streamBitmapDecoder);
