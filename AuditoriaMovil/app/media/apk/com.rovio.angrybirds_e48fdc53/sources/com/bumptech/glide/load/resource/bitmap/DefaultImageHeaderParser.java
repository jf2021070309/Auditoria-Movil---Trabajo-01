...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    private ImageHeaderParser.ImageType getType(Reader reader) throws IOException {
        try {
            ...
            if (firstFourBytes == PNG_HEADER) {
                ...
                return sniffAvif(reader, firstFourBytes) ? ImageHeaderParser.ImageType.AVIF : ImageHeaderParser.ImageType.UNKNOWN;
            } else {
                reader.skip(4L);
    ...
    private boolean sniffAvif(Reader reader, int boxSize) throws IOException {
        ...
        int i = 0;
        while (i < 5 && sizeRemaining > 0) {
            int brand2 = (reader.getUInt16() << 16) | reader.getUInt16();
            if (brand2 == AVIF_BRAND || brand2 == AVIS_BRAND) {
                return true;
            }
            i++;
            sizeRemaining -= 4;
    ...
    private static final class ByteBufferReader implements Reader {
        ...
        public short getUInt8() throws Reader.EndOfFileException {
            ...
            return (short) (this.byteBuffer.get() & Constants.UNKNOWN);
        }
