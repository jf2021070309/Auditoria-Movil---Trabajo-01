...
public class RequestBase {
    protected static final String API_KEY = "doisqxOOSMttYy8IniQ5D84SxGObltjW";
    ...
    protected final String PARAM_PACKAGE_NAME = "realPackageName";
    ...
    public void init(Context application) {
        ...
        if (application instanceof PMAdSDK) {
            this.mPackageName = ((PMAdSDK) application).getRealPackageName();
            this.mVersionCode = ((PMAdSDK) application).getVersionCode();
            this.mVersionName = ((PMAdSDK) application).getVersionName();
            return;
        }
    ...
    protected void postRequest(final String paramObj) {
        ...
        new Thread(new Runnable() { // from class: com.me.game.pmadsdk.network.RequestBase.1
            ...
            public void run() {
                try {
                    ...
                    http.setRequestProperty("android_id", PMAdSDK.mPmAdSDK.getAndroidId());
                    http.setRequestProperty("api_key", RequestBase.API_KEY);
                    StringBuilder builder = new StringBuilder();
                    ...
                    while (true) {
                        ...
                        if (line != null) {
                            ...
                            HandlerUtils.post(RequestBase.this.mHandler, new Runnable() { // from class: com.me.game.pmadsdk.network.RequestBase.1.1
                                @Override // java.lang.Runnable
                                public void run() {
                    ...
                    e.printStackTrace();
                    HandlerUtils.post(RequestBase.this.mHandler, new Runnable() { // from class: com.me.game.pmadsdk.network.RequestBase.1.2
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public static void initApplication(Context context) {
        ProtocolAd.getIns().init(context);
