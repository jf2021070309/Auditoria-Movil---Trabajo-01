...
public class TTAdConstant {
    ...
    public static final String BRANCH = "v5300";
    public static final int BUILD_IN_MODULE_VERSION_CODE = 5305;
    public static final String BUILD_IN_MODULE_VERSION_NAME = "5.3.0.5";
    ...
    public static final String C_H = "ba75249";
    ...
    public static final String KEY_T_N = "_t_n";
    public static final String KEY_T_P = "_t_p";
    ...
    public static final Long LIVE_REWARD_TIME = Long.valueOf((long) PushUIConfig.dismissTime);
    ...
    public static final int SDK_VERSION_CODE = 5305;
    public static final String SDK_VERSION_NAME = "5.3.0.5";
    ...
    public enum RitScenes {
        ...
        GAME_MORE_KLLKRTUNITIES(TTAdConstant.ge("game_more_kllkrtunities")),
