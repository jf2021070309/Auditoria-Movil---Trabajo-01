...
public class MediationNativeAd implements Bridge {
    ...
    public String getAdm() {
        MediationAdLoaderImpl mediationAdLoaderImpl = this.a;
        return mediationAdLoaderImpl != null ? mediationAdLoaderImpl.getAdm() : "";
    }

    public double getCpm() {
        Bridge bridge = this.mGMAd;
        return bridge != null ? ((Double) bridge.call(8143, null, Double.class)).doubleValue() : PangleAdapterUtils.CPM_DEFLAUT_VALUE;
    }
    ...
    public boolean isExpress() {
        Bridge bridge = this.mGMAd;
        if (bridge != null) {
            return ((Boolean) bridge.call(o.a.t, null, Boolean.class)).booleanValue();
        }
        return false;
    }
    ...
    public void shakeViewDismissed() {
        Bridge bridge = this.mGMAd;
        if (bridge != null) {
            bridge.call(o.a.u, null, Void.class);
        }
    }
