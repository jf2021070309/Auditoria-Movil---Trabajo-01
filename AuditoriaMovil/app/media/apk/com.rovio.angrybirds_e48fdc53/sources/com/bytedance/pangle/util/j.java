                    ...
                    if (a == null) {
                        ...
                        if (i.c()) {
                            try {
                                ...
                                a.add(Zeus.getAppApplication().createPackageContext(resources.getString(resources.getIdentifier("android:string/config_webViewPackageName", "string", "android")), 0).getApplicationInfo().sourceDir);
                            } catch (Exception e) {
                            ...
                            try {
                                ...
                                if (z) {
                                    Collections.addAll(a, a(((Context) invokeStaticMethod).getApplicationInfo()));
                                } else {
                                    a.add(((Context) invokeStaticMethod).getApplicationInfo().sourceDir);
                                }
                            } catch (Exception e2) {
