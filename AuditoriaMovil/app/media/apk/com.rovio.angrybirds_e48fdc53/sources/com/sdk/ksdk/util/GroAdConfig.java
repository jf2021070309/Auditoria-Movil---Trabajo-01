...
public class GroAdConfig {
    ...
    public GroAdConfig(String appId, String[] interactionId, String videoId) {
        this.appId = appId;
    ...
    public String toString() {
        return "GromoreAdConfig{appId='" + this.appId + "', interactionId=" + Arrays.toString(this.interactionId) + ", videoId='" + this.videoId + "', interactionTimeClickCount=" + this.interactionTimeClickCount + ", rewardVideoTimeClickCount=" + this.rewardVideoTimeClickCount + '}';
    }
}
