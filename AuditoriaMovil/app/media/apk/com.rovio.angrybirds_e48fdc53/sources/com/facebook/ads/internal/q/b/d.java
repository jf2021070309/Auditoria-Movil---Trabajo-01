...
public class d implements com.facebook.ads.internal.q.b.a {
    ...
    private static final byte[] b = {9, 11, 12, cv.k, cv.k, cv.l, cv.l, cv.m, cv.m, cv.m, cv.m, cv.n, cv.n, cv.n, cv.n, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24};
    ...
    public static void b(int[] iArr, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        if (i6 != 1) {
            if (i6 == 2) {
                ...
                for (int i11 = (i5 * i) / i4; i11 < i10; i11++) {
                    ...
                    int i20 = i11;
                    while (i18 < i2) {
                        iArr[i20] = (int) ((iArr[i20] & (-16777216)) | ((((s * j7) >>> b2) & 255) << 16) | ((((s * j6) >>> b2) & 255) << 8) | (((s * j5) >>> b2) & 255));
                        int i21 = i20 + i;
                        long j10 = j7 - j4;
                        long j11 = j6 - j3;
                        long j12 = j5 - j2;
        ...
        while (true) {
            ...
            long j37 = j28;
            while (i32 < i) {
                iArr[i35] = (int) ((iArr[i35] & (-16777216)) | ((((s * j31) >>> b2) & 255) << 16) | ((((s * j32) >>> b2) & 255) << 8) | (((s * j33) >>> b2) & 255));
                int i36 = i35 + 1;
                long j38 = j31 - j37;
                long j39 = j32 - j29;
                long j40 = j33 - j30;
