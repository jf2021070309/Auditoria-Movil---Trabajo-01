...
public class DeviceAuthDialog extends DialogFragment {
            ...
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.isBeingDestroyed) {
                    ...
                    try {
                        ...
                        requestState.setRequestCode(jSONObject.getString(PluginConstants.KEY_ERROR_CODE));
                        requestState.setInterval(jSONObject.getLong(bg.aU));
    ...
    private GraphRequest getPollRequest() {
        Bundle bundle = new Bundle();
        bundle.putString(PluginConstants.KEY_ERROR_CODE, this.currentRequestState.getRequestCode());
