...
public class NativeAdScrollView extends LinearLayout {
    ...
    private class a extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            View render = NativeAdScrollView.this.d != null ? NativeAdView.render(NativeAdScrollView.this.a, this.b.get(i), NativeAdScrollView.this.d, NativeAdScrollView.this.g) : NativeAdScrollView.this.c.createView(this.b.get(i), i);
