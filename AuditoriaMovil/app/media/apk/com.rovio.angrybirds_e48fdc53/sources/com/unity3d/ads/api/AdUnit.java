...
public class AdUnit {
    ...
    public static void open(Integer num, JSONArray jSONArray, Integer num2, JSONArray jSONArray2, Integer num3, Boolean bool, Boolean bool2, WebViewCallback webViewCallback) {
        ...
        if (!bool.booleanValue() && bool2.booleanValue()) {
            ...
            intent = new android.content.Intent(ClientProperties.getActivity(), AdUnitTransparentSoftwareActivity.class);
            ...
            intent = new android.content.Intent(ClientProperties.getActivity(), AdUnitTransparentActivity.class);
        } else {
