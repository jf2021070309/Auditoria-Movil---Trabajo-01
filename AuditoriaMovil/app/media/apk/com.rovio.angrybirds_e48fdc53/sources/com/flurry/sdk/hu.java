...
public class hu {
    ...
    public static Map<String, List<String>> a(String str) {
        ...
        for (String str2 : str.split("&")) {
            ...
            if (split2.length != 2) {
                ko.a(5, a, "Invalid referrer Element: " + str2 + " in referrer tag " + str);
            } else {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ko.a(3, a, "entry: " + ((String) entry.getKey()) + "=" + entry.getValue());
        }
        ...
        if (sb.length() > 0) {
            ko.a(5, a, "Detected missing referrer keys : " + sb.toString());
        }
        return hashMap;
    }
}
