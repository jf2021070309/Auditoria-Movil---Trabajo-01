...
public class p extends Button {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public p(Context context, d dVar, int i, aa aaVar) {
        super(context);
        this.a = 0;
        this.b = 1;
        this.c = 2;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public p(Context context, int i, d dVar, int i2, aa aaVar) {
    ...
    public void a() {
        ...
        this.w = as.b(b, "background_color");
        this.x = as.b(b, "font_color");
        this.y = as.b(b, "text");
        ...
        setVisibility(4);
        FrameLayout.LayoutParams layoutParams = as.d(b, "wrap_content") ? new FrameLayout.LayoutParams(-2, -2) : new FrameLayout.LayoutParams(this.p, this.q);
        ...
        setGravity(a(true, this.u) | a(false, this.v));
        if (!this.w.equals("")) {
            setBackgroundColor(q.f(this.w));
        }
        if (!this.x.equals("")) {
            setTextColor(q.f(this.x));
        }
        this.A.l().add(a.a("TextView.set_visible", new f() { // from class: com.adcolony.sdk.p.1
        ...
        this.A.l().add(a.a("TextView.set_bounds", new f() { // from class: com.adcolony.sdk.p.4
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.d(dVar);
        ...
        this.A.l().add(a.a("TextView.set_font_color", new f() { // from class: com.adcolony.sdk.p.5
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.f(dVar);
        ...
        this.A.l().add(a.a("TextView.set_background_color", new f() { // from class: com.adcolony.sdk.p.6
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.e(dVar);
        ...
        this.A.l().add(a.a("TextView.set_typeface", new f() { // from class: com.adcolony.sdk.p.7
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.j(dVar);
        ...
        this.A.l().add(a.a("TextView.set_font_size", new f() { // from class: com.adcolony.sdk.p.8
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.g(dVar);
        ...
        this.A.l().add(a.a("TextView.set_font_style", new f() { // from class: com.adcolony.sdk.p.9
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.h(dVar);
        ...
        this.A.l().add(a.a("TextView.get_text", new f() { // from class: com.adcolony.sdk.p.10
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.b(dVar);
        ...
        this.A.l().add(a.a("TextView.set_text", new f() { // from class: com.adcolony.sdk.p.2
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.i(dVar);
        ...
        this.A.l().add(a.a("TextView.align", new f() { // from class: com.adcolony.sdk.p.3
            @Override // com.adcolony.sdk.f
            public void a(d dVar) {
                if (p.this.c(dVar)) {
                    p.this.a(dVar);
        ...
        au.d.b("TextView added to layout");
    }
    ...
    void e(d dVar) {
        this.w = as.b(dVar.b(), "background_color");
        setBackgroundColor(q.f(this.w));
    }

    void f(d dVar) {
        this.x = as.b(dVar.b(), "font_color");
        setTextColor(q.f(this.x));
    }
