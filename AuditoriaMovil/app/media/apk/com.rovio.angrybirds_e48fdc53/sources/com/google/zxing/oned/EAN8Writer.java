...
public final class EAN8Writer extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        for (int i = 0; i <= 3; i++) {
            appendPattern += appendPattern(zArr, appendPattern, UPCEANReader.e[Integer.parseInt(str.substring(i, i + 1))], false);
        }
        int appendPattern2 = appendPattern + appendPattern(zArr, appendPattern, UPCEANReader.c, false);
        for (int i2 = 4; i2 <= 7; i2++) {
            appendPattern2 += appendPattern(zArr, appendPattern2, UPCEANReader.e[Integer.parseInt(str.substring(i2, i2 + 1))], true);
        }
