...
final class d {
            ...
            try {
                ...
                if (forBits == Mode.TERMINATOR) {
                    ...
                    if (forBits == Mode.NUMERIC) {
                        ...
                        a(bitSource, sb, readBits3, z2);
                        z = z2;
                        i = i4;
                        i2 = i3;
                    } else if (forBits == Mode.BYTE) {
                        a(bitSource, sb, readBits3, characterSetECI, arrayList, map);
                        z = z2;
                        i = i4;
                        i2 = i3;
    ...
    private static void a(BitSource bitSource, StringBuilder sb, int i) {
        int i2;
    ...
    private static void b(BitSource bitSource, StringBuilder sb, int i) {
        int i2;
        if (i * 13 > bitSource.available()) {
            throw FormatException.getFormatInstance();
        }
    ...
    private static void a(BitSource bitSource, StringBuilder sb, int i, CharacterSetECI characterSetECI, Collection<byte[]> collection, Map<DecodeHintType, ?> map) {
        String name;
    ...
    private static void a(BitSource bitSource, StringBuilder sb, int i, boolean z) {
        while (i > 1) {
    ...
    private static void c(BitSource bitSource, StringBuilder sb, int i) {
        while (i >= 3) {
