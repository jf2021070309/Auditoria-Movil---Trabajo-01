...
public final class Code128Reader extends OneDReader {
        ...
        while (i4 < size) {
            if (bitArray.get(i4) ^ z2) {
                ...
                if (i3 == 5) {
                    ...
                    int i7 = 103;
                    while (i7 <= 105) {
                        float patternMatchVariance = patternMatchVariance(iArr, a[i7], 0.7f);
    ...
    private static int a(BitArray bitArray, int[] iArr, int i) {
        ...
        for (int i3 = 0; i3 < a.length; i3++) {
            float patternMatchVariance = patternMatchVariance(iArr, a[i3], 0.7f);
            if (patternMatchVariance < f) {
                i2 = i3;
                f = patternMatchVariance;
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x0099 A[FALL_THROUGH, PHI: r8 
      PHI: (r8v12 boolean) = (r8v4 boolean), (r8v5 boolean), (r8v5 boolean) binds: [B:27:0x0096, B:107:0x0228, B:110:0x0236] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // com.google.zxing.oned.OneDReader
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public com.google.zxing.Result decodeRow(int r24, com.google.zxing.common.BitArray r25, java.util.Map<com.google.zxing.DecodeHintType, ?> r26) {
        /*
