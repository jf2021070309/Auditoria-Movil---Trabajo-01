    ...
    public Object getFieldValue(Field field) {
        ...
        if (field.zapw != null) {
            ...
            try {
                ...
                return getClass().getMethod(new StringBuilder(String.valueOf(substring).length() + 4).append(MonitorConstants.CONNECT_TYPE_GET).append(upperCase).append(substring).toString(), new Class[0]).invoke(this, new Object[0]);
            } catch (Exception e) {
