...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private static final int[] d = {0, 336, DownloadErrorCode.ERROR_TEMP_FILE_CREATE_FAILED, 1516};
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) {
        a(this.h, a(bitArray, false, i, map));
        bitArray.reverse();
        a(this.i, a(bitArray, true, i, map));
        bitArray.reverse();
        for (a aVar : this.h) {
            if (aVar.b() > 1) {
                for (a aVar2 : this.i) {
                    if (aVar2.b() > 1 && b(aVar, aVar2)) {
                        return a(aVar, aVar2);
                    }
                }
                continue;
    ...
    private static void a(Collection<a> collection, a aVar) {
        boolean z;
        if (aVar != null) {
    ...
    private static Result a(a aVar, a aVar2) {
        String valueOf = String.valueOf((4537077 * aVar.getValue()) + aVar2.getValue());
        ...
        sb.append(i3);
        ResultPoint[] resultPoints = aVar.a().getResultPoints();
        ResultPoint[] resultPoints2 = aVar2.a().getResultPoints();
    ...
    private static boolean b(a aVar, a aVar2) {
        ...
        int value = (aVar.a().getValue() * 9) + aVar2.a().getValue();
        if (value > 72) {
            value--;
        }
        if (value > 8) {
    ...
    private a a(BitArray bitArray, boolean z, int i, Map<DecodeHintType, ?> map) {
        try {
            int[] a2 = a(bitArray, 0, z);
            FinderPattern a3 = a(bitArray, i, z, a2);
            ResultPointCallback resultPointCallback = map == null ? null : (ResultPointCallback) map.get(DecodeHintType.NEED_RESULT_POINT_CALLBACK);
            if (resultPointCallback != null) {
                float f2 = (a2[0] + a2[1]) / 2.0f;
                if (z) {
            ...
            return new a((a4.getValue() * 1597) + a5.getValue(), a4.getChecksumPortion() + (a5.getChecksumPortion() * 4), a3);
        } catch (NotFoundException e2) {
            return null;
        }
    }

    private DataCharacter a(BitArray bitArray, FinderPattern finderPattern, boolean z) {
        ...
        if (z) {
            ...
            int i13 = (12 - i8) / 2;
            int i14 = e[i13];
            return new DataCharacter((RSSUtils.getRSSvalue(oddCounts, i14, false) * a[i13]) + RSSUtils.getRSSvalue(evenCounts, 9 - i14, true) + c[i13], i12);
        } else if ((i11 & 1) != 0 || i11 > 10 || i11 < 4) {
            throw NotFoundException.getNotFoundInstance();
        } else {
            int i15 = (10 - i11) / 2;
            int i16 = f[i15];
            return new DataCharacter(RSSUtils.getRSSvalue(oddCounts, i16, true) + (RSSUtils.getRSSvalue(evenCounts, 9 - i16, false) * b[i15]) + d[i15], i12);
        }
    }

    private int[] a(BitArray bitArray, int i, boolean z) {
    ...
    private FinderPattern a(BitArray bitArray, int i, boolean z, int[] iArr) {
        int i2;
        ...
        int parseFinderValue = parseFinderValue(decodeFinderCounters, g);
        int i5 = iArr[1];
        if (z) {
