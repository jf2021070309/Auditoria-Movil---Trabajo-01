        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                if ((i != 0 || (i3 != 0 && i3 != length - 1)) && (i != length - 1 || i3 != 0)) {
                    bitMatrix.setRegion(this.d[i3] - 2, i2, 5, 5);
                }
            }
        }
