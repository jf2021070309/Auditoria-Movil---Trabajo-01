    ...
    public ResultPoint[] detect() {
        ...
        if (!z && z6) {
            ...
            while (resultPoint == null && i10 < i9) {
                i10++;
                resultPoint = a(i2, i3 - i10, i2 + i10, i3);
            }
            if (resultPoint == null) {
                throw NotFoundException.getNotFoundInstance();
            }
            ...
            while (resultPoint2 == null && i11 < i9) {
                i11++;
                resultPoint2 = a(i2, i4 + i11, i2 + i11, i4);
            }
            ...
            for (int i12 = 1; resultPoint3 == null && i12 < i9; i12++) {
                resultPoint3 = a(i, i4 + i12, i - i12, i4);
            }
            ...
            for (int i13 = 1; resultPoint4 == null && i13 < i9; i13++) {
                resultPoint4 = a(i, i3 - i13, i - i13, i3);
            }
            if (resultPoint4 == null) {
                throw NotFoundException.getNotFoundInstance();
            }
            return a(resultPoint4, resultPoint, resultPoint3, resultPoint2);
        }
        throw NotFoundException.getNotFoundInstance();
    }
