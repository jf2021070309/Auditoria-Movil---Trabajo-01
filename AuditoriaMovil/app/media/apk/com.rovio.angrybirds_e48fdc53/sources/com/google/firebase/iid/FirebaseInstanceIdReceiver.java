...
public final class FirebaseInstanceIdReceiver extends WakefulBroadcastReceiver {
    ...
    public static int zza(BroadcastReceiver broadcastReceiver, Context context, String str, Intent intent) {
        ...
        boolean z2 = (intent.getFlags() & DownloadExpSwitchCode.BUGFIX_GETPACKAGEINFO_BY_UNZIP) != 0;
        if (z && !z2) {
            return a(broadcastReceiver, context, str, intent);
        }
        int zzb = zzav.zzai().zzb(context, str, intent);
        if (PlatformVersion.isAtLeastO() && zzb == 402) {
            a(broadcastReceiver, context, str, intent);
            return 403;
        }
        return zzb;
    }
    ...
    private static int a(BroadcastReceiver broadcastReceiver, Context context, String str, Intent intent) {
        ...
        a(context, str).zza(intent, broadcastReceiver.goAsync());
        return -1;
    }
