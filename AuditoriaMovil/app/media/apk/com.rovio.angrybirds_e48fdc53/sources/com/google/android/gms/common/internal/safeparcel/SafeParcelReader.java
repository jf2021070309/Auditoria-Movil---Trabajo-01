...
public class SafeParcelReader {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (readSize != i2) {
            ...
            throw new ParseException(new StringBuilder(String.valueOf(hexString).length() + 46).append("Expected size ").append(i2).append(" got ").append(readSize).append(" (0x").append(hexString).append(")").toString(), parcel);
        }
    }
