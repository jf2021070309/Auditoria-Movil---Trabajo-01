...
public final class zac extends zaa {
    ...
    protected final void zaa(Drawable drawable, boolean z, boolean z2, boolean z3) {
        com.google.android.gms.internal.base.zae zaeVar;
        ImageView imageView = this.zanb.get();
        if (imageView != null) {
            ...
            if (zaa) {
                ...
                zaeVar = new com.google.android.gms.internal.base.zae(drawable2, drawable);
            } else {
                zaeVar = drawable;
            }
            ...
            if (zaa) {
                ((com.google.android.gms.internal.base.zae) zaeVar).startTransition(250);
            }
        }
    }
}
