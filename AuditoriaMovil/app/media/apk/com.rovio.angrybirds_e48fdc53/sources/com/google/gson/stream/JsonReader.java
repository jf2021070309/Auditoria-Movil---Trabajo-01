...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) {
                ...
                if (i == 13) {
                    ...
                    throw new IllegalStateException("Expected a name but was " + jsonReader.peek() + jsonReader.h());
                }
            }
        };
    }
    ...
    public void beginArray() {
        ...
        throw new IllegalStateException("Expected BEGIN_ARRAY but was " + peek() + h());
    }
    ...
    public void endArray() {
        ...
        throw new IllegalStateException("Expected END_ARRAY but was " + peek() + h());
    }
    ...
    public void beginObject() {
        ...
        throw new IllegalStateException("Expected BEGIN_OBJECT but was " + peek() + h());
    }
    ...
    public void endObject() {
        ...
        throw new IllegalStateException("Expected END_OBJECT but was " + peek() + h());
    }
    ...
    */
    private int c() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.stream.JsonReader.c():int");
    }
    ...
    public String nextName() {
        ...
        if (i == 14) {
            ...
            throw new IllegalStateException("Expected a name but was " + peek() + h());
        }
        this.a = 0;
        this.o[this.n - 1] = b2;
        return b2;
    ...
    public String nextString() {
        ...
        if (i == 10) {
            ...
            throw new IllegalStateException("Expected a string but was " + peek() + h());
        }
        this.a = 0;
        int[] iArr = this.p;
        int i2 = this.n - 1;
    ...
    public boolean nextBoolean() {
        ...
        if (i == 5) {
            ...
            throw new IllegalStateException("Expected a boolean but was " + peek() + h());
        }
    }
    ...
    public void nextNull() {
        ...
        throw new IllegalStateException("Expected null but was " + peek() + h());
    }
    ...
    public double nextDouble() {
        ...
        if (i == 16) {
            ...
            throw new IllegalStateException("Expected a double but was " + peek() + h());
        }
        this.a = 11;
        double parseDouble = Double.parseDouble(this.l);
        if (!this.d && (Double.isNaN(parseDouble) || Double.isInfinite(parseDouble))) {
            throw new MalformedJsonException("JSON forbids NaN and infinities: " + parseDouble + h());
        }
        this.l = null;
        this.a = 0;
        int[] iArr2 = this.p;
    ...
    public long nextLong() {
        ...
        if (i == 16) {
            ...
            throw new IllegalStateException("Expected a long but was " + peek() + h());
        }
        this.a = 11;
        double parseDouble = Double.parseDouble(this.l);
        long j = (long) parseDouble;
        if (j != parseDouble) {
            throw new NumberFormatException("Expected a long but was " + this.l + h());
        }
        this.l = null;
        this.a = 0;
        int[] iArr3 = this.p;
    ...
    public int nextInt() {
        ...
        if (i == 15) {
            int i2 = (int) this.j;
            if (this.j != i2) {
                throw new NumberFormatException("Expected an int but was " + this.j + h());
            }
            this.a = 0;
            int[] iArr = this.p;
            int i3 = this.n - 1;
        ...
        if (i == 16) {
            ...
            throw new IllegalStateException("Expected an int but was " + peek() + h());
        }
        this.a = 11;
        double parseDouble = Double.parseDouble(this.l);
        int i5 = (int) parseDouble;
        if (i5 != parseDouble) {
            throw new NumberFormatException("Expected an int but was " + this.l + h());
        }
        this.l = null;
        this.a = 0;
        int[] iArr3 = this.p;
    ...
    public String h() {
        return " at line " + (this.h + 1) + " column " + ((this.f - this.i) + 1) + " path " + getPath();
    }
    ...
    private IOException b(String str) {
        throw new MalformedJsonException(str + h());
    }
