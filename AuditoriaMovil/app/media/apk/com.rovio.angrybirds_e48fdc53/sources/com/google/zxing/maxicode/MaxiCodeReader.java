...
public final class MaxiCodeReader implements Reader {
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) {
        if (map != null && map.containsKey(DecodeHintType.PURE_BARCODE)) {
            DecoderResult decode = this.b.decode(a(binaryBitmap.getBlackMatrix()), map);
            Result result = new Result(decode.getText(), decode.getRawBytes(), a, BarcodeFormat.MAXICODE);
