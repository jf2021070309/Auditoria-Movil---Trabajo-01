...
public class c implements f {
    ...
    public void a(g gVar) {
        ...
        while (true) {
            ...
            gVar.a++;
            int a2 = a(b, sb);
            int length = ((sb.length() / 3) << 1) + gVar.d();
            gVar.c(length);
            int dataCapacity = gVar.i().getDataCapacity() - length;
            if (!gVar.g()) {
                StringBuilder sb2 = new StringBuilder();
                if (sb.length() % 3 == 2 && (dataCapacity < 2 || dataCapacity > 2)) {
                    a2 = a(gVar, sb, sb2, a2);
                }
                while (sb.length() % 3 == 1 && ((a2 <= 3 && dataCapacity != 1) || a2 > 3)) {
                    a2 = a(gVar, sb, sb2, a2);
                }
            } else if (sb.length() % 3 == 0 && (a = HighLevelEncoder.a(gVar.a(), gVar.a, a())) != a()) {
                gVar.b(a);
                break;
            }
        }
    ...
    void b(g gVar, StringBuilder sb) {
        ...
        int length2 = ((sb.length() / 3) << 1) + gVar.d();
        gVar.c(length2);
        int dataCapacity = gVar.i().getDataCapacity() - length2;
        if (length == 2) {
            sb.append((char) 0);
            while (sb.length() >= 3) {
                a(gVar, sb);
