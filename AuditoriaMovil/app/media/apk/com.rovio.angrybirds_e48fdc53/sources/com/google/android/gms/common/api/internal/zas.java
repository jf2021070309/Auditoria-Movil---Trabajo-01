    ...
    */
    public final boolean isConnected() {
        /*
            ...
            r1.lock()
            com.google.android.gms.common.api.internal.zabe r1 = r2.zaee     // Catch: java.lang.Throwable -> L28
            boolean r1 = r1.isConnected()     // Catch: java.lang.Throwable -> L28
            if (r1 == 0) goto L26
            com.google.android.gms.common.api.internal.zabe r1 = r2.zaef     // Catch: java.lang.Throwable -> L28
            boolean r1 = r1.isConnected()     // Catch: java.lang.Throwable -> L28
            if (r1 != 0) goto L20
            boolean r1 = r2.zaz()     // Catch: java.lang.Throwable -> L28
            if (r1 != 0) goto L20
            int r1 = r2.zaeo     // Catch: java.lang.Throwable -> L28
            if (r1 != r0) goto L26
        L20:
            java.util.concurrent.locks.Lock r1 = r2.zaen
            r1.unlock()
    ...
    private final PendingIntent zaaa() {
        ...
        return PendingIntent.getActivity(this.mContext, System.identityHashCode(this.zaed), this.zaei.getSignInIntent(), DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25);
    }
