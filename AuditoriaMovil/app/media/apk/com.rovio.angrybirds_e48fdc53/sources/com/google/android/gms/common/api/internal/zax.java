    ...
    */
    private final boolean zaac() {
        /*
            ...
            r0.lock()
            boolean r0 = r3.zafc     // Catch: java.lang.Throwable -> L45
            if (r0 == 0) goto Le
            boolean r0 = r3.zaez     // Catch: java.lang.Throwable -> L45
            if (r0 != 0) goto L15
        Le:
            java.util.concurrent.locks.Lock r0 = r3.zaen
            r0.unlock()
        ...
        L14:
            return r0
        L15:
            java.util.Map<com.google.android.gms.common.api.Api$AnyClientKey<?>, com.google.android.gms.common.api.internal.zaw<?>> r0 = r3.zaeu     // Catch: java.lang.Throwable -> L45
        ...
        L1f:
            ...
            com.google.android.gms.common.api.Api$AnyClientKey r0 = (com.google.android.gms.common.api.Api.AnyClientKey) r0     // Catch: java.lang.Throwable -> L45
            com.google.android.gms.common.ConnectionResult r0 = r3.zaa(r0)     // Catch: java.lang.Throwable -> L45
            if (r0 == 0) goto L37
            boolean r0 = r0.isSuccess()     // Catch: java.lang.Throwable -> L45
            if (r0 != 0) goto L1f
        L37:
            java.util.concurrent.locks.Lock r0 = r3.zaen
            r0.unlock()
    ...
    public final ConnectionResult zaaf() {
        ...
        for (zaw<?> zawVar : this.zaet.values()) {
            ...
            ConnectionResult connectionResult4 = this.zafd.get(zawVar.zak());
            if (!connectionResult4.isSuccess() && (!this.zaev.get(api).booleanValue() || connectionResult4.hasResolution() || this.zaex.isUserResolvableError(connectionResult4.getErrorCode()))) {
                if (connectionResult4.getErrorCode() == 4 && this.zaez) {
