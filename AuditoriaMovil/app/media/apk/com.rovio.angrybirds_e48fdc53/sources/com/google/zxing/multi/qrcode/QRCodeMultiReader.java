...
public final class QRCodeMultiReader extends QRCodeReader implements MultipleBarcodeReader {
    ...
    public Result[] decodeMultiple(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) {
        ...
        List<Result> a2 = a(arrayList);
        return (Result[]) a2.toArray(new Result[a2.size()]);
    }
    ...
    private static List<Result> a(List<Result> list) {
        ...
        if (z) {
            ...
            Result result4 = new Result(sb.toString(), bArr2, b, BarcodeFormat.QR_CODE);
            if (i > 0) {
    ...
    /* loaded from: classes2.dex */
    public static final class a implements Serializable, Comparator<Result> {
        private a() {
        }
