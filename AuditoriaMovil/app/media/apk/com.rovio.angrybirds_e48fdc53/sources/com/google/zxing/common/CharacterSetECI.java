...
public enum CharacterSetECI {
    ...
    private static final Map<Integer, CharacterSetECI> a = new HashMap();
    ...
    static {
        ...
        for (CharacterSetECI characterSetECI : values()) {
            for (int i : characterSetECI.c) {
                a.put(Integer.valueOf(i), characterSetECI);
            }
            b.put(characterSetECI.name(), characterSetECI);
            for (String str : characterSetECI.d) {
