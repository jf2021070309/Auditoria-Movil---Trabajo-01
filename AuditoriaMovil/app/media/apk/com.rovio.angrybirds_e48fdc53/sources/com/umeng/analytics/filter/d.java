...
public class d {
            ...
            if (z) {
                try {
                    ...
                    while (i < decode.length / 4) {
                        int i2 = i * 4;
                        this.d.add(Integer.valueOf(((decode[i2 + 0] & Constants.UNKNOWN) << 24) + ((decode[i2 + 1] & Constants.UNKNOWN) << 16) + ((decode[i2 + 2] & Constants.UNKNOWN) << 8) + (decode[i2 + 3] & Constants.UNKNOWN)));
                        i++;
                    }
                    return;
    ...
    private Integer c(String str) {
        try {
            ...
            return Integer.valueOf(((digest[0] & Constants.UNKNOWN) << 24) + ((digest[1] & Constants.UNKNOWN) << 16) + ((digest[2] & Constants.UNKNOWN) << 8) + (digest[3] & Constants.UNKNOWN));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
