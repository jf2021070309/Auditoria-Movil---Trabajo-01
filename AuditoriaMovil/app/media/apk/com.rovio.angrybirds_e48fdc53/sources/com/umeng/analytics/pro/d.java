...
public class d {
    ...
    public static final String al = as.b().b(as.t);
    public static final String am = as.b().b(as.u);
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", MeasurementEvent.MEASUREMENT_EVENT_NAME_KEY, "token", "time", "ip", bg.O, "region", "city", "browser", bg.x, bg.F, "device_version", bg.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", "minute", "app_version", "sp"};
}
