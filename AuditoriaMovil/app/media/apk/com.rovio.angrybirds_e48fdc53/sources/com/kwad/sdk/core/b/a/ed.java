...
public final class ed implements com.kwad.sdk.core.d<HybridLoadMsg> {
    ...
    private static void a2(HybridLoadMsg hybridLoadMsg, JSONObject jSONObject) {
        ...
        hybridLoadMsg.state = jSONObject.optInt(ServerProtocol.DIALOG_PARAM_STATE);
        hybridLoadMsg.interval = jSONObject.optString(com.umeng.analytics.pro.bg.aU);
    ...
    private static JSONObject b2(HybridLoadMsg hybridLoadMsg, JSONObject jSONObject) {
        ...
        if (hybridLoadMsg.state != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, ServerProtocol.DIALOG_PARAM_STATE, hybridLoadMsg.state);
        }
        if (hybridLoadMsg.interval != null && !hybridLoadMsg.interval.equals("")) {
            com.kwad.sdk.utils.t.putValue(jSONObject, com.umeng.analytics.pro.bg.aU, hybridLoadMsg.interval);
        }
