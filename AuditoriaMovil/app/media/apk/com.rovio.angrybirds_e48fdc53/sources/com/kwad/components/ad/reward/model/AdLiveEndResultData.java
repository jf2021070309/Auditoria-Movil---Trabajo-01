...
public class AdLiveEndResultData extends BaseResultData {
    ...
    public static class AdLivePushEndInfo implements com.kwad.sdk.core.b, Serializable {
        ...
        public String mDisplayWatchingUserCount = AppEventsConstants.EVENT_PARAM_VALUE_NO;
        public String mDisplayLikeUserCount = AppEventsConstants.EVENT_PARAM_VALUE_NO;
        ...
        public void parseJson(JSONObject jSONObject) {
            ...
            this.mDisplayWatchingUserCount = jSONObject.optString("displayWatchingUserCount", AppEventsConstants.EVENT_PARAM_VALUE_NO);
            this.mLiveDuration = jSONObject.optLong("liveDuration");
            this.mLikeUserCount = jSONObject.optInt("likeUserCount");
            this.mDisplayLikeUserCount = jSONObject.optString("displayLikeUserCount", AppEventsConstants.EVENT_PARAM_VALUE_NO);
        }
