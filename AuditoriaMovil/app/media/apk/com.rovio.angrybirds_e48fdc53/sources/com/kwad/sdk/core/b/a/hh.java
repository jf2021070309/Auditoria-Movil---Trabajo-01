...
public final class hh implements com.kwad.sdk.core.d<AdMatrixInfo.RotateDegreeInfo> {
    ...
    private static JSONObject b2(AdMatrixInfo.RotateDegreeInfo rotateDegreeInfo, JSONObject jSONObject) {
        ...
        if (rotateDegreeInfo.direction != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "direction", rotateDegreeInfo.direction);
        }
        return jSONObject;
    }
