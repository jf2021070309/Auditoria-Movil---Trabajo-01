...
public final class hc implements com.kwad.sdk.core.d<RewardMonitorInfo> {
    ...
    private static JSONObject b2(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        if (rewardMonitorInfo.downloadSize != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "download_size", rewardMonitorInfo.downloadSize);
        }
