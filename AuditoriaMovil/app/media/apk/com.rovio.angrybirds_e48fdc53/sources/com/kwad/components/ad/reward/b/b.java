...
public final class b extends g implements a.b {
    ...
    private int[] qW;
    private com.kwad.components.ad.reward.b.a rm;
    private a rn;
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        com.kwad.components.ad.reward.b.a aVar = new com.kwad.components.ad.reward.b.a(layoutInflater.getContext(), viewGroup, this.qW);
        this.rm = aVar;
        aVar.a(this);
        ...
        this.rm.b(r.E(this.mAdTemplate));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (arguments != null) {
            ...
            if (arguments.containsKey("key_end_location")) {
                this.qW = arguments.getIntArray("key_end_location");
            }
        }
    }
}
