...
public final class n {
    public static Charset aFd = Charset.forName("ISO-8859-1");
    public static Charset aFe = Charset.forName("UTF-8");
    private static ThreadLocal<Boolean> aFf = new ThreadLocal<Boolean>() { // from class: com.kwad.sdk.pngencrypt.n.1
    ...
    public static byte[] GN() {
        return new byte[]{-119, 80, 78, 71, cv.k, 10, 26, 10};
    }
    ...
    public static int f(byte[] bArr, int i) {
        return (bArr[i + 1] & Constants.UNKNOWN) | ((bArr[i] & Constants.UNKNOWN) << 8);
    }
