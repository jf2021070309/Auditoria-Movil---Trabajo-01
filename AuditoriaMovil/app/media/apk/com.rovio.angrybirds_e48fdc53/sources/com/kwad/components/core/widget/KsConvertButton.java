...
public class KsConvertButton extends KSCornerButton implements KsAppDownloadListener {
    ...
    private String getAdActionDesc() {
        ...
        if (adTemplate != null) {
            return com.kwad.sdk.core.response.b.a.aw(com.kwad.sdk.core.response.b.d.ck(adTemplate));
        }
        return null;
    }
    ...
    public void onDownloadFailed() {
        AdTemplate adTemplate = this.mAdTemplate;
        aU(adTemplate != null ? com.kwad.sdk.core.response.b.a.aw(com.kwad.sdk.core.response.b.d.ck(adTemplate)) : "立即下载");
    }
    ...
    public void onInstalled() {
        AdTemplate adTemplate = this.mAdTemplate;
        aU(adTemplate != null ? com.kwad.sdk.core.response.b.a.U(com.kwad.sdk.core.response.b.d.ck(adTemplate)) : "立即打开");
    }
