...
public final class ip implements com.kwad.sdk.core.d<TKAdLiveShopItemInfo> {
    ...
    private static void a2(TKAdLiveShopItemInfo tKAdLiveShopItemInfo, JSONObject jSONObject) {
        ...
        tKAdLiveShopItemInfo.price = jSONObject.optString(InAppPurchaseMetaData.KEY_PRICE);
    ...
    private static JSONObject b2(TKAdLiveShopItemInfo tKAdLiveShopItemInfo, JSONObject jSONObject) {
        ...
        if (tKAdLiveShopItemInfo.price != null && !tKAdLiveShopItemInfo.price.equals("")) {
            com.kwad.sdk.utils.t.putValue(jSONObject, InAppPurchaseMetaData.KEY_PRICE, tKAdLiveShopItemInfo.price);
        }
        return jSONObject;
    }
