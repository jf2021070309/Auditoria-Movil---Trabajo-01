...
public class AppRunningInfoNative extends NativeObject implements b<AppRunningInfoNative> {
    private static SimpleDateFormat ajS = new SimpleDateFormat("yyyy-MM-dd:HH:mm:ss");
    ...
    public String toString() {
        return "AppRunningInfo{packageName='" + c.b(this) + "', lastRunningTime=" + U(c.c(this)) + '}';
    }
}
