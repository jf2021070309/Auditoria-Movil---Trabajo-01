...
public final class aw implements com.kwad.sdk.core.d<com.kwad.components.ad.reward.model.b> {
    ...
    private static void a2(com.kwad.components.ad.reward.model.b bVar, JSONObject jSONObject) {
        ...
        bVar.iZ = jSONObject.optLong("lastShowCardTimeStamp");
        bVar.ja = jSONObject.optInt("cardShowCount");
    }
    ...
    private static JSONObject b2(com.kwad.components.ad.reward.model.b bVar, JSONObject jSONObject) {
        ...
        if (bVar.iZ != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "lastShowCardTimeStamp", bVar.iZ);
        }
        if (bVar.ja != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "cardShowCount", bVar.ja);
        }
        return jSONObject;
    }
