...
public final class ia implements com.kwad.sdk.core.d<com.kwad.components.ad.splashscreen.local.a> {
    ...
    private static void a2(com.kwad.components.ad.splashscreen.local.a aVar, JSONObject jSONObject) {
        ...
        aVar.ge = jSONObject.optInt("currentDailyCount");
    }
    ...
    private static JSONObject b2(com.kwad.components.ad.splashscreen.local.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.ge != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "currentDailyCount", aVar.ge);
        }
        return jSONObject;
    }
