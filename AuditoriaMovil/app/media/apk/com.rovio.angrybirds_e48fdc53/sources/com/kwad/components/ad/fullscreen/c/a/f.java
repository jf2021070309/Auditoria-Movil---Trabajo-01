...
public final class f extends com.kwad.components.ad.reward.presenter.a implements m, com.kwad.sdk.core.g.b, com.kwad.sdk.widget.c {
    ...
    private com.kwad.components.ad.reward.e.f mPlayEndPageListener = new com.kwad.components.ad.reward.e.a() { // from class: com.kwad.components.ad.fullscreen.c.a.f.1
        ...
        public final void bE() {
            if (f.this.gR != null) {
                f.this.gR.setVisibility(8);
            }
            if (f.this.gX != null) {
                f.this.gX.setVisibility(8);
            }
            if (f.this.dO != null) {
                f.this.dO.bj(f.this.getContext());
            }
            if (f.this.gZ != null) {
                f.this.gZ.cancel();
                f.this.gZ = null;
    ...
    public Animator a(float f, float f2) {
        ...
        a.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.fullscreen.c.a.f.7
            ...
            public final void onAnimationStart(Animator animator) {
                ...
                f.this.gU.setPivotX(f.this.gU.getWidth());
                f.this.gU.setPivotY(f.this.gU.getHeight());
            }
        });
        ...
        ofFloat3.addUpdateListener(new com.kwad.components.ad.widget.a(this.gW) { // from class: com.kwad.components.ad.fullscreen.c.a.f.8
        ...
        ofFloat4.addUpdateListener(new com.kwad.components.ad.widget.a(this.gU) { // from class: com.kwad.components.ad.fullscreen.c.a.f.9
            @Override // com.kwad.components.ad.widget.a
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
                float floatValue = ((Float) obj).floatValue();
                if (layoutParams != null) {
        ...
        ofArgb.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.fullscreen.c.a.f.10
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    ...
                    GradientDrawable gradientDrawable = (GradientDrawable) f.this.gW.getBackground();
                    gradientDrawable.mutate();
                    gradientDrawable.setColor(intValue);
                    if (intValue == color2) {
                        gradientDrawable.setStroke(dimensionPixelSize, -1);
                    }
                    f.this.gW.setBackground(gradientDrawable);
                } catch (Throwable th) {
        ...
        ofFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.fullscreen.c.a.f.11
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    ...
                    f.this.gS.setAlpha(floatValue);
                    f.this.gT.setAlpha(floatValue);
                } catch (Throwable th) {
                    com.kwad.sdk.core.e.c.printStackTrace(th);
                }
            }
        ...
        ofFloat6.addUpdateListener(new com.kwad.components.ad.widget.a(this.gS) { // from class: com.kwad.components.ad.fullscreen.c.a.f.12
            @Override // com.kwad.components.ad.widget.a
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
        ...
        ofFloat7.addUpdateListener(new com.kwad.components.ad.widget.a(this.gT) { // from class: com.kwad.components.ad.fullscreen.c.a.f.13
            @Override // com.kwad.components.ad.widget.a
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
                layoutParams.height = (int) ((Float) obj).floatValue();
            }
        ...
        clone.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.fullscreen.c.a.f.2
            ...
            public final void onAnimationStart(Animator animator) {
                super.onAnimationStart(animator);
                f.this.gU.setPivotX(dimension2);
                f.this.gU.setPivotY(dimension2);
            }
        });
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.fullscreen.c.a.f.3
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    f.this.gX.setVisibility(0);
                    layoutParams.width = (int) ((Float) valueAnimator.getAnimatedValue()).floatValue();
                    f.this.gX.setLayoutParams(layoutParams);
                } catch (Throwable th) {
                    com.kwad.sdk.core.e.c.printStackTrace(th);
                }
            }
    ...
    private static String a(j jVar, AdInfo adInfo) {
        String dw = com.kwad.sdk.core.response.b.b.dw(adInfo);
        com.kwad.components.core.e.d.c cVar = jVar.mApkDownloadHelper;
        if (!com.kwad.sdk.core.response.b.a.ax(adInfo) || cVar == null) {
            return dw;
        }
        int nA = cVar.nA();
        AdMatrixInfo.DownloadTexts dy = com.kwad.sdk.core.response.b.b.dy(adInfo);
        return nA != 8 ? nA != 12 ? dy.adActionDescription : dy.openAppLabel : dy.installAppLabel;
    }
    ...
    private void cb() {
        ...
        this.gR.post(new Runnable() { // from class: com.kwad.components.ad.fullscreen.c.a.f.6
            @Override // java.lang.Runnable
            public final void run() {
                int height = adBaseFrameLayout.getHeight();
                f fVar = f.this;
                fVar.gZ = fVar.a(dimensionPixelSize, height - dimensionPixelSize2);
                if (f.this.gZ != null) {
                    f.this.gZ.start();
                }
            }
    ...
    public final void ah() {
        ...
        if (com.kwad.components.ad.fullscreen.b.a.a(getContext(), this.qB.mAdTemplate)) {
            this.qB.a(this);
            this.qB.b(this.mPlayEndPageListener);
            cb();
            initView();
            a(ck);
            float ds = com.kwad.sdk.core.response.b.b.ds(ck);
            com.kwad.sdk.core.g.d dVar = this.dO;
            if (dVar == null) {
                com.kwad.sdk.core.g.d dVar2 = new com.kwad.sdk.core.g.d(ds);
                this.dO = dVar2;
                dVar2.a(this);
            } else {
                dVar.e(ds);
