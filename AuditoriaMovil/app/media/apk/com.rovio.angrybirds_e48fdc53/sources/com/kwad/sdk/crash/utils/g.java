...
public final class g {
    ...
    private static final File aCb = new File("/proc/self/task");

    public static void E(File file) {
        try {
            d.a(SystemUtil.de(21) ? new String[]{"logcat", "-v", "threadtime", "-b", "main", "-b", "system", "-b", com.umeng.analytics.pro.d.ar, "-b", "crash", "-d", "-f", file.getPath()} : new String[]{"logcat", "-v", "threadtime", "-b", "main", "-b", "system", "-b", com.umeng.analytics.pro.d.ar, "-d", "-f", file.getPath()}, 0);
        } catch (IOException e) {
    ...
    public static void H(File file) {
        try {
            ...
            if (SystemUtil.de(24)) {
                s.f(f, "dumpMemInfo", open, memoryInfo, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, new String[0]);
            } else if (SystemUtil.de(23)) {
                s.f(f, "dumpMemInfo", open, memoryInfo, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, new String[0]);
            } else if (SystemUtil.de(19)) {
                s.f(f, "dumpMemInfo", open, memoryInfo, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, new String[0]);
            }
            Object open2 = ParcelFileDescriptor.open(file, 973078528);
            if (!SystemUtil.de(26)) {
                open2 = ((ParcelFileDescriptor) open2).getFileDescriptor();
            }
            s.f(f, "dumpGfxInfo", open2, new String[]{SystemUtil.getProcessName(com.kwad.sdk.crash.e.EB().getContext())});
        } catch (Exception e) {
            com.kwad.sdk.core.e.c.printStackTraceOnly(e);
        }
    }
    ...
    public static void a(ExceptionMessage exceptionMessage, int i) {
        com.kwad.sdk.crash.h EH = com.kwad.sdk.crash.e.EB().EH();
        if (EH == null) {
            com.kwad.sdk.core.e.c.d("tag", "getter is null!");
        } else {
            exceptionMessage.mCustomMsg = EH.mN().toString();
        }
    }
    ...
    private static void a(ExceptionMessage exceptionMessage, Context context) {
        ...
        exceptionMessage.mUsageTimeMills = com.kwad.sdk.crash.e.EB().EI();
        exceptionMessage.mAbi = AbiUtil.isArm64(context) ? "arm64" : "arm";
        exceptionMessage.mVersionConflict = TextUtils.equals(exceptionMessage.mVersionCode, ExceptionMessage.getSdkCrashVersionName("1.0", com.kwad.sdk.crash.e.EB().EF()));
    ...
    private static void a(ExceptionMessage exceptionMessage, DiskInfo diskInfo) {
        ...
        try {
            ...
            diskInfo.mDataTotalGB = aj(h.getTotalBytes(path));
            if (!((com.kwad.sdk.service.a.f) ServiceProvider.get(com.kwad.sdk.service.a.f.class)).Q(1024L)) {
                diskInfo.mDataAvailableGB = aj(h.getAvailableBytes(path));
            }
            if ("mounted".equals(Environment.getExternalStorageState()) && (externalStorageDirectory = Environment.getExternalStorageDirectory()) != null) {
                diskInfo.mExternalStorageTotalGB = aj(h.getTotalBytes(externalStorageDirectory.getPath()));
                if (!((com.kwad.sdk.service.a.f) ServiceProvider.get(com.kwad.sdk.service.a.f.class)).Q(1024L)) {
                    diskInfo.mExternalStorageAvailableGB = aj(h.getAvailableBytes(externalStorageDirectory.getPath()));
                }
            }
        } catch (Exception e) {
            com.kwad.sdk.core.e.c.printStackTraceOnly(e);
    ...
    private static void a(ExceptionMessage exceptionMessage, MemoryInfo memoryInfo, Context context) {
        ...
        SystemUtil.a JC = SystemUtil.JC();
        JC.aJS = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        JC.aJO = SystemUtil.JB();
        JC.aJR = Debug.getPss();
        memoryInfo.mTotalMB = (int) (JC.aJO / 1048576);
        memoryInfo.mJavaHeapLimitMB = (int) (com.kwad.sdk.crash.d.azW / 1048576.0d);
        memoryInfo.mJavaHeapMB = (int) (JC.aJS / 1048576);
        memoryInfo.mVssMB = (int) (JC.aJP / 1024);
        memoryInfo.mRssMB = (int) (JC.aJQ / 1024);
        memoryInfo.mPssMB = (int) (JC.aJR / 1024);
        memoryInfo.mThreadsCount = JC.mThreadsCount;
        memoryInfo.mFdCount = Fm();
        if (context != null) {
            memoryInfo.mAvailableMB = (int) (SystemUtil.da(context) / 1048576);
        }
    ...
    private static void a(MemoryInfo memoryInfo) {
        ...
        for (File file : listFiles) {
            ...
            if (!TextUtils.isEmpty(threadInfo.mName)) {
                threadInfo.mName = ad(threadInfo.mName, "\n");
    ...
    private static double aj(long j) {
    ...
    private static void b(ExceptionMessage exceptionMessage, Context context) {
        ...
        if (com.kwad.sdk.crash.d.azX.matcher(absolutePath).matches() || com.kwad.sdk.crash.d.azY.matcher(absolutePath).matches()) {
            packageName = context.getPackageName();
        } else {
            Matcher matcher = com.kwad.sdk.crash.d.azZ.matcher(absolutePath);
            Matcher matcher2 = com.kwad.sdk.crash.d.aAa.matcher(absolutePath);
            if (matcher.matches()) {
    ...
    private static void b(Throwable th, ExceptionMessage exceptionMessage) {
        ...
        exceptionMessage.mCrashDetail = p.replaceAll("[\n\t]", "#");
    }
    ...
    private static String bA(Context context) {
        StringBuilder sb = new StringBuilder();
        try {
            sb.append("BuildConfig Version Name: " + com.kwad.sdk.crash.e.EB().getSdkVersion() + "\n");
    ...
    private static String bB(Context context) {
        ...
        if (classLoader != null) {
            ...
            if (obj != null) {
                ...
                if (split.length >= 2) {
                    sb.append("\n====path: " + split[1] + ", length: " + eT(split[1]));
                }
            }
        }
        return sb.toString();
    ...
    private static void e(ExceptionMessage exceptionMessage) {
        exceptionMessage.mVirtualApp = com.kwad.sdk.crash.e.EB().EE();
        exceptionMessage.mVersionCode = com.kwad.sdk.crash.e.EB().getSdkVersion();
    }
