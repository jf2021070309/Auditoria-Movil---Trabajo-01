...
public final class cj implements com.kwad.sdk.core.d<AdStyleInfo.PlayDetailInfo.DetailTopToolBarInfo> {
    ...
    private static void a2(AdStyleInfo.PlayDetailInfo.DetailTopToolBarInfo detailTopToolBarInfo, JSONObject jSONObject) {
        ...
        detailTopToolBarInfo.style = jSONObject.optInt(AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE);
    ...
    private static JSONObject b2(AdStyleInfo.PlayDetailInfo.DetailTopToolBarInfo detailTopToolBarInfo, JSONObject jSONObject) {
        ...
        if (detailTopToolBarInfo.style != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE, detailTopToolBarInfo.style);
        }
