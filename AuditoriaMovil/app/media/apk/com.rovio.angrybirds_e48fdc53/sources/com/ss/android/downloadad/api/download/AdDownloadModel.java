...
public class AdDownloadModel implements DownloadModel {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt(bg.o, this.mPackageName);
            ...
            if (deepLink != null) {
                ...
                if (!TextUtils.isEmpty(this.mDeepLink.getWebUrl())) {
                    jSONObject.put(MessengerShareContentUtility.BUTTON_URL_TYPE, this.mDeepLink.getWebUrl());
                }
            }
            g gVar = this.mQuickAppModel;
            if (gVar != null) {
                jSONObject.putOpt("quick_app_url", gVar.dr());
            }
            ...
            wb.i().dr(e, "AdDownloadModel toJson");
        }
        return jSONObject;
    }
    ...
    public static AdDownloadModel fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            wb.i().dr(e, "AdDownloadModel fromJson");
        }
        return builder.build();
    }

    private static void appendDeepLinkFromJson(JSONObject jSONObject, Builder builder) {
        builder.setDeepLink(new DeepLink(jSONObject.optString("open_url"), jSONObject.optString(MessengerShareContentUtility.BUTTON_URL_TYPE), null));
    }
