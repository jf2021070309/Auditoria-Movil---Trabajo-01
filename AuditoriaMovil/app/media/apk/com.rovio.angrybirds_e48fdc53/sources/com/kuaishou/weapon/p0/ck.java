...
public class ck {
    ...
    public JSONObject a() {
        ...
        try {
            ...
            jSONObject.put("168", di.b(a3));
            jSONObject.put("169", di.a(a3));
            ...
            if (Engine.loadSuccess) {
                ...
                if (a.b(de.X, 1) == 1 && Build.VERSION.SDK_INT < 23) {
                    ar arVar = new ar(this.a);
                    String a7 = arVar.a("57");
                    if (!TextUtils.isEmpty(a7)) {
                        jSONObject.put("57", a7);
                ...
                if (a.b(de.U, 1) == 1) {
                    ...
                    jSONObject.put("177", new az(this.a, TTAdConstant.SHOW_POLL_TIME_SPLASH_DEFAULT).d("177"));
                }
                if ((e || e2) && a.b(de.W, 0) == 1) {
            ...
            jSONObject.put("11008", a.b(de.g, bp.e));
            ...
            String b5 = a.b(de.m, "", true);
            if (!TextUtils.isEmpty(b5)) {
                jSONObject.put("183", b5);
                a.c(de.m, "");
            }
            jSONObject.put("187", ak.a(this.a) ? 1 : i);
            jSONObject.put("11006", e ? 1 : i);
            jSONObject.put("11029", e2 ? 1 : i);
