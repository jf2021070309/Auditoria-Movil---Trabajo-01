    ...
    private void getEGidImpl(boolean z) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(this.mEgid)) {
                ...
                String a3 = (TextUtils.isEmpty(a2) && g.a(this.mParamContext, new String[]{com.kuaishou.weapon.p0.g.i, com.kuaishou.weapon.p0.g.j})) ? d.a(this.mParamContext).a("Lm91a2R0ZnQ=") : "";
