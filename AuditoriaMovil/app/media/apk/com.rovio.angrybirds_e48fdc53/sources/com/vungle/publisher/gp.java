...
public final class gp implements MembersInjector<gl> {
    ...
    public gp(Provider<ci> provider, Provider<eb.c> provider2, Provider<zl> provider3, Provider<hk.a> provider4, Provider<ct.a> provider5) {
        if (!a && provider == null) {
    ...
    public static MembersInjector<gl> a(Provider<ci> provider, Provider<eb.c> provider2, Provider<zl> provider3, Provider<hk.a> provider4, Provider<ct.a> provider5) {
