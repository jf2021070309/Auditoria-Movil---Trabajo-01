...
public final class kq implements MembersInjector<ki.a> {
    ...
    public static MembersInjector<ki.a> a(Provider<ci> provider, Provider<co.a> provider2, Provider<ct.a> provider3, Provider<jn.a> provider4, Provider<kd.a> provider5, Provider<ki> provider6, Provider<ds.a> provider7) {
        return new kq(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }

    @Override // dagger.MembersInjector
    /* renamed from: a */
    public void injectMembers(ki.a aVar) {
        if (aVar == null) {
