...
public final class jx implements MembersInjector<jt> {
    ...
    static {
        a = !jx.class.desiredAssertionStatus();
    }

    public jx(Provider<ci> provider, Provider<eb.c> provider2, Provider<zl> provider3, Provider<hk.a> provider4, Provider<ct.a> provider5) {
        if (!a && provider == null) {
    ...
    public static MembersInjector<jt> a(Provider<ci> provider, Provider<eb.c> provider2, Provider<zl> provider3, Provider<hk.a> provider4, Provider<ct.a> provider5) {
