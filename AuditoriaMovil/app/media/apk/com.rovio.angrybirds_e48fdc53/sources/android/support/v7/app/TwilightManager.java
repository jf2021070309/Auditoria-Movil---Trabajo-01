...
class TwilightManager {
    ...
    public static TwilightManager getInstance(Context context) {
        if (sInstance == null) {
            ...
            sInstance = new TwilightManager(context2, (LocationManager) context2.getSystemService(PlaceFields.LOCATION));
        }
        return sInstance;
    }
    ...
    private Location getLastKnownLocation() {
        ...
        int permission = PermissionChecker.checkSelfPermission(this.mContext, g.h);
        if (permission == 0) {
            coarseLoc = getLastKnownLocationForProvider("network");
        }
        int permission2 = PermissionChecker.checkSelfPermission(this.mContext, g.g);
        if (permission2 == 0) {
