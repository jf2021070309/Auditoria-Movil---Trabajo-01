...
public abstract class MediaBrowserServiceCompat extends Service {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String clientPackageName, int clientUid, Bundle rootHints) {
            ...
            if (rootHints != null && rootHints.getInt("extra_client_version", 0) != 0) {
                ...
                if (MediaBrowserServiceCompat.this.mSession != null) {
                    ...
                    BundleCompat.putBinder(rootExtras, "extra_session_binder", asBinder);
                } else {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    this.mServiceBinderImpl.connect(data.getString("data_package_name"), data.getInt(MediaBrowserProtocol.DATA_CALLING_PID), data.getInt("data_calling_uid"), rootHints, new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 2:
                ...
                case 3:
                    ...
                    this.mServiceBinderImpl.addSubscription(data.getString("data_media_item_id"), BundleCompat.getBinder(data, "data_callback_token"), options, new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 4:
                ...
                case 5:
                    ...
                    return;
                case 6:
                    Bundle rootHints2 = data.getBundle("data_root_hints");
                    MediaSessionCompat.ensureClassLoader(rootHints2);
                    this.mServiceBinderImpl.registerCallbacks(new ServiceCallbacksCompat(msg.replyTo), data.getString("data_package_name"), data.getInt(MediaBrowserProtocol.DATA_CALLING_PID), data.getInt("data_calling_uid"), rootHints2);
                    return;
                case 7:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString("data_search_query"), searchExtras, (ResultReceiver) data.getParcelable("data_result_receiver"), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 9:
                    ...
                    this.mServiceBinderImpl.sendCustomAction(data.getString("data_custom_action"), customActionExtras, (ResultReceiver) data.getParcelable("data_result_receiver"), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                default:
    ...
    public static class Result<T> {
        ...
        private void checkExtraFields(Bundle extras) {
            if (extras != null && extras.containsKey("android.media.browse.extra.DOWNLOAD_PROGRESS")) {
