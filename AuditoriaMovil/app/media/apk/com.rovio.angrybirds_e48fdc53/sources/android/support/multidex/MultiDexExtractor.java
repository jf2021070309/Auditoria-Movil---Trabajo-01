...
final class MultiDexExtractor {
    ...
    public static List<? extends File> load(Context context, File file, File file2, String str, boolean z) {
        File file3;
        FileLock lock;
    ...
    private static List<ExtractedDex> loadExistingExtractions(Context context, File file, File file2, String str) {
    ...
    private static List<ExtractedDex> performExtractions(File file, File file2) {
        ...
        try {
            ...
            int i = 2;
            while (entry != null) {
                ExtractedDex extractedDex = new ExtractedDex(file2, str + i + ".zip");
                arrayList.add(extractedDex);
                ...
                while (i2 < 3 && !z) {
                    ...
                    Log.i(TAG, "Extraction " + (z ? AnalyticsEvents.PARAMETER_SHARE_OUTCOME_SUCCEEDED : "failed") + " - length " + extractedDex.getAbsolutePath() + ": " + extractedDex.length() + " - crc: " + extractedDex.crc);
                    if (!z) {
                        extractedDex.delete();
