...
public final class ShareCompat {
    ...
    public static String getCallingPackage(Activity calledActivity) {
        ...
        if (result == null) {
            return calledActivity.getIntent().getStringExtra("android.support.v4.app.EXTRA_CALLING_PACKAGE");
        }
        return result;
    }
    ...
    public static class IntentBuilder {
        ...
        private IntentBuilder(Activity launchingActivity) {
            ...
            this.mIntent = action;
            action.putExtra("android.support.v4.app.EXTRA_CALLING_PACKAGE", launchingActivity.getPackageName());
