...
public class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int diameter) {
            RadialGradient radialGradient = new RadialGradient(diameter / 2, diameter / 2, CircleImageView.this.mShadowRadius, new int[]{1023410176, 0}, (float[]) null, Shader.TileMode.CLAMP);
