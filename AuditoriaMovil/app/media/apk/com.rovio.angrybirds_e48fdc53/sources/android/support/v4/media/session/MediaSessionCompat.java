...
public class MediaSessionCompat {
        ...
        if (state.getState() == 3 || state.getState() == 4 || state.getState() == 5) {
            ...
            if (updateTime > 0) {
                ...
                if (metadata != null && metadata.containsKey("android.media.metadata.DURATION")) {
                    long duration2 = metadata.getLong("android.media.metadata.DURATION");
                    duration = duration2;
                } else {
                    duration = -1;
                }
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
                ...
                try {
                    ...
                    if (command.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (impl != null) {
                            ...
                            BundleCompat.putBinder(result, "android.support.v4.media.session.EXTRA_BINDER", asBinder);
            ...
            @Override // android.support.v4.media.session.MediaSessionCompatApi21.Callback
            public void onCustomAction(String action, Bundle extras) {
                Bundle bundle = extras.getBundle("android.support.v4.media.session.action.ARGUMENT_EXTRAS");
                MediaSessionCompat.ensureClassLoader(bundle);
                if (action.equals("android.support.v4.media.session.action.PLAY_FROM_URI")) {
                    Uri uri = (Uri) extras.getParcelable("android.support.v4.media.session.action.ARGUMENT_URI");
                    ...
                    String mediaId = extras.getString("android.support.v4.media.session.action.ARGUMENT_MEDIA_ID");
                    ...
                    String query = extras.getString("android.support.v4.media.session.action.ARGUMENT_QUERY");
                    ...
                    Uri uri2 = (Uri) extras.getParcelable("android.support.v4.media.session.action.ARGUMENT_URI");
                    ...
                    boolean enabled = extras.getBoolean("android.support.v4.media.session.action.ARGUMENT_CAPTIONING_ENABLED");
                    ...
                    int repeatMode = extras.getInt("android.support.v4.media.session.action.ARGUMENT_REPEAT_MODE");
                    Callback.this.onSetRepeatMode(repeatMode);
                } else if (action.equals("android.support.v4.media.session.action.SET_SHUFFLE_MODE")) {
                    int shuffleMode = extras.getInt("android.support.v4.media.session.action.ARGUMENT_SHUFFLE_MODE");
