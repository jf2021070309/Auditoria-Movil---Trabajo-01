...
public final class MediaControllerCompat {
    ...
    static void validateCustomAction(String action, Bundle args) {
        ...
        if (hashCode != -1348483723) {
            if (hashCode == 503011406 && action.equals("android.support.v4.media.session.action.UNFOLLOW")) {
                c = 1;
            }
        } else if (action.equals("android.support.v4.media.session.action.FOLLOW")) {
            c = 0;
        }
        if (c == 0 || c == 1) {
