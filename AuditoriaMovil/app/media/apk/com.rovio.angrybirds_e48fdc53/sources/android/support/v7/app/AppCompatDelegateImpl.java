...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public AppCompatDelegateImpl(Context context, Window window, AppCompatCallback callback) {
        ...
        AppCompatWindowCallback appCompatWindowCallback = new AppCompatWindowCallback(callback2);
    ...
    private boolean shouldRecreateOnNightModeChange() {
        if (this.mApplyDayNightCalled) {
            ...
            if (context instanceof Activity) {
                ...
                try {
                    Context context2 = this.mContext;
                    ActivityInfo info = pm.getActivityInfo(new ComponentName(context2, context2.getClass()), 0);
