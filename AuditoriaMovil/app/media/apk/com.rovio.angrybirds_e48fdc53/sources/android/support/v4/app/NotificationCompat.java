...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public static MessagingStyle extractMessagingStyleFromNotification(Notification notification) {
            ...
            if (extras != null && !extras.containsKey("android.selfDisplayName") && !extras.containsKey(NotificationCompat.EXTRA_MESSAGING_STYLE_USER)) {
                return null;
            }
            try {
        ...
        protected void restoreFromCompatExtras(Bundle extras) {
            ...
            if (extras.containsKey(NotificationCompat.EXTRA_MESSAGING_STYLE_USER)) {
                ...
                this.mUser = new Person.Builder().setName(extras.getString("android.selfDisplayName")).build();
            }
            CharSequence charSequence = extras.getCharSequence("android.conversationTitle");
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public Builder extend(Builder builder) {
                ...
                if (charSequence != null) {
                    wearableBundle.putCharSequence("inProgressLabel", charSequence);
                }
                CharSequence charSequence2 = this.mConfirmLabel;
                if (charSequence2 != null) {
                    wearableBundle.putCharSequence("confirmLabel", charSequence2);
                }
                CharSequence charSequence3 = this.mCancelLabel;
                if (charSequence3 != null) {
                    wearableBundle.putCharSequence("cancelLabel", charSequence3);
                }
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender(Notification notification) {
            ...
            if (wearableBundle != null) {
                ArrayList<Parcelable> parcelables = wearableBundle.getParcelableArrayList("actions");
                ...
                Notification[] pages = NotificationCompat.getNotificationArrayFromBundle(wearableBundle, d.t);
                if (pages != null) {
        ...
        public Builder extend(Builder builder) {
            ...
            if (pendingIntent != null) {
                wearableBundle.putParcelable("displayIntent", pendingIntent);
            }
            if (!this.mPages.isEmpty()) {
                ArrayList<Notification> arrayList = this.mPages;
                wearableBundle.putParcelableArray(d.t, (Parcelable[]) arrayList.toArray(new Notification[arrayList.size()]));
            }
            ...
            if (i2 != 0) {
                wearableBundle.putInt("contentIcon", i2);
            }
            int i3 = this.mContentIconGravity;
            if (i3 != 8388613) {
                wearableBundle.putInt("contentIconGravity", i3);
            }
            int i4 = this.mContentActionIndex;
            if (i4 != -1) {
                wearableBundle.putInt("contentActionIndex", i4);
            }
            int i5 = this.mCustomSizePreset;
            if (i5 != 0) {
                wearableBundle.putInt("customSizePreset", i5);
            }
            int i6 = this.mCustomContentHeight;
            if (i6 != 0) {
                wearableBundle.putInt("customContentHeight", i6);
            }
            int i7 = this.mGravity;
            if (i7 != 80) {
                wearableBundle.putInt("gravity", i7);
            }
            int i8 = this.mHintScreenTimeout;
            if (i8 != 0) {
                wearableBundle.putInt("hintScreenTimeout", i8);
            }
            String str = this.mDismissalId;
            if (str != null) {
                wearableBundle.putString("dismissalId", str);
            }
            String str2 = this.mBridgeTag;
            if (str2 != null) {
                wearableBundle.putString("bridgeTag", str2);
            }
            builder.getExtras().putBundle("android.wearable.EXTENSIONS", wearableBundle);
            return builder;
        }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static Bundle getBundleForUnreadConversation(UnreadConversation uc) {
            ...
            if (remoteInputCompat != null) {
                ...
                b.putParcelable("remote_input", remoteInput);
            }
        ...
        public Builder extend(Builder builder) {
            ...
            if (bitmap != null) {
                carExtensions.putParcelable("large_icon", bitmap);
            }
            int i = this.mColor;
            if (i != 0) {
                carExtensions.putInt("app_color", i);
            }
            ...
            b2.putBundle("android.car.EXTENSIONS", carExtensions);
            return builder;
        }
    ...
    public static Action getAction(Notification notification, int actionIndex) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            SparseArray<Bundle> actionExtrasMap = notification.extras.getSparseParcelableArray("android.support.actionExtras");
