...
public class d extends b {
    ...
    public d(TTAbsAdLoaderAdapter tTAbsAdLoaderAdapter) {
        super(tTAbsAdLoaderAdapter);
    }

    private GMInterstitialAdListener b() {
        return (GMInterstitialAdListener) this.mTTAdatperCallback;
    }
        ...
        if (i != 8111) {
            ...
            if (i == 8129) {
                ...
                if (b() != null) {
                    ...
                    b().onInterstitialShowFail(new AdError(i2, str));
                }
            } else if (i == 1009) {
                if (b() != null) {
