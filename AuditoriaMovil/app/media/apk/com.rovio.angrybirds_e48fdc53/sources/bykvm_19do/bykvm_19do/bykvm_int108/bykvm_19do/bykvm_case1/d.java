...
public class d {
    ...
    public static bykvm_19do.bykvm_19do.bykvm_int108.bykvm_19do.bykvm_for12.c b(String str) {
        try {
            JSONObject jSONObject = new JSONObject(c(str));
            bykvm_19do.bykvm_19do.bykvm_int108.bykvm_19do.bykvm_for12.c cVar = new bykvm_19do.bykvm_19do.bykvm_int108.bykvm_19do.bykvm_for12.c();
