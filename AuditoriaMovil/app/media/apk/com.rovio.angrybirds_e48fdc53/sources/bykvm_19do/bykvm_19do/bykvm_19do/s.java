...
public class s {
    ...
    private static final String[] c = {"aid", "app_version", "tt_data"};
    static final String[] d = {"aid", "version_code", "ab_client", "ab_version", "ab_feature", "ab_group", "iid", "device_platform"};
    ...
    */
    ...
    public static JSONObject a(String str, JSONObject jSONObject) {
        ...
        hashMap.put(DownloadUtils.CONTENT_TYPE, a.h() ? "application/octet-stream;tt-data=a" : "application/json; charset=utf-8");
    ...
    public static boolean b(String str, JSONObject jSONObject) {
        ...
        return jSONObject2 != null && "success".equals(jSONObject2.optString(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, ""));
    }
