...
public final class BlockingSingle<T> {
    ...
    public T value() {
        ...
        BlockingUtils.awaitForComplete(countDownLatch, this.a.subscribe((SingleSubscriber<? super Object>) new SingleSubscriber<T>() { // from class: rx.singles.BlockingSingle.1
