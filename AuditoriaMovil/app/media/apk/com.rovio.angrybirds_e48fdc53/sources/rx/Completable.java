...
public class Completable {
    ...
    public static Completable amb(final Iterable<? extends Completable> iterable) {
        a(iterable);
        return create(new OnSubscribe() { // from class: rx.Completable.30
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(final CompletableSubscriber completableSubscriber) {
                final CompositeSubscription compositeSubscription = new CompositeSubscription();
    ...
    public static Completable error(final Func0<? extends Throwable> func0) {
        a(func0);
        return create(new OnSubscribe() { // from class: rx.Completable.32
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(CompletableSubscriber completableSubscriber) {
                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
    ...
    public static Completable error(final Throwable th) {
        a(th);
        return create(new OnSubscribe() { // from class: rx.Completable.33
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(CompletableSubscriber completableSubscriber) {
                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
    ...
    public static Completable fromAction(final Action0 action0) {
        a(action0);
        return create(new OnSubscribe() { // from class: rx.Completable.34
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(CompletableSubscriber completableSubscriber) {
    ...
    public static Completable fromCallable(final Callable<?> callable) {
        a(callable);
        return create(new OnSubscribe() { // from class: rx.Completable.35
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(CompletableSubscriber completableSubscriber) {
                BooleanSubscription booleanSubscription = new BooleanSubscription();
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        a(observable);
        return create(new OnSubscribe() { // from class: rx.Completable.2
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(final CompletableSubscriber completableSubscriber) {
        ...
        return create(new OnSubscribe() { // from class: rx.Completable.4
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                if (!multipleAssignmentSubscription.isUnsubscribed()) {
                    ...
                    createWorker.schedule(new Action0() { // from class: rx.Completable.4.1
    ...
    public static <R> Completable using(final Func0<R> func0, final Func1<? super R, ? extends Completable> func1, final Action1<? super R> action1, final boolean z) {
        ...
        return create(new OnSubscribe() { // from class: rx.Completable.5
            ...
            public class AnonymousClass1 implements CompletableSubscriber {
                ...
                public void onSubscribe(Subscription subscription) {
                    this.a = subscription;
                    this.d.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.5.1.1
                        @Override // rx.functions.Action0
                        public void call() {
        ...
        return create(new OnSubscribe() { // from class: rx.Completable.8
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.8.1
                    @Override // rx.CompletableSubscriber
                    public void onCompleted() {
                        compositeSubscription.add(createWorker.schedule(new Action0() { // from class: rx.Completable.8.1.1
                            @Override // rx.functions.Action0
                            public void call() {
                                try {
                                    completableSubscriber.onCompleted();
                    ...
                    public void onError(final Throwable th) {
                        if (z) {
                            compositeSubscription.add(createWorker.schedule(new Action0() { // from class: rx.Completable.8.1.2
                                @Override // rx.functions.Action0
                                public void call() {
                                    try {
                                        completableSubscriber.onError(th);
    ...
    public final Completable doOnEach(final Action1<Notification<Object>> action1) {
        ...
        return doOnLifecycle(Actions.empty(), new Action1<Throwable>() { // from class: rx.Completable.9
            @Override // rx.functions.Action1
            /* renamed from: a */
    ...
    protected final Completable doOnLifecycle(Action1<? super Subscription> action1, Action1<? super Throwable> action12, Action0 action0, Action0 action02, Action0 action03) {
        ...
        a(action02);
        a(action03);
        return create(new AnonymousClass11(action0, action02, action12, action1, action03));
    }
            ...
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.11.1
                ...
                public void onSubscribe(final Subscription subscription) {
                    try {
                        ...
                        completableSubscriber.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.11.1.1
                            @Override // rx.functions.Action0
                            public void call() {
                                try {
    ...
    public final Completable doOnTerminate(final Action0 action0) {
        return doOnLifecycle(Actions.empty(), new Action1<Throwable>() { // from class: rx.Completable.13
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(Throwable th) {
                action0.call();
    ...
    public final Completable observeOn(final Scheduler scheduler) {
        a(scheduler);
        return create(new OnSubscribe() { // from class: rx.Completable.17
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.17.1
                    @Override // rx.CompletableSubscriber
                    public void onCompleted() {
                        createWorker.schedule(new Action0() { // from class: rx.Completable.17.1.1
                            @Override // rx.functions.Action0
                            public void call() {
                                try {
                                    completableSubscriber.onCompleted();
                    ...
                    @Override // rx.CompletableSubscriber
                    public void onError(final Throwable th) {
                        createWorker.schedule(new Action0() { // from class: rx.Completable.17.1.2
                            @Override // rx.functions.Action0
                            public void call() {
                                try {
                                    completableSubscriber.onError(th);
    ...
    public final Completable onErrorComplete(final Func1<? super Throwable, Boolean> func1) {
        a(func1);
        return create(new OnSubscribe() { // from class: rx.Completable.18
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(final CompletableSubscriber completableSubscriber) {
    ...
    public final Completable onErrorResumeNext(final Func1<? super Throwable, ? extends Completable> func1) {
        a(func1);
        return create(new OnSubscribe() { // from class: rx.Completable.19
            @Override // rx.functions.Action1
            /* renamed from: a */
            public void call(final CompletableSubscriber completableSubscriber) {
    ...
    public final Completable subscribeOn(final Scheduler scheduler) {
        ...
        return create(new OnSubscribe() { // from class: rx.Completable.25
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                final Scheduler.Worker createWorker = scheduler.createWorker();
                createWorker.schedule(new Action0() { // from class: rx.Completable.25.1
                    @Override // rx.functions.Action0
                    public void call() {
                        try {
    ...
    public final <T> Observable<T> toObservable() {
        return Observable.create(new Observable.OnSubscribe<T>() { // from class: rx.Completable.26
            @Override // rx.functions.Action1
            /* renamed from: a */
    ...
    public final <T> Single<T> toSingleDefault(final T t) {
        a(t);
        return toSingle(new Func0<T>() { // from class: rx.Completable.28
    ...
    class AnonymousClass29 implements OnSubscribe {
        ...
        public void call(final CompletableSubscriber completableSubscriber) {
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.29.1
                ...
                @Override // rx.CompletableSubscriber
                public void onSubscribe(final Subscription subscription) {
                    completableSubscriber.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.29.1.1
                        @Override // rx.functions.Action0
                        public void call() {
                            final Scheduler.Worker createWorker = AnonymousClass29.this.a.createWorker();
                            createWorker.schedule(new Action0() { // from class: rx.Completable.29.1.1.1
                                @Override // rx.functions.Action0
                                public void call() {
                                    try {
                                        subscription.unsubscribe();
