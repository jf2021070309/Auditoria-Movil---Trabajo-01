...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers cachedHeaders, Headers networkHeaders) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (!DownloadUtils.CONTENT_LENGTH.equalsIgnoreCase(fieldName2) && isEndToEnd(fieldName2)) {
    ...
    static boolean isEndToEnd(String fieldName) {
        return ("Connection".equalsIgnoreCase(fieldName) || "Keep-Alive".equalsIgnoreCase(fieldName) || "Proxy-Authenticate".equalsIgnoreCase(fieldName) || "Proxy-Authorization".equalsIgnoreCase(fieldName) || "TE".equalsIgnoreCase(fieldName) || "Trailers".equalsIgnoreCase(fieldName) || DownloadUtils.TRANSFER_ENCODING.equalsIgnoreCase(fieldName) || "Upgrade".equalsIgnoreCase(fieldName)) ? false : true;
    }
}
