...
public final class HttpHeaders {
    ...
    public static long contentLength(Headers headers) {
        return stringToLong(headers.get(DownloadUtils.CONTENT_LENGTH));
    }
    ...
    public static boolean hasBody(Response response) {
        ...
        return (((responseCode >= 100 && responseCode < 200) || responseCode == 204 || responseCode == 304) && contentLength(response) == -1 && !DownloadUtils.VALUE_CHUNKED.equalsIgnoreCase(response.header(DownloadUtils.TRANSFER_ENCODING))) ? false : true;
    }
