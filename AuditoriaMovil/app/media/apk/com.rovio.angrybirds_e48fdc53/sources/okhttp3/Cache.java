...
public final class Cache implements Closeable, Flushable {
    ...
    private final class a implements CacheRequest {
        ...
        public a(final DiskLruCache.Editor editor) {
            ...
            this.e = new ForwardingSink(this.d) { // from class: okhttp3.Cache.a.1
    ...
    private static final class c {
        ...
        public Response a(DiskLruCache.Snapshot snapshot) {
            String str = this.i.get(DownloadUtils.CONTENT_TYPE);
            String str2 = this.i.get(DownloadUtils.CONTENT_LENGTH);
            return new Response.Builder().request(new Request.Builder().url(this.c).method(this.e, null).headers(this.d).build()).protocol(this.f).code(this.g).message(this.h).headers(this.i).body(new b(snapshot, str, str2)).handshake(this.j).sentRequestAtMillis(this.k).receivedResponseAtMillis(this.l).build();
        }
    }
    ...
    public static final class Entry {
        ...
        public Response response(DiskLruCache.Snapshot snapshot) {
            String contentType = this.responseHeaders.get(DownloadUtils.CONTENT_TYPE);
            String contentLength = this.responseHeaders.get(DownloadUtils.CONTENT_LENGTH);
    ...
    private static class b extends ResponseBody {
        ...
        public b(final DiskLruCache.Snapshot snapshot, String str, String str2) {
            ...
            this.c = str;
            this.d = str2;
            this.b = Okio.buffer(new ForwardingSource(snapshot.getSource(1)) { // from class: okhttp3.Cache.b.1
                @Override // okio.ForwardingSource, okio.Source, java.io.Closeable, java.lang.AutoCloseable
                public void close() {
                    snapshot.close();
                    super.close();
