...
#if !defined(BLUR_1D) && (!defined(DISABLE_TEXTURE) || defined(ENABLE_NORMALMAP) || defined(ENABLE_WNORMALMAP) || defined(ENABLE_VTEXCOORD0))
...
#if !defined(DISABLE_LIGHTING) && !defined(DISABLE_SPECULAR)
	#define NEEDS_VTOCAMERA
#endif

#if defined(ENABLE_SPHERE_REFL_MAP)
	#define NEEDS_VTOCAMERA
#endif
