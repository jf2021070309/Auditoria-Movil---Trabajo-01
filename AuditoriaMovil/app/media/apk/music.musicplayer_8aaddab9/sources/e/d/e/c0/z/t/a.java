...
public class a {
    ...
    */
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: e.d.e.c0.z.t.a.b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
    ...
    public static int c(String str, int i2, int i3) throws NumberFormatException {
        ...
        if (i2 < i3) {
            ...
            if (digit < 0) {
                StringBuilder y = e.a.d.a.a.y("Invalid number: ");
        ...
        while (i5 < i3) {
            ...
            if (digit2 < 0) {
                StringBuilder y2 = e.a.d.a.a.y("Invalid number: ");
