...
public final class q extends h.o.c.k implements h.o.b.p<Activity, Application.ActivityLifecycleCallbacks, h.k> {
    ...
    public h.k i(Activity activity, Application.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        ...
        if (e.a(this.a, activity2)) {
            if (activity2 instanceof c.b.c.l) {
                e eVar = this.a;
                eVar.h(activity2, "relaunch", new p(activity2, eVar));
            } else {
                this.a.f(activity2, true);
