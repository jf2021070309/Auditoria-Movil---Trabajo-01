...
public class u {
    ...
    public static Map<Class<?>, List<Constructor<? extends i>>> f2475b = new HashMap();
    ...
    public static int c(Class<?> cls) {
        ...
        if (cls.getCanonicalName() != null) {
            ...
            if (constructor != null) {
                f2475b.put(cls, Collections.singletonList(constructor));
            } else {
                b bVar = b.a;
                Boolean bool = bVar.f2430c.get(cls);
                if (bool != null) {
                    z = bool.booleanValue();
                } else {
                    try {
                        ...
                        while (true) {
                            if (i3 >= length) {
                                bVar.f2430c.put(cls, Boolean.FALSE);
                                z = false;
                                break;
                ...
                if (!z) {
                    ...
                    if (superclass != null && o.class.isAssignableFrom(superclass)) {
                        arrayList = c(superclass) != 1 ? new ArrayList(f2475b.get(superclass)) : null;
                    }
                    ...
                    while (true) {
                        if (i4 < length2) {
                            ...
                            if (cls2 != null && o.class.isAssignableFrom(cls2)) {
                                ...
                                arrayList.addAll(f2475b.get(cls2));
                            }
                            i4++;
                        } else if (arrayList != null) {
                            f2475b.put(cls, arrayList);
                        }
                    }
                }
            }
