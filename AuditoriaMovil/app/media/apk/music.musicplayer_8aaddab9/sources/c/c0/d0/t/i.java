...
public class i {
    public static final String a = c.c0.r.e("ProcessUtils");

    public static boolean a(Context context, c.c0.c cVar) {
        String str;
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                ...
                c.c0.r.c().a(a, "Unable to check ActivityThread for processName", th);
            }
