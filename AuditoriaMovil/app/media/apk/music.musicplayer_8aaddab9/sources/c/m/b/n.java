...
public class n extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    /* loaded from: classes.dex */
    public class d implements c.p.x<c.p.p> {
        public d() {
        }

        @Override // c.p.x
        @SuppressLint({"SyntheticAccessor"})
        public void a(c.p.p pVar) {
            if (pVar == null || !n.this.mShowsDialog) {
                return;
            }
            ...
            if (n.this.mDialog != null) {
                if (FragmentManager.L(3)) {
                    String str = "DialogFragment " + this + " setting the content view on " + n.this.mDialog;
                }
    ...
    public class e extends r {
        ...
        public View b(int i2) {
            return this.a.c() ? this.a.b(i2) : n.this.onFindViewById(i2);
        }

        @Override // c.m.b.r
        public boolean c() {
            return this.a.c() || n.this.onHasView();
        }
    }
    ...
    private void dismissInternal(boolean z, boolean z2) {
        ...
        if (this.mBackStackId >= 0) {
            ...
            if (i2 < 0) {
                throw new IllegalArgumentException(e.a.d.a.a.e("Bad id: ", i2));
            }
            parentFragmentManager.y(new FragmentManager.l(null, i2, 1), z);
            this.mBackStackId = -1;
            return;
        }
        c.m.b.d dVar = new c.m.b.d(getParentFragmentManager());
        dVar.p = true;
        FragmentManager fragmentManager = this.mFragmentManager;
        if (fragmentManager != null && fragmentManager != dVar.q) {
            StringBuilder y = e.a.d.a.a.y("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
            y.append(toString());
            y.append(" is already attached to a FragmentManager.");
            throw new IllegalStateException(y.toString());
        }
        dVar.b(new d0.a(3, this));
        if (z) {
            dVar.g();
        } else {
            dVar.c();
    ...
    public void onAttach(Context context) {
        ...
        LiveData<c.p.p> viewLifecycleOwnerLiveData = getViewLifecycleOwnerLiveData();
        c.p.x<c.p.p> xVar = this.mObserver;
        Objects.requireNonNull(viewLifecycleOwnerLiveData);
        LiveData.a("observeForever");
        LiveData.b bVar = new LiveData.b(viewLifecycleOwnerLiveData, xVar);
        LiveData<c.p.p>.c d2 = viewLifecycleOwnerLiveData.f448c.d(xVar, bVar);
