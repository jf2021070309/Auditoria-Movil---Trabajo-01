...
public interface a extends IInterface {
    ...
    public static abstract class AbstractBinderC0006a extends Binder implements a {
        ...
        public boolean onTransact(int i2, Parcel parcel, Parcel parcel2, int i3) throws RemoteException {
            ...
            switch (i2) {
                ...
                case 3:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                    ((c.b) this).O0(parcel.readInt() != 0 ? PlaybackStateCompat.CREATOR.createFromParcel(parcel) : null);
                    return true;
                case 4:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                ...
                case 8:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                    Q0(parcel.readInt() != 0 ? ParcelableVolumeInfo.CREATOR.createFromParcel(parcel) : null);
                    return true;
                case 9:
                    parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                    parcel.readInt();
    ...
    void K(List<MediaSessionCompat.QueueItem> list) throws RemoteException;

    void O0(PlaybackStateCompat playbackStateCompat) throws RemoteException;

    void Q0(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException;

    void m0(CharSequence charSequence) throws RemoteException;

    void p0() throws RemoteException;

    void r0(MediaMetadataCompat mediaMetadataCompat) throws RemoteException;
}
