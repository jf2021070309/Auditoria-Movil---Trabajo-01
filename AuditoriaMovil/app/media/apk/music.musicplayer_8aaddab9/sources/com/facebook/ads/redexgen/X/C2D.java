...
public final class C2D {
    ...
    static {
        A06();
        A03 = new String[]{A02(452, 7, 20), A02(459, 19, 105), A02(478, 25, 96), A02(503, 15, 30), A02(613, 9, 99), A02(622, 21, 8), A02(643, 27, 68), A02(670, 17, 53), A02(540, 21, 23), A02(418, 16, 83), A02(434, 18, 91), A02(398, 20, 78), A02(696, 20, 116), A02(352, 14, 46), A02(561, 25, SyslogConstants.LOG_ALERT)};
    }
    ...
    private String A03(String str, String str2) {
        String A7b = this.A00.A7b(str, str2);
        return (A7b == null || A7b.equals(A02(586, 4, 39))) ? str2 : A7b;
    }
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C04398z.A1x, new AnonymousClass90(A02(239, 20, 101)));
                return null;
            } else if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C04398z.A1u, new AnonymousClass90(A02(221, 18, 10)));
                return null;
            } else {
                return hashMap;
            }
        } catch (JSONException e2) {
            A08(C04398z.A1w, new AnonymousClass90(e2));
            return null;
        }
    }

    private final void A07() {
        C2I A56 = this.A00.A56();
        A56.ADO(A02(518, 22, SyslogConstants.LOG_CLOCK), 0L);
        A56.A3M();
    }

    public static void A08(int i2, AnonymousClass90 anonymousClass90) {
        C1045Xn A00 = C8T.A00();
        if (A00 != null) {
            A00.A06().A8y(A02(687, 9, 5), i2, anonymousClass90);
        }
    }

    public final long A09() {
        return this.A00.A6t(A02(518, 22, SyslogConstants.LOG_CLOCK), 0L);
    }

    public final C2H A0A() {
        C2H c2h = new C2H(A00());
        try {
            for (C2H c2h2 : A04(A03(A02(503, 15, 30), A02(0, 0, 94)))) {
                c2h.A06(c2h2);
            }
        } catch (JSONException e2) {
            A07();
            A08(C04398z.A1v, new AnonymousClass90(e2));
        }
        return c2h;
    }
    ...
    public final C2H A0B() {
        C2H c2h = new C2H(A01());
        try {
            for (C2H c2h2 : A04(A03(A02(670, 17, 53), A02(0, 0, 94)))) {
                c2h.A06(c2h2);
            }
        } catch (JSONException e2) {
            A07();
            A08(C04398z.A1y, new AnonymousClass90(e2));
        }
        return c2h;
    }
    ...
    public final String A0I() {
        return A03(A02(561, 25, SyslogConstants.LOG_ALERT), A02(0, 0, 94));
    }
    ...
    public final void A0N(@Nullable String str) {
        ...
        A56.ADO(A02(518, 22, SyslogConstants.LOG_CLOCK), System.currentTimeMillis());
        A56.A3M();
    }

    public final boolean A0O(Context context, boolean z) {
        return (z || JQ.A1j(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
