...
public final class II implements QM {
    ...
    public II(View view, int i2, int i3, int i4) {
        this.A02 = i2;
        this.A05 = view;
        this.A04 = i3;
        this.A03 = i4;
    ...
    private void A06(int i2, int i3) {
        this.A01 = i2 == this.A04 ? QL.A04 : QL.A06;
        ...
        this.A00.addListener(new QS(this, i2, i3));
        this.A00.start();
    }
    ...
    public void A07(int i2, int i3, boolean z) {
        ...
        this.A01 = i3 == this.A03 ? QL.A03 : QL.A05;
    }
