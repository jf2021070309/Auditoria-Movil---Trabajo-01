...
public final class C2T {
    ...
    public final void A05(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ...
            for (int size = remove.size() - 1; size >= 0; size--) {
                ...
                c2s.A01 = true;
                for (int i2 = 0; i2 < c2s.A03.countActions(); i2++) {
                    String action = c2s.A03.getAction(i2);
    ...
    */
    public final boolean A07(android.content.Intent r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C2T.A07(android.content.Intent):boolean");
    }
}
