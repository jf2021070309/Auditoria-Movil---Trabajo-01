...
public final class DD implements WS {
    ...
    public DD(long j2, int i2, long j3) {
        this(j2, i2, j3, -1L, null);
    }

    public DD(long j2, int i2, long j3, long j4, long[] jArr) {
        this.A02 = j2;
        this.A00 = i2;
        this.A03 = j3;
        this.A01 = j4;
    ...
    public static DD A01(long j2, long j3, Ci ci, C0660Ii c0660Ii) {
        int flags;
        int i2 = ci.A04;
        int i3 = ci.A03;
        int A08 = c0660Ii.A08();
        int samplesPerFrame = A08 & 1;
        if (samplesPerFrame != 1 || (flags = c0660Ii.A0H()) == 0) {
            return null;
        }
        long dataSize = C0676Iy.A0F(flags, i2 * 1000000, i3);
        int samplesPerFrame2 = A08 & 6;
        if (samplesPerFrame2 != 6) {
            return new DD(j3, ci.A02, dataSize);
        }
        long A0H = c0660Ii.A0H();
        long[] jArr = new long[100];
        for (int i4 = 0; i4 < 100; i4++) {
            long durationUs = c0660Ii.A0E();
            jArr[i4] = durationUs;
        }
        if (j2 != -1 && j2 != j3 + A0H) {
        ...
        return new DD(j3, ci.A02, dataSize, A0H, jArr);
    }
    ...
    public final Ck A7N(long j2) {
        ...
        if (!A8g()) {
            return new Ck(new C0523Cm(0L, this.A02 + this.A00));
        }
        long positionOffset = C0676Iy.A0E(j2, 0L, this.A03);
        ...
        return new Ck(new C0523Cm(positionOffset, this.A02 + C0676Iy.A0E(Math.round((scaledPosition / 256.0d) * this.A01), this.A00, this.A01 - 1)));
    }
        ...
        if (A8g()) {
            ...
            if (A06[4].length() != 1) {
                ...
                if (positionOffset > j4) {
                    ...
                    int A0B = C0676Iy.A0B(this.A04, (long) d3, true, true);
                    long A00 = A00(A0B);
