...
public final class C1344dt implements AnonymousClass03<Bitmap> {
    ...
    public final String A02 = C1344dt.class.getSimpleName();
    ...
    public static String A01(int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < copyOfRange.length; i5++) {
            byte b2 = (byte) ((copyOfRange[i5] ^ i4) ^ 8);
            if (A07[7].charAt(0) == 'p') {
    ...
    public C1344dt(int i2, int i3, boolean z, boolean z2, boolean z3) {
        this.A01 = i2;
        this.A00 = i3;
        this.A05 = z;
        this.A03 = z2;
    ...
    public final AnonymousClass02<Bitmap> A39(File file, C0L c0l) {
        ...
        try {
            ...
            c0l.A8r(new C1339dn(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable th) {
            if (A07[6].length() != 26) {
                String[] strArr = A07;
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass03
    @SuppressLint({"CatchGeneralException"})
    public final void A4A(File file, C0L c0l) throws C1339dn {
        if (this.A03) {
            try {
                Bitmap A03 = C0M.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
                if (A03 != null) {
                ...
                c0l.A92(th);
                throw new C1339dn(A01(18, 33, 49), th);
            }
        }
    }
}
