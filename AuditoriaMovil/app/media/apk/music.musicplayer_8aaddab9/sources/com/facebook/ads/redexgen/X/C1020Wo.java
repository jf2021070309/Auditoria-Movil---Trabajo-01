...
public final class C1020Wo<T extends CN> implements CM<T>, C3<T> {
    ...
    public final List<C1021Wp<T>> A08;
    public final List<C1021Wp<T>> A09;
    public final UUID A0A;
    public final boolean A0B;
    /* JADX WARN: Incorrect inner types in field signature: Lcom/facebook/ads/redexgen/X/Wo<TT;>.MediaDrmHandler; */
    ...
    */
    public static com.facebook.ads.internal.exoplayer2.drm.DrmInitData.SchemeData A00(com.facebook.ads.internal.exoplayer2.drm.DrmInitData r8, java.util.UUID r9, boolean r10) {
        ...
        L8:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C1020Wo.A0E
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 30
        ...
        L23:
            ...
            throw r0
        L29:
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C1020Wo.A0E
            java.lang.String r1 = "V0Q9eaLMfBF3CEdW"
            r0 = 2
            r2[r0] = r1
            if (r5 != 0) goto L42
            java.util.UUID r0 = com.facebook.ads.redexgen.X.AG.A01
            boolean r0 = r0.equals(r9)
            if (r0 == 0) goto L43
            java.util.UUID r0 = com.facebook.ads.redexgen.X.AG.A02
        ...
        L51:
            ...
            return r0
        L59:
            java.util.UUID r0 = com.facebook.ads.redexgen.X.AG.A05
            boolean r0 = r0.equals(r9)
            if (r0 == 0) goto L8f
            r4 = 0
        L62:
            ...
            if (r0 == 0) goto L8d
            byte[] r0 = r3.A04
            int r2 = com.facebook.ads.redexgen.X.DL.A00(r0)
        L7a:
        ...
        La6:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1020Wo.A00(com.facebook.ads.internal.exoplayer2.drm.DrmInitData, java.util.UUID, boolean):com.facebook.ads.internal.exoplayer2.drm.DrmInitData$SchemeData");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Wo != com.facebook.ads.internal.exoplayer2.drm.DefaultDrmSessionManager<T extends com.facebook.ads.redexgen.X.CN> */
    ...
    public final CL<T> A2P(Looper looper, DrmInitData drmInitData) {
        ...
        IJ.A04(looper2 == null || looper2 == looper);
        if (this.A09.isEmpty()) {
            this.A01 = looper;
            if (this.A0C == null) {
        ...
        C1021Wp<T> c1021Wp2 = (C1021Wp<T>) false;
        if (this.A02 == null && (schemeData = A00(drmInitData, this.A0A, false)) == null) {
            CD cd = new CD(this.A0A);
            this.A04.A04(cd);
            return new C1019Wn(new CJ(cd));
        }
        if (!this.A0B) {
            c1021Wp = c1021Wp2;
            if (!this.A09.isEmpty()) {
                C1021Wp<T> c1021Wp3 = this.A09.get(0);
                if (A0E[0].length() != 30) {
            ...
            byte[] bArr = c1021Wp2;
            if (schemeData != null) {
                bArr = (C1021Wp<T>) schemeData.A04;
            }
            Iterator<C1021Wp<T>> it = this.A09.iterator();
            while (true) {
                if (it.hasNext()) {
                    C1021Wp<T> next = it.next();
                    if (next.A0M(bArr)) {
                        c1021Wp = next;
                        break;
                    }
        ...
        if (c1021Wp == null) {
            c1021Wp = new C1021Wp<>(this.A0A, this.A05, this, schemeData, this.A00, this.A02, this.A07, this.A06, looper, this.A04, this.A03);
            this.A09.add(c1021Wp);
        }
        c1021Wp.A0G();
        return c1021Wp;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Wo != com.facebook.ads.internal.exoplayer2.drm.DefaultDrmSessionManager<T extends com.facebook.ads.redexgen.X.CN> */
    @Override // com.facebook.ads.redexgen.X.CM
    public final boolean A3w(@NonNull DrmInitData drmInitData) {
        if (this.A02 != null) {
            return true;
        }
        ...
        if (A0E[2].length() != 25) {
            ...
            return !(A01(92, 4, 43).equals(str) || A01(96, 4, 62).equals(str) || A01(104, 4, 119).equals(str)) || C0676Iy.A02 >= 25;
        }
        throw new RuntimeException();
    }
    ...
    public final void ABx() {
        for (C1021Wp<T> c1021Wp : this.A08) {
            c1021Wp.A0H();
        }
        this.A08.clear();
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Wp != com.facebook.ads.internal.exoplayer2.drm.DefaultDrmSession<T extends com.facebook.ads.redexgen.X.CN> */
    @Override // com.facebook.ads.redexgen.X.C3
    public final void ADN(C1021Wp<T> c1021Wp) {
        this.A08.add(c1021Wp);
        if (this.A08.size() == 1) {
            c1021Wp.A0I();
        }
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Wp != com.facebook.ads.internal.exoplayer2.drm.DefaultDrmSession<T extends com.facebook.ads.redexgen.X.CN> */
    @Override // com.facebook.ads.redexgen.X.CM
    public final void ADp(CL<T> cl) {
        if (cl instanceof C1019Wn) {
            return;
        }
        C1021Wp<T> c1021Wp = (C1021Wp) cl;
        if (c1021Wp.A0L()) {
            this.A09.remove(c1021Wp);
            if (this.A08.size() > 1 && this.A08.get(0) == c1021Wp) {
                this.A08.get(1).A0I();
            }
            this.A08.remove(c1021Wp);
        }
    }
}
