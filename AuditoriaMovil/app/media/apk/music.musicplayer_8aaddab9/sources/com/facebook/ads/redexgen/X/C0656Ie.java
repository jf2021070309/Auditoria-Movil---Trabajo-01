...
public final class C0656Ie {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0049, code lost:
        r6 = r11[0];
        r5 = com.facebook.ads.redexgen.X.C0656Ie.A02;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00a1, code lost:
        r5 = r10 - 1;
        r6 = com.facebook.ads.redexgen.X.C0656Ie.A02;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:57:0x00e5, code lost:
        r3 = r4 - 2;
        r2 = com.facebook.ads.redexgen.X.C0656Ie.A02;
     */
    ...
    */
    public static int A04(byte[] r8, int r9, int r10, boolean[] r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0656Ie.A04(byte[], int, int, boolean[]):int");
    }

    public static C0654Ic A05(byte[] bArr, int i2, int i3) {
        C0661Ij c0661Ij = new C0661Ij(bArr, i2, i3);
        c0661Ij.A07(8);
        int picParameterSetId = c0661Ij.A04();
        int A042 = c0661Ij.A04();
        c0661Ij.A06();
        boolean bottomFieldPicOrderInFramePresentFlag = c0661Ij.A0A();
        return new C0654Ic(picParameterSetId, A042, bottomFieldPicOrderInFramePresentFlag);
    }

    public static C0655Id A06(byte[] bArr, int i2, int i3) {
        int frameCropBottomOffset;
        int cropUnitX;
        C0661Ij c0661Ij = new C0661Ij(bArr, i2, i3);
        c0661Ij.A07(8);
        int A052 = c0661Ij.A05(8);
        c0661Ij.A07(16);
        int sarWidth = c0661Ij.A04();
        int frameHeight = 1;
        boolean z = false;
        if (A052 == 100 || A052 == 110 || A052 == 122 || A052 == 244 || A052 == 44 || A052 == 83 || A052 == 86 || A052 == 118 || A052 == 128 || A052 == 138) {
            frameHeight = c0661Ij.A04();
            if (frameHeight == 3) {
                z = c0661Ij.A0A();
            }
            c0661Ij.A04();
            ...
            if (c0661Ij.A0A()) {
                ...
                while (i5 < i4) {
                    if (c0661Ij.A0A()) {
                        ...
                        A09(c0661Ij, seqParameterSetId);
                    }
                    i5++;
                }
            }
        }
        int seqParameterSetId2 = c0661Ij.A04();
        int i6 = seqParameterSetId2 + 4;
        int A042 = c0661Ij.A04();
        int i7 = 0;
        boolean z2 = false;
        if (A042 == 0) {
            int picOrderCntType = c0661Ij.A04();
            i7 = picOrderCntType + 4;
        } else if (A042 == 1) {
            z2 = c0661Ij.A0A();
            c0661Ij.A03();
            c0661Ij.A03();
            int cropUnitX2 = c0661Ij.A04();
            long j2 = cropUnitX2;
        ...
        c0661Ij.A04();
        c0661Ij.A06();
        int A043 = c0661Ij.A04() + 1;
        int picWidthInMbs = c0661Ij.A04();
        int i9 = picWidthInMbs + 1;
        boolean A0A = c0661Ij.A0A();
        ...
        if (c0661Ij.A0A()) {
            int A044 = c0661Ij.A04();
            int A045 = c0661Ij.A04();
            int A046 = c0661Ij.A04();
            int A047 = c0661Ij.A04();
            if (frameHeight == 0) {
        ...
        if (frameWidth2 == frameHeight2) {
            ...
            if (A0A2) {
                ...
                if (frameWidth3 == str4.charAt(3)) {
                    ...
                    if (A0A3) {
                        int A053 = c0661Ij.A05(8);
                        if (A053 == 255) {
                            int aspectRatioIdc = c0661Ij.A05(16);
                            int picOrderCntLsbLength = c0661Ij.A05(16);
            ...
            return new C0655Id(sarWidth, i10, i11, f2, z, A0A, i6, A042, i7, z2);
        }
        throw new RuntimeException();
    }

    public static void A09(C0661Ij c0661Ij, int nextScale) {
        int i2 = 8;
        int deltaScale = 8;
        for (int i3 = 0; i3 < nextScale; i3++) {
            if (deltaScale != 0) {
                int deltaScale2 = c0661Ij.A03();
