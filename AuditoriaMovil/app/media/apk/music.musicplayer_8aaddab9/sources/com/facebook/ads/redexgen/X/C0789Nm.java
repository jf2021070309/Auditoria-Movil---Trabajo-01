...
public final class C0789Nm extends LinearLayout {
    ...
    static {
        ...
        A0F = new View$OnTouchListenerC0783Ng();
        A0D = Color.argb(34, 0, 0, 0);
    }

    public C0789Nm(C1046Xo c1046Xo, WebView webView) {
        super(c1046Xo);
        this.A09 = new T5(this);
        this.A08 = webView;
        this.A07 = JR.A06(c1046Xo);
        A08(c1046Xo);
    }
    ...
    private void A08(C1046Xo c1046Xo) {
        ...
        this.A01.setImageBitmap(MU.A01(MT.BROWSER_CLOSE));
        this.A01.setOnTouchListener(A0F);
        this.A01.setOnClickListener(new View$OnClickListenerC0784Nh(this));
        ...
        if (this.A07) {
            ...
            this.A00.setOnClickListener(new View$OnClickListenerC0785Ni(this));
            addView(this.A00, layoutParams2);
        }
        this.A05 = new C0795Ns(c1046Xo);
        ...
        if (this.A07) {
            ...
            this.A02.setImageBitmap(MU.A02(MT.BACK_ARROW));
            this.A02.setOnTouchListener(A0F);
            this.A02.setOnClickListener(new View$OnClickListenerC0786Nj(this));
        ...
        this.A03.setContentDescription(A05(16, 19, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH));
        this.A03.setScaleType(ImageView.ScaleType.CENTER);
        this.A03.setOnTouchListener(A0F);
        this.A03.setOnClickListener(new View$OnClickListenerC0787Nk(this, c1046Xo));
        addView(this.A03, layoutParams5);
        setupDefaultNativeBrowser(c1046Xo);
    }

    public InterfaceC0798Nv getBrowserNavigationListener() {
        return this.A09;
    }

    public void setListener(InterfaceC0788Nl interfaceC0788Nl) {
        this.A04 = interfaceC0788Nl;
    }
    ...
    private void setupDefaultNativeBrowser(C1046Xo c1046Xo) {
        Bitmap A01;
        List<ResolveInfo> queryIntentActivities = c1046Xo.getPackageManager().queryIntentActivities(new Intent(A05(46, 26, 84), A0E), 65536);
        if (queryIntentActivities.size() == 0) {
            ...
            if (queryIntentActivities.size() == 1) {
                if (A05(72, 18, 95).equals(queryIntentActivities.get(0).activityInfo.packageName)) {
                    MT mt = MT.BROWSER_LAUNCH_CHROME;
                    if (A0B[5].length() == 31) {
                        throw new RuntimeException();
                    }
                    String[] strArr = A0B;
            ...
            A01 = MU.A01(MT.BROWSER_LAUNCH_NATIVE);
        }
