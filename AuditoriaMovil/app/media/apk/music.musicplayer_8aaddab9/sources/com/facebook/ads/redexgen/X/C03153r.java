...
public final class C03153r {
    ...
    public final InterfaceC03143q A01;
    public final C03133p A00 = new C03133p();
    ...
    public C03153r(InterfaceC03143q interfaceC03143q) {
        this.A01 = interfaceC03143q;
    }
    ...
    public final int A05() {
        return this.A01.A5z() - this.A02.size();
    }
    ...
    public final View A08(int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            AbstractC03344l A62 = this.A01.A62(view);
            if (A62.A0I() == i2 && !A62.A0b() && !A62.A0c()) {
                return view;
            }
        }
        return null;
    ...
    public final View A09(int i2) {
        return this.A01.A5y(A00(i2));
    }

    public final View A0A(int i2) {
        return this.A01.A5y(i2);
    }

    public final void A0B() {
        this.A00.A04();
        for (int size = this.A02.size() - 1; size >= 0; size--) {
            this.A01.ABA(this.A02.get(size));
    ...
    public final void A0H(View view, int i2, ViewGroup.LayoutParams layoutParams, boolean z) {
        ...
        this.A01.A3S(view, A00, layoutParams);
    }
