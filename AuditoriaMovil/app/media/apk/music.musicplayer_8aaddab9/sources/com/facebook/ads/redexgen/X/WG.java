...
public final class WG implements DV {
    ...
    public WG(long j2, long j3, DY dy, int i2, long j4) {
        IJ.A03(j2 >= 0 && j3 > j2);
        this.A0B = dy;
        this.A09 = j2;
        this.A08 = j3;
    ...
    private final long A01(long j2, InterfaceC0518Cd interfaceC0518Cd) throws IOException, InterruptedException {
        if (this.A04 == this.A01) {
            return -(this.A05 + 2);
        }
        long A7E = interfaceC0518Cd.A7E();
        if (A0D(interfaceC0518Cd, this.A01)) {
            this.A0A.A03(interfaceC0518Cd, false);
            ...
            if (j3 < 0) {
                ...
                long initialPosition = interfaceC0518Cd.A7E();
            ...
            long A7E2 = interfaceC0518Cd.A7E() - (i2 * (j3 > 0 ? 1L : 2L));
            long j5 = this.A01;
            long j6 = this.A04;
            long j7 = (j5 - j6) * j3;
            String[] strArr3 = A0D;
            ...
            if (pageSize != str2.charAt(24)) {
                ...
                return Math.min(Math.max(A7E2 + (j7 / (initialPosition5 - this.A05)), j6), this.A01 - 1);
            }
            String[] strArr4 = A0D;
            strArr4[1] = "HnyCEdH4by64";
            strArr4[7] = "f67XG71IQfud";
            return Math.min(Math.max(A7E2 + (j7 / (this.A02 - this.A05)), j6), this.A01 - 1);
        }
        long j8 = this.A04;
        if (j8 != A7E) {
            return j8;
    ...
    private final long A02(InterfaceC0518Cd interfaceC0518Cd) throws IOException, InterruptedException {
        A0C(interfaceC0518Cd);
        this.A0A.A02();
        while ((this.A0A.A04 & 4) != 4 && interfaceC0518Cd.A7E() < this.A08) {
            this.A0A.A03(interfaceC0518Cd, false);
            interfaceC0518Cd.AEy(this.A0A.A01 + this.A0A.A00);
        }
        return this.A0A.A05;
    }

    private final long A03(InterfaceC0518Cd interfaceC0518Cd, long j2, long j3) throws IOException, InterruptedException {
        this.A0A.A03(interfaceC0518Cd, false);
    ...
    private final void A0C(InterfaceC0518Cd interfaceC0518Cd) throws IOException, InterruptedException {
        if (A0D(interfaceC0518Cd, this.A08)) {
            return;
        }
        throw new EOFException();
    }

    private final boolean A0D(InterfaceC0518Cd interfaceC0518Cd, long j2) throws IOException, InterruptedException {
        long min = Math.min(3 + j2, this.A08);
        byte[] bArr = new byte[ThrowableProxyConverter.BUILDER_CAPACITY];
        int length = bArr.length;
        while (true) {
            if (interfaceC0518Cd.A7E() + length > min && (length = (int) (min - interfaceC0518Cd.A7E())) < 4) {
                return false;
            }
            interfaceC0518Cd.AD5(bArr, 0, length, false);
    ...
    public final long ADV(InterfaceC0518Cd interfaceC0518Cd) throws IOException, InterruptedException {
        ...
        if (i2 == 0) {
            ...
            if (j3 == 0) {
                ...
                long A01 = A01(j3, interfaceC0518Cd);
                if (A01 >= 0) {
                    return A01;
                }
                A03 = A03(interfaceC0518Cd, this.A06, -(A01 + 2));
            }
            this.A00 = 3;
            return -(2 + A03);
        }
        this.A07 = A02(interfaceC0518Cd);
        this.A00 = 3;
        return this.A03;
    }
