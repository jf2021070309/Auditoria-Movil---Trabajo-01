...
public final class C0636Hi {
    ...
    public C0636Hi(Uri uri, long j2, long j3, long j4, @Nullable String str, int i2) {
        this(uri, null, j2, j3, j4, str, i2);
    }

    public C0636Hi(Uri uri, long j2, long j3, @Nullable String str) {
        this(uri, j2, j2, j3, str, 0);
    }

    public C0636Hi(Uri uri, long j2, long j3, @Nullable String str, int i2) {
        this(uri, j2, j2, j3, str, i2);
    }

    public C0636Hi(Uri uri, @Nullable byte[] bArr, long j2, long j3, long j4, @Nullable String str, int i2) {
        boolean z = true;
        IJ.A03(j2 >= 0);
        IJ.A03(j3 >= 0);
        if (j4 <= 0 && j4 != -1) {
