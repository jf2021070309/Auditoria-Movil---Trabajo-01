...
public final class XR implements C0S {
    ...
    private void A02(int i2, String str, JSONObject jSONObject, boolean z) {
        ...
        try {
            jSONObject.put(A00(33, 13, 121), C04338t.A0H(this.A00));
        } catch (JSONException unused) {
        }
        this.A00.A06().A8z(A00(27, 6, 27), i2 + 4000, anonymousClass90);
        if (this.A00.A03().A8P()) {
    ...
    public final void A90(C0T c0t, JSONObject jSONObject) {
        A02(c0t.A02(), c0t.toString(), jSONObject, Arrays.binarySearch(XJ.A09, c0t) != -1);
    }

    @Override // com.facebook.ads.redexgen.X.C0S
    public final void A9C(int i2, JSONObject jSONObject) {
