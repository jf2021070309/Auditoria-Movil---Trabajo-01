...
public enum EnumC03635o {
    ...
    EnumC03635o(String str) {
        this.A00 = str;
    }

    @Nullable
    public static EnumC03635o A00(@Nullable String str) {
        EnumC03635o[] values;
        for (EnumC03635o enumC03635o : values()) {
            if (enumC03635o.A00.equals(str)) {
                return enumC03635o;
            }
        }
        return null;
