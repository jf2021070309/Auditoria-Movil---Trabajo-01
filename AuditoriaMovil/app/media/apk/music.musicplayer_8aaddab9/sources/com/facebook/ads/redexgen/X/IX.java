...
public final class IX implements QM {
    ...
    public IX(View view, int i2, Drawable drawable, Drawable drawable2) {
        this.A03 = i2;
        this.A07 = view;
        this.A05 = drawable;
        this.A04 = drawable2;
    ...
    private void A04(boolean z) {
        ...
        if (z) {
            this.A02 = QL.A06;
            ML.A0S(this.A07, this.A00);
            this.A00.startTransition(this.A03);
            this.A06.postDelayed(new C0657If(this), this.A03);
            return;
        }
        ML.A0S(this.A07, this.A05);
        this.A02 = QL.A05;
    }
    ...
    private void A05(boolean z) {
        ...
        if (z) {
            ...
            this.A06.postDelayed(new C0658Ig(this), this.A03);
            return;
        }
        ML.A0S(this.A07, this.A04);
        this.A02 = QL.A03;
    }
