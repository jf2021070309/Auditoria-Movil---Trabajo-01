...
public final class C1V {
    ...
    public static C02491b A01(JSONObject jSONObject) {
        return new C02481a().A02(A08(jSONObject)).A03(A09(jSONObject)).A04();
    }
    ...
    public static String A04(JSONObject jSONObject) {
        ...
        return genericTextObject == null ? A02 : genericTextObject.optString(A02(150, 8, 90), A02);
    }
    ...
    public static String A08(JSONObject jSONObject) {
        JSONObject genericTextObject = jSONObject.optJSONObject(A02(217, 12, 62));
        String A02 = A02(SyslogConstants.LOG_CLOCK, 17, 1);
