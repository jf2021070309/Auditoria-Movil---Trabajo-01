...
public class C1083Yz implements InterfaceC03956v {
    ...
    public C1083Yz(C1069Yl c1069Yl) {
        this.A00 = c1069Yl;
    }
        ...
        if (strArr != null) {
            ...
            while (true) {
                ...
                if (i2 < i3) {
                    ...
                    C7A signalValueTypeDef = this.A00.A08(C7J.A08(sb.toString().getBytes(A00(1, 5, 16)), C7I.A06));
