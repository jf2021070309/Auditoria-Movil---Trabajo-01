...
public final class BA {
    ...
    static {
        ...
        A02 = new int[]{32, 40, 48, 56, 64, 80, 96, SyslogConstants.LOG_ALERT, 128, SyslogConstants.LOG_LOCAL4, 192, 224, 256, 320, 384, 448, AdRequest.MAX_CONTENT_URL_LENGTH, 576, 640};
    ...
    */
    ...
    public static Format A07(C0660Ii c0660Ii, String str, String str2, DrmInitData drmInitData) {
        int i2 = A05[(c0660Ii.A0E() & 192) >> 6];
        int A0E = c0660Ii.A0E();
    ...
    public static Format A08(C0660Ii c0660Ii, String str, String str2, DrmInitData drmInitData) {
        c0660Ii.A0Z(2);
        int i2 = A05[(c0660Ii.A0E() & 192) >> 6];
        int A0E = c0660Ii.A0E();
        ...
        int numDepSub = (c0660Ii.A0E() & 30) >> 1;
        if (numDepSub > 0) {
            int numDepSub2 = c0660Ii.A0E();
            if ((numDepSub2 & 2) != 0) {
                channelCount += 2;
            }
        }
        String A0A = A0A(9, 10, 49);
        if (c0660Ii.A04() > 0 && (c0660Ii.A0E() & 1) != 0) {
            A0A = A0A(19, 14, 63);
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.facebook.ads.redexgen.X.B9 A09(com.facebook.ads.redexgen.X.C0659Ih r19) {
        /*
            Method dump skipped, instructions count: 850
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.BA.A09(com.facebook.ads.redexgen.X.Ih):com.facebook.ads.redexgen.X.B9");
    }
}
