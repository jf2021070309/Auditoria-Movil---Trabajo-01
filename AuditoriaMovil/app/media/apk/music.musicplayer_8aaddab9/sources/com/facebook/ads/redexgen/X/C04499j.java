...
public final class C04499j {
    ...
    public final int A04(C04499j c04499j) {
        int i2 = this.A00;
        int i3 = c04499j.A00;
        if (i2 != i3) {
            return i2 - i3;
        }
        return this.A01 - c04499j.A01;
    }

    public final C04499j A05(int i2) {
        int i3 = this.A01;
        if (i2 + i3 >= 0) {
            return new C04499j(this.A00, i3 + i2);
        }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof C04499j) {
            C04499j c04499j = (C04499j) obj;
            int i2 = c04499j.A00;
            int i3 = this.A00;
            if (A03[4].charAt(2) != 'U') {
            ...
            return i2 == i3 && c04499j.A01 == this.A01;
        }
        return false;
    }
