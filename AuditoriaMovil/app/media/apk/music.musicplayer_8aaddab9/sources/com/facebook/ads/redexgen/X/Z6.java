...
public class Z6 implements AnonymousClass72<String> {
    ...
    public Z6(Enumeration<InetAddress> enumeration) {
        this.A00 = A01(enumeration);
    }

    public /* synthetic */ Z6(Enumeration enumeration, Z7 z7) {
        this(enumeration);
    }
    ...
    public static Map<String, String> A01(Enumeration<InetAddress> enumeration) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (!(nextElement instanceof Inet4Address)) {
                ...
                A00 = A00(3, 2, SyslogConstants.LOG_CLOCK);
    ...
    public final boolean A8S(Object obj) {
        ...
        if (map != null) {
            ...
            strArr[4] = "R3xveNN";
            if (map2 != null) {
                if (map.size() != z6.A00.size()) {
                    return false;
                }
                Iterator<Map.Entry<String, String>> it = this.A00.entrySet().iterator();
                Iterator<Map.Entry<String, String>> newInetAddressIterator = z6.A00.entrySet().iterator();
                while (it.hasNext()) {
        ...
        return this.A00 == null && z6.A00 == null;
    }
