...
public class UL extends L7 {
    ...
    public final void A06() {
        ...
        try {
            ...
            if (all.size() > 1) {
                C0695Jr.A06(this.A00, RD.A00(this.A00), all);
            }
            sharedPreferences.edit().clear().apply();
            sharedPreferences.edit().putString(A00(45, 19, 10), this.A00.A07().A02()).putString(A00(64, 21, 50), MC.A02(this.A00.A07().A01())).apply();
        } catch (JSONException e2) {
            this.A00.A06().A8y(A00(31, 14, 7), 3502, new AnonymousClass90(e2));
            sharedPreferences.edit().clear().apply();
        }
        synchronized (C0695Jr.class) {
            SharedPreferences.Editor edit = sharedPreferences.edit();
            for (Map.Entry entry : C0695Jr.A02().entrySet()) {
                edit.putInt((String) entry.getKey(), ((Integer) entry.getValue()).intValue());
            }
            edit.apply();
            atomicInteger = C0695Jr.A04;
            atomicInteger.set(2);
        }
    }
}
