...
public final class HC {
    ...
    public static long A01(String str) throws NumberFormatException {
        String[] A0l;
        long j2 = 0;
        String[] A0m = C0676Iy.A0m(str, A02(50, 2, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH));
        for (String subpart : C0676Iy.A0l(A0m[0], A02(1, 1, 3))) {
    ...
    public static void A04(C0660Ii c0660Ii) throws GZ {
        String line = c0660Ii.A0P();
