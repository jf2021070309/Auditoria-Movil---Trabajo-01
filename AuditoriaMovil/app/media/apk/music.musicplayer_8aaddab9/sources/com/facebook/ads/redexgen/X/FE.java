...
public class FE extends C1241c9 {
    ...
    public final void A05(ViewParent viewParent, View view, int i2, int i3, int[] iArr) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 54, 31), e2);
        }
    }
    ...
    public final boolean A07(ViewParent viewParent, View view, float f2, float f3) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(50, 53, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), e2);
            return false;
        }
    }
