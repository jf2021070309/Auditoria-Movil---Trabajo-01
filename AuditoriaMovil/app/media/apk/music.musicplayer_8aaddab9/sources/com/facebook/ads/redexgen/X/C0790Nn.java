...
public final class C0790Nn extends ProgressBar {
    public static final int A02 = Color.argb(26, 0, 0, 0);
    public static final int A03 = Color.rgb(88, (int) SyslogConstants.LOG_LOCAL2, 255);
    public Paint A00;
    public Rect A01;

    public C0790Nn(C1046Xo c1046Xo, AttributeSet attributeSet, int i2) {
