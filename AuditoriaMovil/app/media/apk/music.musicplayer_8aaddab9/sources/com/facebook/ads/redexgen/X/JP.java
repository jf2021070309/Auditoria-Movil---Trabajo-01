...
public final class JP {
    ...
    public static long A00(Context context) {
        return JQ.A0O(context).A25(A02(29, 25, 4), -1L);
    }

    public static long A01(Context context) {
        return JQ.A0O(context).A25(A02(131, 31, 5), -1L);
    }

    public static boolean A04(Context context) {
        return JQ.A0O(context).A29(A02(54, 39, 15), true);
    }

    public static boolean A05(Context context) {
        return JQ.A0O(context).A29(A02(0, 29, 11), false);
    }

    public static boolean A06(Context context) {
        return JQ.A0O(context).A29(A02(93, 16, 92), false);
    }

    public static boolean A07(Context context) {
        return JQ.A0O(context).A29(A02(FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD, 22, 1), false);
    }
}
