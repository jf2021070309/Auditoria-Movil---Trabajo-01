...
public abstract class AbstractC02772d<K, V> {
        ...
        if (this.A02 == null) {
            this.A02 = new Collection<V>() { // from class: com.facebook.ads.redexgen.X.2c
                ...
                public final void clear() {
                    AbstractC02772d.this.A0D();
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final boolean contains(Object obj) {
                    return AbstractC02772d.this.A06(obj) >= 0;
                }
                ...
                public final boolean isEmpty() {
                    return AbstractC02772d.this.A04() == 0;
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection, java.lang.Iterable
                public final Iterator<V> iterator() {
                    return new C2Y(AbstractC02772d.this, 1);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final boolean remove(Object obj) {
                    int A06 = AbstractC02772d.this.A06(obj);
                    if (A06 >= 0) {
                        AbstractC02772d.this.A0E(A06);
                        return true;
                ...
                public final boolean removeAll(Collection<?> collection) {
                    int A04 = AbstractC02772d.this.A04();
                    boolean z = false;
                    int i2 = 0;
                    while (i2 < A04) {
                        if (collection.contains(AbstractC02772d.this.A07(i2, 1))) {
                            AbstractC02772d.this.A0E(i2);
                            i2--;
                            A04--;
                            z = true;
                        }
                ...
                public final int size() {
                    return AbstractC02772d.this.A04();
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final Object[] toArray() {
                    return AbstractC02772d.this.A0G(1);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final <T> T[] toArray(T[] tArr) {
                    T[] array = (T[]) AbstractC02772d.this.A0H(tArr, 1);
                    return array;
                }
            };
        }
            ...
            this.A00 = new Set<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2Z
                ...
                public final boolean addAll(Collection<? extends Map.Entry<K, V>> collection) {
                    ...
                    for (Map.Entry<K, V> entry : collection) {
                        AbstractC02772d.this.A0F(entry.getKey(), entry.getValue());
                    }
                    return A04 != AbstractC02772d.this.A04();
                }
                ...
                public final boolean contains(Object obj) {
                    if (obj instanceof Map.Entry) {
                        ...
                        int A05 = AbstractC02772d.this.A05(entry.getKey());
                        if (A05 < 0) {
                            return false;
                        }
                        return C2W.A04(AbstractC02772d.this.A07(A05, 1), entry.getValue());
                    }
                    return false;
                }
                ...
                public final boolean equals(Object obj) {
                    return AbstractC02772d.A03(this, obj);
                }
                ...
                public final int hashCode() {
                    int i2 = 0;
                    for (int A04 = AbstractC02772d.this.A04() - 1; A04 >= 0; A04--) {
                        int i3 = 0;
                        Object A07 = AbstractC02772d.this.A07(A04, 0);
                        Object A072 = AbstractC02772d.this.A07(A04, 1);
                ...
                public final Iterator<Map.Entry<K, V>> iterator() {
                    return new C02752b(AbstractC02772d.this);
                }
    ...
    public final Set<K> A0C() {
        if (this.A01 == null) {
            this.A01 = new Set<K>() { // from class: com.facebook.ads.redexgen.X.2a
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean contains(Object obj) {
                    return AbstractC02772d.this.A05(obj) >= 0;
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean containsAll(Collection<?> collection) {
                    return AbstractC02772d.A00(AbstractC02772d.this.A0A(), collection);
                }
                ...
                public final int hashCode() {
                    ...
                    for (int A04 = AbstractC02772d.this.A04() - 1; A04 >= 0; A04--) {
                        int i3 = 0;
                        Object obj = AbstractC02772d.this.A07(A04, 0);
                        if (obj != null) {
                            i3 = obj.hashCode();
                        }
                        i2 += i3;
                ...
                public final Iterator<K> iterator() {
                    return new C2Y(AbstractC02772d.this, 0);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean remove(Object obj) {
                    int A05 = AbstractC02772d.this.A05(obj);
                    if (A05 >= 0) {
                        AbstractC02772d.this.A0E(A05);
                        return true;
                    }
                    return false;
                }
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean removeAll(Collection<?> collection) {
                    return AbstractC02772d.A01(AbstractC02772d.this.A0A(), collection);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean retainAll(Collection<?> collection) {
                    return AbstractC02772d.A02(AbstractC02772d.this.A0A(), collection);
                }
                ...
                @Override // java.util.Set, java.util.Collection
                public final Object[] toArray() {
                    return AbstractC02772d.this.A0G(0);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final <T> T[] toArray(T[] tArr) {
                    T[] array = (T[]) AbstractC02772d.this.A0H(tArr, 0);
                    return array;
                }
            };
        }
