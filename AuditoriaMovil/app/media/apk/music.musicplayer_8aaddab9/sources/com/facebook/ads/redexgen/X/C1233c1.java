...
public class C1233c1 implements C4R {
    ...
    public final void A04(F6 f6, boolean z) {
        this.A00 = 0;
        int[] iArr = this.A03;
        if (iArr != null) {
            Arrays.fill(iArr, -1);
        ...
        C4T c4t = f6.A06;
        if (f6.A04 != null && c4t != null && c4t.A1Y()) {
            if (z) {
                boolean A0J = f6.A00.A0J();
                String[] strArr = A05;
                if (strArr[0].charAt(30) != strArr[5].charAt(30)) {
                    A05[7] = "b5aEeD0";
                    if (!A0J) {
                        c4t.A1v(f6.A04.A0D(), this);
                    }
                }
                throw new RuntimeException();
            } else if (!f6.A1t()) {
                c4t.A1u(this.A01, this.A02, f6.A0s, this);
            }
            int i2 = this.A00;
            int i3 = c4t.A00;
            String[] strArr2 = A05;
