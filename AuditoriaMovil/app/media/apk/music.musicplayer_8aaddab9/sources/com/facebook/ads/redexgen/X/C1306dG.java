...
public final class C1306dG extends AbstractC02370p {
    ...
    public C1306dG(C1046Xo c1046Xo, AbstractC02380q abstractC02380q, C0869Qp c0869Qp, C1315dP c1315dP) {
        super(c1046Xo, abstractC02380q, c0869Qp);
        this.A02 = EnumC02470z.A03;
        this.A03 = null;
        this.A0D = c1315dP;
    }
    ...
    */
    private org.json.JSONObject A04(android.view.View r10) throws org.json.JSONException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1306dG.A04(android.view.View):org.json.JSONObject");
    }
    ...
    public final void A06(Map<String, String> map) {
        ...
        K7 k7 = this.A04;
        if (k7 != null) {
            map.put(A01(97, 3, 121), String.valueOf(k7.A04()));
        }
        if (this.A07) {
            map.put(A01(83, 3, 95), Boolean.TRUE.toString());
        }
        if (this.A0B) {
            map.put(A01(89, 3, SyslogConstants.LOG_ALERT), Boolean.TRUE.toString());
        }
        if (this.A08) {
        ...
        EnumC02470z enumC02470z = this.A02;
        if (enumC02470z != null) {
            map.put(A01(106, 14, 33), enumC02470z.toString());
        }
        if (this.A09) {
        ...
        if (view != null) {
            map.put(A01(69, 4, 45), String.valueOf((int) (view.getWidth() / C0739Lm.A00)));
            map.put(A01(65, 4, 34), String.valueOf((int) (this.A01.getHeight() / C0739Lm.A00)));
        }
    ...
    public final void A09(EnumC02470z enumC02470z) {
        this.A02 = enumC02470z;
    }
