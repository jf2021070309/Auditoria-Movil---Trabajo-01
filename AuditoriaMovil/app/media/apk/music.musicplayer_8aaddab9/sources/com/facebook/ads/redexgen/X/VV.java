...
public final class VV extends DownloadAction {
    ...
    static {
        A06();
        A03 = new VW(A05(0, 11, 68), 0);
    }

    public VV(Uri uri, boolean z, @Nullable byte[] bArr, @Nullable String str) {
    ...
    /* renamed from: A02 */
    public final VU A07(F5 f5) {
        return new VU(this.A01, this.A00, f5);
    }

    private String A04() {
        String str = this.A00;
        return str != null ? str : I9.A01(this.A01);
    }
    ...
    public final boolean A09(DownloadAction downloadAction) {
        return (downloadAction instanceof VV) && A04().equals(((VV) downloadAction).A04());
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (strArr[0].charAt(3) != strArr[1].charAt(3)) {
            ...
            return C0676Iy.A0g(this.A00, ((VV) obj).A00);
        }
