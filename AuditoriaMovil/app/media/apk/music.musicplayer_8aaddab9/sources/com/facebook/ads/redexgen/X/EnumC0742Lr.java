...
public enum EnumC0742Lr {
    ...
    EnumC0742Lr(int i2, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i2;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0742Lr A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0742Lr[] values;
        for (EnumC0742Lr enumC0742Lr : values()) {
            if (enumC0742Lr.A01 == nativeComponentTag) {
                return enumC0742Lr;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0742Lr A00 = A00(nativeComponentTag);
        if (view != null && A00 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0742Lr enumC0742Lr) {
        if (view != null && enumC0742Lr != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0742Lr);
        }
    }
