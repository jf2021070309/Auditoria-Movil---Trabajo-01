...
public final class C0869Qp {
    ...
    public final C1046Xo A0D;
    public final WeakReference<AbstractC0868Qo> A0E;
    ...
    static {
        A0M();
        A0I = C0869Qp.class.getSimpleName();
    }

    public C0869Qp(View view, int i2, int i3, boolean z, WeakReference<AbstractC0868Qo> weakReference, C1046Xo c1046Xo) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = 1000;
        this.A08 = true;
        this.A05 = new C0870Qq(C0Q.A0M);
    ...
    public C0869Qp(View view, int i2, WeakReference<AbstractC0868Qo> weakReference, C1046Xo c1046Xo) {
        this(view, i2, 0, false, weakReference, c1046Xo);
    }

    public C0869Qp(View view, int i2, boolean z, WeakReference<AbstractC0868Qo> weakReference, C1046Xo c1046Xo) {
        this(view, i2, 0, z, weakReference, c1046Xo);
    }
    ...
    public static /* synthetic */ int A05(C0869Qp c0869Qp) {
        int i2 = c0869Qp.A00;
        c0869Qp.A00 = i2 + 1;
        return i2;
    }
    ...
    */
    public static int A08(java.util.Vector<android.graphics.Rect> r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0869Qp.A08(java.util.Vector):int");
    }
    ...
    public static C0870Qq A0E(View view, int i2, C1046Xo c1046Xo) {
        DisplayMetrics displayMetrics;
        if (view == null) {
            A0N(null, false, A0H(472, 16, 113));
            return new C0870Qq(C0Q.A08);
        }
        boolean A1r = JQ.A1r(c1046Xo);
        String A0H2 = A0H(534, 37, 121);
        String A0H3 = A0H(331, 22, 99);
        if (A1r) {
            if (view.getParent() == null) {
                A0N(view, false, A0H3);
                return new C0870Qq(C0Q.A0K);
            } else if (!view.isShown()) {
                A0N(view, false, A0H2);
                return new C0870Qq(C0Q.A0N);
            }
        } else if (view.getParent() == null) {
            A0N(view, false, A0H3);
            return new C0870Qq(C0Q.A0H);
        } else if (!view.isShown()) {
            A0N(view, false, A0H2);
            return new C0870Qq(C0Q.A0H);
        }
            ...
            if (A0H[4].charAt(15) == 'A') {
                ...
                try {
                    ...
                    if (!view.getGlobalVisibleRect(rect)) {
                        return new C0870Qq(C0Q.A07);
                    }
                    int heightPixels = Build.VERSION.SDK_INT;
                    if (A0H[1].length() == 16) {
                        A0H[1] = "Od97VXu84qI514kY";
                        if (heightPixels >= 17) {
                            Display display = ((WindowManager) c1046Xo.getSystemService(A0H(713, 6, 30))).getDefaultDisplay();
                            displayMetrics = new DisplayMetrics();
                            display.getRealMetrics(displayMetrics);
                        } else {
                            displayMetrics = c1046Xo.getResources().getDisplayMetrics();
                        }
                        ...
                        if (A1i) {
                            ...
                            if (mViewabilityThreshold2 < 0 || displayMetrics.widthPixels - iArr[0] < targetVisibleAreaSize) {
                                ...
                                return new C0870Qq(C0Q.A0D, f2);
                            }
                            int widthPixels = (int) ((height * (100.0d - heightPixels2)) / 100.0d);
                            if (rect.top - iArr[1] > widthPixels) {
                                A0N(view, false, A0H(436, 36, 63));
                                return new C0870Qq(C0Q.A0E, f2);
                            } else if ((iArr[1] + height) - rect.bottom > widthPixels) {
                                A0N(view, false, A0H(397, 39, 30));
                                return new C0870Qq(C0Q.A0C, f2);
                            }
                        }
                        if (!C0753Mc.A03(c1046Xo)) {
                            A0N(view, false, A0H(185, 26, 62));
                            return new C0870Qq(C0Q.A0L, f2);
                        }
                        Map<String, String> A01 = C0754Md.A01(c1046Xo);
                        if (MM.A04(A01)) {
                            A0N(view, false, A0H(156, 29, 77));
                            return new C0870Qq(C0Q.A0A, f2);
                        } else if (JQ.A1J(c1046Xo) && MM.A03(A01)) {
                            A0N(view, false, A0H(31, 31, 14));
                            return new C0870Qq(C0Q.A05, f2, A01);
                        } else {
                            A0N(view, true, A0H(515, 19, 99));
                            return new C0870Qq(C0Q.A0J, f2, A01);
                        }
                    }
    ...
    */
    public static java.util.Vector<android.graphics.Rect> A0K(android.view.View r7) {
        ...
        L1a:
            ...
            boolean r0 = r3 instanceof com.facebook.ads.redexgen.X.C0830Pc
            r2 = 0
            if (r0 != 0) goto L43
            r1 = 1
        L2a:
            boolean r0 = r3 instanceof com.facebook.ads.redexgen.X.SN
            if (r0 == 0) goto L34
            boolean r0 = com.facebook.ads.redexgen.X.C0871Qr.A00(r3)
            if (r0 != 0) goto L35
        L34:
            r2 = 1
        L35:
        ...
        L45:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0869Qp.A0K(android.view.View):java.util.Vector");
    }
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if ((view instanceof ViewGroup) && (C0871Qr.A00(view) || i2 != 0)) {
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        hashMap.put(A0H(711, 2, 69), MC.A05(this.A03));
