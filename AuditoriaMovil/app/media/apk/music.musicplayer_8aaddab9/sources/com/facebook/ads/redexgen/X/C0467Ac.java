...
public final class C0467Ac {
    ...
    public final InterfaceC0597Fv[] A0A;
    public final boolean[] A0B;
    public final InterfaceC0576Fa A0C;
    public final HT A0D;
    public final InterfaceC0485Au[] A0E;
    ...
    public C0467Ac(InterfaceC0485Au[] interfaceC0485AuArr, long j2, HT ht, HW hw, InterfaceC0576Fa interfaceC0576Fa, Object obj, C0468Ad c0468Ad) {
        this.A0E = interfaceC0485AuArr;
        this.A00 = j2 - c0468Ad.A03;
        this.A0D = ht;
        this.A0C = interfaceC0576Fa;
        this.A09 = IJ.A01(obj);
        this.A02 = c0468Ad;
        this.A0A = new InterfaceC0597Fv[interfaceC0485AuArr.length];
        this.A0B = new boolean[interfaceC0485AuArr.length];
        VM A4P = interfaceC0576Fa.A4P(c0468Ad.A04, hw);
        this.A08 = c0468Ad.A02 != Long.MIN_VALUE ? new C0515Bz(A4P, true, 0L, c0468Ad.A02) : A4P;
    }
    ...
    private void A02(HU hu) {
        ...
        while (true) {
            ...
            if (i2 < i3) {
                boolean A00 = hu.A00(i2);
                HQ A002 = hu.A01.A00(i2);
                if (A00 && A002 != null) {
                    A002.A58();
                }
                i2++;
    ...
    private void A04(InterfaceC0597Fv[] interfaceC0597FvArr) {
        int i2 = 0;
        while (true) {
            InterfaceC0485Au[] interfaceC0485AuArr = this.A0E;
            if (i2 < interfaceC0485AuArr.length) {
                if (interfaceC0485AuArr[i2].A7h() == 5 && this.A04.A00(i2)) {
                    interfaceC0597FvArr[i2] = new VR();
                }
                i2++;
            } else {
                return;
    ...
    private void A05(InterfaceC0597Fv[] interfaceC0597FvArr) {
        int i2 = 0;
        while (true) {
            InterfaceC0485Au[] interfaceC0485AuArr = this.A0E;
            if (i2 < interfaceC0485AuArr.length) {
                if (interfaceC0485AuArr[i2].A7h() == 5) {
                    interfaceC0597FvArr[i2] = null;
                }
                i2++;
            } else {
                return;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0087, code lost:
        com.facebook.ads.redexgen.X.IJ.A04(r12.A04.A00(r5));
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0099, code lost:
        if (r12.A0E[r5].A7h() == 5) goto L31;
     */
    ...
    */
    public final long A0B(long r13, boolean r15, boolean[] r16) {
        ...
        L1d:
            ...
            com.facebook.ads.redexgen.X.HU r0 = r12.A04
            r12.A03(r0)
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C0467Ac.A0G
            r0 = 7
            r1 = r1[r0]
            r0 = 5
            ...
            throw r0
        L3b:
            java.lang.String[] r4 = com.facebook.ads.redexgen.X.C0467Ac.A0G
        ...
        L64:
            ...
            r0 = 57
            if (r1 == r0) goto La0
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C0467Ac.A0G
        ...
        Lb7:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0467Ac.A0B(long, boolean, boolean[]):long");
    }
    ...
    public final long A0C(boolean z) {
        ...
        long A5s = this.A08.A5s();
        if (A5s == Long.MIN_VALUE && z) {
            C0468Ad c0468Ad = this.A02;
            String[] strArr = A0G;
            if (strArr[1].charAt(21) != strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    public final void A0D() {
        ...
        try {
            if (this.A02.A02 != Long.MIN_VALUE) {
                this.A0C.ADo(((C0515Bz) this.A08).A05);
            } else {
                this.A0C.ADo(this.A08);
            }
    ...
    public final void A0E(float f2) throws AM {
        this.A06 = true;
        this.A03 = this.A08.A7g();
        A0I(f2);
    ...
    public final boolean A0H() {
        return this.A06 && (!this.A05 || this.A08.A5s() == Long.MIN_VALUE);
    }

    public final boolean A0I(float f2) throws AM {
        HQ[] A01;
        HU A0T = this.A0D.A0T(this.A0E, this.A03);
        if (A0T.A01(this.A07)) {
            return false;
        }
        this.A04 = A0T;
