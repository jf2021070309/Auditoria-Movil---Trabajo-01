...
public final class OS extends LinearLayout {
    public static final int A06 = (int) (C0739Lm.A00 * 4.0f);
    public int A00;
    ...
    public OS(C1046Xo c1046Xo, int i2, int i3, int i4, int i5) {
        super(c1046Xo);
        this.A00 = A06;
        this.A04 = c1046Xo;
        setOrientation(0);
    ...
    private void A01() {
        ...
        while (true) {
            OT[] otArr = this.A05;
            if (i2 < otArr.length) {
                ((LinearLayout.LayoutParams) otArr[i2].getLayoutParams()).leftMargin = i2 == 0 ? 0 : this.A00;
                i2++;
            } else {
                requestLayout();
                return;
