...
public final class C1309dJ implements InterfaceC02310i {
    ...
    public C1309dJ(String str, String str2, EnumC02300h enumC02300h, Collection<String> detectionStrings, Map<String, String> metadata, String str3, String str4, @Nullable String str5) {
        this.A04 = str;
        this.A01 = str2;
        this.A00 = enumC02300h;
    ...
    @Nullable
    public static C1309dJ A00(JSONObject jSONObject) {
        JSONArray jSONArray;
        if (jSONObject == null) {
            return null;
        }
        ...
        String A02 = C0743Ls.A02(jSONObject, markup3);
        String markup4 = A01(50, 21, 57);
        EnumC02300h A00 = EnumC02300h.A00(jSONObject.optString(markup4));
        try {
        ...
        Collection<String> A01 = C02320j.A01(jSONArray);
        ...
        return new C1309dJ(optString, activationCommand, A00, A01, hashMap, encryptedCPM, A02, C0743Ls.A02(jSONObject, A01(37, 13, 95)));
    }
