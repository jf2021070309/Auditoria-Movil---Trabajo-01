...
public final class C1001Vt implements InterfaceC0551Dx {
    ...
    public boolean A08;
    public boolean A09;
    public final InterfaceC0536Di A0A;
    public final C0659Ih A0B = new C0659Ih(new byte[10]);
    public int A03 = 0;
    ...
    public C1001Vt(InterfaceC0536Di interfaceC0536Di) {
        this.A0A = interfaceC0536Di;
    }
    ...
    private boolean A05(C0660Ii c0660Ii, byte[] bArr, int i2) {
    ...
    public final void A48(C0660Ii c0660Ii, boolean z) throws C0470Af {
        if (z) {
            int i2 = this.A03;
            if (i2 != 0 && i2 != 1) {
        ...
        while (c0660Ii.A04() > 0) {
            ...
            if (i3 != 0) {
                if (i3 != 1) {
                    if (i3 == 2) {
                        if (A05(c0660Ii, this.A0B.A00, Math.min(10, this.A01)) && A05(c0660Ii, null, this.A01)) {
                            A01();
                            this.A0A.AD1(this.A04, this.A06);
                            A03(3);
                        }
                    } else if (i3 != 3) {
                        continue;
                        ...
                        if (i5 > 0) {
                            A04 -= i5;
                            c0660Ii.A0X(c0660Ii.A06() + A04);
                        }
                        this.A0A.A47(c0660Ii);
                        int i6 = this.A02;
                        if (i6 != -1) {
                            this.A02 = i6 - A04;
                            if (this.A02 == 0) {
                                InterfaceC0536Di interfaceC0536Di = this.A0A;
                                if (A0D[0].charAt(8) != '6') {
                                    throw new RuntimeException();
                                }
                                String[] strArr = A0D;
                ...
                } else if (A05(c0660Ii, this.A0B.A00, 9)) {
                    A03(A04() ? 2 : 0);
                }
            } else {
                c0660Ii.A0Z(c0660Ii.A04());
            }
        }
    }
