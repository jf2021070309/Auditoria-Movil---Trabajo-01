...
public final class C7X {
    ...
    public static void A02(C8U c8u, C7N c7n, int i2, String str, long j2) {
        if (!A06(c8u)) {
            return;
        }
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(A00(SyslogConstants.LOG_CLOCK, 14, 2), c7n.A00);
            jSONObject.put(A00(134, 13, 118), c7n.A01);
            if (j2 > 0) {
                jSONObject.put(A00(191, 9, 97), MC.A06(System.currentTimeMillis() - j2));
            }
            AnonymousClass90 anonymousClass90 = new AnonymousClass90(str);
            anonymousClass90.A05(jSONObject);
            anonymousClass90.A03(1);
            c8u.A06().A8z(A00(154, 5, 17), i2, anonymousClass90);
        } catch (Throwable th) {
            c8u.A06().A3Q(th);
        }
    }

    public static void A03(C8U c8u, C7R c7r, String str, int i2, @Nullable String str2, @Nullable Integer num, @Nullable Long l2) {
        if (A06(c8u)) {
            A05(c8u, c7r.A05, c7r.A06, c7r.A07, A00(186, 5, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), str, i2, str2, num, l2, null);
        }
    }
    ...
    public static void A04(C8U c8u, C7W c7w, boolean z) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(A00(SyslogConstants.LOG_CLOCK, 14, 2), c7w.A00);
            jSONObject.put(A00(134, 13, 118), c7w.A03);
            jSONObject.put(A00(104, 16, 42), c7w.A02);
            jSONObject.put(A00(159, 13, 119), c7w.A01);
            if (JQ.A1a(c8u)) {
                jSONObject.put(A00(200, 3, 82), c7w.A04);
            }
            String A002 = z ? A00(61, 10, 0) : A00(71, 11, 55);
            int i2 = z ? A05 : A06;
            AnonymousClass90 anonymousClass90 = new AnonymousClass90(A002);
            anonymousClass90.A05(jSONObject);
            anonymousClass90.A03(1);
            c8u.A06().A8z(A00(154, 5, 17), i2, anonymousClass90);
        } catch (Throwable th) {
    ...
    @SuppressLint({"CatchGeneralException"})
    public static void A05(C8U c8u, String str, String str2, String str3, String str4, String str5, int i2, @Nullable String str6, @Nullable Integer num, @Nullable Long l2, @Nullable Integer num2) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(A00(SyslogConstants.LOG_CLOCK, 14, 2), str);
    ...
    public static boolean A06(C8U c8u) {
        ...
        return A062 <= 0 || c8u.A07().A00() <= 1.0d / ((double) A062);
    }
}
