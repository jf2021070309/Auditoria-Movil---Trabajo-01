...
public final class C0545Dr {
    public static byte[] A02;
    public final List<Format> A00;
    public final InterfaceC0525Co[] A01;
    ...
    public C0545Dr(List<Format> list) {
        this.A00 = list;
        this.A01 = new InterfaceC0525Co[list.size()];
    }

    public final void A02(long j2, C0660Ii c0660Ii) {
        C0610Gi.A03(j2, c0660Ii, this.A01);
    }

    public final void A03(Ce ce, C0550Dw c0550Dw) {
        for (int i2 = 0; i2 < this.A01.length; i2++) {
            ...
            IJ.A05(z, A00(0, 43, 85) + str);
            AFI.A5U(Format.A08(format.A0M != null ? format.A0M : c0550Dw.A04(), str, null, -1, format.A0D, format.A0N, format.A03, null));
            this.A01[i2] = AFI;
        }
    }
}
