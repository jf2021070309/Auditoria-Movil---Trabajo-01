...
public final class C1J {
    ...
    public static List<C1B> A01(JSONArray jSONArray, JSONObject jSONObject, C1046Xo c1046Xo, C1N c1n) {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            try {
                ...
                c1n.A3A(A002, jSONObject2);
                arrayList.add(A002);
            } catch (JSONException e2) {
                c1046Xo.A06().A8y(A00(8, 7, 31), C04398z.A20, new AnonymousClass90(e2));
            }
        }
        return arrayList;
    }
