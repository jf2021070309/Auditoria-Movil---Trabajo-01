...
public abstract class C7A<T> {
    ...
    public C7A(long j2, @Nullable AnonymousClass78 anonymousClass78, T signalValue, AnonymousClass79 anonymousClass79) {
        this.A00 = j2;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.7A != com.facebook.ads.internal.botdetection.signals.model.signal_value.SignalValueTypeDef<T> */
    public final boolean A0B(@Nullable C7A<T> c7a, EnumSet<EnumC03996z> enumSet) {
        long A08;
        ...
        boolean z = false;
        if (enumSet.contains(EnumC03996z.A0E)) {
            z = A0A(c7a);
        }
        if (enumSet.contains(EnumC03996z.A0C)) {
            z &= (A01() == null || c7a.A01() == null || !A01().A02().equals(c7a.A01().A02())) ? false : true;
        }
        if (enumSet.contains(EnumC03996z.A0D)) {
