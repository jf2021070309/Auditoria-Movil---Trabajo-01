...
public final class IH implements QM {
    ...
    public IH(View view, int i2, int i3, int i4) {
        this.A05 = view;
        this.A02 = i2;
        this.A04 = i3;
        this.A03 = i4;
    ...
    private ValueAnimator A00(View view, int i2, int i3) {
        ...
        ofInt.addUpdateListener(new QV(this, view));
        return ofInt;
    }
    ...
    public void A08(boolean z) {
        if (z) {
            ...
            this.A00.addListener(new QU(this));
            this.A00.start();
            return;
        }
    ...
    public void A09(boolean z) {
        ...
        if (z) {
            ...
            this.A00.addListener(new QT(this));
            this.A00.start();
            return;
        }
        View view = this.A05;
