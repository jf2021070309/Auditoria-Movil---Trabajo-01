...
public final class C04288n {
    ...
    public C04288n(String str, Map<String, String> map) {
        this(str, map, false);
    }

    public C04288n(String str, Map<String, String> map, boolean z) {
        this.A01 = str;
        this.A02 = map;
    ...
    public final Map<String, String> A02() {
        ...
        hashMap.put(A00(18, 10, SyslogConstants.LOG_CLOCK), this.A01);
