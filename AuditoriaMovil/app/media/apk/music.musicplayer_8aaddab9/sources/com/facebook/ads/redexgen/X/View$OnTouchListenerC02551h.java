...
public class View$OnTouchListenerC02551h extends F6 implements View.OnTouchListener {
    ...
    public View$OnTouchListenerC02551h(C1046Xo c1046Xo) {
        super(c1046Xo);
        this.A05 = 0;
        this.A00 = 0;
        this.A03 = true;
    ...
    public View$OnTouchListenerC02551h(C1046Xo c1046Xo, AttributeSet attributeSet) {
    ...
    public View$OnTouchListenerC02551h(C1046Xo c1046Xo, AttributeSet attributeSet, int i2) {
    ...
    private int A06(int i2) {
        int i3 = this.A00 - i2;
        int A7F = this.A02.A7F(i3);
        int i4 = this.A06;
        if (i3 > i4) {
            return A08(this.A05, A7F);
        }
        if (i3 < (-i4)) {
            return A07(this.A05, A7F);
        }
        return this.A05;
    }
    ...
    public void setSnapDelegate(PR pr) {
        this.A02 = pr;
    }
}
