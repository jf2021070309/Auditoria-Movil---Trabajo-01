...
public class E2 extends Exception {
    ...
    public E2(Format format, Throwable th, boolean z, int i2) {
        super(A01(23, 22, 74) + i2 + A01(45, 3, 58) + format, th);
        this.A02 = format.A0O;
        this.A03 = z;
        this.A00 = null;
        this.A01 = A00(i2);
    ...
    public E2(Format format, Throwable th, boolean z, String str) {
        ...
        this.A03 = z;
        this.A00 = str;
        this.A01 = C0676Iy.A02 >= 21 ? A02(th) : null;
    }

    public static String A00(int i2) {
        String A01 = i2 < 0 ? A01(101, 4, 95) : A01(0, 0, 105);
        return A01(48, 53, 91) + A01 + Math.abs(i2);
    }
