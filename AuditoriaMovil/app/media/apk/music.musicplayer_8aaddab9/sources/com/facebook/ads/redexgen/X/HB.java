...
public final class HB {
    ...
    public static int A00(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -1074341483:
                ...
                break;
            case 100571:
                boolean equals = str.equals(A03(203, 3, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH));
                if (A02[3].length() != 10) {
    ...
    public static Layout.Alignment A02(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -1074341483:
                ...
                break;
            case 100571:
                if (str.equals(A03(203, 3, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH))) {
                    c2 = 4;
                    break;
                }
                c2 = 65535;
    ...
    public static String A04(String str) {
        ...
        return C0676Iy.A0m(trim, A03(156, 5, 39))[0];
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0086, code lost:
        if (com.facebook.ads.redexgen.X.HB.A02[2].charAt(8) == 'y') goto L48;
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0088, code lost:
        com.facebook.ads.redexgen.X.HB.A02[3] = "V2wLbBmXpgkEOhtSXmoT1";
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x009d, code lost:
        r4 = r6.A0H();
        r2 = com.facebook.ads.redexgen.X.HB.A02;
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00b1, code lost:
        if (r2[0].length() == r2[6].length()) goto L46;
     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00b3, code lost:
        com.facebook.ads.redexgen.X.HB.A02[3] = "i3U";
     */
    ...
    */
    ...
    public static void A09(String str, H8 h8) throws NumberFormatException {
        ...
        if (indexOf != -1) {
            h8.A06(A00(str.substring(indexOf + 1)));
            str = str.substring(0, indexOf);
        } else {
            h8.A06(Level.ALL_INT);
        }
    ...
    public static void A0A(String str, H8 h8) throws NumberFormatException {
        int indexOf = str.indexOf(44);
        if (indexOf != -1) {
            h8.A08(A00(str.substring(indexOf + 1)));
            str = str.substring(0, indexOf);
        } else {
            h8.A08(Level.ALL_INT);
        }
        h8.A04(HC.A00(str));
    }
    ...
    */
                ...
                if (i3 >= length) {
                    ...
                    if (tagName != null && A0E(tagName)) {
                        if (z) {
                            ...
                            arrayDeque.push(H9.A01(substring, spannableStringBuilder.length()));
                        }
                    }
                }
            }
    ...
    public static void A0D(List<H6> list, String str, H9 h9, List<HA> list2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            H6 h6 = list.get(i2);
            int A09 = h6.A09(str, h9.A01, h9.A03, h9.A02);
            if (A09 > 0) {
                list2.add(new HA(A09, h6));
            }
        }
    ...
    */
    ...
    public static boolean A0F(String str, Matcher matcher, C0660Ii c0660Ii, H8 h8, StringBuilder sb, List<H6> list) {
        try {
    ...
    public final boolean A0G(C0660Ii c0660Ii, H8 h8, List<H6> list) {
        String A0P = c0660Ii.A0P();
        if (A0P == null) {
            return false;
        }
        ...
        if (matcher.matches()) {
            return A0F(null, matcher, c0660Ii, h8, this.A00, list);
        }
        ...
        if (matcher2.matches()) {
            return A0F(A0P.trim(), matcher2, c0660Ii, h8, this.A00, list);
        }
        return false;
    }
}
