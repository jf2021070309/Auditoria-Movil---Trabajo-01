...
public final class MQ implements Executor {
    ...
    static {
        A04();
        A08 = new MQ(A00(7, 7, 8), 0);
        A06 = new MQ(A00(0, 5, 91), 0);
        A07 = new MQ(A00(5, 2, 3), 0);
        A03 = 32;
        A0C = Executors.newSingleThreadExecutor();
        A0B = Executors.newFixedThreadPool(5);
        A0D = new AtomicBoolean();
        A0E = new AtomicBoolean();
        A0A = Executors.newCachedThreadPool(new MO());
        A09 = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    }

    @VisibleForTesting
    public MQ(String str, int i2) {
        this.A02 = i2;
        int availableProcessors = Runtime.getRuntime().availableProcessors();
        int KEEP_ALIVE_SECONDS = (availableProcessors * 2) + 1;
        this.A01 = new ThreadPoolExecutor(Math.max(2, Math.min(availableProcessors - 1, 4)), KEEP_ALIVE_SECONDS, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new MP(this, str));
    ...
    public static void A05(Context context) {
        A0D.set(JQ.A1u(context));
        A0E.set(JQ.A1t(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (MQ.class) {
            ...
            if (size == oldThreshold) {
                ...
                C1045Xn A00 = C8T.A00();
                if (A00 != null) {
                    InterfaceC04388y A062 = A00.A06();
                    String A002 = A00(42, 7, 27);
                    int i3 = C04398z.A1S;
                    String A003 = A00(21, 21, 46);
                    A062.A8y(A002, i3, new AnonymousClass90(A003, A00(14, 7, 25) + i2));
                }
            }
        }
