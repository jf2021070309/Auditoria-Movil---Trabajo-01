...
public final class C02410t {
    ...
    public final synchronized void A07(String str) throws JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
                ...
                for (int i2 = 0; i2 < jSONArray.length() && i2 < C1O.A00(); i2++) {
    ...
    public final void A09(JSONObject jSONObject) throws JSONException {
        ...
        C1O c1o = new C1O(optString);
        if (optString != null && this.A00.has(optString) && (this.A00.get(optString) instanceof C1O)) {
            c1o = (C1O) this.A00.get(optString);
        }
        String A00 = A00(40, 11, 80);
        if (jSONObject.has(A00)) {
            c1o.A06((JSONArray) jSONObject.get(A00));
        }
        String A002 = A00(57, 20, 33);
        if (jSONObject.has(A002)) {
            c1o.A04(jSONObject.optInt(A002));
        }
        c1o.A05(optInt, optInt2, optLong, optInt3);
        String[] strArr = A04;
        String str = strArr[3];
