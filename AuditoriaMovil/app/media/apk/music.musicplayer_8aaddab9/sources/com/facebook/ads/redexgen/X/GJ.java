...
public final class GJ implements InterfaceC1361eB {
    ...
    public final InterfaceC1357e7 A02;
    ...
    public GJ(View view, InterfaceC1357e7 interfaceC1357e7) {
        this.A03 = new WeakReference<>(view);
        this.A02 = interfaceC1357e7;
    }
    ...
    private final void A02(List<Rect> list) {
        ...
        list2.add(rect);
        Iterator<InterfaceC1356e6> it = this.A02.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC1361eB
    public final void A7r(List<Rect> list) {
        if (A06) {
            A03(list);
        } else {
            A02(list);
