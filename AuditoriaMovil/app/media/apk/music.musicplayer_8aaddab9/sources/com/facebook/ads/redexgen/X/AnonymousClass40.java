...
public class AnonymousClass40 {
    ...
    public int A02;
    public int A03;
    public AbstractC03344l A04;
    public AbstractC03344l A05;

    public static String A00(int i2, int i3, int i4) {
        byte[] copyOfRange = Arrays.copyOfRange(A06, i2, i2 + i3);
        for (int i5 = 0; i5 < copyOfRange.length; i5++) {
            byte b2 = (byte) ((copyOfRange[i5] - i4) - 94);
            if (A07[0].length() == 11) {
    ...
    public AnonymousClass40(AbstractC03344l abstractC03344l, AbstractC03344l abstractC03344l2) {
        this.A05 = abstractC03344l;
        this.A04 = abstractC03344l2;
    }

    public AnonymousClass40(AbstractC03344l abstractC03344l, AbstractC03344l abstractC03344l2, int i2, int i3, int i4, int i5) {
        this(abstractC03344l, abstractC03344l2);
        this.A00 = i2;
        this.A01 = i3;
        this.A02 = i4;
        this.A03 = i5;
