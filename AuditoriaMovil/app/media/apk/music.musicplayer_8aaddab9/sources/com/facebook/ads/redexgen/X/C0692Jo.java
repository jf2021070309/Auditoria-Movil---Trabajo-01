...
public final class C0692Jo {
    ...
    public final InterfaceC0684Jg A00;
    ...
    public C0692Jo(String str, InterfaceC0684Jg interfaceC0684Jg) {
        this.A01 = str;
        this.A00 = interfaceC0684Jg;
    }

    public final void A02(EnumC0691Jn enumC0691Jn, @Nullable Map<String, String> map) {
        A03(enumC0691Jn.A02(), map);
    }

    public final void A03(String str, @Nullable Map<String, String> map) {
        if (!C0694Jq.A0B(this.A01, str)) {
            return;
        }
        if (map == null) {
            map = new HashMap<>();
