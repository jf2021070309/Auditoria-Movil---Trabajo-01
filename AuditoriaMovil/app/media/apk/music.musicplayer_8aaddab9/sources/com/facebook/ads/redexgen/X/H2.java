...
public final class H2 {
    ...
    public final C0660Ii A00 = new C0660Ii();
    ...
    public static char A00(C0660Ii c0660Ii, int i2) {
        return (char) c0660Ii.A00[i2];
    }

    public static String A02(C0660Ii c0660Ii) {
        int limit = c0660Ii.A06();
        int A07 = c0660Ii.A07();
        int position = 0;
        while (limit < A07 && position == 0) {
            int i2 = limit + 1;
            int position2 = c0660Ii.A00[limit];
            int limit2 = (char) position2;
            position = limit2 == 41 ? 1 : 0;
            limit = i2;
        }
        return c0660Ii.A0S((limit - 1) - c0660Ii.A06()).trim();
    }

    public static String A03(C0660Ii c0660Ii, StringBuilder sb) {
        sb.setLength(0);
        int A06 = c0660Ii.A06();
        int A07 = c0660Ii.A07();
        boolean z = false;
        while (A06 < A07 && !z) {
            char c2 = (char) c0660Ii.A00[A06];
        ...
        c0660Ii.A0Z(A06 - c0660Ii.A06());
        return sb.toString();
    }

    public static String A04(C0660Ii c0660Ii, StringBuilder sb) {
        A0A(c0660Ii);
        if (c0660Ii.A04() == 0) {
            return null;
        }
        String A032 = A03(c0660Ii, sb);
        String A01 = A01(0, 0, 21);
        if (!A01.equals(A032)) {
            return A032;
        }
        return A01 + ((char) c0660Ii.A0E());
    }

    public static String A05(C0660Ii c0660Ii, StringBuilder sb) {
        StringBuilder sb2 = new StringBuilder();
        boolean z = false;
        while (!z) {
            int A06 = c0660Ii.A06();
            String A042 = A04(c0660Ii, sb);
            if (A042 == null) {
                return null;
            }
            if (A01(118, 1, 28).equals(A042) || A01(8, 1, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH).equals(A042)) {
                c0660Ii.A0Y(A06);
                z = true;
            } else {
                sb2.append(A042);
    ...
    public static String A06(C0660Ii c0660Ii, StringBuilder sb) {
        A0A(c0660Ii);
        if (c0660Ii.A04() < 5) {
            return null;
        }
        if (A01(3, 5, 31).equals(c0660Ii.A0S(5))) {
            int A06 = c0660Ii.A06();
            String A042 = A04(c0660Ii, sb);
            if (A042 == null) {
                return null;
            ...
            String str = null;
            String token3 = A01(0, 1, SyslogConstants.LOG_CLOCK);
            if (token3.equals(A042)) {
                str = A02(c0660Ii);
            }
            String A043 = A04(c0660Ii, sb);
    ...
    private void A08(H6 h6, String str) {
        ...
        String[] A0l = C0676Iy.A0l(str, A01(9, 2, 90));
        String str2 = A0l[0];
        int indexOf2 = str2.indexOf(35);
        if (indexOf2 != -1) {
            h6.A0J(str2.substring(0, indexOf2));
        ...
        if (idPrefixIndex2 > 1) {
            ...
            h6.A0L((String[]) Arrays.copyOfRange(A0l, 1, idPrefixIndex3));
        }
    }

    public static void A09(C0660Ii c0660Ii) {
        do {
        } while (!TextUtils.isEmpty(c0660Ii.A0P()));
    }

    public static void A0A(C0660Ii c0660Ii) {
        boolean z = true;
        while (c0660Ii.A04() > 0 && z) {
            if (!A0D(c0660Ii)) {
                boolean A0C = A0C(c0660Ii);
                String[] strArr = A03;
                if (strArr[4].length() == strArr[5].length()) {
                    throw new RuntimeException();
                }
    ...
    public static void A0B(C0660Ii c0660Ii, H6 h6, StringBuilder sb) {
        A0A(c0660Ii);
        String token = A03(c0660Ii, sb);
        String A01 = A01(0, 0, 21);
        if (A01.equals(token)) {
            return;
        }
        if (!A01(2, 1, 94).equals(A04(c0660Ii, sb))) {
            return;
        }
        A0A(c0660Ii);
        String A05 = A05(c0660Ii, sb);
        if (A05 == null || A01.equals(A05)) {
            return;
        }
        int A06 = c0660Ii.A06();
        String A042 = A04(c0660Ii, sb);
        if (!A01(8, 1, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH).equals(A042)) {
        ...
        if (A01(50, 5, 124).equals(token)) {
            ...
            if (!A01(108, 9, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION).equals(A05)) {
                return;
            }
            h6.A0G(true);
    ...
    public static boolean A0C(C0660Ii c0660Ii) {
        int limit = c0660Ii.A06();
        int A07 = c0660Ii.A07();
    ...
    public static boolean A0D(C0660Ii c0660Ii) {
        char A00 = A00(c0660Ii, c0660Ii.A06());
        if (A00 != '\t' && A00 != '\n' && A00 != '\f' && A00 != '\r') {
            String[] strArr = A03;
    ...
    public final H6 A0E(C0660Ii c0660Ii) {
        this.A01.setLength(0);
        int A06 = c0660Ii.A06();
        A09(c0660Ii);
        this.A00.A0b(c0660Ii.A00, c0660Ii.A06());
        this.A00.A0Y(A06);
