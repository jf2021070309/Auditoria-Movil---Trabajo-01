...
public final class BJ extends V3 {
    ...
    public static int A04(TrackGroup trackGroup, int[] iArr, HG hg) {
        ...
        for (int i3 = 0; i3 < trackGroup.A01; i3++) {
            if (A0J(trackGroup.A01(i3), iArr[i3], hg)) {
                i2++;
            }
        }
        return i2;
    ...
    public static Point A05(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (A03[2].charAt(31) != 'o') {
            ...
            if (tempViewportWidth >= i6) {
                return new Point(i2, C0676Iy.A04(i2 * i5, i4));
            }
            return new Point(C0676Iy.A04(i3 * i4, i5), i3);
        }
        throw new RuntimeException();
    }

    @Nullable
    private final HQ A06(int i2, TrackGroupArray trackGroupArray, int[][] iArr, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters) throws AM {
        ...
        while (true) {
            ...
            if (i4 < i5) {
                ...
                return new BI(trackGroup, trackIndex);
            }
        }
    }
    ...
    public static HQ A07(TrackGroupArray trackGroupArray, int[][] iArr, int requiredAdaptiveSupport, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters, HP hp) throws AM {
        ...
        for (int i3 = 0; i3 < trackGroupArray.A01; i3++) {
            ...
            if (A0O.length > 0) {
                return ((HP) IJ.A01(hp)).A4T(A01, A0O);
            }
        }
        return null;
    }
    ...
    @Nullable
    private final HQ A08(TrackGroupArray trackGroupArray, int[][] iArr, int i2, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters, @Nullable HP hp) throws AM {
        int trackIndex = -1;
        int i3 = -1;
        HH trackScore = null;
        for (int i4 = 0; i4 < trackGroupArray.A01; i4++) {
            ...
            for (int i5 = 0; i5 < A01.A01; i5++) {
                if (A0H(iArr2[i5], defaultTrackSelector$Parameters.A0B)) {
                    HH hh = new HH(A01.A01(i5), defaultTrackSelector$Parameters, iArr2[i5]);
        ...
        if (!defaultTrackSelector$Parameters.A0D && hp != null) {
            ...
            if (A0N.length > 0) {
                return hp.A4T(A012, A0N);
            }
        }
        return new BI(A012, trackIndex);
    }

    @Nullable
    private final HQ A09(TrackGroupArray trackGroupArray, int[][] iArr, int i2, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters, @Nullable HP hp) throws AM {
        HQ hq = null;
        if (!defaultTrackSelector$Parameters.A0D && hp != null) {
            hq = A07(trackGroupArray, iArr, i2, defaultTrackSelector$Parameters, hp);
        }
        if (hq == null) {
    ...
    */
    public static com.facebook.ads.redexgen.X.HQ A0A(com.facebook.ads.internal.exoplayer2.source.TrackGroupArray r19, int[][] r20, com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$Parameters r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.BJ.A0A(com.facebook.ads.internal.exoplayer2.source.TrackGroupArray, int[][], com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$Parameters):com.facebook.ads.redexgen.X.HQ");
    }
    ...
    */
    private final com.facebook.ads.redexgen.X.HQ A0B(com.facebook.ads.internal.exoplayer2.source.TrackGroupArray r15, int[][] r16, com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$Parameters r17) throws com.facebook.ads.redexgen.X.AM {
        ...
        L56:
            ...
            r6 = r4
            r5 = r3
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.BJ.A03
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 3
        ...
        L86:
            ...
            goto L31
        L88:
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.BJ.A03
        ...
        L9b:
            return r0
        L9c:
            com.facebook.ads.redexgen.X.BI r0 = new com.facebook.ads.redexgen.X.BI
            r0.<init>(r6, r5)
            goto L9b
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.BJ.A0B(com.facebook.ads.internal.exoplayer2.source.TrackGroupArray, int[][], com.facebook.ads.internal.exoplayer2.trackselection.DefaultTrackSelector$Parameters):com.facebook.ads.redexgen.X.HQ");
    }
    ...
    public static void A0G(HO ho, int[][][] iArr, C0486Av[] c0486AvArr, HQ[] hqArr, int rendererType) {
        if (rendererType == 0) {
            return;
        }
        int i2 = -1;
        ...
        while (true) {
            ...
            int A01 = ho.A01(i4);
            HQ hq = hqArr[i4];
            if ((A01 == 1 || A01 == 2) && hq != null && A0M(iArr[i4], ho.A02(i4), hq)) {
                if (A01 == 1) {
                    if (i2 != -1) {
                        z = false;
                        break;
        ...
        C0486Av c0486Av = new C0486Av(rendererType);
        c0486AvArr[i2] = c0486Av;
        c0486AvArr[i3] = c0486Av;
    }
    ...
    public static boolean A0J(Format format, int i2, HG hg) {
        if (A0H(i2, false) && format.A05 == hg.A00 && format.A0C == hg.A01) {
    ...
    public static boolean A0K(Format format, @Nullable String str) {
        return str != null && TextUtils.equals(str, C0676Iy.A0L(format.A0N));
    }
    ...
    public static boolean A0L(Format format, @Nullable String str, int i2, int i3, int i4, int i5, int i6) {
        ...
        if (str == null || C0676Iy.A0g(format.A0O, str)) {
    ...
    public static int[] A0N(TrackGroup trackGroup, int[] iArr, boolean z) {
        ...
        while (true) {
            if (configurationCount < trackGroup.A01) {
                ...
                HG hg2 = new HG(A01.A05, A01.A0C, z ? null : A01.A0O);
                String[] strArr = A03;
                if (strArr[4].length() == strArr[0].length()) {
                    break;
                }
                A03[6] = "SWl";
                if (hashSet.add(hg2) && (A042 = A04(trackGroup, iArr, hg2)) > i2) {
                    hg = hg2;
                    i2 = A042;
                }
                configurationCount++;
                ...
                if (A03[1].charAt(3) == 'F') {
                    ...
                    int index = 0;
                    for (int i3 = 0; i3 < trackGroup.A01; i3++) {
                        if (A0J(trackGroup.A01(i3), iArr[i3], (HG) IJ.A01(hg))) {
    ...
    public static int[] A0O(TrackGroup trackGroup, int[] iArr, boolean z, int i2, int i3, int i4, int trackIndex, int i5, int i6, boolean z2) {
        ...
        if (trackGroup.A01 >= 2) {
            ...
            return A0D.size() < 2 ? A04 : C0676Iy.A0j(A0D);
        }
        return A04;
    }
    ...
    private final HQ[] A0P(HO ho, int[][][] iArr, int[] iArr2, DefaultTrackSelector$Parameters defaultTrackSelector$Parameters) throws AM {
        ...
        for (int i3 = 0; i3 < A00; i3++) {
            ...
            if (2 == A01) {
                if (i2 == 0) {
                    z = true;
                    hqArr[i3] = A09(ho.A02(i3), iArr[i3], iArr2[i3], defaultTrackSelector$Parameters, this.A00);
                    i2 = hqArr[i3] != null ? 1 : 0;
                } else {
                    z = true;
                }
                if (ho.A02(i3).A01 <= 0) {
        ...
        if (A03[3].charAt(2) != 'E') {
            ...
            for (int i5 = 0; i5 < A00; i5++) {
                ...
                if (A012 != 1) {
                    if (A012 != 2) {
                        if (A012 != 3) {
                            hqArr[i5] = A06(A012, ho.A02(i5), iArr[i5], defaultTrackSelector$Parameters);
                        } else if (i4 == 0) {
                            hqArr[i5] = A0B(ho.A02(i5), iArr[i5], defaultTrackSelector$Parameters);
                            i4 = hqArr[i5] != null ? 1 : 0;
                        }
                    }
                } else if (!z2) {
                    hqArr[i5] = A08(ho.A02(i5), iArr[i5], iArr2[i5], defaultTrackSelector$Parameters, seenVideoRendererWithMappedTracks ? null : this.A00);
                    z2 = hqArr[i5] != null;
                }
            }
            return hqArr;
    ...
    public final Pair<C0486Av[], HQ[]> A0V(HO ho, int[][][] iArr, int[] iArr2) throws AM {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            if (defaultTrackSelector$Parameters.A06(i3)) {
                ...
                TrackGroupArray A022 = ho.A02(i3);
                if (defaultTrackSelector$Parameters.A07(i3, A022)) {
                    ...
                    if (A05 == null) {
                        ...
                        A0P[i3] = new BI(A022.A01(A05.A00), A05.A02[0]);
                    } else {
                        A0P[i3] = ((HP) IJ.A01(this.A00)).A4T(A022.A01(A05.A00), A05.A02);
                    }
                }
            }
        }
        C0486Av[] c0486AvArr = new C0486Av[i2];
        for (int i4 = 0; i4 < i2; i4++) {
            c0486AvArr[i4] = !defaultTrackSelector$Parameters.A06(i4) && (ho.A01(i4) == 5 || A0P[i4] != null) ? C0486Av.A01 : null;
        }
        A0G(ho, iArr, c0486AvArr, A0P, defaultTrackSelector$Parameters.A04);
        return Pair.create(c0486AvArr, A0P);
    }
}
