...
public final class C1341dq implements AnonymousClass00 {
    ...
    static {
        A04();
        A0B = C1341dq.class.getSimpleName();
    }

    public C1341dq(C8U c8u, AnonymousClass08 anonymousClass08, C0L c0l) {
        this.A05 = c8u;
        ...
        try {
            ...
            while (true) {
                ...
                if (read != -1) {
                    ...
                    return new Cdo(byteArrayOutputStream.toByteArray());
                }
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x00c8, code lost:
        ...
        r21.A00().A4A(r4, r16.A04);
        r16.A06.put(r10, r4);
        r16.A04.ADc(r10, 2112, null, java.lang.Integer.valueOf(r8), java.lang.Long.valueOf(r6), r17);
     */
    ...
    /* JADX WARN: Not initialized variable reg: 10, insn: 0x0100: INVOKE  
     ...
     type: INTERFACE call: com.facebook.ads.redexgen.X.0L.ADc(java.lang.String, int, java.lang.String, java.lang.Integer, java.lang.Long, com.facebook.ads.redexgen.X.06):void, block:B:40:0x00f5 */
    /* JADX WARN: Not initialized variable reg: 10, insn: 0x011a: INVOKE  
      ...
      (r14 I:java.lang.Long)
      (r15 I:com.facebook.ads.redexgen.X.06)
     type: INTERFACE call: com.facebook.ads.redexgen.X.0L.ADc(java.lang.String, int, java.lang.String, java.lang.Integer, java.lang.Long, com.facebook.ads.redexgen.X.06):void, block:B:46:0x010f */
    ...
    */
    private java.io.File A02(com.facebook.ads.redexgen.X.AnonymousClass06 r17, java.lang.String r18, java.lang.String r19, int r20, com.facebook.ads.redexgen.X.AnonymousClass09 r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1341dq.A02(com.facebook.ads.redexgen.X.06, java.lang.String, java.lang.String, int, com.facebook.ads.redexgen.X.09):java.io.File");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void A05(android.content.Context r24, com.facebook.ads.redexgen.X.C1338dm r25, java.lang.String r26, int r27, int r28, long r29) throws com.facebook.ads.redexgen.X.C0H {
        /*
            Method dump skipped, instructions count: 435
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1341dq.A05(android.content.Context, com.facebook.ads.redexgen.X.dm, java.lang.String, int, int, long):void");
    }

    @SuppressLint({"CatchGeneralException"})
    private void A06(C1338dm c1338dm) {
        try {
            File A04 = c1338dm.A04();
            if (A04.exists()) {
                c1338dm.A06();
    ...
    private boolean A07(C1338dm c1338dm) {
        try {
            c1338dm.A05();
            return true;
        } catch (C1336dk e2) {
        ...
        if (anonymousClass09.A03()) {
            ...
            if (file != null) {
                ...
                if (A0A[6].charAt(7) != 'U') {
                    ...
                    strArr[0] = "ARXa8ML4Mz";
                    strArr[4] = "7SNAJeIyn";
                    c0l.ADd(str, true, anonymousClass06);
                    return anonymousClass09.A00().A39(file, this.A04);
                }
                throw new RuntimeException();
            }
            this.A04.ADd(anonymousClass06.A09, false, anonymousClass06);
    ...
    public final AnonymousClass02<Bitmap> AE3(AnonymousClass06 anonymousClass06, boolean z) {
        return A08(anonymousClass06, new AnonymousClass09(new C1344dt(anonymousClass06.A01, anonymousClass06.A00, this.A02.A04(), this.A02.A03(), z)));
    }
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass00
    @Nullable
    public final File AE4(AnonymousClass06 anonymousClass06) {
        AnonymousClass09 anonymousClass09 = new AnonymousClass09(new C1343ds());
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass00
    @Nullable
    public final String AE5(AnonymousClass06 anonymousClass06) {
        return (String) A08(anonymousClass06, new AnonymousClass09(new C1342dr())).A00();
    }
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass00
    @Nullable
    public final String AE6(AnonymousClass06 anonymousClass06) {
        AnonymousClass09 anonymousClass09 = new AnonymousClass09(new C1342dr());
        anonymousClass09.A01(true);
        anonymousClass09.A02(false);
