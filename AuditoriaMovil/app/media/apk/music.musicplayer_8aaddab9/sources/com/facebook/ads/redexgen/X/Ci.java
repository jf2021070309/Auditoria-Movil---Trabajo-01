...
public final class Ci {
    ...
    static {
        ...
        A09 = new int[]{32, 64, 96, 128, SyslogConstants.LOG_LOCAL4, 192, 224, 256, 288, 320, 352, 384, 416, 448};
        A0D = new int[]{32, 48, 56, 64, 80, 96, SyslogConstants.LOG_ALERT, 128, SyslogConstants.LOG_LOCAL2, SyslogConstants.LOG_LOCAL4, SyslogConstants.LOG_LOCAL6, 192, 224, 256};
        A0A = new int[]{32, 48, 56, 64, 80, 96, SyslogConstants.LOG_ALERT, 128, SyslogConstants.LOG_LOCAL4, 192, 224, 256, 320, 384};
        A0B = new int[]{32, 40, 48, 56, 64, 80, 96, SyslogConstants.LOG_ALERT, 128, SyslogConstants.LOG_LOCAL4, 192, 224, 256, 320};
        A0C = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, SyslogConstants.LOG_ALERT, 128, SyslogConstants.LOG_LOCAL2, SyslogConstants.LOG_LOCAL4};
    }
    ...
    public static boolean A04(int version, Ci ci) {
        ...
        ci.A03(i2, str, i5, samplesPerFrame, (frameSize2 & 3) == 3 ? 1 : 2, bitrateIndex2 * 1000, i4);
        return true;
    }
}
