...
public final class DU {
    ...
    public final C0660Ii A0A = new C0660Ii(255);
    ...
    public final boolean A03(InterfaceC0518Cd interfaceC0518Cd, boolean z) throws IOException, InterruptedException {
        this.A0A.A0V();
        A02();
        if (!(interfaceC0518Cd.A6s() == -1 || interfaceC0518Cd.A6s() - interfaceC0518Cd.A79() >= 27) || !interfaceC0518Cd.AD5(this.A0A.A00, 0, 27, true)) {
            if (z) {
                return false;
            }
        ...
        if (A0C[1].charAt(3) != 'Q') {
            ...
            if (this.A03 != 0) {
                ...
                throw new C0470Af(A00(50, 31, 79));
            }
            ...
            this.A0A.A0V();
            interfaceC0518Cd.AD4(this.A0A.A00, 0, this.A02);
            int i2 = 0;
            while (true) {
                int i3 = this.A02;
                if (A0C[2].length() == 23) {
