...
public class GV implements RK {
    ...
    public final RL A03;
    public final List<RM> A04 = new ArrayList();
    ...
    private boolean A04(@Nullable JSONObject jSONObject, @Nullable JSONObject jSONObject2) {
        ...
        boolean A02 = RJ.A02(jSONObject, jSONObject2);
        String[] strArr = A06;
    ...
    */
    public final synchronized boolean A05(org.json.JSONObject r9, @androidx.annotation.Nullable org.json.JSONObject r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.GV.A05(org.json.JSONObject, org.json.JSONObject):boolean");
    }

    @Override // com.facebook.ads.redexgen.X.RK
    public final synchronized void A3E(RM rm) {
        this.A04.add(rm);
    }
