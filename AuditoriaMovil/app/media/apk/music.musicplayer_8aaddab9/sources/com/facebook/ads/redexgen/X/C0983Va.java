...
public final class C0983Va implements EG {
     ...
     */
    public static ChapterFrame A06(C0660Ii c0660Ii, int i2, int i3, boolean z, int i4, @Nullable ES es) throws UnsupportedEncodingException {
        int A06 = c0660Ii.A06();
        int A022 = A02(c0660Ii.A00, A06);
        String str = new String(c0660Ii.A00, A06, A022 - A06, A0I(169, 10, 52));
        c0660Ii.A0Y(A022 + 1);
        int A08 = c0660Ii.A08();
        ...
        int i5 = A06 + i2;
        while (c0660Ii.A06() < i5) {
            Id3Frame A0B = A0B(i3, c0660Ii, z, i4, es);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    public static int A01(C0660Ii c0660Ii, int i2) {
        ...
        for (int A06 = c0660Ii.A06(); A06 + 1 < i2; A06++) {
    ...
    public static ApicFrame A04(C0660Ii c0660Ii, int i2, int i3) throws UnsupportedEncodingException {
        int A022;
        String A0M;
        int A0E = c0660Ii.A0E();
        String A0H = A0H(A0E);
        byte[] bArr = new byte[i2 - 1];
        c0660Ii.A0c(bArr, 0, i2 - 1);
        String A0I = A0I(458, 6, 63);
        String A0I2 = A0I(169, 10, 52);
        if (i3 == 2) {
            A022 = 2;
            A0M = A0I + C0676Iy.A0M(new String(bArr, 0, 3, A0I2));
            if (A0I(474, 9, 14).equals(A0M)) {
                A0M = A0I(464, 10, 41);
            }
        } else {
            A022 = A02(bArr, 0);
            A0M = C0676Iy.A0M(new String(bArr, 0, A022, A0I2));
            if (A0M.indexOf(47) == -1) {
                A0M = A0I + A0M;
            }
        }
    ...
    public static BinaryFrame A05(C0660Ii c0660Ii, int i2, String str) {
        byte[] bArr = new byte[i2];
        c0660Ii.A0c(bArr, 0, i2);
        return new BinaryFrame(str, bArr);
    }

    public static ChapterTocFrame A07(C0660Ii c0660Ii, int framePosition, int elementIdEndIndex, boolean z, int i2, @Nullable ES es) throws UnsupportedEncodingException {
        int A06 = c0660Ii.A06();
        int A022 = A02(c0660Ii.A00, A06);
        String A0I = A0I(169, 10, 52);
        String str = new String(c0660Ii.A00, A06, A022 - A06, A0I);
        c0660Ii.A0Y(A022 + 1);
        int A0E = c0660Ii.A0E();
        boolean z2 = (A0E & 2) != 0;
        boolean z3 = (A0E & 1) != 0;
        int ctocFlags = c0660Ii.A0E();
        String[] strArr = new String[ctocFlags];
        for (int childCount = 0; childCount < ctocFlags; childCount++) {
            int A062 = c0660Ii.A06();
            int i3 = A02(c0660Ii.A00, A062);
            strArr[childCount] = new String(c0660Ii.A00, A062, i3 - A062, A0I);
            int startIndex = i3 + 1;
            c0660Ii.A0Y(startIndex);
        }
        ArrayList arrayList = new ArrayList();
        int i4 = A06 + framePosition;
        while (c0660Ii.A06() < i4) {
            Id3Frame A0B = A0B(elementIdEndIndex, c0660Ii, z, i2, es);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
    ...
    public static CommentFrame A08(C0660Ii c0660Ii, int i2) throws UnsupportedEncodingException {
        if (i2 < 4) {
            return null;
        }
        int A0E = c0660Ii.A0E();
        ...
        c0660Ii.A0c(data, 0, 3);
        String str = new String(data, 0, 3);
        byte[] bArr = new byte[i2 - 4];
        c0660Ii.A0c(bArr, 0, i2 - 4);
    ...
    public static GeobFrame A09(C0660Ii c0660Ii, int i2) throws UnsupportedEncodingException {
        int A0E = c0660Ii.A0E();
        String A0H = A0H(A0E);
        byte[] bArr = new byte[i2 - 1];
        c0660Ii.A0c(bArr, 0, i2 - 1);
    ...
    */
    public static com.facebook.ads.redexgen.X.ET A0A(com.facebook.ads.redexgen.X.C0660Ii r9) {
        /*
            Method dump skipped, instructions count: 283
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0983Va.A0A(com.facebook.ads.redexgen.X.Ii):com.facebook.ads.redexgen.X.ET");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.facebook.ads.internal.exoplayer2.metadata.id3.Id3Frame A0B(int r23, com.facebook.ads.redexgen.X.C0660Ii r24, boolean r25, int r26, @androidx.annotation.Nullable com.facebook.ads.redexgen.X.ES r27) {
        /*
            Method dump skipped, instructions count: 601
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0983Va.A0B(int, com.facebook.ads.redexgen.X.Ii, boolean, int, com.facebook.ads.redexgen.X.ES):com.facebook.ads.internal.exoplayer2.metadata.id3.Id3Frame");
    }

    public static PrivFrame A0C(C0660Ii c0660Ii, int i2) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i2];
        c0660Ii.A0c(bArr, 0, i2);
        int A022 = A02(bArr, 0);
    ...
    public static TextInformationFrame A0D(C0660Ii c0660Ii, int i2) throws UnsupportedEncodingException {
        if (i2 < 1) {
            return null;
        }
        int A0E = c0660Ii.A0E();
    ...
    public static TextInformationFrame A0E(C0660Ii c0660Ii, int encoding, String charset) throws UnsupportedEncodingException {
        if (encoding < 1) {
            return null;
        }
        int A0E = c0660Ii.A0E();
    ...
    public static UrlLinkFrame A0F(C0660Ii c0660Ii, int i2) throws UnsupportedEncodingException {
        if (i2 < 1) {
            String[] strArr = A02;
        ...
        int descriptionEndIndex = c0660Ii.A0E();
    ...
    public static UrlLinkFrame A0G(C0660Ii c0660Ii, int i2, String str) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i2];
        c0660Ii.A0c(bArr, 0, i2);
    ...
    public static String A0J(int i2, int i3, int i4, int i5, int i6) {
        return i2 == 2 ? String.format(Locale.US, A0I(0, 6, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5)) : String.format(Locale.US, A0I(6, 8, 10), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean A0M(com.facebook.ads.redexgen.X.C0660Ii r17, int r18, int r19, boolean r20) {
        /*
            Method dump skipped, instructions count: 243
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0983Va.A0M(com.facebook.ads.redexgen.X.Ii, int, int, boolean):boolean");
    }
    ...
    public final Metadata A0O(byte[] bArr, int i2) {
        ...
        while (c0660Ii.A04() >= i10) {
            i6 = A0A.A01;
            Id3Frame A0B = A0B(i6, c0660Ii, unsignedIntFrameSizeHack, i10, this.A00);
            if (A0B != null) {
                arrayList.add(A0B);
            }
        }
