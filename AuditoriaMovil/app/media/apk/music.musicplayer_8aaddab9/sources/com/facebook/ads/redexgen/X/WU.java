...
public final class WU implements InterfaceC0517Cc {
    ...
    public static final InterfaceC0519Cf A0r;
    ...
    public final C0660Ii A0i;
    public final C0660Ii A0j;
    public final C0660Ii A0k;
    public final C0660Ii A0l;
    public final C0660Ii A0m;
    public final C0660Ii A0n;
    ...
    public WU(Cu cu, int i2) {
        ...
        this.A0d = cu;
        this.A0d.A8J(new WV(this, null));
        this.A0o = (i2 & 1) == 0;
        this.A0e = new D1();
        this.A0c = new SparseArray<>();
        this.A0k = new C0660Ii(4);
        this.A0n = new C0660Ii(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0l = new C0660Ii(4);
        this.A0i = new C0660Ii(C0656Ie.A03);
        this.A0h = new C0660Ii(4);
        this.A0j = new C0660Ii();
        this.A0m = new C0660Ii();
        this.A0f = new C0660Ii(8);
        this.A0g = new C0660Ii();
    }

    private int A00(InterfaceC0518Cd interfaceC0518Cd, InterfaceC0525Co interfaceC0525Co, int i2) throws IOException, InterruptedException {
        int AEK;
        ...
        if (A04 > 0) {
            ...
            interfaceC0525Co.AEL(this.A0j, AEK);
        } else {
            AEK = interfaceC0525Co.AEK(interfaceC0518Cd, i2, false);
        }
        this.A07 += AEK;
        this.A08 += AEK;
        return AEK;
    ...
    private long A01(long j2) throws C0470Af {
        long j3 = this.A0M;
        if (j3 != -9223372036854775807L) {
            return C0676Iy.A0F(j2, j3, 1000L);
        }
        throw new C0470Af(A03(189, 54, 33));
    }
    ...
    */
    private com.facebook.ads.redexgen.X.InterfaceC0522Cl A02() {
        /*
            r11 = this;
            long r3 = r11.A0K
            r8 = 0
            ...
            int r0 = (r3 > r1 ? 1 : (r3 == r1 ? 0 : -1))
            if (r0 == 0) goto L2e
            com.facebook.ads.redexgen.X.IY r0 = r11.A0Q
            if (r0 == 0) goto L2e
            int r0 = r0.A02()
            if (r0 == 0) goto L2e
            com.facebook.ads.redexgen.X.IY r0 = r11.A0P
            if (r0 == 0) goto L2e
            int r1 = r0.A02()
            com.facebook.ads.redexgen.X.IY r0 = r11.A0Q
            int r0 = r0.A02()
        ...
        L49:
            ...
            r4[r10] = r0
            long r0 = r11.A0K
            com.facebook.ads.redexgen.X.IY r2 = r11.A0P
            long r2 = r2.A03(r10)
            long r0 = r0 + r2
            r6[r10] = r0
            int r10 = r10 + 1
        ...
        L7c:
            ...
            r11.A0Q = r8
            r11.A0P = r8
            com.facebook.ads.redexgen.X.Wl r0 = new com.facebook.ads.redexgen.X.Wl
            r0.<init>(r9, r6, r5, r4)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.WU.A02():com.facebook.ads.redexgen.X.Cl");
    }
    ...
    private void A07(InterfaceC0518Cd interfaceC0518Cd, int i2) throws IOException, InterruptedException {
        if (this.A0k.A07() >= i2) {
            return;
        }
        if (this.A0k.A05() < i2) {
            C0660Ii c0660Ii = this.A0k;
            c0660Ii.A0b(Arrays.copyOf(c0660Ii.A00, Math.max(this.A0k.A00.length * 2, i2)), this.A0k.A07());
        }
        interfaceC0518Cd.readFully(this.A0k.A00, this.A0k.A07(), i2 - this.A0k.A07());
        this.A0k.A0X(i2);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void A08(com.facebook.ads.redexgen.X.InterfaceC0518Cd r11, com.facebook.ads.redexgen.X.Cy r12, int r13) throws java.io.IOException, java.lang.InterruptedException {
        /*
            Method dump skipped, instructions count: 665
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.WU.A08(com.facebook.ads.redexgen.X.Cd, com.facebook.ads.redexgen.X.Cy, int):void");
    }

    private void A09(InterfaceC0518Cd interfaceC0518Cd, byte[] bArr, int i2) throws IOException, InterruptedException {
        ...
        interfaceC0518Cd.readFully(this.A0m.A00, bArr.length, i2);
        this.A0m.A0W(length);
    }

    private void A0A(InterfaceC0518Cd interfaceC0518Cd, byte[] bArr, int i2, int i3) throws IOException, InterruptedException {
        int min = Math.min(i3, this.A0j.A04());
        interfaceC0518Cd.readFully(bArr, i2 + min, i3 - min);
        if (min > 0) {
    ...
    private void A0B(Cy cy, long j2) {
        if (cy.A0X != null) {
            cy.A0X.A03(cy, j2);
        } else {
            if (A03(843, 11, 56).equals(cy.A0Y)) {
                ...
                if (A03(833, 10, 45).equals(cy.A0Y)) {
                    A0C(cy, A03(14, 19, 119), 21, AbstractComponentTracker.LINGERING_TIMEOUT, A0v);
                }
            }
            cy.A0W.AEM(j2, this.A01, this.A08, 0, cy.A0V);
        }
        this.A0V = true;
        A05();
    }

    private void A0C(Cy cy, String str, int i2, long j2, byte[] bArr) {
        A0D(this.A0m.A00, this.A0C, str, i2, j2, bArr);
        InterfaceC0525Co interfaceC0525Co = cy.A0W;
        C0660Ii c0660Ii = this.A0m;
        interfaceC0525Co.AEL(c0660Ii, c0660Ii.A07());
    ...
    public static void A0D(byte[] bArr, long j2, String str, int i2, long j3, byte[] bArr2) {
        ...
        if (j2 == -9223372036854775807L) {
            ...
            A0i = C0676Iy.A0i(String.format(Locale.US, str, Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(lastValue), Integer.valueOf((int) ((j5 - (lastValue * 1000000)) / j3))));
        }
        System.arraycopy(A0i, 0, bArr, i2, bArr2.length);
    }

    private boolean A0E(C0521Cj c0521Cj, long j2) {
        if (this.A0Y) {
            this.A0J = j2;
            c0521Cj.A00 = this.A0F;
            this.A0Y = false;
            return true;
        }
        if (this.A0a) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:57:0x01b9, code lost:
        if (A03(ch.qos.logback.core.net.SyslogConstants.LOG_LOCAL4, 13, 94).equals(r4) != false) goto L71;
     */
    ...
    */
    public static boolean A0F(java.lang.String r4) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.WU.A0F(java.lang.String):boolean");
    }
    ...
    public final void A0I(int i2) throws C0470Af {
        if (i2 == 160) {
            if (this.A04 != 2) {
                return;
            }
        ...
        if (A0q[3].charAt(28) == 'C') {
            ...
            if (i2 == 174) {
                ...
                throw new C0470Af(A03(667, 50, 104));
            } else if (i2 == 25152) {
                if (this.A0O.A0c) {
                    ...
                    throw new C0470Af(A03(449, 55, 66));
                }
                return;
                ...
                if (i2 == 28032) {
                    if (this.A0O.A0c && this.A0O.A0f != null) {
                        throw new C0470Af(A03(243, 53, 91));
                    }
                    return;
                    ...
                    throw new C0470Af(A03(756, 26, 66));
                }
            }
        }
        throw new RuntimeException();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:121:0x0354, code lost:
        throw new com.facebook.ads.redexgen.X.C0470Af(A03(396, 37, com.google.ads.mediation.facebook.FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION));
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0K(int r19, int r20, com.facebook.ads.redexgen.X.InterfaceC0518Cd r21) throws java.io.IOException, java.lang.InterruptedException {
        /*
            Method dump skipped, instructions count: 916
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.WU.A0K(int, int, com.facebook.ads.redexgen.X.Cd):void");
    }

    public final void A0L(int i2, long j2) throws C0470Af {
        String A03 = A03(0, 14, 56);
        if (i2 == 20529) {
            if (j2 == 0) {
                return;
            }
            throw new C0470Af(A03(327, 21, 54) + j2 + A03);
        } else if (i2 != 20530) {
            switch (i2) {
                case 131:
                    this.A0O.A0Q = (int) j2;
                ...
                case 16980:
                    ...
                    throw new C0470Af(A03(296, 16, SyslogConstants.LOG_ALERT) + j2 + A03);
                case 17029:
                    if (j2 >= 1 && j2 <= 2) {
                        return;
                    }
                    throw new C0470Af(A03(377, 19, 127) + j2 + A03);
                case 17143:
                    if (j2 == 1) {
                        return;
                    }
                    throw new C0470Af(A03(433, 16, 53) + j2 + A03);
                case 18401:
                    if (j2 == 5) {
                        return;
                    }
                    throw new C0470Af(A03(312, 15, 26) + j2 + A03);
                case 18408:
                    if (j2 == 1) {
                        return;
                    }
                    throw new C0470Af(A03(52, 22, 45) + j2 + A03);
                case 21420:
            ...
            throw new C0470Af(A03(348, 21, 50) + j2 + A03);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00df, code lost:
        if (com.facebook.ads.redexgen.X.WU.A0q[7].length() == 22) goto L58;
     */
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00e1, code lost:
        com.facebook.ads.redexgen.X.WU.A0q[4] = "xUjpTE6fi698I1UVKMv3yTWS8T";
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x0108, code lost:
        throw new com.facebook.ads.redexgen.X.C0470Af(A03(717, 39, 13));
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0M(int r8, long r9, long r11) throws com.facebook.ads.redexgen.X.C0470Af {
        /*
            Method dump skipped, instructions count: 317
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.WU.A0M(int, long, long):void");
    }

    public final void A0N(int i2, String str) throws C0470Af {
        if (i2 == 134) {
            this.A0O.A0Y = str;
        } else if (i2 != 17026) {
            if (i2 != 2274716) {
            ...
            throw new C0470Af(A03(369, 8, 86) + str + A03(0, 14, 56));
        }
    }
    ...
    public final int ADU(InterfaceC0518Cd interfaceC0518Cd, C0521Cj c0521Cj) throws IOException, InterruptedException {
        ...
        boolean z = true;
        while (z && !this.A0V) {
            z = this.A0d.ADW(interfaceC0518Cd);
            if (z && A0E(c0521Cj, interfaceC0518Cd.A7E())) {
                return 1;
            }
        }
        if (z) {
    ...
    public final boolean AF0(InterfaceC0518Cd interfaceC0518Cd) throws IOException, InterruptedException {
        return new D0().A01(interfaceC0518Cd);
    }
}
