...
public final class IT implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new IR(C0676Iy.A0P(A04(0, 67, 11), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i2) {
        ...
        if (i2 == 1) {
            ...
            if (eglCreatePbufferSurface == null) {
                throw new IR(A04(90, 30, 124));
            }
        }
        if (!EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext)) {
            throw new IR(A04(SyslogConstants.LOG_LOCAL4, 21, 115));
        }
    ...
    public static void A06(int[] iArr) {
        ...
        throw new IR(A04(181, 29, 47) + Integer.toHexString(errorCode));
    }

    public final SurfaceTexture A07() {
        return (SurfaceTexture) IJ.A01(this.A00);
    }
    ...
    public final void A09(int i2) {
        ...
        this.A01 = A01(this.A02, A00, i2);
        this.A03 = A03(this.A02, A00, this.A01, i2);
        A06(this.A05);
