...
public final class C0601Fz extends AbstractC1329dd {
    ...
    static {
        A06();
        A04 = C0601Fz.class.getSimpleName();
    }

    public C0601Fz(C1046Xo c1046Xo, InterfaceC0684Jg interfaceC0684Jg, String str, Uri uri, Map<String, String> map, @Nullable C02340m c02340m, boolean z) {
    ...
    @Nullable
    private Intent A00(C02330k c02330k) {
        if (!TextUtils.isEmpty(c02330k.A05()) && C0744Lt.A04(((AbstractC02280f) this).A00, c02330k.A05())) {
            String A032 = c02330k.A03();
            ...
            PackageManager packageManager = ((AbstractC02280f) this).A00.getPackageManager();
            if (packageManager == null) {
                return null;
            }
            if (TextUtils.isEmpty(c02330k.A04()) && TextUtils.isEmpty(A032)) {
                return packageManager.getLaunchIntentForPackage(c02330k.A05());
            }
            Intent A01 = A01(c02330k);
    ...
    private Intent A01(C02330k c02330k) {
        Intent intent = new Intent(A03(88, 26, 38));
        intent.addFlags(268435456);
        if (!TextUtils.isEmpty(c02330k.A05()) && !TextUtils.isEmpty(c02330k.A04())) {
            intent.setComponent(new ComponentName(c02330k.A05(), c02330k.A04()));
        }
        if (!TextUtils.isEmpty(c02330k.A03())) {
            intent.setData(Uri.parse(c02330k.A03()));
        }
        return intent;
    }
    ...
    */
    private java.util.List<com.facebook.ads.redexgen.X.C02330k> A04() {
        /*
            r8 = this;
        ...
        L41:
            ...
            com.facebook.ads.redexgen.X.0k r0 = com.facebook.ads.redexgen.X.C02330k.A00(r0)     // Catch: org.json.JSONException -> L57
            if (r0 == 0) goto L54
        ...
        L57:
            r6 = move-exception
            com.facebook.ads.redexgen.X.Xo r0 = r8.A00
            com.facebook.ads.redexgen.X.8y r5 = r0.A06()
            int r4 = com.facebook.ads.redexgen.X.C04398z.A1t
            ...
            java.lang.String r0 = A03(r2, r1, r0)
            r5.A8y(r0, r4, r3)
            java.lang.String r3 = com.facebook.ads.redexgen.X.C0601Fz.A04
            r2 = 0
            r1 = 26
            r0 = 10
            java.lang.String r0 = A03(r2, r1, r0)
        ...
        L7f:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0601Fz.A04():java.util.List");
    }

    private final List<Intent> A05() {
        List<C02330k> A042 = A04();
        ArrayList arrayList = new ArrayList();
        if (A042 != null) {
            for (C02330k c02330k : A042) {
                Intent intent = A00(c02330k);
                if (intent != null) {
    ...
    private boolean A07() {
        ...
        for (Intent intent : A05) {
            try {
                result = LL.A0B(((AbstractC02280f) this).A00, intent);
    ...
    private boolean A08() {
        LV lv = new LV();
        try {
            LV.A0A(lv, ((AbstractC02280f) this).A00, A02(), this.A02);
            return true;
        } catch (Exception unused) {
            String str = A03(26, 27, 35) + this.A00.toString();
            String queryParameter = this.A00.getQueryParameter(A03(228, 22, 18));
            if (queryParameter != null && queryParameter.length() > 0) {
                LV.A0A(lv, ((AbstractC02280f) this).A00, Uri.parse(queryParameter), this.A02);
                return false;
            }
            return false;
        }
