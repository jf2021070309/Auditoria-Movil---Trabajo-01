...
public final class C0594Fs {
    ...
    public final synchronized int A09(AZ az, C1024Ws c1024Ws, boolean z, boolean z2, Format format, C0593Fr c0593Fr) {
        if (!A0I()) {
            if (z2) {
                c1024Ws.A02(4);
                return -4;
        ...
        if (z || this.A0G[A00] != format) {
            ...
            c1024Ws.A00 = this.A0F[A00];
            c1024Ws.A02(this.A0B[A00]);
            c0593Fr.A00 = this.A0C[A00];
            c0593Fr.A01 = this.A0E[A00];
            c0593Fr.A02 = this.A0H[A00];
            this.A03++;
            return -4;
        }
    }
    ...
    public final long A0C(int i2) {
        int A00;
        int A06 = A06() - i2;
        IJ.A03(A06 >= 0 && A06 <= this.A02 - this.A03);
        this.A02 -= A06;
    ...
    public final synchronized void A0G(long j2, int i2, long j3, int i3, C0524Cn c0524Cn) {
        if (this.A0A) {
            if ((i2 & 1) == 0) {
                return;
            }
        ...
        if (this.A02 == this.A01) {
            ...
            C0524Cn[] c0524CnArr = new C0524Cn[i4];
            ...
            C0524Cn[] c0524CnArr2 = this.A0H;
            int beforeWrap5 = this.A04;
            System.arraycopy(c0524CnArr2, beforeWrap5, c0524CnArr, 0, i5);
            ...
            System.arraycopy(this.A0H, 0, c0524CnArr, i5, i6);
    ...
    public final synchronized boolean A0K(Format format) {
        ...
        this.A09 = false;
        if (C0676Iy.A0g(format, this.A08)) {
            return false;
        }
        this.A08 = format;
        return true;
