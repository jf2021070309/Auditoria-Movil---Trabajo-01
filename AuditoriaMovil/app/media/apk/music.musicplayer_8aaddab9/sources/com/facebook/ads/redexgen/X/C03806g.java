...
public final class C03806g {
    ...
    public C03806g(int i2, int i3, int i4, float[] fArr, float f2, float f3, float f4) {
        this.A05 = i2;
        this.A03 = i3;
        this.A04 = i4;
        this.A06 = fArr;
    ...
    public final boolean A0B(C03806g c03806g) {
        if (A05() == c03806g.A05() && A03() == c03806g.A03() && A04() == c03806g.A04()) {
            float abs = Math.abs(A08()[0] - c03806g.A08()[0]);
            String[] strArr = A08;
            if (strArr[0].charAt(29) != strArr[3].charAt(29)) {
                String[] strArr2 = A08;
                strArr2[6] = "Q56kdX7pfJkTmJKAWug";
                strArr2[4] = "SmNIYc6TXNif2amUYYL";
                if (abs < C6C.A01() && Math.abs(A08()[1] - c03806g.A08()[1]) < C6C.A01()) {
                    int i2 = (Math.abs(A02() - c03806g.A02()) > C6C.A01() ? 1 : (Math.abs(A02() - c03806g.A02()) == C6C.A01() ? 0 : -1));
                    String[] strArr3 = A08;
                    ...
                    if (i2 < 0 && Math.abs(A01() - c03806g.A01()) < C6C.A01() && Math.abs(A00() - c03806g.A00()) < C6C.A01()) {
                        return true;
                    }
                }
            } else {
