...
public final class C5I implements InterstitialAdApi, Repairable {
    ...
    public static void A01() {
        A05 = new byte[]{-29, -25, -30, -27, 20, -33, -24, -30, -71, -22, -24, -70, -23, -75, -75, -70, 37, 31, 34, 34, 31, 85, 82, 37, -49, -12, -6, -21, -8, -12, -25, -14, -90, -21, -8, -8, -11, -8, -76, -112, -29, 8, 14, -1, 12, 13, 14, 3, 14, 3, -5, 6, -70, -5, -2, -70, -2, -1, 13, 14, 12, 9, 19, -1, -2, -56, -19, -13, -28, -15, -14, -13, -24, -13, -24, -32, -21, -97, -32, -29, -97, -21, -18, -32, -29, -97, -15, -28, -16, -12, -28, -14, -13, -28, -29, -18, 19, 25, 10, 23, 24, 25, 14, 25, 14, 6, 17, -59, 6, 9, -59, 24, 13, 20, 28, -59, 8, 6, 17, 17, 10, 9, -10, -9, 5, 6, 4, 1, 11, -28, -17, -52, -17, -31, -28, -63, -28, 49, 38, 45, 53};
    }
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, @Nullable String str, boolean z) {
        KU.A05(A00(129, 8, 2), A00(65, 30, 1), A00(16, 8, 113));
        if (str == null) {
            this.A04.A0D().A2d();
        } else {
            this.A04.A0D().A2c();
    ...
    public final void destroy() {
        KU.A05(A00(122, 7, 20), A00(40, 25, 28), A00(8, 8, 7));
        if (JQ.A1U(this.A04)) {
            return;
        }
        this.A03.A05();
    ...
    public final void repair(Throwable th) {
        if (this.A02.A02() != null) {
            ...
            A02.onError(interstitialAd, new AdError(AdError.INTERNAL_ERROR_CODE, A00(24, 16, 8) + M3.A03(this.A04, th)));
        }
    }
    ...
    public final boolean show() {
        KU.A05(A00(137, 4, 64), A00(95, 27, 39), A00(0, 8, 49));
        this.A04.A0D().A2m();
