...
public final class C02661s {
    ...
    public static AdSettings.IntegrationErrorMode A00(C1046Xo c1046Xo) {
        ...
        if (integrationErrorMode == AdSettings.IntegrationErrorMode.INTEGRATION_ERROR_CRASH_DEBUG_MODE && !A03(c1046Xo)) {
    ...
    public static boolean A03(C1046Xo c1046Xo) {
        return (c1046Xo.getApplicationInfo().flags & 2) != 0;
    }
}
