...
public final class C04599u {
     ...
     */
    public final synchronized C9l A06(int i2, byte[] bArr, int i3, int[] iArr, int i4) throws IOException {
        C04589t A00 = A00();
        boolean z = false;
        int i5 = 1;
        if (i2 >= 0) {
            ...
            if (i6 <= i2) {
                return new C9l(z ? EnumC04509k.A03 : EnumC04509k.A04, i2, i2, 0);
            }
            A00.A02.seek(j2);
            A00.A02.read(bArr, i3, i7);
            return new C9l(EnumC04509k.A02, i2, i6, i7);
        }
    ...
    public C04599u(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C04589t.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 30), file.getCanonicalPath()));
        }
    }

    private C04589t A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C04589t.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i2, long j2) throws IOException {
        this.A00.A03[i2] = j2;
        this.A00.A02.seek(C04589t.A02(i2));
    ...
    public final synchronized void A08() throws IOException {
        if (!this.A01) {
            A07();
            if (!this.A02.delete()) {
                throw new IOException(String.format(Locale.US, A01(0, 25, SyslogConstants.LOG_CLOCK), this.A02.getCanonicalPath()));
            }
        } else {
            throw new IOException(A01(86, 28, 15));
        }
