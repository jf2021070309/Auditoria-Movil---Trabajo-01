...
public final class C03695u {
    ...
    public static C03685t A00(ContentResolver contentResolver) {
        ...
        try {
            ...
            if (query == null || !query.moveToFirst()) {
                C03685t c03685t = new C03685t(null, null, false);
                if (query != null) {
                    query.close();
                }
                return c03685t;
            ...
            C03685t c03685t2 = new C03685t(string, advertisingId, Boolean.valueOf(query.getString(query.getColumnIndex(A012))).booleanValue());
            query.close();
            return c03685t2;
        } catch (Throwable th) {
            if (0 != 0) {
