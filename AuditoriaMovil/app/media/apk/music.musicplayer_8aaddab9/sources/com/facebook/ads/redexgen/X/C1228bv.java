...
public class C1228bv implements InterfaceC03143q {
    ...
    public C1228bv(F6 f6) {
        this.A00 = f6;
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC03143q
    public final void A3S(View view, int i2, ViewGroup.LayoutParams layoutParams) {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC03143q
    public final void A4l(int i2) {
        AbstractC03344l A0G;
        View A5y = A5y(i2);
        if (A5y != null && (A0G = F6.A0G(A5y)) != null) {
            if (!A0G.A0e() || A0G.A0h()) {
                A0G.A0T(256);
            } else {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC03143q
    public final AbstractC03344l A62(View view) {
        return F6.A0G(view);
    }
