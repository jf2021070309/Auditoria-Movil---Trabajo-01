...
public final class C0712Kk {
    public static C0712Kk A00;
    ...
    public static synchronized C0712Kk A00() {
        C0712Kk c0712Kk;
        synchronized (C0712Kk.class) {
            c0712Kk = A00;
        }
        return c0712Kk;
    }
    ...
    */
    private com.facebook.ads.redexgen.X.C0946To A01(com.facebook.ads.redexgen.X.C1046Xo r11, org.json.JSONObject r12, long r13) throws org.json.JSONException {
        /*
            r10 = this;
            ...
            com.facebook.ads.redexgen.X.9I r6 = com.facebook.ads.redexgen.X.C9I.A00(r0)
        ...
        L59:
            ...
            r0 = 0
            com.facebook.ads.redexgen.X.C0694Jq.A06(r11, r9, r13, r0)
            r2 = 19
            r1 = 7
            r0 = 39
            java.lang.String r0 = A04(r2, r1, r0)
        ...
        Lc1:
            ...
            com.facebook.ads.redexgen.X.To r0 = new com.facebook.ads.redexgen.X.To
            r0.<init>(r5, r1)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0712Kk.A01(com.facebook.ads.redexgen.X.Xo, org.json.JSONObject, long):com.facebook.ads.redexgen.X.To");
    }

    private C0945Tn A02(JSONObject jSONObject) {
        return new C0945Tn(jSONObject.optString(A04(117, 7, 88), A04(0, 0, 87)), jSONObject.optInt(A04(47, 4, 116), 0), null);
    }

    private C0945Tn A03(JSONObject jSONObject) {
        try {
            JSONObject jSONObject2 = jSONObject.getJSONArray(A04(124, 10, 18)).getJSONObject(0);
            C9I A002 = C9I.A00(jSONObject2.getJSONObject(A04(88, 10, 63)));
            String optString = jSONObject2.optString(A04(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 14, 70));
            ...
            return new C0945Tn(optString3, jSONObject.optInt(adReportingConfig2, 0), new C9H(A002, optString, optString2));
        } catch (JSONException unused) {
            return A02(jSONObject);
        }
    }

    public final C0714Km A06(C1046Xo c1046Xo, String str, long j2) throws JSONException {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (c2 == 0) {
                return A01(c1046Xo, jSONObject, j2);
            }
            if (c2 != 1) {
        ...
        return new C0714Km(EnumC0713Kl.A04);
    }
}
