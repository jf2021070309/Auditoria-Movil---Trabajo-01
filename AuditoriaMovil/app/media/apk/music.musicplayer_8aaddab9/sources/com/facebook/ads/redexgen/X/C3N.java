...
public class C3N {
    ...
    public void A03(ViewParent viewParent, View view) {
        if (viewParent instanceof InterfaceC02902r) {
    ...
    public boolean A07(ViewParent viewParent, View view, float f2, float f3) {
        if (viewParent instanceof InterfaceC02902r) {
            return ((InterfaceC02902r) viewParent).onNestedPreFling(view, f2, f3);
        }
        String[] strArr = A01;
    ...
    public boolean A08(ViewParent viewParent, View view, float f2, float f3, boolean z) {
        if (viewParent instanceof InterfaceC02902r) {
            return ((InterfaceC02902r) viewParent).onNestedFling(view, f2, f3, z);
        }
        return false;
    }
    ...
    public boolean A09(ViewParent viewParent, View view, View view2, int i2) {
        if (viewParent instanceof InterfaceC02902r) {
            return ((InterfaceC02902r) viewParent).onStartNestedScroll(view, view2, i2);
        }
        return false;
    }
}
