...
public final class IS implements QM {
    ...
    public QL A01 = QL.A05;
    public final int A02;
    public final View A03;
    public final boolean A04;

    public IS(View view, int i2, boolean z) {
        this.A02 = i2;
        this.A03 = view;
        this.A04 = z;
    }
    ...
    private void A04(boolean z) {
        ...
        this.A00 = this.A03.animate().alpha(1.0f).setDuration(this.A02).setListener(new QQ(this));
    }

    private void A05(boolean z) {
        this.A01 = QL.A06;
        if (z) {
            this.A00 = this.A03.animate().alpha(0.0f).setDuration(this.A02).setListener(new QR(this));
            return;
        }
        View view = this.A03;
