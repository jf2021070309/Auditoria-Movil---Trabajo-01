...
public final class V0 implements InterfaceC0632He {
    ...
    public final long ACt(C0636Hi c0636Hi) throws IOException {
        ...
        if (A00(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 4, 62).equals(scheme)) {
            String[] A0l = C0676Iy.A0l(uri.getSchemeSpecificPart(), A00(0, 1, 18));
            if (A0l.length == 2) {
                ...
                if (strArr[4].length() != strArr[0].length()) {
                    ...
                    if (str.contains(A00(1, 7, 106))) {
                        try {
                            ...
                            throw new C0470Af(A00(8, 43, 126) + dataString, e2);
                        }
                    } else {
            ...
            throw new C0470Af(A00(59, 23, 21) + uri);
        }
        throw new C0470Af(A00(82, 20, 99) + scheme);
    }
