...
public abstract class AbstractC1340dp implements C0B {
    public static byte[] A01;
    public static String[] A02 = {"0PvfoUFANCVNmnYZfPoejD6ohCtuxysE", "CTVBuEwwodohpQOP7b4j4", "9BgxiAbaVpMmFPJgyPUrG0VpyjL4diCu", "0p8mXLPxFyBv4phdqx8YrWMD1W9nJbZf", "G0yvPsPNC2vYmeMn8hYLEKyQ1tXXfhoe", "IW3zcZDApc8b2NyXBv", "Oqr2oLquorC4BSN9LXFNL8a9XNzmbM1Z", GoogleApiAvailabilityLight.TRACKING_SOURCE_NOTIFICATION};
    ...
    public abstract boolean A08(File file, long j2, int i2);

    static {
        A04();
        A03 = AbstractC1340dp.class.getSimpleName();
    }
        ...
        for (File file : list) {
            ...
            if (!A08(file, A022, size)) {
                ...
                if (file.delete()) {
                    size--;
                    A022 -= length;
                    Log.i(A03, A03(61, 11, 10) + file + A03(19, 42, SyslogConstants.LOG_CLOCK));
                } else {
    ...
    public void AFH(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC1340dp.this.A06(this.A00);
                return null;
            }
        });
    }
