...
public final class C1W implements Serializable {
    ...
    public C1W(String str, String str2, int i2, String str3, String str4, OB ob, int i3, boolean z, boolean z2, C1X c1x, boolean z3, String str5) {
        if (z3) {
    ...
    public static int A00(JSONObject jSONObject) {
        ...
        return jSONObject.optInt(A03(263, 19, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH), 0);
    }
    ...
    public static C1W A01(JSONObject jSONObject) {
        ...
        return new C1W(optJSONObject.optString(A03(282, 3, 72)), optJSONObject.optString(A03(143, 19, 61)), A00(jSONObject), A05(optJSONObject), A04(optJSONObject), A02(optJSONObject), optJSONObject.optInt(A03(285, 32, 0), Level.TRACE_INT), optJSONObject.optBoolean(A03(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 17, 87), true), optJSONObject.optBoolean(A03(88, 15, 37)), C1X.A00(optJSONObject.optString(A03(211, 17, 50), A0F.name())), optJSONObject.optBoolean(A03(162, 25, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION)), jSONObject.optString(A03(70, 2, 71)));
    }

    public static OB A02(JSONObject jSONObject) {
        return OB.A00(jSONObject.optInt(A03(187, 11, 74), A0G.A03()));
    }

    public static String A04(JSONObject jSONObject) {
        JSONObject genericTextObject = jSONObject.optJSONObject(A03(SyslogConstants.LOG_CLOCK, 12, 5));
        String A03 = A03(0, 45, 90);
        return genericTextObject == null ? A03 : genericTextObject.optString(A03(72, 16, 125), A03);
    }

    public static String A05(JSONObject jSONObject) {
        JSONObject genericTextObject = jSONObject.optJSONObject(A03(SyslogConstants.LOG_CLOCK, 12, 5));
        String A03 = A03(45, 13, 101);
        return genericTextObject == null ? A03 : genericTextObject.optString(A03(228, 18, 6), A03);
    }
