...
public final class E0 {
                        ...
                        if (strArr3[0].length() != strArr3[5].length()) {
                            ...
                            if (!A03.equals(str2) && !A03(172, 15, 105).equals(str2) && !A03(187, 15, 4).equals(str2) && !A03(202, 9, 47).equals(str2)) {
                                if (A03(131, 9, 31).equals(str2)) {
                                    i3 = 6;
                                } else if (A03(SyslogConstants.LOG_LOCAL3, 10, 45).equals(str2)) {
                                    i3 = 16;
                                } else {
                                    i3 = 30;
                                }
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0676Iy.A02 >= 21 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0676Iy.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public final Point A0E(int widthAlignment, int heightAlignment) {
        ...
        return new Point(C0676Iy.A04(widthAlignment, widthAlignment2) * widthAlignment2, C0676Iy.A04(heightAlignment, heightAlignment2) * heightAlignment2);
    }
    ...
    public final boolean A0I(String codecMimeType) {
        String A05;
        if (codecMimeType == null || this.A01 == null || (A05 = C0653Ib.A05(codecMimeType)) == null) {
            return true;
        }
        ...
        if (A08[7].charAt(21) != 'h') {
            ...
            A06(A03(335, 20, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH) + codecMimeType + A03 + A05);
            return false;
        }
        throw new RuntimeException();
    }
