...
public enum AdErrorType {
    ...
    NO_FILL(1001, A00(2103, 7, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH), true),
    LOAD_TOO_FREQUENTLY(1002, A00(261, 31, 74), true),
    DISABLED_APP(1005, A00(368, 39, 20), true),
    SERVER_ERROR(2000, A00(2209, 12, 94), true),
    INTERNAL_ERROR(AdError.INTERNAL_ERROR_CODE, A00(1620, 14, 50), true),
    CACHE_FAILURE_ERROR(AdError.CACHE_ERROR_CODE, A00(2124, 19, 38), true),
    START_BEFORE_INIT(2005, A00(2528, 36, 24), true),
    REMOTE_ADS_SERVICE_ERROR(AdError.REMOTE_ADS_SERVICE_ERROR, A00(343, 25, 28), true),
    INTERSTITIAL_AD_TIMEOUT(AdError.INTERSTITIAL_AD_TIMEOUT, A00(2221, 31, SyslogConstants.LOG_CLOCK), true),
    ...
    NO_MEDIAVIEW_IN_NATIVEBANNERAD(AdError.ICONVIEW_MISSING_ERROR_CODE, A00(1847, 47, FacebookMediationAdapter.ERROR_NULL_CONTEXT), true),
    ...
    AdErrorType(int i2, String str, boolean z) {
        this.A00 = i2;
        this.A01 = str;
        this.A02 = z;
    }
