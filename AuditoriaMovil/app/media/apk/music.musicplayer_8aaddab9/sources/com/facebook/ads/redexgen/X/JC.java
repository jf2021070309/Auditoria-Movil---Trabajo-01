...
public final class JC {
    ...
    public JC(@Nullable Context context) {
        if (context != null) {
        ...
        if (this.A09 != null) {
            this.A0A = C0676Iy.A02 >= 17 ? A01(context) : null;
            this.A0B = JB.A00();
        } else {
            this.A0A = null;
            this.A0B = null;
    ...
    public final long A07(long j2, long j3) {
        ...
        this.A03 = j5;
        JB jb = this.A0B;
        if (jb == null || this.A06 == -9223372036854775807L) {
