...
public abstract class AbstractC1331df<T> implements C0X<T> {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.df != com.facebook.ads.funnel.FunnelParamType$AbstractFunnelParamType<T> */
    public AbstractC1331df(String str) {
        this.A00 = str;
    }
