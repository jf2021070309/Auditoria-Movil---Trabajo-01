...
public class C04589t {
    ...
    public C04589t(RandomAccessFile randomAccessFile, long[] jArr, long j2) throws IOException {
    ...
    public static C04589t A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(416, 3, 41));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C04599u.A03);
            randomAccessFile.write(new byte[C04599u.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C04589t(randomAccessFile, new long[C04599u.A03], randomAccessFile.length());
    ...
    */
    public static com.facebook.ads.redexgen.X.C04589t A04(java.io.File r12) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 284
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C04589t.A04(java.io.File):com.facebook.ads.redexgen.X.9t");
    }
