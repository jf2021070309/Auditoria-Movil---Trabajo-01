...
public final class LH {
    ...
    public static LG A00() throws ClassNotFoundException, NoSuchMethodException, NoSuchFieldException, InvocationTargetException, IllegalAccessException {
    ...
    public static LG A01(Context context) {
        try {
    ...
    public static LG A02(Context context) {
        if (context == null) {
            return LG.A0C;
        }
