...
public class C1199bR extends AbstractC02922t {
    ...
    public C1199bR(C5N c5n) {
        this.A01 = c5n;
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC02922t
    ...
    public final Object A08(ViewGroup viewGroup, int i2) {
        ...
        if (adViewProvider != null) {
            ...
            type = this.A01.A02;
            if (type != null) {
                c1046Xo2 = this.A01.A06;
                type2 = this.A01.A02;
                nativeAdViewAttributes2 = this.A01.A03;
                render = NativeAdView.render(c1046Xo2, this.A00.get(i2), type2, nativeAdViewAttributes2);
            } else {
                c1046Xo = this.A01.A06;
                nativeAdViewAttributes = this.A01.A03;
                render = NativeAdView.render(c1046Xo, this.A00.get(i2), nativeAdViewAttributes);
            }
        }
    ...
    public final void A0D() {
        ...
        for (int i3 = 0; i3 < min; i3++) {
            ...
            U1.A0L(nextNativeAd.getInternalNativeAd()).A1b(true);
