...
public final class C02952w extends AbstractC0504Bo {
    ...
    public C02952w(@Nullable List<byte[]> list) {
        super(A02(182, 10, 127));
        if (list != null && !list.isEmpty()) {
            this.A04 = true;
            String A0Q = C0676Iy.A0Q(list.get(0));
            IJ.A03(A0Q.startsWith(A02(47, 8, 70)));
            A06(A0Q);
            A04(new C0660Ii(list.get(1)));
            return;
        }
        this.A04 = false;
    }
    ...
    public static long A00(String str) {
        ...
        return parseLong + (timestampUs2 * 1000000) + (Long.parseLong(matcher.group(4)) * AbstractComponentTracker.LINGERING_TIMEOUT);
    }

    /* JADX INFO: Access modifiers changed from: private */
    @Override // com.facebook.ads.redexgen.X.AbstractC0504Bo
    /* renamed from: A01 */
    public final VC A0b(byte[] bArr, int i2, boolean z) {
        ...
        A05(c0660Ii, arrayList, iy);
        GX[] gxArr = new GX[arrayList.size()];
        arrayList.toArray(gxArr);
        return new VC(gxArr, iy.A05());
    }

    private void A04(C0660Ii c0660Ii) {
        String A0P;
        do {
            A0P = c0660Ii.A0P();
            if (A0P == null) {
    ...
    private void A05(C0660Ii c0660Ii, List<GX> list, IY iy) {
        while (true) {
    ...
    */
    private void A06(java.lang.String r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C02952w.A06(java.lang.String):void");
    }

    private void A07(String str, List<GX> list, IY iy) {
        int i2 = this.A01;
        ...
        if (split.length != this.A01) {
            Log.w(A02, A02(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 55, 76) + str);
            return;
        }
        ...
        list.add(new GX(replaceAll.replaceAll(A02(200, 3, 92), A023).replaceAll(A02(203, 3, 123), A023)));
        iy.A04(A00);
        if (endTimeUs != -9223372036854775807L) {
            list.add(null);
            iy.A04(endTimeUs);
