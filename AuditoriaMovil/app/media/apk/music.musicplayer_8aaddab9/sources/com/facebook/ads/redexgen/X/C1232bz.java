...
public class C1232bz extends AbstractC03294g {
    ...
    public C1232bz(Context context) {
    ...
    private final int A03(View view, int top) {
        ...
        int start = A08.A0o(view) - c4u.topMargin;
        int end = A08.A0j(view) + c4u.bottomMargin;
        return A0N(start, end, A08.A0g(), A08.A0X() - A08.A0d(), top);
    }

    private final void A07(C03274e c03274e) {
        PointF A0P = A0P(A07());
        ...
        c03274e.A04((int) (this.A00 * 1.2f), (int) (this.A01 * 1.2f), (int) (A0L(10000) * 1.2f), this.A05);
    }

    @Override // com.facebook.ads.redexgen.X.AbstractC03294g
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC03294g
    public final void A0H(int i2, int i3, C03314i c03314i, C03274e c03274e) {
        if (A06() == 0) {
            A09();
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC03294g
    public void A0I(View view, C03314i c03314i, C03274e c03274e) {
        int A0O = A0O(view, A0K());
        int A03 = A03(view, A00());
        int A0M = A0M((int) Math.sqrt((A0O * A0O) + (A03 * A03)));
        if (A0M > 0) {
            c03274e.A04(-A0O, -A03, A0M, this.A04);
        }
    }
    ...
    public PointF A0P(int i2) {
        C4T A08 = A08();
        if (A08 instanceof InterfaceC03284f) {
            return ((InterfaceC03284f) A08).A44(i2);
        }
        Log.w(A04(0, 20, 70), A04(20, 93, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION) + InterfaceC03284f.class.getCanonicalName());
        return null;
    }
}
