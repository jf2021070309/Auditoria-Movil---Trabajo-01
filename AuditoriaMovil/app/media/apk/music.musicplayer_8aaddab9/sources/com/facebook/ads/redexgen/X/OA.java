...
public final class OA {
    ...
    public OA(Map<String, String> extraData) {
        this.A00 = extraData;
    }

    public final OA A02(@Nullable MD md) {
        if (md != null) {
            this.A00.put(A00(11, 5, 0), C0743Ls.A01(md.A04()));
        }
        return this;
    }

    public final OA A03(@Nullable C0869Qp c0869Qp) {
        if (c0869Qp != null) {
            this.A00.putAll(c0869Qp.A0S());
        }
        return this;
    }

    public final OA A04(@Nullable String str) {
