...
public final class D8 {
    ...
    static {
        A0J();
        A08 = C0676Iy.A08(A0I(696, 4, 97));
        A05 = C0676Iy.A08(A0I(662, 4, 88));
        A07 = C0676Iy.A08(A0I(692, 4, 90));
        A04 = C0676Iy.A08(A0I(636, 4, 39));
        A06 = C0676Iy.A08(A0I(666, 4, 31));
        A02 = C0676Iy.A08(A0I(606, 4, 0));
        A03 = C0676Iy.A08(A0I(632, 4, 95));
    }

    public static float A00(C0660Ii c0660Ii, int i2) {
        c0660Ii.A0Y(i2 + 8);
        return c0660Ii.A0H() / c0660Ii.A0H();
    }

    public static int A01(C0660Ii c0660Ii) {
        int size = c0660Ii.A0E();
        int i2 = size & 127;
        while ((size & 128) == 128) {
            size = c0660Ii.A0E();
            i2 = (i2 << 7) | (size & 127);
    ...
    public static int A02(C0660Ii c0660Ii) {
        c0660Ii.A0Y(16);
    ...
    public static int A03(C0660Ii c0660Ii, int i2, int i3) {
        int A062 = c0660Ii.A06();
        while (A062 - i2 < i3) {
            c0660Ii.A0Y(A062);
            int A082 = c0660Ii.A08();
            IJ.A05(A082 > 0, A0I(574, 32, 45));
            if (c0660Ii.A08() == D3.A0S) {
                return A062;
            }
            A062 += A082;
        }
    ...
    public static long A04(C0660Ii c0660Ii) {
        int fullAtom = 8;
        c0660Ii.A0Y(8);
    ...
    */
    public static android.util.Pair<long[], long[]> A05(com.facebook.ads.redexgen.X.WQ r9) {
        /*
            if (r9 == 0) goto La
            int r0 = com.facebook.ads.redexgen.X.D3.A0O
            com.facebook.ads.redexgen.X.WP r0 = r9.A07(r0)
            if (r0 != 0) goto L10
        La:
            r0 = 0
            ...
            return r0
        L10:
            com.facebook.ads.redexgen.X.Ii r8 = r0.A00
            r0 = 8
            r8.A0Y(r0)
            int r0 = r8.A08()
        ...
        L96:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.D8.A05(com.facebook.ads.redexgen.X.WQ):android.util.Pair");
    }

    public static Pair<Long, String> A06(C0660Ii c0660Ii) {
        c0660Ii.A0Y(8);
        int A012 = D3.A01(c0660Ii.A08());
    ...
    public static Pair<String, byte[]> A07(C0660Ii c0660Ii, int i2) {
        c0660Ii.A0Y(i2 + 8 + 4);
        c0660Ii.A0Z(1);
        A01(c0660Ii);
        c0660Ii.A0Z(2);
    ...
    public static Pair<Integer, DP> A08(C0660Ii c0660Ii, int schemeInformationBoxPosition, int schemeInformationBoxSize) {
        ...
        while (true) {
            ...
            if (i4 < schemeInformationBoxSize) {
                c0660Ii.A0Y(i2);
                int A082 = c0660Ii.A08();
                int A083 = c0660Ii.A08();
                if (A083 == D3.A0T) {
                    num = Integer.valueOf(c0660Ii.A08());
                } else if (A083 == D3.A0z) {
                    c0660Ii.A0Z(4);
                    str = c0660Ii.A0S(4);
                } else if (A083 == D3.A0y) {
                ...
                i2 += A082;
            } else if (A0I(566, 4, 31).equals(str) || A0I(558, 4, 36).equals(str) || A0I(570, 4, SyslogConstants.LOG_ALERT).equals(str) || A0I(562, 4, 123).equals(str)) {
                boolean z = true;
                IJ.A05(num != null, A0I(610, 22, 33));
                IJ.A05(i3 != -1, A0I(640, 22, 40));
                DP A0D = A0D(c0660Ii, i3, childAtomSize, str);
                if (A0D == null) {
                    z = false;
                }
                IJ.A05(z, A0I(670, 22, 79));
    ...
    public static Pair<Integer, DP> A09(C0660Ii c0660Ii, int i2, int i3) {
        Pair<Integer, DP> A082;
        int A062 = c0660Ii.A06();
        while (A062 - i2 < i3) {
            c0660Ii.A0Y(A062);
            int A083 = c0660Ii.A08();
            IJ.A05(A083 > 0, A0I(574, 32, 45));
            if (c0660Ii.A08() == D3.A13 && (A082 = A08(c0660Ii, A062, A083)) != null) {
                return A082;
            }
            A062 += A083;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.facebook.ads.redexgen.X.D6 A0A(com.facebook.ads.redexgen.X.C0660Ii r24, int r25, int r26, java.lang.String r27, com.facebook.ads.internal.exoplayer2.drm.DrmInitData r28, boolean r29) throws com.facebook.ads.redexgen.X.C0470Af {
        /*
            Method dump skipped, instructions count: 470
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.D8.A0A(com.facebook.ads.redexgen.X.Ii, int, int, java.lang.String, com.facebook.ads.internal.exoplayer2.drm.DrmInitData, boolean):com.facebook.ads.redexgen.X.D6");
    }

    public static D7 A0B(C0660Ii c0660Ii) {
        long A0M;
        int a11;
        c0660Ii.A0Y(8);
        int a00 = D3.A01(c0660Ii.A08());
        ...
        if (i2 != 0) {
            ...
            A0M = a00 == 0 ? c0660Ii.A0M() : c0660Ii.A0N();
        ...
        c0660Ii.A0Z(16);
        int fullAtom2 = c0660Ii.A08();
        int a002 = c0660Ii.A08();
        c0660Ii.A0Z(4);
        int trackId = c0660Ii.A08();
        int durationPosition = c0660Ii.A08();
    ...
    public static DO A0C(WQ wq, WP wp, long j2, DrmInitData drmInitData, boolean z, boolean z2) throws C0470Af {
        long A0F;
        int i2;
        int i3;
        int i4;
        long j3 = j2;
        WQ A062 = wq.A06(D3.A0d);
        int A022 = A02(A062.A07(D3.A0V).A00);
        if (A022 == -1) {
            return null;
        }
        WP A072 = wq.A07(D3.A1J);
        if (A01[3].charAt(8) != 'p') {
            throw new RuntimeException();
        }
        A01[2] = "QWUsjPBg";
        ...
        long A042 = A04(wp.A00);
        if (j3 == -9223372036854775807L) {
            A0F = -9223372036854775807L;
        } else {
            A0F = C0676Iy.A0F(j3, 1000000L, A042);
        }
        WQ A063 = A062.A06(D3.A0h).A06(D3.A16);
        Pair<Long, String> A064 = A06(A062.A07(D3.A0c).A00);
        C0660Ii c0660Ii = A063.A07(D3.A1A).A00;
        i2 = A0B.A00;
        i3 = A0B.A01;
        D6 A0A = A0A(c0660Ii, i2, i3, (String) A064.second, drmInitData, z2);
        long[] editListDurations = null;
        long[] jArr = null;
        if (!z) {
            Pair<long[], long[]> A052 = A05(wq.A06(D3.A0N));
            editListDurations = (long[]) A052.first;
            jArr = (long[]) A052.second;
        }
        if (A0A.A02 != null) {
            i4 = A0B.A00;
            return new DO(i4, A022, ((Long) A064.first).longValue(), A042, A0F, A0A.A02, A0A.A01, A0A.A03, A0A.A00, editListDurations, jArr);
        }
        return null;
    }

    public static DP A0D(C0660Ii c0660Ii, int childPosition, int i2, String str) {
        int constantIvSize = childPosition + 8;
        while (constantIvSize - childPosition < i2) {
            c0660Ii.A0Y(constantIvSize);
            int defaultCryptByteBlock = c0660Ii.A08();
            if (c0660Ii.A08() == D3.A1G) {
                int version = D3.A01(c0660Ii.A08());
                boolean z = true;
                c0660Ii.A0Z(1);
                int i3 = 0;
                ...
                c0660Ii.A0c(bArr, 0, defaultPerSampleIvSize);
                byte[] bArr2 = null;
                if (z && A0E == 0) {
                    int A0E2 = c0660Ii.A0E();
                    bArr2 = new byte[A0E2];
                    c0660Ii.A0c(bArr2, 0, A0E2);
                    if (A01[2].length() != 8) {
                        throw new RuntimeException();
                    }
                    A01[2] = "N18HcU44";
                }
                return new DP(z, str, A0E, bArr, i3, i4, bArr2);
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:130:0x03ac, code lost:
        ...
        r1 = (int) r5;
        r44.A01 = r1;
        com.facebook.ads.redexgen.X.C0676Iy.A0a(r13, 1000000, r0.A06);
     */
    /* JADX WARN: Code restructure failed: missing block: B:131:0x03cb, code lost:
        return new com.facebook.ads.redexgen.X.DR(r42, r19, r20, r18, r13, r21, r29);
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.facebook.ads.redexgen.X.DR A0E(com.facebook.ads.redexgen.X.DO r42, com.facebook.ads.redexgen.X.WQ r43, com.facebook.ads.redexgen.X.C0520Cg r44) throws com.facebook.ads.redexgen.X.C0470Af {
        /*
            Method dump skipped, instructions count: 1443
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.D8.A0E(com.facebook.ads.redexgen.X.DO, com.facebook.ads.redexgen.X.WQ, com.facebook.ads.redexgen.X.Cg):com.facebook.ads.redexgen.X.DR");
    }

    public static Metadata A0F(WP wp, boolean z) {
        if (z) {
            return null;
        }
        ...
        while (c0660Ii.A04() >= 8) {
            ...
            if (A083 == atomType) {
                c0660Ii.A0Y(A062);
                return A0H(c0660Ii, A062 + A082);
            }
            int atomType2 = A082 - 8;
            c0660Ii.A0Z(atomType2);
        }
        return null;
    }

    public static Metadata A0G(C0660Ii c0660Ii, int i2) {
        c0660Ii.A0Z(8);
        ArrayList arrayList = new ArrayList();
        while (c0660Ii.A06() < i2) {
            Metadata.Entry A012 = DG.A01(c0660Ii);
            if (A012 != null) {
                arrayList.add(A012);
            }
        }
    ...
    public static Metadata A0H(C0660Ii c0660Ii, int i2) {
        c0660Ii.A0Z(12);
        while (c0660Ii.A06() < i2) {
            int A062 = c0660Ii.A06();
            int A082 = c0660Ii.A08();
    ...
    public static void A0K(C0660Ii c0660Ii, int i2, int i3, int i4, int i5, int width, DrmInitData drmInitData, D6 d6, int childPosition) throws C0470Af {
        ...
        if (stereoMode == height) {
            Pair<Integer, DP> A09 = A09(c0660Ii, i3, i4);
            if (A09 != null) {
                ...
                d6.A03[childPosition] = (DP) A09.second;
            }
            c0660Ii.A0Y(A062);
        }
        List<byte[]> list = null;
        ...
        while (A062 - i3 < i4) {
            c0660Ii.A0Y(A062);
            int A063 = c0660Ii.A06();
            int A082 = c0660Ii.A08();
            if (A082 == 0 && c0660Ii.A06() - i3 == i4) {
                break;
            }
            IJ.A05(A082 > 0, A0I(574, 32, 45));
            int A083 = c0660Ii.A08();
            if (A083 == D3.A08) {
                ...
                IJ.A04(str == null);
                Pair<String, byte[]> A072 = A07(c0660Ii, A063);
        ...
        d6.A02 = Format.A04(Integer.toString(i5), str, null, -1, -1, A0I, A0I2, -1.0f, list, width, f2, bArr, i6, null, drmInitData2);
    }

    public static void A0L(C0660Ii c0660Ii, int i2, int i3, int i4, int i5, String str, D6 d6) throws C0470Af {
        String A0I;
        c0660Ii.A0Y(i3 + 8 + 8);
        List list = null;
        ...
        d6.A02 = Format.A09(Integer.toString(i5), A0I, null, -1, 0, str, -1, null, j2, list);
    }

    public static void A0M(C0660Ii c0660Ii, int i2, int i3, int i4, int channelCount, String str, boolean z, DrmInitData drmInitData, D6 d6, int i5) throws C0470Af {
        int childAtomType;
        int childPosition;
        int A032;
        DrmInitData drmInitData2 = drmInitData;
        ...
        if (i7 == 0 || i7 == 1) {
            childAtomType = c0660Ii.A0I();
            c0660Ii.A0Z(6);
            childPosition = c0660Ii.A0F();
            if (i7 == 1) {
                c0660Ii.A0Z(16);
            }
        } else if (i7 == 2) {
            c0660Ii.A0Z(16);
            childPosition = (int) Math.round(c0660Ii.A03());
            childAtomType = c0660Ii.A0H();
            c0660Ii.A0Z(20);
        } else {
            return;
        }
        int atomType = c0660Ii.A06();
        if (i6 == D3.A0Q) {
            Pair<Integer, DP> A09 = A09(c0660Ii, i3, i4);
            if (A09 != null) {
                ...
                d6.A03[i5] = (DP) A09.second;
            }
            c0660Ii.A0Y(atomType);
        }
        String str4 = null;
        if (i6 == D3.A04) {
            str4 = A0I(426, 9, 31);
        } else {
            int sampleRate2 = D3.A0M;
            if (i6 == sampleRate2) {
                str4 = A0I(457, 10, 8);
            } else {
                int sampleRate3 = D3.A0I;
                if (i6 == sampleRate3) {
                    str4 = A0I(501, 13, 63);
                } else {
                    int sampleRate4 = D3.A0K;
                    if (i6 != sampleRate4) {
                        int sampleRate5 = D3.A0L;
                        if (i6 != sampleRate5) {
                            int sampleRate6 = D3.A0J;
                            if (i6 == sampleRate6) {
                                str4 = A0I(530, 28, 10);
                            } else {
                                int sampleRate7 = D3.A0v;
                                if (i6 == sampleRate7) {
                                    str4 = A0I(416, 10, 25);
                                } else {
                                    int sampleRate8 = D3.A0w;
                                    if (i6 == sampleRate8) {
                                        str4 = A0I(445, 12, 124);
                                    } else {
                                        int sampleRate9 = D3.A0a;
                                        if (i6 != sampleRate9) {
                                            int sampleRate10 = D3.A14;
                                            if (i6 != sampleRate10) {
                                                int sampleRate11 = D3.A03;
                                                if (i6 == sampleRate11) {
                                                    str4 = A0I(482, 10, 92);
                                                } else {
                                                    int sampleRate12 = D3.A05;
                                                    if (i6 == sampleRate12) {
                                                        str4 = A0I(435, 10, 88);
                                                    }
                                                }
                    ...
                    str4 = A0I(SyslogConstants.SYSLOG_PORT, 16, 70);
                }
            }
        }
        byte[] bArr = null;
        while (atomType - i3 < i4) {
            ...
            IJ.A05(A082 > 0, A0I(574, 32, 45));
            int A083 = c0660Ii.A08();
            if (A083 == D3.A0S || (z && A083 == D3.A1V)) {
                if (A083 == D3.A0S) {
                    A032 = atomType;
                } else {
                    A032 = A03(c0660Ii, atomType, A082);
                }
                if (A032 != -1) {
                    Pair<String, byte[]> A072 = A07(c0660Ii, A032);
                    str4 = (String) A072.first;
                    bArr = (byte[]) A072.second;
                    if (A0I(467, 15, 48).equals(str4)) {
                        Pair<Integer, Integer> A033 = IN.A03(bArr);
                ...
                c0660Ii.A0Y(i8);
                d6.A02 = BA.A07(c0660Ii, Integer.toString(channelCount), str, drmInitData2);
            } else if (A083 == D3.A0H) {
                c0660Ii.A0Y(atomType + 8);
                d6.A02 = BA.A08(c0660Ii, Integer.toString(channelCount), str, drmInitData2);
            } else if (A083 == D3.A0G) {
                d6.A02 = Format.A07(Integer.toString(channelCount), str4, null, -1, -1, childAtomType, childPosition, null, drmInitData2, 0, str);
            } else if (A083 == D3.A05) {
                bArr = new byte[A082];
                c0660Ii.A0Y(atomType);
                c0660Ii.A0c(bArr, 0, A082);
            }
            atomType += A082;
        }
        if (d6.A02 != null || str4 == null) {
            return;
        }
        int i9 = A0I(492, 9, 89).equals(str4) ? 2 : -1;
        String mimeType = Integer.toString(channelCount);
        d6.A02 = Format.A06(mimeType, str4, null, -1, -1, childAtomType, childPosition, i9, bArr != null ? Collections.singletonList(bArr) : null, drmInitData2, 0, str);
    }

    public static boolean A0N(long[] jArr, long j2, long j3, long j4) {
        int length = jArr.length - 1;
        int latestDelayIndex = C0676Iy.A06(3, 0, length);
        return jArr[0] <= j3 && j3 < jArr[latestDelayIndex] && jArr[C0676Iy.A06(jArr.length - 3, 0, length)] < j4 && j4 <= j2;
    }

    public static byte[] A0O(C0660Ii c0660Ii, int i2, int i3) {
        int i4 = i2 + 8;
        while (i4 - i2 < i3) {
            c0660Ii.A0Y(i4);
            int A082 = c0660Ii.A08();
            if (c0660Ii.A08() == D3.A0q) {
                return Arrays.copyOfRange(c0660Ii.A00, i4, i4 + A082);
            }
            i4 += A082;
        }
        return null;
