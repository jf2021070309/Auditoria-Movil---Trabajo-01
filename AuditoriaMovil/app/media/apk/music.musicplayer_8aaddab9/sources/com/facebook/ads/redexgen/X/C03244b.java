...
public final class C03244b {
    ...
    public C4a A01;
    public AbstractC03324j A04;
    public final /* synthetic */ F6 A08;
    public final ArrayList<AbstractC03344l> A05 = new ArrayList<>();
    public ArrayList<AbstractC03344l> A02 = null;
    public final ArrayList<AbstractC03344l> A06 = new ArrayList<>();
    public final List<AbstractC03344l> A07 = Collections.unmodifiableList(this.A05);
    public int A03 = 2;
    public int A00 = 2;
    ...
    public C03244b(F6 f6) {
        this.A08 = f6;
    }

    private final View A00(int i2, boolean z) {
        return A0I(i2, z, Long.MAX_VALUE).A0H;
    }

    private final AbstractC03344l A01(int i2) {
        int size;
        int A0D;
        ArrayList<AbstractC03344l> arrayList = this.A02;
        if (arrayList == null || (size = arrayList.size()) == 0) {
            return null;
        }
        for (int i3 = 0; i3 < size; i3++) {
            AbstractC03344l abstractC03344l = this.A02.get(i3);
            if (!abstractC03344l.A0i() && abstractC03344l.A0I() == i2) {
                abstractC03344l.A0T(32);
                return abstractC03344l;
            }
        }
        if (this.A08.A04.A0B() && (A0D = this.A08.A00.A0D(i2)) > 0 && A0D < this.A08.A04.A0D()) {
            long A04 = this.A08.A04.A04(A0D);
            for (int i4 = 0; i4 < size; i4++) {
                AbstractC03344l abstractC03344l2 = this.A02.get(i4);
                if (!abstractC03344l2.A0i() && abstractC03344l2.A0K() == A04) {
                    abstractC03344l2.A0T(32);
                    return abstractC03344l2;
                }
            }
        }
        return null;
    ...
    private final AbstractC03344l A02(int cacheSize, boolean z) {
        View A08;
        int size = this.A05.size();
        for (int i2 = 0; i2 < size; i2++) {
            AbstractC03344l abstractC03344l = this.A05.get(i2);
            if (!abstractC03344l.A0i() && abstractC03344l.A0I() == cacheSize && !abstractC03344l.A0b() && (this.A08.A0s.A09 || !abstractC03344l.A0c())) {
                abstractC03344l.A0T(32);
                return abstractC03344l;
            }
        }
        if (!z && (A08 = this.A08.A01.A08(cacheSize)) != null) {
            AbstractC03344l A0G = F6.A0G(A08);
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            AbstractC03344l abstractC03344l2 = this.A06.get(i3);
            if (!abstractC03344l2.A0b() && abstractC03344l2.A0I() == cacheSize) {
                if (!z) {
                    this.A06.remove(i3);
                }
                return abstractC03344l2;
    ...
    */
    private final com.facebook.ads.redexgen.X.AbstractC03344l A03(long r8, int r10, boolean r11) {
        /*
            Method dump skipped, instructions count: 313
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C03244b.A03(long, int, boolean):com.facebook.ads.redexgen.X.4l");
    }
    ...
    private void A09(AbstractC03344l abstractC03344l) {
        if (this.A08.A1s()) {
            ...
            if (!AnonymousClass38.A0F(view)) {
                abstractC03344l.A0T(16384);
                AnonymousClass38.A0B(view, this.A08.A09.A0A());
            }
        }
    }

    private void A0A(AbstractC03344l abstractC03344l) {
        if (abstractC03344l.A0H instanceof ViewGroup) {
            A08((ViewGroup) abstractC03344l.A0H, false);
        }
    }

    private final void A0B(AbstractC03344l abstractC03344l) {
        if (this.A08.A07 != null) {
            throw new NullPointerException(A04(779, 14, 62));
        }
        C4H c4h = this.A08.A04;
        if (this.A08.A0s != null) {
            this.A08.A0t.A0B(abstractC03344l);
        }
    }

    private final boolean A0C(AbstractC03344l abstractC03344l) {
        if (abstractC03344l.A0c()) {
            return this.A08.A0s.A07();
        }
        if (abstractC03344l.A03 >= 0 && abstractC03344l.A03 < this.A08.A04.A0D()) {
            if (this.A08.A0s.A07() || this.A08.A04.A03(abstractC03344l.A03) == abstractC03344l.A0H()) {
                return !this.A08.A04.A0B() || abstractC03344l.A0K() == this.A08.A04.A04(abstractC03344l.A03);
            }
            return false;
        }
        throw new IndexOutOfBoundsException(A04(211, 60, SyslogConstants.LOG_ALERT) + abstractC03344l + this.A08.A1I());
    }

    private boolean A0D(AbstractC03344l abstractC03344l, int i2, int i3, long j2) {
        abstractC03344l.A08 = this.A08;
        ...
        if (j2 != Long.MAX_VALUE) {
            ...
            if (!c4a.A0A(A0H, nanoTime, j2)) {
                return false;
            }
        }
        this.A08.A04.A0A(abstractC03344l, i2);
        this.A01.A05(abstractC03344l.A0H(), this.A08.getNanoTime() - nanoTime);
        A09(abstractC03344l);
        if (this.A08.A0s.A07()) {
            abstractC03344l.A04 = i3;
            return true;
        }
        return true;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.facebook.ads.redexgen.X.AbstractC03344l A0I(int r23, boolean r24, long r25) {
        /*
            Method dump skipped, instructions count: 768
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C03244b.A0I(int, boolean, long):com.facebook.ads.redexgen.X.4l");
    }

    public final List<AbstractC03344l> A0J() {
        return this.A07;
    }
    ...
    public final void A0M() {
        int size = this.A06.size();
        for (int i2 = 0; i2 < size; i2++) {
            C4U c4u = (C4U) this.A06.get(i2).A0H.getLayoutParams();
            if (c4u != null) {
                c4u.A01 = true;
            }
        }
    ...
    public final void A0N() {
        if (this.A08.A04 != null && this.A08.A04.A0B()) {
            int size = this.A06.size();
            for (int i2 = 0; i2 < size; i2++) {
                AbstractC03344l abstractC03344l = this.A06.get(i2);
                if (A0A[0].length() != 16) {
                    throw new RuntimeException();
                }
                String[] strArr = A0A;
                ...
                if (abstractC03344l != null) {
                    abstractC03344l.A0T(6);
                    abstractC03344l.A0Y(null);
                }
            }
            return;
        }
    ...
    public final void A0R(int i2, int i3) {
        int size = this.A06.size();
        for (int i4 = 0; i4 < size; i4++) {
            AbstractC03344l abstractC03344l = this.A06.get(i4);
            if (abstractC03344l != null && abstractC03344l.A03 >= i2) {
                abstractC03344l.A0W(i3, true);
            }
        }
    }
    ...
    public final void A0S(int end, int inBetweenOffset) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            AbstractC03344l abstractC03344l = this.A06.get(i4);
            if (abstractC03344l != null && abstractC03344l.A03 >= cachedCount && abstractC03344l.A03 <= i2) {
                int i5 = abstractC03344l.A03;
                String[] strArr = A0A;
                if (strArr[5].charAt(0) == strArr[3].charAt(0)) {
                    throw new RuntimeException();
                }
                ...
                if (i5 == end) {
                    abstractC03344l.A0W(inBetweenOffset - end, false);
                } else {
                    abstractC03344l.A0W(i3, false);
                }
            }
        }
    }
    ...
    public final void A0T(int cachedCount, int i2) {
        ...
        for (int size = this.A06.size() - 1; size >= 0; size--) {
            AbstractC03344l abstractC03344l = this.A06.get(size);
            if (abstractC03344l != null && (pos = abstractC03344l.A03) >= cachedCount && pos < i3) {
                abstractC03344l.A0T(2);
                A07(size);
            }
        }
    }
    ...
    public final void A0U(int cachedCount, int i2, boolean z) {
        ...
        for (int size = this.A06.size() - 1; size >= 0; size--) {
            AbstractC03344l abstractC03344l = this.A06.get(size);
            if (abstractC03344l != null) {
                if (abstractC03344l.A03 >= i3) {
                    abstractC03344l.A0W(-i2, z);
                } else if (abstractC03344l.A03 >= cachedCount) {
                    abstractC03344l.A0T(8);
                    A07(size);
                }
            }
        }
    ...
    public final void A0a(AbstractC03324j abstractC03324j) {
        this.A04 = abstractC03324j;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00d8, code lost:
        r0 = com.facebook.ads.redexgen.X.F6.A1E;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0b(com.facebook.ads.redexgen.X.AbstractC03344l r10) {
        /*
            Method dump skipped, instructions count: 384
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C03244b.A0b(com.facebook.ads.redexgen.X.4l):void");
    }

    public final void A0c(AbstractC03344l abstractC03344l) {
        boolean z;
        z = abstractC03344l.A0G;
        if (z) {
            this.A02.remove(abstractC03344l);
        } else {
            this.A05.remove(abstractC03344l);
        }
        abstractC03344l.A0F = null;
        abstractC03344l.A0G = false;
        abstractC03344l.A0O();
    }

    public final void A0d(AbstractC03344l abstractC03344l, boolean z) {
        F6.A0t(abstractC03344l);
        if (abstractC03344l.A0k(16384)) {
            abstractC03344l.A0U(0, 16384);
            AnonymousClass38.A0B(abstractC03344l.A0H, null);
        }
        if (z) {
            A0B(abstractC03344l);
        }
        abstractC03344l.A08 = null;
        A0H().A09(abstractC03344l);
    }
}
