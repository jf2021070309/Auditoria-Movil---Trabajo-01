...
public final class C1338dm implements C0G {
    public static byte[] A03;
    public static String[] A04 = {"P4WBUOUbWFZVPUfllum665PEFtgA", "hl2hcMpTCTU39UgF1EW38AmixRhm49P4", "sNWuTokwvfj2sOZCyjSoO11B4mAkUdMG", "H", "URwERncuc0axl8tzw7s1hCSOmGWPEg1Z", "US601emoXJvV4DnAkF2mociZLiAqpNhW", "6", "hJG0zhFr2Lsx"};
    public File A00;
    ...
    public C1338dm(File file, C0B c0b) throws C1336dk {
        File file2;
        try {
            if (c0b != null) {
                this.A02 = c0b;
            ...
            throw new C1336dk(A00(186, 17, 126) + file + A00(0, 14, 84), e2);
        }
    }
    ...
    public final synchronized int A03() throws C1336dk {
        try {
        } catch (IOException e2) {
            throw new C1336dk(A00(137, 29, 81) + this.A00, e2);
        }
    ...
    public final synchronized void A05() throws C1336dk {
        try {
            this.A01.setLength(0L);
        } catch (IOException e2) {
            throw new C1336dk(A00(57, 16, 6), e2);
        }
        String[] strArr = A04;
    ...
    public final synchronized void A06() throws C1336dk {
        try {
            this.A01.close();
            this.A02.AFH(this.A00);
        } catch (IOException e2) {
            throw new C1336dk(A00(104, 19, 99) + this.A00, e2);
        }
    }

    public final synchronized void A07() throws C1336dk {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (renamed) {
            ...
            try {
                ...
                throw new C1336dk(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e2);
            }
        }
        throw new C1336dk(A00(166, 20, 40) + this.A00 + A00(44, 4, 124) + file + A00(14, 16, 28));
    }

    public final synchronized void A08(byte[] bArr, int i2) throws C1336dk {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i2);
            } else {
                throw new C1336dk(A00(73, 31, 52) + this.A00 + A00(30, 14, 118));
            }
        } catch (IOException e2) {
            throw new C1336dk(String.format(Locale.US, A00(203, 53, 105), Integer.valueOf(i2), this.A01, Integer.valueOf(bArr.length)), e2);
        }
    }
