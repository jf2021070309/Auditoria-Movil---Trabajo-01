...
public enum PD {
    ...
    A0K(A01(418, 10, 38)),
    A0J(A01(407, 11, 121)),
    A0P(A01(482, 12, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH)),
    A0L(A01(446, 11, 11)),
    A0B(A01(320, 11, 93)),
    A08(A01(428, 18, 20)),
    A0I(A01(398, 9, 16)),
    A0O(A01(0, 0, FacebookMediationAdapter.ERROR_NULL_CONTEXT));
    ...
    public static PD A00(String str) {
        PD[] values;
        for (PD pd : values()) {
            if (pd.A00.equalsIgnoreCase(str)) {
                return pd;
            }
        }
        return A0O;
