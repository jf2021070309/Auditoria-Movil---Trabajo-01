...
public final class YV extends C03866m {
    @Nullable
    ...
    static {
        A08();
        A05 = YV.class.getSimpleName();
    }

    public YV(Context context, C6C c6c) {
        super(context, c6c);
        this.A00 = context;
        A01 = A04(this.A00);
        A02 = A06();
    ...
    public C7A A02(HashMap<String, YW> hashMap) {
