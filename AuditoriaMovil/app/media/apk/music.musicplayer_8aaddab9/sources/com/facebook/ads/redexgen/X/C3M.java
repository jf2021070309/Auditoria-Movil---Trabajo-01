...
public class C3M extends ViewGroup {
    ...
    private final C3E A04(int i2) {
        for (int i3 = 0; i3 < this.A0t.size(); i3++) {
            C3E c3e = this.A0t.get(i3);
            if (c3e.A02 == i2) {
                return c3e;
            }
        }
    ...
    private final C3E A05(int i2, int i3) {
        C3E c3e = new C3E();
        c3e.A02 = i2;
        c3e.A03 = this.A01.A08(this, i2);
        c3e.A01 = this.A01.A04(i2);
    ...
    private void A0A() {
        ...
        while (i2 < getChildCount()) {
            C3F lp = (C3F) getChildAt(i2).getLayoutParams();
            if (!lp.A05) {
                removeViewAt(i2);
                i2--;
            }
    ...
    private final void A0D() {
        ...
        AnonymousClass38.A0B(this, new C1242cB(this));
        if (AnonymousClass38.A00(this) == 0) {
            AnonymousClass38.A09(this, 1);
        }
        AnonymousClass38.A0C(this, new C1243cC(this));
    }
    ...
    */
    ...
    private void A0Q(C3E c3e, int i2, C3E c3e2) {
        float f2;
        C3E c3e3;
        C3E c3e4;
        ...
        if (c3e2 != null) {
            ...
            if (i3 < c3e.A02) {
                int i4 = 0;
                float f4 = c3e2.A00 + c3e2.A01 + f3;
                int i5 = i3 + 1;
                while (i5 <= c3e.A02 && i4 < this.A0t.size()) {
                    C3E c3e5 = this.A0t.get(i4);
                    while (true) {
                        c3e4 = c3e5;
                        if (i5 <= c3e4.A02 || i4 >= this.A0t.size() - 1) {
                            break;
                        }
                        i4++;
                        c3e5 = this.A0t.get(i4);
                    }
                    while (i5 < c3e4.A02) {
                        AbstractC02922t abstractC02922t = this.A01;
                        if (A0v[2].length() == 14) {
                            throw new RuntimeException();
                        }
                        A0v[2] = "unjnr1JPHveRA3A";
                        f4 += abstractC02922t.A04(i5) + f3;
                        i5++;
                    }
                    c3e4.A00 = f4;
                    f4 += c3e4.A01 + f3;
                ...
                float f5 = c3e2.A00;
                int i6 = i3 - 1;
                while (i6 >= c3e.A02 && size >= 0) {
                    C3E c3e6 = this.A0t.get(size);
                    while (true) {
                        c3e3 = c3e6;
                        if (i6 >= c3e3.A02 || size <= 0) {
                            break;
                        }
                        size--;
        ...
        float f8 = c3e.A00 + c3e.A01 + f3;
        int i11 = c3e.A02 + 1;
        int i12 = i2 + 1;
        while (i12 < size2) {
            C3E c3e8 = this.A0t.get(i12);
            while (i11 < c3e8.A02) {
    ...
    private final boolean A0W() {
        AbstractC02922t abstractC02922t = this.A01;
        if (abstractC02922t != null && this.A00 < abstractC02922t.A05() - 1) {
            A0L(this.A00 + 1, true);
            return true;
    ...
    */
    ...
    public AbstractC02922t getAdapter() {
        return this.A01;
    }

    @Override // android.view.ViewGroup
    public final int getChildDrawingOrder(int i2, int i3) {
        return ((C3F) this.A0d.get(this.A0F == 2 ? (i2 - 1) - i3 : i3).getLayoutParams()).A01;
    }
    ...
    */
            ...
            if (i6 < childCount) {
                ...
                if (size != 8) {
                    ...
                    if (c3f2 != null && c3f2.A05) {
                        int i7 = c3f2.A04 & 7;
                        int hgrav = c3f2.A04;
                        int i8 = hgrav & SyslogConstants.LOG_ALERT;
                ...
                for (int i11 = 0; i11 < childCount2; i11++) {
                    ...
                    if (childAt2.getVisibility() != 8 && ((c3f = (C3F) childAt2.getLayoutParams()) == null || !c3f.A05)) {
                        ...
                        if (strArr2[4].length() == strArr2[5].length()) {
                            ...
                            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (f2 * c3f.A00), 1073741824);
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        AbstractC02922t abstractC02922t = this.A01;
        if (abstractC02922t != null) {
            viewPager$SavedState.A01 = abstractC02922t.A07();
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        AbstractC02922t abstractC02922t;
        float f2;
        if (this.A0h) {
            return true;
        }
        if ((motionEvent.getAction() == 0 && motionEvent.getEdgeFlags() != 0) || (abstractC02922t = this.A01) == null || abstractC02922t.A05() == 0) {
            return false;
        }
        if (this.A0U == null) {
            this.A0U = VelocityTracker.obtain();
    ...
    public void setAdapter(AbstractC02922t abstractC02922t) {
        AbstractC02922t abstractC02922t2 = this.A01;
        if (abstractC02922t2 != null) {
            abstractC02922t2.A0A(null);
            for (int i2 = 0; i2 < this.A0t.size(); i2++) {
                C3E c3e = this.A0t.get(i2);
    ...
    public void setOffscreenPageLimit(int i2) {
        if (i2 < 1) {
            Log.w(A08(300, 9, 47), A08(127, 31, 60) + i2 + A08(51, 26, 90) + 1);
            i2 = 1;
        }
        if (i2 != this.A0L) {
            this.A0L = i2;
    ...
    public void setPageMarginDrawable(@DrawableRes int i2) {
        setPageMarginDrawable(C2P.A00(getContext(), i2));
    }
