...
public final class C0619Gr {
    ...
    public final C0611Gj A04;
    public final C0612Gk A05;
    public final C0618Gq A06;

    public static String A09(int i2, int i3, int i4) {
        byte[] copyOfRange = Arrays.copyOfRange(A07, i2, i2 + i3);
        for (int i5 = 0; i5 < copyOfRange.length; i5++) {
            byte b2 = (byte) ((copyOfRange[i5] - i4) - 74);
            String[] strArr = A08;
    ...
    public C0619Gr(int i2, int i3) {
        ...
        this.A01 = new Canvas();
        this.A05 = new C0612Gk(719, 575, 0, 719, 0, 575);
        this.A04 = new C0611Gj(0, A0F(), A0G(), A0H());
        this.A06 = new C0618Gq(i2, i3);
    }
    ...
    public static int A01(C0659Ih c0659Ih, int[] iArr, byte[] bArr, int i2, int i3, Paint paint, Canvas canvas) {
        int i4 = i2;
        int column = 0;
        do {
            int runLength = 0;
            byte A04 = c0659Ih.A04(2);
            if (A04 != 0) {
                runLength = 1;
            } else {
                ...
                if (A0F) {
                    runLength = c0659Ih.A04(3) + 3;
                    A04 = c0659Ih.A04(2);
                } else if (c0659Ih.A0F()) {
                    runLength = 1;
                    A04 = 0;
                } else {
                    int A042 = c0659Ih.A04(2);
                    if (A042 == 0) {
                        column = 1;
                        A04 = 0;
                    } else if (A042 != 1) {
                        if (A042 == 2) {
                            runLength = c0659Ih.A04(4) + 12;
                            A04 = c0659Ih.A04(2);
                        } else if (A042 != 3) {
                            A04 = 0;
                        } else {
                            int A043 = c0659Ih.A04(8);
                            String[] strArr3 = A08;
    ...
    public static int A02(C0659Ih c0659Ih, int[] iArr, byte[] bArr, int i2, int i3, Paint paint, Canvas canvas) {
        int runLength = i2;
        int column = 0;
        do {
            int clutIndex = 0;
            byte A04 = c0659Ih.A04(4);
            if (A04 != 0) {
                clutIndex = 1;
            } else if (!c0659Ih.A0F()) {
                ...
                clutIndex = c0659Ih.A04(2) + 4;
                A04 = c0659Ih.A04(4);
            } else {
                int A043 = c0659Ih.A04(2);
                if (A043 == 0) {
                    clutIndex = 1;
                    A04 = 0;
                } else if (A043 == 1) {
                    ...
                    clutIndex = c0659Ih.A04(4) + 9;
                    A04 = c0659Ih.A04(4);
                } else if (A043 != 3) {
                    A04 = 0;
                } else {
                    clutIndex = c0659Ih.A04(8) + 25;
                    A04 = c0659Ih.A04(4);
                }
            }
    ...
    public static int A03(C0659Ih c0659Ih, int[] iArr, @Nullable byte[] bArr, int i2, int peek, Paint paint, Canvas canvas) {
        int A04;
        int runLength = i2;
        int column = 0;
        do {
            byte A042 = c0659Ih.A04(8);
            if (A042 != 0) {
                A04 = 1;
            } else if (!c0659Ih.A0F()) {
                A04 = c0659Ih.A04(7);
    ...
    public static C0611Gj A04(C0659Ih c0659Ih, int i2) {
        int[] iArr;
        int A04;
        int clutId;
        int i3;
        ...
        int[] A0H = A0H();
        while (i4 > 0) {
            int r = c0659Ih.A04(b2);
            int t = c0659Ih.A04(b2);
            int y = i4 - 2;
            if ((t & 128) != 0) {
            ...
            if ((t & 1) != 0) {
                A04 = c0659Ih.A04(b2);
                clutId = c0659Ih.A04(b2);
                i3 = c0659Ih.A04(b2);
                cb = c0659Ih.A04(b2);
                i4 = y - 4;
            } else {
                A04 = c0659Ih.A04(6) << 2;
                int remainingLength = c0659Ih.A04(4);
                clutId = remainingLength << 4;
                int cr2 = c0659Ih.A04(4);
                i3 = cr2 << 4;
                int cr3 = c0659Ih.A04(2);
                cb = cr3 << 6;
                i4 = y - 2;
            }
            if (A04 == 0) {
            ...
            int cb4 = i3 - 128;
            int a2 = C0676Iy.A06(i5, 0, 255);
            int b4 = C0676Iy.A06(i6, 0, 255);
            iArr[r] = A00(b3, a2, b4, C0676Iy.A06((int) (A04 + (cb4 * 1.772d)), 0, 255));
            b2 = 8;
        }
        return new C0611Gj(A042, clutEntries8Bit, A0G, A0H);
    }

    public static C0612Gk A05(C0659Ih c0659Ih) {
        ...
        boolean A0F = c0659Ih.A0F();
        c0659Ih.A08(3);
        int A04 = c0659Ih.A04(16);
        int A042 = c0659Ih.A04(16);
        if (A0F) {
            verticalPositionMinimum = c0659Ih.A04(16);
            verticalPositionMaximum = c0659Ih.A04(16);
            width = c0659Ih.A04(16);
            height = c0659Ih.A04(16);
        } else {
        ...
        return new C0612Gk(A04, A042, verticalPositionMinimum, verticalPositionMaximum, width, height);
    }

    public static C0613Gl A06(C0659Ih c0659Ih) {
        int objectCodingMethod = c0659Ih.A04(16);
        c0659Ih.A08(4);
        int A04 = c0659Ih.A04(2);
        boolean A0F = c0659Ih.A0F();
        c0659Ih.A08(1);
        byte[] bArr = null;
        byte[] bArr2 = null;
        if (A04 == 1) {
            c0659Ih.A08(c0659Ih.A04(8) * 16);
        } else if (A04 == 0) {
            int A042 = c0659Ih.A04(16);
            int objectId = c0659Ih.A04(16);
            String[] strArr = A08;
            String str = strArr[4];
            ...
            if (A042 > 0) {
                bArr = new byte[A042];
                c0659Ih.A0E(bArr, 0, A042);
            }
            if (objectId > 0) {
                bArr2 = new byte[objectId];
                c0659Ih.A0E(bArr2, 0, objectId);
            } else {
                bArr2 = bArr;
            }
        }
        return new C0613Gl(objectCodingMethod, A0F, bArr, bArr2);
    }

    public static C0614Gm A07(C0659Ih c0659Ih, int timeoutSecs) {
        int remainingLength = c0659Ih.A04(8);
        ...
        while (regionHorizontalAddress > 0) {
            ...
            sparseArray.put(A043, new C0615Gn(c0659Ih.A04(16), c0659Ih.A04(16)));
        }
        return new C0614Gm(remainingLength, A04, A042, sparseArray);
    }

    public static C0616Go A08(C0659Ih c0659Ih, int i2) {
        int i3 = 8;
        int A04 = c0659Ih.A04(8);
        c0659Ih.A08(4);
        boolean A0F = c0659Ih.A0F();
        c0659Ih.A08(3);
        int A042 = c0659Ih.A04(16);
        int A043 = c0659Ih.A04(16);
        int A044 = c0659Ih.A04(3);
        int A045 = c0659Ih.A04(3);
        c0659Ih.A08(2);
        int id = c0659Ih.A04(8);
        int A046 = c0659Ih.A04(8);
        int width = c0659Ih.A04(4);
        int height = c0659Ih.A04(2);
        c0659Ih.A08(2);
        int pixelCode8Bit = i2 - 10;
        SparseArray sparseArray = new SparseArray();
        while (pixelCode8Bit > 0) {
            int pixelCode4Bit = c0659Ih.A04(16);
            int pixelCode2Bit = c0659Ih.A04(2);
            int remainingLength = c0659Ih.A04(2);
            int objectHorizontalPosition = c0659Ih.A04(12);
            c0659Ih.A08(4);
            int objectVerticalPosition = c0659Ih.A04(12);
            pixelCode8Bit -= 6;
            int remainingLength2 = 0;
            int objectType = 0;
            if (pixelCode2Bit == 1 || pixelCode2Bit == 2) {
                remainingLength2 = c0659Ih.A04(i3);
                objectType = c0659Ih.A04(i3);
                pixelCode8Bit -= 2;
            ...
            sparseArray.put(pixelCode4Bit, new C0617Gp(pixelCode2Bit, remainingLength, objectHorizontalPosition, objectVerticalPosition, remainingLength2, objectType));
            i3 = 8;
        }
        return new C0616Go(A04, A0F, A042, A043, A044, A045, id, A046, width, height, sparseArray);
    }

    public static void A0B(C0613Gl c0613Gl, C0611Gj c0611Gj, int i2, int i3, int i4, Paint paint, Canvas canvas) {
        int[] iArr;
        if (i2 == 3) {
            iArr = c0611Gj.A03;
        } else if (i2 == 2) {
        ...
        A0D(c0613Gl.A03, iArr, i2, i3, i4, paint, canvas);
        A0D(c0613Gl.A02, iArr, i2, i3, i4 + 1, paint, canvas);
    }

    public static void A0C(C0659Ih c0659Ih, C0618Gq c0618Gq) {
        int dataFieldLimit = c0659Ih.A04(8);
        int A04 = c0659Ih.A04(16);
        int A042 = c0659Ih.A04(16);
        int A02 = c0659Ih.A02() + A042;
        int i2 = A042 * 8;
        int pageId = c0659Ih.A01();
        if (i2 > pageId) {
            Log.w(A09(31, 9, 98), A09(0, 31, 5));
            int pageId2 = c0659Ih.A01();
            c0659Ih.A08(pageId2);
            return;
        }
        switch (dataFieldLimit) {
            case 16:
                if (A04 == c0618Gq.A03) {
                    C0614Gm c0614Gm = c0618Gq.A01;
                    C0614Gm A072 = A07(c0659Ih, A042);
                    if (A072.A00 != 0) {
                        c0618Gq.A01 = A072;
                        c0618Gq.A08.clear();
                        c0618Gq.A06.clear();
                        c0618Gq.A07.clear();
                        break;
                    } else if (c0614Gm != null && c0614Gm.A02 != A072.A02) {
                        c0618Gq.A01 = A072;
                        break;
                    }
                }
                break;
            case 17:
                C0614Gm c0614Gm2 = c0618Gq.A01;
                if (A04 == c0618Gq.A03 && c0614Gm2 != null) {
                    C0616Go A082 = A08(c0659Ih, A042);
                    if (c0614Gm2.A00 == 0) {
                        A082.A00(c0618Gq.A08.get(A082.A03));
                    }
                    c0618Gq.A08.put(A082.A03, A082);
                    break;
                }
                break;
            case ConnectionResult.SERVICE_UPDATING /* 18 */:
                if (A04 == c0618Gq.A03) {
                    C0611Gj A043 = A04(c0659Ih, A042);
                    c0618Gq.A06.put(A043.A00, A043);
                    break;
                } else if (A04 == c0618Gq.A02) {
                    C0611Gj A044 = A04(c0659Ih, A042);
                    c0618Gq.A04.put(A044.A00, A044);
                    break;
                }
                break;
            case 19:
                if (A04 == c0618Gq.A03) {
                    C0613Gl A06 = A06(c0659Ih);
                    c0618Gq.A07.put(A06.A00, A06);
                    break;
                } else if (A04 == c0618Gq.A02) {
                    C0613Gl A062 = A06(c0659Ih);
                    c0618Gq.A05.put(A062.A00, A062);
                    break;
                }
                break;
            case 20:
                if (A04 == c0618Gq.A03) {
                    c0618Gq.A00 = A05(c0659Ih);
                    break;
                }
                break;
        }
        int pageId3 = c0659Ih.A02();
        c0659Ih.A09(A02 - pageId3);
    }
    ...
    public static void A0D(byte[] bArr, int[] iArr, int i2, int column, int i3, Paint paint, Canvas canvas) {
        ...
        byte[] bArr3;
        int line = i3;
        C0659Ih c0659Ih = new C0659Ih(bArr);
            ...
            if (A04 != 240) {
                switch (A04) {
                    case 16:
                        ...
                        dataType = A01(c0659Ih, iArr, bArr3, dataType, line, paint, canvas);
                        c0659Ih.A05();
                        continue;
                    case 17:
                        if (i2 == 3) {
                        ...
                        dataType = A02(c0659Ih, iArr, bArr2, dataType, line, paint, canvas);
                        c0659Ih.A05();
                        continue;
                    case ConnectionResult.SERVICE_UPDATING /* 18 */:
                        dataType = A03(c0659Ih, iArr, null, dataType, line, paint, canvas);
                        continue;
                    default:
                        String[] strArr2 = A08;
                        if (strArr2[1].length() == strArr2[5].length()) {
                        ...
                        switch (A04) {
                            case 32:
                                clutMapTable2To8 = A0E(4, 4, c0659Ih);
                                continue;
                            case 33:
                                bArr4 = A0E(4, 8, c0659Ih);
                                continue;
                            case 34:
                                bArr4 = A0E(16, 8, c0659Ih);
                                continue;
                            default:
                                continue;
                        }
    ...
    public static byte[] A0E(int i2, int i3, C0659Ih c0659Ih) {
        byte[] bArr = new byte[i2];
        for (int i4 = 0; i4 < i2; i4++) {
            bArr[i4] = (byte) c0659Ih.A04(i3);
        }
        return bArr;
    }
    ...
    */
    public static int[] A0G() {
        ...
        L51:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0619Gr.A0G():int[]");
    }
    ...
    */
    public static int[] A0H() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0619Gr.A0H():int[]");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0123, code lost:
        r11 = r20.A06;
        r10 = com.facebook.ads.redexgen.X.C0619Gr.A08;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x0166, code lost:
        if (com.facebook.ads.redexgen.X.C0619Gr.A08[2].charAt(23) == 'o') goto L74;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x0168, code lost:
        com.facebook.ads.redexgen.X.C0619Gr.A08[2] = "8CBvTLi9MCYkuIvOm7pX0icqjNgV3H5L";
     */
    ...
    */
    public final java.util.List<com.facebook.ads.redexgen.X.GX> A0I(byte[] r21, int r22) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0619Gr.A0I(byte[], int):java.util.List");
    }
