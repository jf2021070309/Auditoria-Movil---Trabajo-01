...
import com.facebook.ads.redexgen.X.C02340m;
...
public final class C02340m {
    public static byte[] A06;
    public static String[] A07 = {"jY95Z4e8SjES", "FWAQk0vwFzOT3H3ejUps9E7fwyQUHgqv", "R9UUrzGy7cjs1hDg6byYlCYbXfp8nW0w", "dKAdSxu4tDkfYe86wdSSQ2n2Du5", "FgFVZj7d091u9rUO", "kSt0PMlvWs2DEAK3GKEU98UDJan6EgWc", "nGXCIrfUxBd8PJB10o2gs7oQf", GoogleApiAvailabilityLight.TRACKING_SOURCE_NOTIFICATION};
    @Nullable
    public Application A01;
    @Nullable
    public UserReturnTracker$UserReturnListener A03;
    public final InterfaceC0684Jg A05;
    public long A00 = 0;
    @Nullable
    public String A04 = null;
    @Nullable
    public EnumC02270e A02 = null;
    ...
    public C02340m(InterfaceC0684Jg interfaceC0684Jg, final Activity activity, int i2) {
        this.A05 = interfaceC0684Jg;
    ...
    @Nullable
    public static C02340m A00(InterfaceC0684Jg interfaceC0684Jg, @Nullable Activity activity) {
        return A01(interfaceC0684Jg, activity, Build.VERSION.SDK_INT);
    }

    @Nullable
    @VisibleForTesting
    public static C02340m A01(InterfaceC0684Jg interfaceC0684Jg, @Nullable Activity activity, int i2) {
        if (activity != null && i2 >= 14) {
            return new C02340m(interfaceC0684Jg, activity, i2);
        }
        return null;
    }

    private void A04(String str, long j2, long j3, @Nullable EnumC02270e enumC02270e) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j2));
        hashMap.put(A02(0, 9, 34), Long.toString(j3));
        if (enumC02270e != null) {
            hashMap.put(A02(19, 7, 9), enumC02270e.name());
        }
        this.A05.A9N(str, hashMap);
    }
    ...
    public final void A06(@Nullable EnumC02270e enumC02270e) {
        this.A02 = enumC02270e;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC02270e enumC02270e = EnumC02270e.A03;
        if (A07[2].charAt(6) == '9') {
