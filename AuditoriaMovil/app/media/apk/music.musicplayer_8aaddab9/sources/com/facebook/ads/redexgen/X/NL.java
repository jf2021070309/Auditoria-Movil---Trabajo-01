...
public final class NL extends LinearLayout {
    ...
    public static final int A04 = (int) (C0739Lm.A00 * 16.0f);
    public static final int A05 = (int) (C0739Lm.A00 * 12.0f);
    public static final int A06 = (int) (C0739Lm.A00 * 12.0f);
    public static final int A03 = (int) (C0739Lm.A00 * 16.0f);

    public NL(C1046Xo c1046Xo) {
        super(c1046Xo);
        this.A00 = false;
        setOrientation(0);
        int i2 = A04;
    ...
    public void setData(String str, @Nullable MT mt) {
