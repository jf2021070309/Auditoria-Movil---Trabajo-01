...
import com.facebook.ads.redexgen.X.C0556Ec;
...
public final class SpliceScheduleCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceScheduleCommand> CREATOR = new C0556Ec();
    ...
    public /* synthetic */ SpliceScheduleCommand(Parcel parcel, C0556Ec c0556Ec) {
        this(parcel);
    }
    ...
    public static SpliceScheduleCommand A00(C0660Ii c0660Ii) {
        int A0E = c0660Ii.A0E();
        ArrayList arrayList = new ArrayList(A0E);
        for (int i2 = 0; i2 < A0E; i2++) {
            arrayList.add(Ee.A03(c0660Ii));
