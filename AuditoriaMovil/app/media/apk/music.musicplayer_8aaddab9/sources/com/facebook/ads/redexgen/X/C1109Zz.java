...
public class C1109Zz implements AnonymousClass71 {
    ...
    public C1109Zz(BluetoothDevice bluetoothDevice) {
    ...
    public final boolean A8S(Object obj) {
        C1109Zz c1109Zz = (C1109Zz) obj;
        if (((this.A05 == null && c1109Zz.A05 == null) || this.A05.equals(c1109Zz.A05)) && this.A03 == c1109Zz.A03 && this.A04 == c1109Zz.A04 && this.A00 == c1109Zz.A00) {
            int i2 = this.A01;
            ...
            strArr[5] = "lCz1bJjVX";
            strArr[0] = "UsNKRzwfX";
            if (i2 == c1109Zz.A01 && this.A02 == c1109Zz.A02) {
                return true;
            }
        }
        return false;
    ...
    public final int AEu() {
        return (this.A05 != null ? A01(5, 1, 18).length() + this.A05.length() : 0) + A01(8, 2, 64).length() + 4 + A01(10, 1, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD).length() + 4 + A01(0, 2, 5).length() + 4 + A01(2, 3, 108).length() + 4 + A01(6, 2, 61).length() + 4;
    }

    @Override // com.facebook.ads.redexgen.X.AnonymousClass71
    public final JSONObject AFF() throws JSONException {
