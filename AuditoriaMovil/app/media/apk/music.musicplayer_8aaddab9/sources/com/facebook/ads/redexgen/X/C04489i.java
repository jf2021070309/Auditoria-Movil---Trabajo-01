...
public final class C04489i implements Closeable {
    ...
    public C04489i(File file) throws IOException {
        ...
        this.A00 = new C04499j(readInt, readInt2);
    }
    ...
    public final C04499j A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C04499j c04499j) throws IOException {
        if (!this.A01) {
            if (c04499j.A02() >= 0 && c04499j.A03() >= 0) {
                this.A00 = c04499j;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c04499j.A02()), Integer.valueOf(c04499j.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
