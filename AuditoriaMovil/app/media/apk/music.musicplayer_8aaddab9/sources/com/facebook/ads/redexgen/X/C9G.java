...
public final class C9G {
    ...
    public static String[] A06 = {"eUnDvYC27elWl0OIYD", "wrMh9NtoanrD8h1augOH3NVqQQ0tAgF4", "3vDVqZB4rWVKvgx5b3OF0nUGahQCrcY0", "6DD0LSomG9znTW4FMaj4ZQ8CLI18bTcT", "m4OyWRD3KmqD5PEshfLk2St9BNh2LjNQ", "DUnTMJffq4UJY2Y02e5xG0xwhTP4jnlH", "V", "fiQ9VXnw7bAvrgjS7V4rUJQz4dMTS6ql"};
    public String A00;
    public String A01;
    public String A02;
    public Date A03;
    ...
    public C9G(String str, String str2, String str3, Date date) {
        this.A01 = str;
        this.A00 = str2;
        this.A02 = str3;
        this.A03 = date;
    ...
    public static List<C9G> A01(String str) {
        if (str == null) {
            return null;
        }
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            ...
            if (jSONObject != null) {
                arrayList.add(new C9G(jSONObject));
            }
        }
        return arrayList;
    }
