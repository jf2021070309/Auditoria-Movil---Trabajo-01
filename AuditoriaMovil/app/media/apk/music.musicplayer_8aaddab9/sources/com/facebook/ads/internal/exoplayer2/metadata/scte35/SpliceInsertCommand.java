...
import com.facebook.ads.redexgen.X.C0554Ea;
...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public SpliceInsertCommand(long j2, boolean z, boolean z2, boolean z3, boolean z4, long j3, long j4, List<C0554Ea> list, boolean z5, long j5, int i2, int i3, int i4) {
        this.A06 = j2;
        this.A0B = z;
        this.A09 = z2;
        this.A0A = z3;
    ...
    public SpliceInsertCommand(Parcel parcel) {
        ...
        for (int i2 = 0; i2 < readInt; i2++) {
            arrayList.add(C0554Ea.A00(parcel));
        }
    ...
    public static SpliceInsertCommand A00(C0660Ii c0660Ii, long j2, C0672Iu c0672Iu) {
        long A0M = c0660Ii.A0M();
        boolean z = (c0660Ii.A0E() & 128) != 0;
        boolean z2 = false;
        ...
        if (!z) {
            ...
            if (autoReturn && !spliceImmediateFlag) {
                programSplicePts = TimeSignalCommand.A00(c0660Ii, j2);
            }
            if (!autoReturn) {
                int A0E2 = c0660Ii.A0E();
                emptyList = new ArrayList(A0E2);
                for (int i5 = 0; i5 < A0E2; i5++) {
                    int A0E3 = c0660Ii.A0E();
                    long j4 = -9223372036854775807L;
                    if (!spliceImmediateFlag) {
                        j4 = TimeSignalCommand.A00(c0660Ii, j2);
                    }
                    long spliceEventId = j4;
                    emptyList.add(new C0554Ea(A0E3, spliceEventId, c0672Iu.A07(j4), null));
                }
            }
            if (programSpliceFlag) {
                long A0E4 = c0660Ii.A0E();
                z3 = (A0E4 & 128) != 0;
                j3 = (1000 * (((A0E4 & 1) << 32) | c0660Ii.A0M())) / 90;
            }
            i2 = c0660Ii.A0I();
            i3 = c0660Ii.A0E();
            i4 = c0660Ii.A0E();
        }
        return new SpliceInsertCommand(A0M, z, z2, autoReturn, spliceImmediateFlag, programSplicePts, c0672Iu.A07(programSplicePts), emptyList, z3, j3, i2, i3, i4);
    }
