...
public final class Ee {
    ...
    public final List<C0557Ed> A06;
    public final boolean A07;
    public final boolean A08;
    public final boolean A09;
    public final boolean A0A;

    public Ee(long j2, boolean z, boolean z2, boolean z3, List<C0557Ed> list, long j3, boolean z4, long j4, int i2, int i3, int i4) {
        this.A04 = j2;
        this.A0A = z;
        this.A08 = z2;
        this.A09 = z3;
    ...
    public static Ee A02(C0660Ii c0660Ii) {
        long A0M = c0660Ii.A0M();
        boolean autoReturn = (c0660Ii.A0E() & 128) != 0;
        boolean z = false;
        boolean z2 = false;
        ...
        if (!autoReturn) {
            ...
            if (!z2) {
                ...
                for (int i4 = 0; i4 < A0E2; i4++) {
                    arrayList.add(new C0557Ed(c0660Ii.A0E(), c0660Ii.A0M(), null));
                }
            }
            if (z4) {
                int componentCount = c0660Ii.A0E();
                long j4 = componentCount;
                int i5 = ((128 & j4) > 0L ? 1 : ((128 & j4) == 0L ? 0 : -1));
                z3 = i5 != 0;
                long breakDuration90khz = ((1 & j4) << 32) | c0660Ii.A0M();
                j3 = (1000 * breakDuration90khz) / 90;
            }
            i2 = c0660Ii.A0I();
            headerByte = c0660Ii.A0E();
            i3 = c0660Ii.A0E();
        }
        return new Ee(A0M, autoReturn, z, z2, arrayList, j2, z3, j3, i2, headerByte, i3);
    }

    public static /* synthetic */ Ee A03(C0660Ii c0660Ii) {
        return A02(c0660Ii);
    }
    ...
    public static /* synthetic */ void A05(Ee ee, Parcel parcel) {
        ee.A04(parcel);
    }
}
