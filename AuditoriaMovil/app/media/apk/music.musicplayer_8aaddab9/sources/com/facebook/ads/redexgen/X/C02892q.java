...
public final class C02892q {
    ...
    public C02892q(@NonNull View view) {
        this.A04 = view;
    }
    ...
    public final boolean A07(float f2, float f3) {
        ...
        return C3O.A06(A00, this.A04, f2, f3);
    }
    ...
    public final boolean A08(float f2, float f3, boolean z) {
        ...
        return C3O.A07(A00, this.A04, f2, f3, z);
    }
        ...
        if (A06()) {
            if (A05[0].charAt(13) != 't') {
                ...
                for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                    if (C3O.A08(parent, view, this.A04, i2, i3)) {
                        A01(i3, parent);
                        C3O.A05(parent, view, this.A04, i2, i3);
                        return true;
                    }
    ...
    public final boolean A0D(int i2, int i3, int i4, int i5, @Nullable int[] iArr, int i6) {
        ...
        if (i2 != 0 || i3 != 0 || i4 != 0 || i5 != 0) {
            ...
            C3O.A03(A00, this.A04, i2, i3, i4, i5, i6);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
    ...
    */
    public final boolean A0F(int r17, int r18, @androidx.annotation.Nullable int[] r19, @androidx.annotation.Nullable int[] r20, int r21) {
        ...
        L20:
            r7 = 0
            r6 = 0
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C02892q.A05
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
            if (r1 == r0) goto L9b
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C02892q.A05
        ...
        La7:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C02892q.A0F(int, int, int[], int[], int):boolean");
    }
}
