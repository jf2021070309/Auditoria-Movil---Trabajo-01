...
public abstract class V3 extends HT {
    ...
    public abstract Pair<C0486Av[], HQ[]> A0V(HO ho, int[][][] iArr, int[] iArr2) throws AM;

    public static int A0Q(InterfaceC0485Au[] interfaceC0485AuArr, TrackGroup trackGroup) throws AM {
        int rendererIndex = interfaceC0485AuArr.length;
        int i2 = 0;
        for (int trackIndex = 0; trackIndex < interfaceC0485AuArr.length; trackIndex++) {
            InterfaceC0485Au interfaceC0485Au = interfaceC0485AuArr[trackIndex];
            for (int i3 = 0; i3 < trackGroup.A01; i3++) {
                int formatSupportLevel = interfaceC0485Au.AFC(trackGroup.A01(i3)) & 7;
    ...
    public static int[] A0R(InterfaceC0485Au interfaceC0485Au, TrackGroup trackGroup) throws AM {
        int[] iArr = new int[trackGroup.A01];
        for (int i2 = 0; i2 < trackGroup.A01; i2++) {
            iArr[i2] = interfaceC0485Au.AFC(trackGroup.A01(i2));
        }
        return iArr;
    }

    public static int[] A0S(InterfaceC0485Au[] interfaceC0485AuArr) throws AM {
        int[] iArr = new int[interfaceC0485AuArr.length];
        int i2 = 0;
        while (true) {
            ...
            if (i2 < length) {
                int i4 = interfaceC0485AuArr[i2].AFE();
                iArr[i2] = i4;
                i2++;
            } else {
                return iArr;
    ...
    */
    public final com.facebook.ads.redexgen.X.HU A0T(com.facebook.ads.redexgen.X.InterfaceC0485Au[] r12, com.facebook.ads.internal.exoplayer2.source.TrackGroupArray r13) throws com.facebook.ads.redexgen.X.AM {
        /*
            r11 = this;
            int r0 = r12.length
            int r0 = r0 + 1
        ...
        L5b:
            ...
            r2 = r4[r5]
            r0 = r3[r5]
            java.lang.Object[] r1 = com.facebook.ads.redexgen.X.C0676Iy.A0k(r0, r2)
            ...
            r7[r5] = r0
            r0 = r9[r5]
            java.lang.Object[] r0 = com.facebook.ads.redexgen.X.C0676Iy.A0k(r0, r2)
            int[][] r0 = (int[][]) r0
            r9[r5] = r0
            r0 = r12[r5]
            int r0 = r0.A7h()
        ...
        L84:
            ...
            int r0 = r12.length
            r0 = r3[r0]
            java.lang.Object[] r0 = com.facebook.ads.redexgen.X.C0676Iy.A0k(r0, r1)
            ...
            com.facebook.ads.redexgen.X.Av[] r2 = (com.facebook.ads.redexgen.X.C0486Av[]) r2
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.V3.A0T(com.facebook.ads.redexgen.X.Au[], com.facebook.ads.internal.exoplayer2.source.TrackGroupArray):com.facebook.ads.redexgen.X.HU");
    }
