...
public abstract class V4 implements HQ {
    ...
    public V4(TrackGroup trackGroup, int... iArr) {
        IJ.A04(iArr.length > 0);
        this.A04 = (TrackGroup) IJ.A01(trackGroup);
    ...
    @Override // com.facebook.ads.redexgen.X.HQ
    public final Format A6g(int i2) {
        return this.A02[i2];
    }

    @Override // com.facebook.ads.redexgen.X.HQ
    public final int A6m(int i2) {
        return this.A05[i2];
    }

    @Override // com.facebook.ads.redexgen.X.HQ
    public final Format A7O() {
        return this.A02[A7P()];
    }

    @Override // com.facebook.ads.redexgen.X.HQ
    public final TrackGroup A7f() {
        return this.A04;
    }

    @Override // com.facebook.ads.redexgen.X.HQ
    public void ABm(float f2) {
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        V4 v4 = (V4) obj;
        return this.A04 == v4.A04 && Arrays.equals(this.A05, v4.A05);
    }
