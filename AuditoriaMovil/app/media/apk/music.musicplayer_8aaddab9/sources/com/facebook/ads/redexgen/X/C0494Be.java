...
public final class C0494Be {
    ...
    public boolean A0L;
    public boolean A0M;
    public final InterfaceC0492Bc A0N;
    ...
    public C0494Be(InterfaceC0492Bc interfaceC0492Bc) {
        this.A0N = (InterfaceC0492Bc) IJ.A01(interfaceC0492Bc);
        if (C0676Iy.A02 >= 18) {
            try {
    ...
    private void A08(long j2, long audioTimestampSystemTimeUs) {
        ...
        if (Math.abs(A02 - j2) > 5000000) {
            this.A0N.ACR(audioTimestampPositionFrames, A02, j2, audioTimestampSystemTimeUs);
            this.A0I.A04();
        } else if (Math.abs(A02(audioTimestampPositionFrames) - audioTimestampSystemTimeUs) > 5000000) {
            this.A0N.ABs(audioTimestampPositionFrames, A02, j2, audioTimestampSystemTimeUs);
            this.A0I.A04();
        } else {
            this.A0I.A03();
        }
    ...
    public static boolean A0A(int i2) {
        return C0676Iy.A02 < 23 && (i2 == 5 || i2 == 6);
    }
    ...
    public final void A0G(AudioTrack audioTrack, int i2, int i3, int i4) {
        ...
        this.A02 = i3;
        this.A00 = i4;
        this.A0I = new C0491Bb(audioTrack);
        this.A03 = audioTrack.getSampleRate();
        this.A0M = A0A(i2);
        this.A0L = C0676Iy.A0c(i2);
    ...
    public final boolean A0L(long j2) {
        InterfaceC0492Bc interfaceC0492Bc;
        int playState = this.A0H.getPlayState();
        if (this.A0M) {
            if (playState == 2) {
                this.A0K = false;
        ...
        boolean z = this.A0K;
        this.A0K = A0J(j2);
        if (z && !this.A0K && playState != 1 && (interfaceC0492Bc = this.A0N) != null) {
            interfaceC0492Bc.ACZ(this.A00, AG.A01(this.A05));
        }
        return true;
    }
}
