...
public final class C0919Sn extends OD {
    ...
    static {
        A07();
        A0P = C2U.A01(-1, 77);
        A0M = (int) (C0739Lm.A00 * 12.0f);
        A0N = (int) (C0739Lm.A00 * 8.0f);
        A0J = (int) (C0739Lm.A00 * 26.0f);
        A0L = (int) (C0739Lm.A00 * 144.0f);
        A0K = (int) (C0739Lm.A00 * 48.0f);
        A0O = (int) (C0739Lm.A00 * 16.0f);
        A0Q = (int) (C0739Lm.A00 * 14.0f);
    }

    public C0919Sn(C1046Xo c1046Xo, int i2, boolean z, C1K c1k, boolean z2, String str, InterfaceC0684Jg interfaceC0684Jg, InterfaceC0761Mk interfaceC0761Mk, C0869Qp c0869Qp, MD md) {
        super(c1046Xo, i2, c1k, z2, str, interfaceC0684Jg, interfaceC0761Mk, c0869Qp, md);
        this.A0B = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0G = c1046Xo;
        ...
        this.A09 = new OS(this.A0G, A0Q, 5, A0P, -1);
    ...
    private void A03() {
        ...
        ML.A0K(this.A05);
        this.A05.setLayoutParams(OD.A05);
        this.A05.setTextColor(this.A0A ? this.A07.A06(true) : -1);
        ML.A0X(this.A05, true, 18);
    ...
    private void A05() {
        removeAllViews();
        super.A01.setLayoutParams(OD.A05);
        A03();
        A02();
        A01();
        A04();
    ...
    private void A06() {
        ...
        os.setRating(Float.parseFloat(A03));
    ...
    public void setInfo(C1I c1i, C1L c1l, String str, String str2, @Nullable OG og) {
        super.setInfo(c1i, c1l, str, str2, og);
        this.A06 = c1i;
        this.A08 = c1l;
        A06();
    }
