...
public final class C1Y extends C3G {
    ...
    public C1Y(Context context, E6 e6, long j2, @Nullable CM<C1018Wm> cm, boolean z, @Nullable Handler handler, @Nullable JM jm, int i2) {
        super(2, e6, cm, z);
        this.A0U = j2;
        this.A0T = i2;
        this.A0V = context.getApplicationContext();
        this.A0W = new JC(this.A0V);
        this.A0X = new JL(handler, jm);
        this.A0Y = A0M();
    ...
    */
    ...
    public static Point A02(E0 e0, Format format) throws E9 {
        ...
        while (longEdgePx < length) {
            ...
            if (C0676Iy.A02 >= 21) {
                ...
                Point A0E = e0.A0E(i6, i4);
                if (e0.A0H(A0E.x, A0E.y, format.A01)) {
                    return A0E;
                }
            } else {
                int A04 = C0676Iy.A04(i4, 16) * 16;
                int A042 = C0676Iy.A04(i5, 16) * 16;
                int i7 = A04 * A042;
    ...
    private final MediaFormat A03(Format format, J8 j8, boolean z, int i2) {
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString(A05(1094, 4, 60), format.A0O);
        mediaFormat.setInteger(A05(1359, 5, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH), format.A0F);
        mediaFormat.setInteger(A05(971, 6, 97), format.A08);
        EC.A06(mediaFormat, format.A0P);
        EC.A03(mediaFormat, A05(954, 10, SyslogConstants.LOG_CLOCK), format.A01);
        EC.A04(mediaFormat, A05(1180, 16, 77), format.A0B);
        EC.A02(mediaFormat, format.A0J);
        mediaFormat.setInteger(A05(1079, 9, 16), j8.A02);
        mediaFormat.setInteger(A05(1055, 10, 79), j8.A00);
        EC.A04(mediaFormat, A05(1065, 14, 77), j8.A01);
        if (C0676Iy.A02 >= 23) {
    ...
    private final J8 A04(E0 e0, Format format, Format[] formatArr) throws E9 {
        int i2 = format.A0F;
        int i3 = format.A08;
        int A00 = A00(e0, format);
        if (formatArr.length == 1) {
            return new J8(i2, i3, A00);
        }
        boolean z = false;
        for (Format format2 : formatArr) {
            if (A0V(e0.A03, format, format2)) {
                ...
                A00 = Math.max(A00, A00(e0, format2));
            }
        }
        if (z) {
            ...
            Log.w(A052, sb2);
            Point A02 = A02(e0, format);
            if (A02 != null) {
                i2 = Math.max(i2, A02.x);
                i3 = Math.max(i3, A02.y);
                A00 = Math.max(A00, A01(e0, format.A0O, i2, i3));
    ...
    private void A06() {
        MediaCodec A1C;
        this.A0R = false;
        if (C0676Iy.A02 >= 23 && this.A0S && (A1C = A1C()) != null) {
            this.A00 = new J9(this, A1C);
        }
    }
    ...
    private void A09() {
        ...
        if (this.A0E != this.A08 || this.A0C != this.A06 || this.A0D != this.A07 || this.A03 != this.A01) {
            ...
            jl.A01(this.A08, this.A06, this.A07, this.A01);
            this.A0E = this.A08;
            this.A0C = this.A06;
            this.A0D = this.A07;
            this.A03 = this.A01;
    ...
    private void A0L(Surface surface) throws AM {
        ...
        if (this.A0O != surface) {
            ...
            if (A7V == 1 || A7V == 2) {
                MediaCodec A1C = A1C();
                if (C0676Iy.A02 >= 23 && A1C != null && surface != null && !this.A0Q) {
                    A0J(A1C, surface);
                } else {
                    A1G();
                    A1I();
    ...
    public static boolean A0M() {
        if (C0676Iy.A02 <= 22) {
            if (A05(948, 6, 4).equals(C0676Iy.A03)) {
                if (A05(545, 6, 122).equals(C0676Iy.A05)) {
                    return true;
                }
            }
        }
    ...
    private final boolean A0S(MediaCodec mediaCodec, int i2, long j2, long j3) throws AM {
        int A0z = A0z(j3);
        if (A0z == 0) {
            return false;
        }
    ...
    */
    ...
    public static boolean A0V(boolean z, Format format, Format format2) {
        if (format.A0O.equals(format2.A0O) && format.A0B == format2.A0B && (z || (format.A0F == format2.A0F && format.A08 == format2.A08))) {
            ...
            if (C0676Iy.A0g(colorInfo, colorInfo2)) {
                return true;
            }
        }
        return false;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.CM != com.facebook.ads.internal.exoplayer2.drm.DrmSessionManager<com.facebook.ads.internal.exoplayer2.drm.FrameworkMediaCrypto> */
    @Override // com.facebook.ads.redexgen.X.C3G
    public final int A1B(E6 e6, CM<C1018Wm> cm, Format format) throws E9 {
        ...
        if (C0653Ib.A0B(str)) {
            ...
            if (strArr[2].charAt(13) != strArr[0].charAt(13)) {
                ...
                strArr2[1] = "UL9g0IqkI";
                if (A6M == null) {
                    return (!z || e6.A6M(str, false) == null) ? 1 : 2;
                } else if (AbstractC0546Ds.A0x(cm, drmInitData)) {
                    boolean A0I = A6M.A0I(format.A0K);
                    if (A0I && format.A0F > 0 && format.A08 > 0) {
                        if (C0676Iy.A02 >= 21) {
                            ...
                            A0I = A6M.A0H(i3, i4, format.A01);
                        } else {
                            A0I = format.A0F * format.A08 <= EB.A00();
                            if (!A0I) {
                                String str2 = A05(298, 29, 54) + format.A0F + A05(1379, 1, 65) + format.A08 + A05(856, 3, 97) + C0676Iy.A04 + A05(855, 1, 27);
                            }
                        }
                    }
                    boolean decoderCapable = A6M.A03;
                    int i5 = decoderCapable ? 16 : 8;
                    boolean decoderCapable2 = A6M.A06;
    ...
    */
    ...
    public final void A1M(C1024Ws c1024Ws) {
        this.A04++;
        this.A0K = Math.max(c1024Ws.A00, this.A0K);
        if (C0676Iy.A02 < 23 && this.A0S) {
            A1R();
        }
    }
    ...
    public final void A1N(E0 e0, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws E9 {
        ...
        if (C0676Iy.A02 >= 23 && this.A0S) {
            this.A00 = new J9(this, mediaCodec);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.C3G
    public final boolean A1P(long unadjustedFrameReleaseTimeNs, long j2, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i2, int i3, long unadjustedFrameReleaseTimeNs2, boolean z) throws AM {
                ...
                if (!this.A0R || (z2 && A0R(j3, j4 - this.A0L))) {
                    ...
                    if (C0676Iy.A02 >= 21) {
                        ...
                        if (adjustedReleaseTimeNs > 11000) {
                            try {
                                Thread.sleep((adjustedReleaseTimeNs - AbstractComponentTracker.LINGERING_TIMEOUT) / 1000);
