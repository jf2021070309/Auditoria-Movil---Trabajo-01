...
public final class C5N implements NativeAdScrollViewApi {
    ...
    public C5N(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @Nullable NativeAdScrollView.AdViewProvider adViewProvider, int i2, @Nullable NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i3) {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i2 > 0) {
                ...
                this.A02 = type;
                this.A00 = i3;
                C1199bR c1199bR = new C1199bR(this);
                this.A05 = new C1198bQ(context);
                if (this.A02 == null) {
                    if (i2 > 0) {
                        this.A05.A00(((int) C0739Lm.A00) * i2);
                    }
                } else {
                    this.A05.A00((int) (C0739Lm.A00 * this.A02.getHeight()));
                }
                this.A05.setAdapter(c1199bR);
                setInset(20);
                c1199bR.A0D();
