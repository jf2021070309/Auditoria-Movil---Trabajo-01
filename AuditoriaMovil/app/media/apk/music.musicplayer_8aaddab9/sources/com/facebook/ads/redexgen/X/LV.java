...
public final class LV {
    ...
    @VisibleForTesting
    public static Intent A01(C1046Xo c1046Xo, Uri uri) {
        Intent A002 = A00(uri);
        A002.addCategory(A02(SyslogConstants.LOG_LOCAL2, 33, 39));
        A002.addFlags(268435456);
        A002.putExtra(A02(198, 34, 15), c1046Xo.getPackageName());
        A002.putExtra(A02(270, 14, 67), false);
        if (JQ.A1I(c1046Xo)) {
    ...
    private void A04(C1046Xo c1046Xo, Uri uri) {
        LL.A0B(c1046Xo, A01(c1046Xo, uri));
    }

    private final void A05(C1046Xo c1046Xo, Uri uri) throws LT {
        if (A0C(c1046Xo)) {
            Intent A012 = A01(c1046Xo, uri);
    ...
    private void A06(C1046Xo c1046Xo, Uri uri, String str) {
        AdActivityIntent A04 = LL.A04(c1046Xo);
        A04.addFlags(268435456);
        A04.putExtra(A02(361, 8, 31), EnumC0717Kp.A02);
        ...
        try {
            ...
            c1046Xo.A06().A8y(A02(FacebookMediationAdapter.ERROR_NULL_CONTEXT, 11, 73), C04398z.A05, new AnonymousClass90(e2));
            Log.e(A02(90, 17, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), A02(0, 90, 82), e2);
        }
    }

    private final void A07(C1046Xo c1046Xo, Uri uri, String str) {
        LL.A0D(c1046Xo, uri, str);
    }

    private final void A08(C1046Xo c1046Xo, Uri uri, String str) {
        boolean A05 = JR.A05(c1046Xo);
        if (A0B(uri) && A05) {
            A06(c1046Xo, uri, str);
            return;
        }
    ...
    public static void A09(LV lv, C1046Xo c1046Xo, Uri uri, String str) {
        lv.A07(c1046Xo, uri, str);
    }

    public static void A0A(LV lv, C1046Xo c1046Xo, Uri uri, String str) {
        boolean z;
        try {
            if (A0B(uri)) {
    ...
    */
    public static boolean A0B(android.net.Uri r5) {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.LV.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L61:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.LV.A0B(android.net.Uri):boolean");
    }

    private boolean A0C(C1046Xo c1046Xo) {
        for (ResolveInfo appInfo : c1046Xo.getPackageManager().queryIntentActivities(new Intent(A02(118, 26, 123), Uri.parse(A02(301, 34, 19))), 0)) {
