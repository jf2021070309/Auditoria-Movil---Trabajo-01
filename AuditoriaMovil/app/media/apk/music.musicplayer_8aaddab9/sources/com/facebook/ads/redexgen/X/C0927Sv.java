...
public final class C0927Sv extends O0 {
    ...
    public final WeakReference<O3> A0A;
    ...
    static {
        A06();
        A0H = C0927Sv.class.getSimpleName();
    }

    public C0927Sv(C1046Xo c1046Xo, WeakReference<O3> weakReference, int i2, String str) {
        this(c1046Xo, weakReference, i2, false);
        if (JQ.A1F(c1046Xo)) {
            c1046Xo.A00().A09().AFU(this, str == null ? A04(0, 0, 74) : str, false, true);
            this.A06 = true;
        }
    }

    public C0927Sv(C1046Xo c1046Xo, WeakReference<O3> weakReference, int i2, boolean z) {
        super(c1046Xo);
        this.A0B = new AtomicBoolean();
        this.A0C = new AtomicBoolean(true);
        this.A07 = new Path();
        this.A08 = new RectF();
        this.A0D = new AtomicInteger(Level.TRACE_INT);
        ...
        this.A02 = new C0931Sz(this);
        this.A03 = new C0869Qp(this, i2, new WeakReference(this.A02), this.A09);
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        if (Build.VERSION.SDK_INT > 16) {
            addJavascriptInterface(new O2(this, weakReference.get(), this.A03, this.A0B, this.A0C, this.A09), A04(0, 9, 97));
        }
    }
    ...
    public final WebViewClient A0E() {
        return new O5(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }
    ...
    public final void A0F() {
        this.A09.A0D().AFW();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C0929Sx(this.A03));
    }

    public final void A0G(int i2, int i3) {
        C0869Qp c0869Qp = this.A03;
        if (c0869Qp != null) {
            c0869Qp.A0W(i2);
            this.A03.A0X(i3);
        }
