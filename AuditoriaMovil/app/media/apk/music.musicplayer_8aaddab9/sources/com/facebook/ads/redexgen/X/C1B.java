...
public final class C1B implements Serializable {
    ...
    public static String A01(int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < copyOfRange.length; i5++) {
            byte b2 = (byte) ((copyOfRange[i5] ^ i4) ^ 58);
            String[] strArr = A0B;
    ...
    public static C1B A00(JSONObject jSONObject) {
        ...
        C1D A0I = new C1D().A0K(jSONObject.optString(A01(472, 9, 61))).A0H(jSONObject.optLong(A01(448, 24, 104), -1L)).A0F(optInt).A0E(jSONObject.optInt(A01(250, 18, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), Integer.MAX_VALUE)).A0I(C1W.A01(jSONObject));
        JSONObject optJSONObject = jSONObject.optJSONObject(A01(SyslogConstants.LOG_LOCAL5, 5, 84));
        if (optJSONObject != null) {
            C1D adMediaBuilder = A0I.A0J(optJSONObject.optString(A01(405, 3, 58)));
            C1D adMediaBuilder2 = adMediaBuilder.A0D(optJSONObject.optInt(A01(481, 5, 21)));
            if (A0B[1].length() == 16) {
        ...
        c1b.A08(new C1M(C0743Ls.A04(jSONObject.optJSONArray(A01(123, 15, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT)))));
