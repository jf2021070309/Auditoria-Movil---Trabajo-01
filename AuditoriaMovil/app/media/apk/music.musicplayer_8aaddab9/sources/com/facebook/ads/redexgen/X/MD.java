...
public final class MD {
    ...
    static {
        A02();
        A0K = MD.class.getSimpleName();
    }

    private EnumC0742Lr A00() {
        View view;
        View view2 = this.A0G;
        if (view2 == null || (view = this.A0F) == null) {
            return EnumC0742Lr.A0I;
        }
        if (view2 != view) {
            return EnumC0742Lr.A0G;
        }
        if (Build.VERSION.SDK_INT < 4) {
            return EnumC0742Lr.A0F;
        }
        Object tag = this.A0G.getTag(EnumC0742Lr.A02);
        if (tag == null) {
            return EnumC0742Lr.A0H;
        }
        if (!(tag instanceof EnumC0742Lr)) {
            return EnumC0742Lr.A0J;
        }
        return (EnumC0742Lr) tag;
    }
    ...
    public final Map<String, String> A04() {
        ...
        if (j3 > 0) {
            ...
            if (j4 > j3) {
                ...
                hashMap.put(A01(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 6, 16), String.valueOf(this.A03));
                ...
                hashMap.put(A01(SyslogConstants.LOG_LOCAL1, 7, 117), valueOf);
        ...
        hashMap2.put(A01(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 6, 16), String.valueOf(this.A03));
        ...
        hashMap2.put(A01(SyslogConstants.LOG_LOCAL1, 7, 117), valueOf);
    ...
    public final void A06(MotionEvent motionEvent, View view, View view2) {
        ...
        if (action != 0) {
            ...
            this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / C0739Lm.A00);
            this.A08 = (int) (((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1]) / C0739Lm.A00);
            this.A0F = view2;
            return;
        }
        this.A04 = (int) (iArr[0] / C0739Lm.A00);
        this.A05 = (int) (iArr[1] / C0739Lm.A00);
        this.A06 = (int) (view.getWidth() / C0739Lm.A00);
        this.A03 = (int) (view.getHeight() / C0739Lm.A00);
        this.A09 = 1;
        this.A0E = System.currentTimeMillis();
        this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / C0739Lm.A00);
        this.A0B = (int) (((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1]) / C0739Lm.A00);
