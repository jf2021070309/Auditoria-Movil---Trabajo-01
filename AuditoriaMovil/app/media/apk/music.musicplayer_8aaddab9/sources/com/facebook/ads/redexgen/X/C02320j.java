    ...
    */
    public static java.util.Collection<java.lang.String> A01(@androidx.annotation.Nullable org.json.JSONArray r3) {
        ...
        L20:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C02320j.A01(org.json.JSONArray):java.util.Collection");
    }

    public static boolean A03(C1046Xo c1046Xo, InterfaceC02310i interfaceC02310i, InterfaceC0684Jg interfaceC0684Jg) {
        EnumC02300h A6o = interfaceC02310i.A6o();
        if (A6o == null || A6o == EnumC02300h.A03) {
            return false;
        }
        boolean z = false;
        Collection<String> A6N = interfaceC02310i.A6N();
        ...
        while (true) {
            ...
            if (C0744Lt.A04(c1046Xo, packageName)) {
                z = true;
                break;
            }
        }
        if (z != (A6o == EnumC02300h.A02)) {
            return false;
        }
        String A64 = interfaceC02310i.A64();
        boolean isEmpty = TextUtils.isEmpty(A64);
        String[] strArr = A01;
        ...
        A06.A8y(packageName3, i2, anonymousClass90);
        return true;
    }
}
