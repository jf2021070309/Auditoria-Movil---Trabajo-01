...
public final class LJ implements Window.Callback {
    public static final List<LI> A01 = Collections.synchronizedList(new ArrayList());
    public Window.Callback A00;

    public LJ(Window.Callback callback, Activity activity) {
        this.A00 = callback;
    }

    public static void A00(LI li) {
        A01.add(li);
    }
