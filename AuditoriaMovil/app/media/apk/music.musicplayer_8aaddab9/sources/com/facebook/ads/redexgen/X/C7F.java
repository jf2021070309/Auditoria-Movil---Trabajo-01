...
public final class C7F {
    ...
    public C7F(Context context, EnumC03996z enumC03996z, @Nullable String str) {
        try {
            A04(context);
            if (enumC03996z.A04() == EnumC03996z.A0G.A04()) {
                A05(context, str);
            }
        } catch (Throwable th) {
            C6O.A03(th);
    ...
    public static C7F A00(Context context, EnumC03996z enumC03996z, @Nullable String str) {
        if (A01 == null) {
            A01 = new C7F(context, enumC03996z, str);
        }
        return A01;
    }
