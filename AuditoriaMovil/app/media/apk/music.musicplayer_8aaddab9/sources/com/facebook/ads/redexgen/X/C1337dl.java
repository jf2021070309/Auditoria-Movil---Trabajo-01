...
public final class C1337dl implements C0K {
    ...
    static {
        A04();
        A07 = C1337dl.class.getSimpleName();
    }

    public C1337dl(String str) {
        this(str, C0I.A01(str));
    }

    public C1337dl(String str, int i2) {
        this(str);
        this.A00 = i2;
    }

    public C1337dl(String str, @Nullable String str2) {
        this.A05 = Level.ALL_INT;
        this.A00 = -1;
    ...
    private HttpURLConnection A02(int i2, int i3) throws IOException, C1339dn {
        String A01;
        ...
        do {
            ...
            sb.append(A01(234, 16, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH));
            if (i2 > 0) {
                A01 = A01(19, 13, 86) + i2;
            } else {
                A01 = A01(0, 0, 78);
            ...
            if (code > 5) {
                throw new C1339dn(A01(293, 20, 106) + code);
            }
        } while (z);
        return httpURLConnection;
    }

    private void A03() throws C1339dn {
    ...
    private final void A05(int i2, int i3) throws C1339dn {
        try {
            this.A02 = A02(i2, i3);
            this.A06 = this.A02.getContentType();
            this.A01 = new BufferedInputStream(this.A02.getInputStream(), Compressor.BUFFER_SIZE);
            this.A05 = A00(this.A02, i2, this.A02.getResponseCode());
        } catch (IOException e2) {
            throw new C1339dn(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i2, e2);
        }
    }
    ...
    public final void close() throws C1339dn {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C1339dn(A01(92, 37, 93), e2);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final synchronized int length() throws C1339dn {
        int i2;
        int i3 = this.A05;
    ...
    public final int read(byte[] bArr) throws C1339dn {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C1339dn(A01 + this.A03, e3);
            }
        }
        throw new C1339dn(A01 + this.A03 + A01(51, 23, 21));
    }
