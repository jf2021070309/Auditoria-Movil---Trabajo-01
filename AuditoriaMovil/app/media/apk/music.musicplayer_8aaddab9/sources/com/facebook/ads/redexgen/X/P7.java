...
public final class P7 {
    ...
    public static WebResourceResponse A00(C1046Xo c1046Xo, WebResourceRequest webResourceRequest, Uri uri, String str, HashMap<String, String> hashMap) throws IOException {
        String A02 = A02(85, 5, 49);
        try {
            P8 p8 = new P8(uri, C0857Qd.A05(c1046Xo).A0E(c1046Xo));
            int available = p8.available();
            if (available <= 0) {
                A05(c1046Xo, 1, new Pair[]{new Pair(A02(61, 9, 77), String.valueOf(available))});
                return null;
            }
            ...
            if (A03 != null) {
                try {
                    ...
                    if (rangeHeader.charAt(0) != '8') {
                        ...
                        c1046Xo.A0D().A52();
                        return new WebResourceResponse(str, null, 206, A02(46, 15, 36), hashMap, p8);
                    }
                    throw new RuntimeException();
                } catch (NumberFormatException e2) {
                    String rangeHeader3 = e2.toString();
                    A05(c1046Xo, 3, new Pair[]{new Pair(A02, rangeHeader3)});
                    return null;
                }
            }
            c1046Xo.A0D().A52();
            ...
            A05(c1046Xo, 2, new Pair[]{new Pair(A02, e3.toString())});
            return null;
        }
    }

    @RequiresApi(api = CommonStatusCodes.RECONNECTION_TIMED_OUT_DURING_UPDATE)
    public static P6 A01(String str) {
        if (str == null) {
            P6 p6 = new P6();
            p6.A03 = false;
            p6.A02 = null;
        ...
        if (split.length >= 2) {
            if (A02(70, 5, 60).equals(split[0].toLowerCase(Locale.US).trim())) {
                ...
                p63.A03 = true;
                p63.A02 = str;
                p63.A01 = TextUtils.isEmpty(split2[0]) ? 0 : Integer.parseInt(split2[0]);
                if (split2.length > 1) {
                    p63.A00 = TextUtils.isEmpty(split2[1]) ? -1 : Integer.parseInt(split2[1]);
                } else {
                    p63.A00 = -1;
                }
                return p63;
    ...
    public static void A05(C1046Xo c1046Xo, int i2, Pair<String, String>[] pairArr) {
        ...
        c1046Xo.A0D().A51(jSONObject.toString());
    }
