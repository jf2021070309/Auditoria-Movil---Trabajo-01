...
public abstract class C3G extends AbstractC0546Ds {
    ...
    public Format A07;
    public CL<C1018Wm> A08;
    public CL<C1018Wm> A09;
    public E0 A0A;
    ...
    public final AZ A0W;
    public final C1024Ws A0X;
    public final C1024Ws A0Y;
    @Nullable
    public final CM<C1018Wm> A0Z;
    public final E6 A0a;
    ...
    public abstract int A1B(E6 e6, CM<C1018Wm> cm, Format format) throws E9;

    public abstract void A1N(E0 e0, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws E9;

    public abstract boolean A1P(long j2, long j3, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i2, int i3, long j4, boolean z) throws AM;

    static {
        A0j();
        A0f = C0676Iy.A0h(A0Z(59, 76, 80));
    }
    ...
    public C3G(int i2, E6 e6, @Nullable CM<C1018Wm> cm, boolean z) {
        super(i2);
        IJ.A04(C0676Iy.A02 >= 16);
        this.A0a = (E6) IJ.A01(e6);
        this.A0Z = cm;
        this.A0c = z;
        this.A0X = new C1024Ws(0);
        this.A0Y = C1024Ws.A02();
        this.A0W = new AZ();
    ...
    private int A0W(String str) {
        if (C0676Iy.A02 <= 25 && A0Z(263, 25, 64).equals(str)) {
            String str2 = C0676Iy.A06;
            if (A0e[5].charAt(22) != 'm') {
                String[] strArr = A0e;
                strArr[3] = "rXHSxRetqBcaMazmAuD1LrMN32rrN6yB";
                strArr[0] = "PYELojq5TDB6rkMOhN6BPW4xOGIFZ2Jw";
                if (str2.startsWith(A0Z(625, 7, 8)) || C0676Iy.A06.startsWith(A0Z(597, 7, 55)) || C0676Iy.A06.startsWith(A0Z(604, 7, 110)) || C0676Iy.A06.startsWith(A0Z(618, 7, 51))) {
                    return 2;
                }
            }
        ...
        if (C0676Iy.A02 < 24) {
            if (A0Z(338, 22, 88).equals(str) || A0Z(360, 29, 116).equals(str)) {
                if (!A0Z(683, 8, 33).equals(C0676Iy.A03)) {
                    String str3 = C0676Iy.A03;
                    String A0Z = A0Z(691, 12, 106);
                    String[] strArr2 = A0e;
                    if (strArr2[1].charAt(9) != strArr2[6].charAt(9)) {
                        A0e[7] = "EJTrH92MD698cCrSnGocCFo99KF41O7G";
                        if (!A0Z.equals(str3)) {
                            if (!A0Z(703, 7, 118).equals(C0676Iy.A03)) {
                                if (A0Z(732, 7, 17).equals(C0676Iy.A03)) {
                                    return 1;
                                }
                                return 0;
                            }
    ...
    public static MediaCodec.CryptoInfo A0Y(C1024Ws c1024Ws, int i2) {
        MediaCodec.CryptoInfo A02 = c1024Ws.A02.A02();
        if (i2 == 0) {
            return A02;
        }
    ...
    private boolean A0l() {
        if (A0Z(147, 6, 32).equals(C0676Iy.A05)) {
            if (!A0Z(139, 4, 90).equals(C0676Iy.A06)) {
                if (A0Z(135, 4, 82).equals(C0676Iy.A06)) {
                }
            }
            return true;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0092, code lost:
        r16.A0C = false;
        r16.A0X.A01.put(com.facebook.ads.redexgen.X.C3G.A0f);
        r16.A06.queueInputBuffer(r16.A03, 0, com.facebook.ads.redexgen.X.C3G.A0f.length, 0, 0);
        A0h();
        r16.A0J = true;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:95:0x01d9, code lost:
        com.facebook.ads.redexgen.X.C0656Ie.A0A(r16.A0X.A01);
     */
    ...
    */
    ...
    private boolean A0p(long j2, long j3) throws AM {
        boolean A1P;
    ...
    public static boolean A0q(E0 e0) {
        String str = e0.A02;
        if (C0676Iy.A02 > 17 || (!A0Z(573, 24, 89).equals(str) && !A0Z(426, 31, 118).equals(str))) {
            if (A0Z(147, 6, 32).equals(C0676Iy.A05)) {
                if (!A0Z(143, 4, 72).equals(C0676Iy.A06) || !e0.A05) {
                }
            }
            return false;
        }
    ...
    public static boolean A0r(String str) {
        if (C0676Iy.A02 > 23 || !A0Z(548, 25, 69).equals(str)) {
            if (C0676Iy.A02 <= 19) {
                if (A0Z(710, 6, 87).equals(C0676Iy.A03)) {
                    String[] strArr = A0e;
                    if (strArr[3].charAt(8) == strArr[0].charAt(8)) {
                        throw new RuntimeException();
                    }
    ...
    public static boolean A0s(String str) {
        return C0676Iy.A02 == 21 && A0Z(526, 22, 34).equals(str);
    }
    ...
    */
    public static boolean A0t(java.lang.String r4) {
        /*
            int r0 = com.facebook.ads.redexgen.X.C0676Iy.A02
            r1 = 18
            if (r0 < r1) goto L81
            int r0 = com.facebook.ads.redexgen.X.C0676Iy.A02
            if (r0 != r1) goto L4a
            ...
            if (r0 != 0) goto L81
        L4a:
            int r1 = com.facebook.ads.redexgen.X.C0676Iy.A02
            r0 = 19
            if (r1 != r0) goto L83
            java.lang.String r3 = com.facebook.ads.redexgen.X.C0676Iy.A06
    ...
    public static boolean A0u(String str, Format format) {
        return C0676Iy.A02 < 21 && format.A0P.isEmpty() && A0Z(313, 25, 36).equals(str);
    }

    public static boolean A0v(String str, Format format) {
        return C0676Iy.A02 <= 18 && format.A05 == 1 && A0Z(288, 25, 17).equals(str);
    }
    ...
    private boolean A0w(boolean z) throws AM {
        ...
        int A7V = this.A08.A7V();
        if (A7V != 1) {
            return A7V != 4;
        }
        throw AM.A01(this.A08.A6X(), A0y());
    }
    ...
    public void A12() {
        ...
        try {
            ...
            try {
                if (this.A08 != null) {
                    this.A0Z.ADp(this.A08);
                }
                try {
                    if (this.A09 != null && this.A09 != this.A08) {
                        this.A0Z.ADp(this.A09);
                    }
                } finally {
                }
            } catch (Throwable th) {
    ...
    public final void A1I() throws AM {
        ...
        if (this.A0A == null) {
            try {
                ...
                A0k(new E2(this.A07, e2, z, -49998));
            }
            if (this.A0A == null) {
                A0k(new E2(this.A07, (Throwable) null, z, -49999));
            }
        }
        if (!A1Q(this.A0A)) {
            return;
    ...
    public void A1L(Format format) throws AM {
        ...
        if (!C0676Iy.A0g(drmInitData2, drmInitData)) {
            if (this.A07.A0H != null) {
                CM<C1018Wm> cm = this.A0Z;
                if (A0e[5].charAt(22) != 'm') {
                    String[] strArr = A0e;
                    ...
                    if (cm != null) {
                        ...
                        if (A0e[5].charAt(22) != 'm') {
                            ...
                            this.A09 = cm.A2P(myLooper, drmInitData3);
                            CL<C1018Wm> cl = this.A09;
                            if (cl == this.A08) {
                                CM<C1018Wm> cm2 = this.A0Z;
                                String[] strArr2 = A0e;
                                if (strArr2[1].charAt(9) == strArr2[6].charAt(9)) {
                                    throw new RuntimeException();
                                }
                        ...
                        throw AM.A01(new IllegalStateException(A0Z(193, 34, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT)), A0y());
                    }
                }
                throw new RuntimeException();
            }
    ...
    public void A1M(C1024Ws c1024Ws) {
    }
    ...
    */
    ...
    public final int AFC(Format format) throws AM {
        try {
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0546Ds, com.facebook.ads.redexgen.X.InterfaceC0485Au
