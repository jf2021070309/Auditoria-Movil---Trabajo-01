...
public final class ML {
    ...
    public static int A01(int i2) {
        return (int) TypedValue.applyDimension(2, i2, C0739Lm.A01);
    }

    public static int A02(int i2) {
        if (A0a(i2)) {
            return C2U.A02(i2, -1, 0.4f);
        }
        return C2U.A02(i2, -16777216, 0.2f);
    }
    ...
    public static void A0F(int i2, View view) {
        ...
        scaleAnimation.setAnimationListener(new C0933Tb(view, scaleAnimation2));
