...
public final class C1026Wu implements BL {
    ...
    public final float A00(float f2) {
        float A00 = C0676Iy.A00(f2, 0.1f, 8.0f);
        if (this.A00 != A00) {
            this.A00 = A00;
            this.A08 = null;
        }
    ...
    public final long A02(long j2) {
        ...
        if (j3 >= FileSize.KB_COEFFICIENT) {
            ...
            int i3 = this.A05;
            if (i2 == i3) {
                return C0676Iy.A0F(j2, this.A06, j3);
            }
            return C0676Iy.A0F(j2, this.A06 * i2, j3 * i3);
        }
        return (long) (this.A01 * j2);
    }

    @Override // com.facebook.ads.redexgen.X.BL
    public final boolean A46(int i2, int i3, int i4) throws BK {
        if (i4 == 2) {
            int i5 = this.A04;
            if (i5 == -1) {
                i5 = i2;
        ...
        throw new BK(i2, i3, i4);
    }

    @Override // com.facebook.ads.redexgen.X.BL
    public final ByteBuffer A72() {
    ...
    public final boolean A8R() {
        C0506Bq c0506Bq;
        return this.A0C && ((c0506Bq = this.A08) == null || c0506Bq.A0H() == 0);
    }

    @Override // com.facebook.ads.redexgen.X.BL
    public final void ADR() {
        IJ.A04(this.A08 != null);
        this.A08.A0J();
        this.A0C = true;
    }

    @Override // com.facebook.ads.redexgen.X.BL
    public final void ADS(ByteBuffer byteBuffer) {
        IJ.A04(this.A08 != null);
    ...
    public final void flush() {
        if (A8N()) {
            C0506Bq c0506Bq = this.A08;
            if (c0506Bq == null) {
                this.A08 = new C0506Bq(this.A05, this.A02, this.A01, this.A00, this.A03);
            } else {
                c0506Bq.A0I();
            }
        }
