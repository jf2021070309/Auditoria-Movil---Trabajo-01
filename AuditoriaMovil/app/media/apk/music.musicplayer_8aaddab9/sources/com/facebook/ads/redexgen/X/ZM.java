...
public class ZM implements AnonymousClass72<String> {
    ...
    public final boolean A8S(Object obj) {
        ZM zm = (ZM) obj;
        File file = this.A03;
        if (file == null || zm.A03 == null) {
            return false;
        }
        String absolutePath = file.getAbsolutePath();
        String absolutePath2 = zm.A03.getAbsolutePath();
        String[] strArr = A05;
        ...
        if (absolutePath.equals(absolutePath2) && this.A00 == zm.A00) {
            long j2 = this.A02;
            long j3 = zm.A02;
            String[] strArr3 = A05;
