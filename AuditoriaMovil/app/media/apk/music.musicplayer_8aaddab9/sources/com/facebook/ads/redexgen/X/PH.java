...
public final class PH {
    ...
    public static PG A00(C1046Xo c1046Xo, JSONObject jSONObject, C7U c7u, C0692Jo c0692Jo, C0820Or c0820Or, boolean z) {
        boolean updateUrls;
        String str;
        String str2;
        boolean z2 = z;
        ...
        if (z2) {
            str = c7u.A0P(optString);
            str2 = c7u.A0P(optString2);
        ...
        c0692Jo.A02(EnumC0691Jn.A0P, null);
        try {
            ...
            if (optJSONObject != null && optJSONObject.optString(A012) != null) {
                ...
                if (updateUrls) {
                    optJSONObject.put(A012, c7u.A0O(optJSONObject.optString(A012)));
                }
            }
            ...
            if (optJSONArray != null) {
                for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                    ...
                    if (updateUrls) {
                        optJSONArray.put(i2, c7u.A0O(optString3));
                    }
                }
            }
            ...
            if (optJSONArray2 != null) {
                for (int i3 = 0; i3 < optJSONArray2.length(); i3++) {
                    A03(arrayList, arrayList2, optJSONArray2.optJSONObject(i3), c7u, updateUrls);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c7u, updateUrls);
            }
        } catch (JSONException unused) {
            c0820Or.A04(C04398z.A0w, A01(0, 43, 79));
        }
        return new PG(jSONObject, str, str2, arrayList, arrayList2, arrayList3, z2);
    }
    ...
    public static void A03(ArrayList<String> arrayList, ArrayList<String> arrayList2, JSONObject jSONObject, C7U c7u, boolean z) throws JSONException {
        ...
        if (optJSONObject != null) {
            ...
            if (optJSONObject.optString(A012) != null) {
                ...
                if (z) {
                    optJSONObject.put(A012, c7u.A0O(optString));
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(A013))) {
            ...
            if (z) {
                jSONObject.put(A013, c7u.A0P(optString2));
            }
        }
    }
}
