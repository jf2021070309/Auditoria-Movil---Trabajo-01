...
public final class C0676Iy {
    ...
    public static long A0F(long multiplicationFactor, long j2, long j3) {
        if (j3 >= j2 && j3 % j2 == 0) {
    ...
    public static long A0G(long result, long j2, long j3) {
        long j4 = result + j2;
    ...
    public static long A0I(long maxPositionUs, C0488Ax c0488Ax, long j2, long j3) {
        if (C0488Ax.A04.equals(c0488Ax)) {
            return maxPositionUs;
        }
        long A0H = A0H(maxPositionUs, c0488Ax.A01, Long.MIN_VALUE);
        long A0G = A0G(maxPositionUs, c0488Ax.A00, Long.MAX_VALUE);
        boolean z = true;
        boolean z2 = A0H <= j2 && j2 <= A0G;
        z = (A0H > j3 || j3 > A0G) ? false : false;
        if (z2 && z) {
    ...
    public static String A0O(String str) {
        ...
        while (i2 > 0 && matcher.find()) {
            ...
            sb.append((CharSequence) str, i5, startOfNotEscaped2);
            sb.append(c2);
            i5 = matcher.end();
            i2--;
        }
        if (i5 < percentCharacterCount) {
            sb.append((CharSequence) str, i5, percentCharacterCount);
        }
    ...
    public static String A0Q(byte[] bArr) {
        return new String(bArr, Charset.forName(A0J(SyslogConstants.LOG_LOCAL3, 5, 63)));
    }

    public static String A0R(byte[] bArr, int i2, int i3) {
        return new String(bArr, i2, i3, Charset.forName(A0J(SyslogConstants.LOG_LOCAL3, 5, 63)));
    }
    ...
    public static ExecutorService A0T(String str) {
        return Executors.newSingleThreadExecutor(new ThreadFactoryC0675Ix(str));
    }
    ...
    public static void A0W(InterfaceC0632He interfaceC0632He) {
    ...
    */
    public static byte[] A0h(java.lang.String r6) {
        /*
            int r0 = r6.length()
            int r0 = r0 / 2
            byte[] r5 = new byte[r0]
        ...
        L2b:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0676Iy.A0h(java.lang.String):byte[]");
    }

    public static byte[] A0i(String str) {
        return str.getBytes(Charset.forName(A0J(SyslogConstants.LOG_LOCAL3, 5, 63)));
    }
