...
public final class AN extends Q8 {
    ...
    @Nullable
    public NativeAd A01;
    public InterfaceC0684Jg A02;
    @Nullable
    public InterfaceC0769Ms A03;
    @Nullable
    public AnonymousClass88 A04;
    @Nullable
    public String A05;
    @Nullable
    public String A06;
    ...
    static {
        A03();
        A0F = AN.class.getSimpleName();
    }

    public AN(C1046Xo c1046Xo) {
        super(c1046Xo);
        this.A0D = UUID.randomUUID().toString();
        this.A0C = new C0476Al(this);
        this.A0B = new C0474Aj(this);
        this.A0A = new C0473Ai(this);
        this.A08 = new AnonymousClass16(this, c1046Xo);
        this.A09 = c1046Xo;
        A02();
    }

    public AN(C1046Xo c1046Xo, AttributeSet attributeSet) {
    ...
    public AN(C1046Xo c1046Xo, AttributeSet attributeSet, int i2) {
    ...
    private void A04(Intent intent) {
        if (this.A04 == null) {
            ...
            intent.putExtra(A01(322, 8, 34), EnumC0717Kp.A06);
    ...
    private void A05(String str) {
        InterfaceC04388y A06 = this.A09.A06();
        int i2 = C04398z.A1x;
        String defaultErrorMessage = AdErrorType.PARSER_FAILURE.getDefaultErrorMessage();
        A06.A8y(A01(198, 7, SyslogConstants.LOG_CLOCK), i2, new AnonymousClass90(defaultErrorMessage, A01(90, 7, 93) + str));
    ...
    public final void A0m() {
        AdActivityIntent A04 = LL.A04(this.A09);
        A04(A04);
        try {
            A0e(false, 6);
            setVisibility(8);
            ...
            this.A09.A06().A8y(A01(SyslogConstants.LOG_LOCAL6, 11, 126), C04398z.A05, new AnonymousClass90(e2));
            Log.e(A01(97, 17, 22), A01(0, 90, 38), e2);
        }
    }

    @Nullable
    public InterfaceC0769Ms getListener() {
        return this.A03;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.Q8, android.view.ViewGroup, android.view.View
    ...
    public void setAdEventManager(InterfaceC0684Jg interfaceC0684Jg) {
        this.A02 = interfaceC0684Jg;
    }

    public void setClientToken(@Nullable String str) {
        AnonymousClass88 anonymousClass88;
        AnonymousClass88 anonymousClass882 = this.A04;
        if (anonymousClass882 != null) {
            anonymousClass882.A0g();
        }
        this.A05 = str;
        if (str != null) {
            anonymousClass88 = new AnonymousClass88(this.A09, this.A02, this, str);
        } else {
            anonymousClass88 = null;
        }
    ...
    public void setListener(@Nullable InterfaceC0769Ms interfaceC0769Ms) {
        this.A03 = interfaceC0769Ms;
    }
