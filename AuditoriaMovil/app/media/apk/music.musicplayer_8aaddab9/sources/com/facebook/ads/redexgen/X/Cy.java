...
public final class Cy {
    ...
    public /* synthetic */ Cy(WW ww) {
        this();
    }

    public static Pair<String, List<byte[]>> A00(C0660Ii c0660Ii) throws C0470Af {
        try {
            c0660Ii.A0Z(16);
            ...
            if (A0K == 826496599) {
                ...
                for (int A06 = c0660Ii.A06() + 20; A06 < bArr.length - 4; A06++) {
                    if (bArr[A06] == 0 && bArr[A06 + 1] == 0) {
                        ...
                        if (offset == 1) {
                            ...
                            if (offset2 == 15) {
                                ...
                                return new Pair<>(A01(934, 10, FacebookMediationAdapter.ERROR_NULL_CONTEXT), Collections.singletonList(bufferData));
                            }
                        } else {
                            continue;
                        }
                ...
                throw new C0470Af(A01(238, 45, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD));
            }
            Log.w(A01(283, 17, 56), A01(419, 51, 124));
            return new Pair<>(A01(944, 15, 9), null);
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw new C0470Af(A01(137, 33, 53));
        }
    }

    public static /* synthetic */ String A02(Cy cy, String str) {
        cy.A0g = str;
        return str;
    }

    public static List<byte[]> A03(byte[] bArr) throws C0470Af {
    ...
    public static boolean A05(C0660Ii c0660Ii) throws C0470Af {
        UUID uuid;
        UUID uuid2;
        try {
            int A0C = c0660Ii.A0C();
            ...
            if (A0C == 65534) {
                c0660Ii.A0Y(24);
                long A0L = c0660Ii.A0L();
                uuid = WU.A0s;
                if (A0L == uuid.getMostSignificantBits()) {
                    long A0L2 = c0660Ii.A0L();
                    uuid2 = WU.A0s;
            ...
            throw new C0470Af(A01(170, 34, 13));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:299:0x041c, code lost:
        ...
        r2 = com.facebook.ads.redexgen.X.WU.A0t;
        r7.add(r2);
        r7.add(r27.A0d);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:303:0x0475, code lost:
        if (com.facebook.ads.redexgen.X.Cy.A0i[6].charAt(13) == 'P') goto L60;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:306:0x047d, code lost:
        r6 = com.facebook.ads.redexgen.X.Cy.A0i;
        r6[2] = "mzu";
    ...
    /* JADX WARN: Code restructure failed: missing block: B:310:0x049a, code lost:
        ...
        r7 = com.facebook.ads.redexgen.X.Cy.A0i;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:313:0x04ce, code lost:
        com.facebook.ads.redexgen.X.Cy.A0i[6] = "fbrpEOPCxs8P1PkqPKxhpgVrBLZobrss";
        r2 = com.facebook.ads.internal.exoplayer2.Format.A0A(r8, r1, null, -1, r3, r2, r27.A0g, r27.A0U);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:413:0x0790, code lost:
        throw new com.facebook.ads.redexgen.X.C0470Af(A01(398, 21, 82));
     */
    ...
    */
    public final void A09(com.facebook.ads.redexgen.X.Ce r28, int r29) throws com.facebook.ads.redexgen.X.C0470Af {
        /*
