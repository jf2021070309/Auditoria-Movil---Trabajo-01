...
public abstract class AbstractC03294g {
    ...
    public boolean A05;
    public int A00 = -1;
    public final C03274e A06 = new C03274e(0, 0);
    ...
    public abstract void A0H(int i2, int i3, C03314i c03314i, C03274e c03274e);

    public abstract void A0I(View view, C03314i c03314i, C03274e c03274e);
    ...
    public void A04(int i2, int i3) {
        F6 f6 = this.A03;
        if (!this.A05 || this.A00 == -1 || f6 == null) {
            A09();
        }
        this.A04 = false;
        View view = this.A01;
        if (view != null) {
            ...
            strArr2[0] = "WYaFIbeKL";
            if (A00 == i4) {
                A0I(this.A01, f6.A0s, this.A06);
                C03274e c03274e = this.A06;
                if (A08[5].length() != 9) {
                    String[] strArr3 = A08;
                    strArr3[6] = "M";
                    strArr3[2] = "Q";
    ...
    public final void A0D(F6 f6, C4T c4t) {
        this.A03 = f6;
        this.A02 = c4t;
        if (this.A00 != -1) {
