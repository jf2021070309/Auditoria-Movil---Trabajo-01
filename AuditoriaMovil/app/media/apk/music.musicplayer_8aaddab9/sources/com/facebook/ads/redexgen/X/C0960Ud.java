...
public final class C0960Ud implements ID {
    ...
    public static final C0960Ud A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C0960Ud(Collections.emptyMap());
    }

    public C0960Ud(Map<String, byte[]> map) {
        Map<String, byte[]> metadata = Collections.unmodifiableMap(map);
        this.A01 = metadata;
    }

    public static C0960Ud A00(DataInputStream dataInputStream) throws IOException {
        ...
        return new C0960Ud(hashMap);
    }

    public static Map<String, byte[]> A02(Map<String, byte[]> map, IF r3) {
    ...
    public final C0960Ud A08(IF r3) {
        Map<String, byte[]> A022 = A02(this.A01, r3);
        if (A06(A022)) {
            return this;
        }
        return new C0960Ud(A022);
    }
    ...
    public final long A5W(String str, long j2) {
    ...
    @Override // com.facebook.ads.redexgen.X.ID
    public final String A5Y(String str, String str2) {
        if (this.A01.containsKey(str)) {
