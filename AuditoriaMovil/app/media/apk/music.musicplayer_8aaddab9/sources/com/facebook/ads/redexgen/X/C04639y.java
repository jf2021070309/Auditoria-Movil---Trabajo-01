...
public final class C04639y implements Closeable {
    ...
    public final C04539o A01;
    public final Deque<C04629x> A02 = new LinkedList();
    ...
    public C04639y(C04539o c04539o, InterfaceC04619w interfaceC04619w) throws IOException {
        this.A01 = c04539o;
        A05(c04539o, interfaceC04619w);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C04629x A00() throws IOException {
        int i2 = -1;
        if (!this.A02.isEmpty()) {
        ...
        this.A02.add(new C04629x(i3, new C04599u(newFile)));
    ...
    private void A04(int i2, File file) throws IOException {
        C04599u c04599u = new C04599u(file);
        c04599u.A05();
        this.A02.addFirst(new C04629x(i2, c04599u));
    }

    private void A05(C04539o c04539o, InterfaceC04619w interfaceC04619w) throws IOException {
        File[] listFiles = c04539o.A05().listFiles();
        if (listFiles != null) {
            ...
            for (File file : listFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC04619w.AE1(String.format(Locale.US, A02(260, 39, 79), file.getCanonicalPath()));
                }
            }
            if (!hashMap.isEmpty()) {
                int i3 = i2;
                ...
                while (it.hasNext()) {
                    ...
                    if (intValue < i3) {
                        interfaceC04619w.AE1(String.format(Locale.US, A02(166, 61, 2), Integer.valueOf(intValue), Integer.valueOf(i3)));
                ...
                while (i2 >= i3) {
                    ...
                    try {
                        ...
                        interfaceC04619w.AE2(String.format(Locale.US, A02(104, 62, 43), file2.getCanonicalPath(), Integer.valueOf(i2)), e2);
            ...
            for (File file3 : hashSet) {
                if (!file3.delete()) {
                    interfaceC04619w.AE1(String.format(Locale.US, A02(40, 26, 29), file3.getCanonicalPath()));
                }
            }
            return;
        }
        throw new IOException(String.format(Locale.US, A02(66, 38, 93), c04539o.A05().getCanonicalPath()));
    }
    ...
    public final synchronized C04519m A0A(int i2, int i3, byte[] bArr, int i4, int[] iArr, int i5) throws IOException {
        if (!this.A00) {
            for (C04629x c04629x : this.A02) {
                if (c04629x.A00() == i2) {
                    return new C04519m(i2, c04629x.A02(i3, bArr, i4, iArr, i5));
                }
            }
            return new C04519m(-1, new C9l(EnumC04509k.A04, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 62));
    }
