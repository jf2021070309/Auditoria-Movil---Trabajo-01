...
public class C1248cI<T> implements InterfaceC02782e<T> {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.cI != com.facebook.ads.internal.androidx.support.v4.util.Pools$SimplePool<T> */
    public C1248cI(int i2) {
        if (i2 > 0) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.cI != com.facebook.ads.internal.androidx.support.v4.util.Pools$SimplePool<T> */
    @Override // com.facebook.ads.redexgen.X.InterfaceC02782e
    public T A2O() {
        int i2 = this.A00;
        if (i2 > 0) {
            int i3 = i2 - 1;
