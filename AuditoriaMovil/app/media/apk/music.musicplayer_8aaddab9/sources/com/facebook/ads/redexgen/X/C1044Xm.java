...
public final class C1044Xm extends C8h {
    ...
    static {
        ...
        A09 = new C8b(1, A00(207, 8, 2), A00(89, 59, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION));
        String A002 = A00(4, 7, 49);
        A05 = new C8b(2, A00(173, 8, 25), A002);
        String A003 = A00(69, 4, 81);
        A0A = new C8b(3, A00(215, 4, 66), A003);
        String A004 = A00(11, 4, 110);
        A08 = new C8b(4, A00(203, 4, 55), A004);
        A07 = new C8b(5, A00(191, 12, 9), A004);
        A06 = new C8b(6, A00(181, 10, 19), A003);
        A03 = new C8b(7, A00(155, 4, 29), A003);
        A02 = new C8b(8, A00(148, 7, 100), A002);
        A0B = new C8b[]{A04, A09, A05, A0A, A08, A07, A06, A03, A02};
        A0C = C8h.A02(A00(167, 6, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), A0B);
    }

    public C1044Xm(C04218d c04218d) {
        super(c04218d);
    }
    ...
    public final Cursor A0B() {
        return A05().rawQuery(A00(42, 27, SyslogConstants.LOG_CLOCK), null);
    }
    ...
    public final String A0E(String str, int i2, String str2, double d2, double d3, String str3, Map<String, String> map) throws SQLiteException {
        ...
        if (A01[2].charAt(6) != '9') {
            ...
            A05().insertOrThrow(A00(167, 6, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), null, contentValues);
            return uuid;
        }
    ...
    public final boolean A0F(String str) {
        ...
        return A052.delete(A00(167, 6, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), sb.toString(), new String[]{str}) > 0;
    }
}
