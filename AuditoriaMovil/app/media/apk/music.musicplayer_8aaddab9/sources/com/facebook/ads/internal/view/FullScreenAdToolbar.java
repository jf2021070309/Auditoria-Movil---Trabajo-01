...
import com.facebook.ads.redexgen.X.AbstractC0760Mj;
import com.facebook.ads.redexgen.X.C02491b;
import com.facebook.ads.redexgen.X.C0692Jo;
import com.facebook.ads.redexgen.X.C0739Lm;
import com.facebook.ads.redexgen.X.C0758Mh;
import com.facebook.ads.redexgen.X.C1046Xo;
import com.facebook.ads.redexgen.X.C1K;
import com.facebook.ads.redexgen.X.C1U;
import com.facebook.ads.redexgen.X.InterfaceC0759Mi;
import com.facebook.ads.redexgen.X.InterfaceC0761Mk;
import com.facebook.ads.redexgen.X.ML;
import com.facebook.ads.redexgen.X.N4;
import com.facebook.ads.redexgen.X.PT;
import com.facebook.ads.redexgen.X.View$OnClickListenerC0765Mo;
import java.util.Arrays;
/* loaded from: assets/audience_network.dex */
public final class FullScreenAdToolbar extends AbstractC0760Mj {
    ...
    @Nullable
    public InterfaceC0759Mi A00;
    public final RelativeLayout A01;
    public final C0692Jo A02;
    public final C0758Mh A03;
    ...
    static {
        A03();
        A09 = (int) (C0739Lm.A00 * 10.0f);
        A0D = (int) (C0739Lm.A00 * 16.0f);
        int i2 = A0D;
        int i3 = A09;
        A0B = i2 - i3;
        A0C = (i2 * 2) - i3;
        A0A = (int) (C0739Lm.A00 * 4.0f);
    }

    public FullScreenAdToolbar(C1046Xo c1046Xo, InterfaceC0761Mk interfaceC0761Mk, C0692Jo c0692Jo, @ToolbarActionView$ToolbarActionMode int i2, int i3) {
        super(c1046Xo);
        this.A04 = interfaceC0761Mk;
        this.A02 = c0692Jo;
        setGravity(16);
        this.A05 = new N4(c1046Xo, i2);
        this.A05.setContentDescription(A02(0, 8, 50));
        this.A05.setActionClickListener(new View$OnClickListenerC0765Mo(this));
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0760Mj
    public final void A04(C1K c1k, boolean z) {
        int A04 = c1k.A04(z);
        this.A06.A01(c1k.A0A(z), A04);
        ...
        if (z) {
            ...
            ML.A0Q(this.A03, 0, -16777216, A0A);
            return;
        }
        ML.A0M(this, 0);
    }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0760Mj
    public void setPageDetails(C1U c1u, String str, int i2, C02491b c02491b) {
    ...
    public void setPageDetailsVisible(boolean z) {
        ...
        if (z) {
            ...
            relativeLayout.addView(pt);
        }
        N4 n4 = this.A05;
        String[] strArr2 = A08;
        if (strArr2[2].length() == strArr2[3].length()) {
            n4.setToolbarMessageEnabled(!z);
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC0760Mj
    public void setToolbarListener(InterfaceC0759Mi interfaceC0759Mi) {
        this.A00 = interfaceC0759Mi;
    }
}
