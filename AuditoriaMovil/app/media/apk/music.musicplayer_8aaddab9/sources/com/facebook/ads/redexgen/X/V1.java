...
public final class V1 implements InterfaceC0632He {
    ...
    @Nullable
    public final InterfaceC0651Hz<? super V1> A06;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Hz != com.facebook.ads.internal.exoplayer2.upstream.TransferListener<? super com.facebook.ads.internal.exoplayer2.upstream.ContentDataSource> */
    public V1(Context context, @Nullable InterfaceC0651Hz<? super V1> interfaceC0651Hz) {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0632He
    public final long ACt(C0636Hi c0636Hi) throws C0628Ha {
        try {
            this.A02 = c0636Hi.A04;
            ...
            if (this.A01 != null) {
                ...
                long skip = this.A03.skip(c0636Hi.A03 + startOffset) - startOffset;
                long skipped = c0636Hi.A03;
                ...
                if (i2 == 0) {
                    ...
                    this.A04 = true;
                    InterfaceC0651Hz<? super V1> interfaceC0651Hz = this.A06;
            ...
            throw new C0628Ha(e2);
        }
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0632He
    public final void close() throws C0628Ha {
        int length;
        int i2;
        this.A02 = null;
        try {
            ...
            try {
                try {
                    ...
                    throw new C0628Ha(e3);
                }
            } finally {
                this.A01 = null;
                if (this.A04) {
                    this.A04 = false;
                    InterfaceC0651Hz<? super V1> interfaceC0651Hz2 = this.A06;
            ...
            throw new C0628Ha(e4);
        }
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0632He
    public final int read(byte[] bArr, int i2, int i3) throws C0628Ha {
        if (i3 == 0) {
            return 0;
        }
        long j2 = this.A00;
        ...
        if (read == -1) {
            ...
            throw new C0628Ha(new EOFException());
        }
        long j3 = this.A00;
        if (j3 != -1) {
            this.A00 = j3 - read;
