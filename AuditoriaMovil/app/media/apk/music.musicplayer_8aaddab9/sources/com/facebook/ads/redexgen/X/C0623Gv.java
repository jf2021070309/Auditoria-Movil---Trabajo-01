...
public final class C0623Gv {
    ...
    public C0623Gv(@Nullable String str, String str2, long j2, long j3, H1 h1, String[] strArr, String str3) {
        this.A05 = str;
        this.A06 = str2;
        this.A03 = h1;
        this.A0A = strArr;
        ...
        this.A02 = j2;
        this.A01 = j3;
        this.A04 = (String) IJ.A01(str3);
        this.A09 = new HashMap<>();
        this.A08 = new HashMap<>();
    }

    private final int A00() {
        List<C0623Gv> list = this.A00;
        if (list == null) {
            return 0;
        }
        return list.size();
    ...
    private final C0623Gv A03(int i2) {
        List<C0623Gv> list = this.A00;
        if (list != null) {
            return list.get(i2);
        }
    ...
    public static C0623Gv A04(String str) {
        return new C0623Gv(null, C0625Gx.A02(str), -9223372036854775807L, -9223372036854775807L, null, null, A06(0, 0, 104));
    }

    public static C0623Gv A05(String str, long j2, long j3, H1 h1, String[] strArr, String str2) {
        return new C0623Gv(str, null, j2, j3, h1, strArr, str2);
    }

    private void A08(long j2, Map<String, H1> map, Map<String, SpannableStringBuilder> map2) {
        if (!A0C(j2)) {
            return;
        }
    ...
    */
    private void A09(long r10, boolean r12, java.lang.String r13, java.util.Map<java.lang.String, android.text.SpannableStringBuilder> r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0623Gv.A09(long, boolean, java.lang.String, java.util.Map):void");
    }

    private void A0A(Map<String, H1> map, SpannableStringBuilder spannableStringBuilder, int i2, int i3) {
        H1 A00 = C0625Gx.A00(this.A03, this.A0A, map);
        if (A00 != null) {
            C0625Gx.A05(spannableStringBuilder, i2, i3, A00);
        }
    }

    private void A0B(TreeSet<Long> treeSet, boolean z) {
        boolean equals = A06(10, 1, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH).equals(this.A05);
        if (z || equals) {
            long j2 = this.A02;
            if (A0C[1].length() == 9) {
                throw new RuntimeException();
    ...
    public final List<GX> A0D(long j2, Map<String, H1> map, Map<String, C0624Gw> map2) {
        ...
        for (Map.Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            C0624Gw c0624Gw = map2.get(entry.getKey());
            arrayList.add(new GX(A01(entry.getValue()), (Layout.Alignment) null, c0624Gw.A00, c0624Gw.A05, c0624Gw.A04, c0624Gw.A01, (int) Level.ALL_INT, c0624Gw.A03, c0624Gw.A06, c0624Gw.A02));
        }
        return arrayList;
    }

    public final void A0E(C0623Gv c0623Gv) {
        if (this.A00 == null) {
            this.A00 = new ArrayList();
        }
        this.A00.add(c0623Gv);
    }
