...
public final class C0756Mf {
    ...
    public static void A02(Activity activity, int i2, C1046Xo c1046Xo) {
        try {
            activity.setRequestedOrientation(i2);
        } catch (IllegalStateException e2) {
            c1046Xo.A06().A9G(A00(0, 7, 79), C04398z.A09, new AnonymousClass90(e2));
        }
    }
}
