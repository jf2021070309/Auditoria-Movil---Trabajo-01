...
public final class DP {
    ...
    public DP(boolean z, @Nullable String str, int i2, byte[] bArr, int i3, int i4, @Nullable byte[] bArr2) {
        IJ.A03((bArr2 == null) ^ (i2 == 0));
        this.A03 = z;
        this.A02 = str;
        this.A00 = i2;
        this.A04 = bArr2;
        this.A01 = new C0524Cn(A00(str), bArr, i3, i4);
    }
