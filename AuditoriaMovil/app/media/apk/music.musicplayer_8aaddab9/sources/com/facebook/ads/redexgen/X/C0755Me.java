...
public final class C0755Me {
    ...
    public static void A01() {
        A01 = new byte[]{-2, 28, 30, 16, 41, 11, 22, 33, 11, 35, 29, 41, 29, 18, 25, 33, 39, 41, 27, 52, 33, 22, 40, 41, 52, 22, 41, 41, 26, 34, 37, 41, 40, 34, 36, 22, 47, 28, 17, 35, 36, 47, 17, 36, 36, 21, 29, 32, 36, 47, 36, 25, 29, 21, 26, 28, 14, 39, 20, 9, 27, 28, 39, 26, 13, 27, 29, 20, 28, 39, 11, 23, 12, 13, -38, -27, -16, -38, -14, -20};
    }

    public C0755Me(Context context) {
        this.A00 = context;
    }
    ...
    private void A02(StringBuilder sb) {
        ...
        int lastIndex = 0;
        while (true) {
            int indexOf = sb.indexOf(A00(0, 1, SyslogConstants.LOG_CLOCK), i2);
            if (indexOf != -1) {
                lastIndex++;
                if (lastIndex == 5) {
    ...
    public final void A03(String str) {
        ...
        if (previous2.equals(str)) {
            String previous3 = A00(1, 15, SyslogConstants.LOG_ALERT);
    ...
    public final void A04(String str) {
        C0719Ks.A00(this.A00).edit().putString(A00(54, 20, 110), str).apply();
    }
    ...
    public final boolean A06() {
        return C0719Ks.A00(this.A00).getBoolean(A00(1, 15, SyslogConstants.LOG_ALERT), false);
    }
}
