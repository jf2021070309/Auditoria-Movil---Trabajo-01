...
public class ApplovinAdapter extends AppLovinMediationAdapter implements MediationBannerAdapter, MediationInterstitialAdapter, OnContextChangedListener, MediationRewardedAd {
        ...
        public void onInitializeSuccess(String str) {
            ...
            AppLovinAdLoadListener appLovinAdLoadListener = new AppLovinAdLoadListener() { // from class: com.applovin.mediation.ApplovinAdapter.1.1
                ...
                public void adReceived(AppLovinAd appLovinAd) {
                    ...
                    y.append(" for zone: ");
                    y.append(ApplovinAdapter.this.mZoneId);
                    ...
                    AppLovinSdkUtils.runOnUiThread(new Runnable() { // from class: com.applovin.mediation.ApplovinAdapter.1.1.1
                        ...
                        public void run() {
                            MediationInterstitialListener unused = ApplovinAdapter.this.mMediationInterstitialListener;
                ...
                public void failedToReceiveAd(int i2) {
                    final AdError adError2 = AppLovinUtils.getAdError(i2);
    ...
    public void showInterstitial() {
        ...
        if (this.appLovinInterstitialAd != null) {
            StringBuilder y = a.y("Showing interstitial for zone: ");
