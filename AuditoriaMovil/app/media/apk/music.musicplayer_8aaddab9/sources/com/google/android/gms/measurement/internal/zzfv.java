...
public final class zzfv implements zzgq {
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (zzq.zzs.zze.getApplicationContext() instanceof Application) {
                ...
                if (z) {
                    ...
                    a.G(zzq.zzs, "Registered activity lifecycle callback");
                }
            }
        } else {
            a.H(this, "Application context is not an Application");
        }
    ...
    public final void zzE() {
        ...
        if (networkInfo == null || !networkInfo.isConnected()) {
            a.H(this, "Network is not available for Deferred Deep Link request. Skipping");
            return;
        }
        zzkz zzv = zzv();
        zzh().zzs.zzk.zzh();
    ...
    public final void zzH(com.google.android.gms.internal.measurement.zzcl zzclVar) {
        ...
        zzm.zzg();
        int i2 = 100;
        int i3 = zzm.zza().getInt("consent_source", 100);
        ...
        if (!(zzk == null && zzk2 == null) && zzm().zzl(-10)) {
            ...
            if (TextUtils.isEmpty(zzh().zzn()) || !(i3 == 0 || i3 == 30 || i3 == 10 || i3 == 30 || i3 == 30 || i3 == 40)) {
                zznx.zzc();
        ...
        if (zzM()) {
            ...
            if (!zzv().zzac("android.permission.INTERNET")) {
                a.F(this, "App is missing INTERNET permission");
            }
            if (!zzv().zzac("android.permission.ACCESS_NETWORK_STATE")) {
                a.F(this, "App is missing ACCESS_NETWORK_STATE permission");
            }
            if (!Wrappers.packageManager(this.zze).isCallerInstantApp() && !this.zzk.zzx()) {
                if (!zzkz.zzai(this.zze)) {
                    a.F(this, "AppMeasurementReceiver not registered/enabled");
                }
                if (!zzkz.zzaj(this.zze, false)) {
                    a.F(this, "AppMeasurementService not registered/enabled");
                }
            }
            a.F(this, "Uploading is not possible. App measurement disabled");
        }
        zzm().zzi.zza(true);
    }
