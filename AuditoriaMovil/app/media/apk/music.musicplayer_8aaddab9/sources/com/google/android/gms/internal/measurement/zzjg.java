...
public final class zzjg extends zzii<Double> implements RandomAccess, zzke, zzlj {
    ...
    private zzjg(double[] dArr, int i2) {
        this.zzb = dArr;
        this.zzc = i2;
    }
    ...
    public final int hashCode() {
        ...
        for (int i3 = 0; i3 < this.zzc; i3++) {
            i2 = (i2 * 31) + zzkf.zzc(Double.doubleToLongBits(this.zzb[i3]));
        }
        return i2;
    }
