...
public final class zzeep implements zzeec<zzcva> {
    ...
    public final /* synthetic */ zzfsm zzc(final zzezz zzezzVar, zzfal zzfalVar, zzdsw zzdswVar, Object obj) throws Exception {
        final zzcml zzb = this.zzc.zzb(this.zzd.zze, zzezzVar, zzfalVar.zzb.zzb);
        zzb.zzav(zzezzVar.zzS);
        zzdswVar.zza(this.zzb, (View) zzb);
        zzchl zzchlVar = new zzchl();
        final zzcus zzR = this.zza.zzR(new zzcxv(zzfalVar, zzezzVar, null), new zzdjm(new zzeer(this.zzf, zzchlVar, zzezzVar, zzb, this.zzd, this.zzh, this.zzg), zzb), new zzcut(zzezzVar.zzW));
