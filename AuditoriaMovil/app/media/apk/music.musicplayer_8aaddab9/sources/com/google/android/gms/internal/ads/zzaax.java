...
public final class zzaax {
    ...
    public final String zza(byte[] bArr, byte[] bArr2) throws zzaaw {
        byte[] doFinal;
        byte[] iv;
    ...
    public final byte[] zzb(byte[] bArr, String str) throws zzaaw {
        byte[] doFinal;
        int length = bArr.length;
        try {
            byte[] zzb2 = zzzo.zzb(str, false);
