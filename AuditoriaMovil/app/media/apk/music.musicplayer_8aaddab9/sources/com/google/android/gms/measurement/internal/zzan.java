...
public final class zzan extends zzgp {
    ...
    public final boolean zze() {
        ...
        if (bool == null) {
            if (a.a(this.zzs.zzau(), "android.permission.GET_ACCOUNTS") != 0) {
            ...
            try {
                ...
                this.zzs.zzay().zzh().zzb("Exception checking account types", e2);
            }
    ...
    public final boolean zzf() {
        ...
        this.zzb = e.a.d.a.a.s(new StringBuilder(String.valueOf(lowerCase).length() + 1 + String.valueOf(lowerCase2).length()), lowerCase, "-", lowerCase2);
        return false;
    }
}
