...
public final class zzdr extends zzdn<Boolean> implements RandomAccess, zzeu, zzfx {
    ...
    private zzdr(boolean[] zArr, int i2) {
        this.zzb = zArr;
        this.zzc = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzeu zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzdr(Arrays.copyOf(this.zzb, i2), this.zzc);
        }
