...
public final class zzagv implements zzhp, zzfb {
    ...
    private final boolean zza(int i2, zzhf zzhfVar) {
        ...
        if (zzhfVar != null) {
            ...
            int i3 = 0;
            while (true) {
                if (i3 >= zzagxVar.zzc.size()) {
                    break;
                } else if (zzagxVar.zzc.get(i3).zzd == zzhfVar.zzd) {
        ...
        if (zzhoVar2.zza != i4 || !zzamq.zzc(zzhoVar2.zzb, zzhfVar2)) {
            zzhoVar = this.zza.zze;
            this.zzc = zzhoVar.zza(i4, zzhfVar2, 0L);
        }
        zzfa zzfaVar2 = this.zzd;
        if (zzfaVar2.zza == i4 && zzamq.zzc(zzfaVar2.zzb, zzhfVar2)) {
            return true;
        }
        zzfaVar = this.zza.zzf;
        this.zzd = zzfaVar.zza(i4, zzhfVar2);
        return true;
    }
