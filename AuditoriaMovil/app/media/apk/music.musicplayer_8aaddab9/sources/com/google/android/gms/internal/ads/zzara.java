...
public final class zzara implements zzapo, zzapv {
    ...
    private final void zzi(long j2) throws zzanp {
        zzaru zzaruVar;
        zzaps zzapsVar;
        zzaru zzaruVar2;
        zzarc zza2;
        while (!this.zzf.isEmpty() && this.zzf.peek().zza == j2) {
            ...
            if (pop.zzaR == zzaqk.zzE) {
                ...
                int i2 = 0;
                while (i2 < pop.zzc.size()) {
                    zzaqi zzaqiVar = pop.zzc.get(i2);
                    if (zzaqiVar.zzaR == zzaqk.zzG && (zza2 = zzaqr.zza(zzaqiVar, pop.zzc(zzaqk.zzF), -9223372036854775807L, null, this.zzq)) != null) {
                        ...
                        if (zzb2.zza != 0) {
                            zzaqz zzaqzVar = new zzaqz(zza2, zzb2, this.zzn.zzbf(i2, zza2.zzb));
    ...
    public final void zze(long j2, long j3) {
        ...
        if (zzaqzVarArr != null) {
            for (zzaqz zzaqzVar : zzaqzVarArr) {
                zzarf zzarfVar = zzaqzVar.zzb;
                int zza2 = zzarfVar.zza(j3);
                if (zza2 == -1) {
                    zza2 = zzarfVar.zzb(j3);
                }
                zzaqzVar.zzd = zza2;
            }
        }
    ...
    public final int zzg(zzapn zzapnVar, zzapt zzaptVar) throws IOException, InterruptedException {
        ...
        while (true) {
            ...
            if (i2 == 0) {
                ...
                int i3 = this.zzh;
                if (i3 == zzaqk.zzE || i3 == zzaqk.zzG || i3 == zzaqk.zzH || i3 == zzaqk.zzI || i3 == zzaqk.zzJ || i3 == zzaqk.zzS) {
                ...
                while (true) {
                    ...
                    if (i4 >= zzaqzVarArr.length) {
                        break;
                    }
                    zzaqz zzaqzVar = zzaqzVarArr[i4];
                    int i6 = zzaqzVar.zzd;
                    zzarf zzarfVar = zzaqzVar.zzb;
                    if (i6 != zzarfVar.zza) {
                        long j3 = zzarfVar.zzb[i6];
                        if (j3 < j2) {
                            i5 = i4;
                            j2 = j3;
                        }
                ...
                long j4 = zzarfVar2.zzb[i7];
                int i8 = zzarfVar2.zzc[i7];
                if (zzaqzVar2.zza.zzg == 1) {
                    j4 += 8;
                    i8 -= 8;
                }
                long zzh2 = (j4 - zzapnVar.zzh()) + this.zzl;
                ...
                long j5 = this.zzi - this.zzj;
                long zzh3 = zzapnVar.zzh() + j5;
                zzaux zzauxVar2 = this.zzk;
                if (zzauxVar2 != null) {
                    zzapnVar.zzb(zzauxVar2.zza, this.zzj, (int) j5, false);
                    ...
                    zzapnVar.zzd((int) j5, false);
                } else {
                    zzaptVar.zza = zzapnVar.zzh() + j5;
                    z = true;
                    zzi(zzh3);
                    if (z && this.zzg != 2) {
                        return 1;
