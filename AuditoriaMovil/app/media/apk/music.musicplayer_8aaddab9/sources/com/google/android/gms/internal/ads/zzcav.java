...
public final class zzcav extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(id = SyslogConstants.LOG_LPR)
    ...
    @SafeParcelable.Field(id = SyslogConstants.LOG_NEWS)
