...
public final class zac {
    ...
    public static String zac(Context context, int i2) {
        ...
        return i2 != 1 ? i2 != 2 ? i2 != 3 ? resources.getString(17039370) : resources.getString(R.string.common_google_play_services_enable_button) : resources.getString(R.string.common_google_play_services_update_button) : resources.getString(R.string.common_google_play_services_install_button);
    }
    ...
    private static String zai(Context context, String str) {
        ...
        synchronized (hVar) {
            Locale b2 = b.h(context.getResources().getConfiguration()).b(0);
            if (!b2.equals(zab)) {
                hVar.clear();
                zab = b2;
            }
