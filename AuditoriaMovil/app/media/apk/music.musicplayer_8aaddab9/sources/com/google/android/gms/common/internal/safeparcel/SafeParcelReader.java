...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i2) {
        if (parcel.dataPosition() != i2) {
            throw new ParseException(a.R(37, "Overread allowed size end=", i2), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i2 < dataPosition || i2 > parcel.dataSize()) {
            throw new ParseException(a.S(54, "Size read is invalid start=", dataPosition, " end=", i2), parcel);
        }
        return i2;
    }
    ...
    private static void zza(Parcel parcel, int i2, int i3, int i4) {
        ...
        sb.append(" got ");
        sb.append(i3);
        throw new ParseException(a.s(sb, " (0x", hexString, ")"), parcel);
    }
