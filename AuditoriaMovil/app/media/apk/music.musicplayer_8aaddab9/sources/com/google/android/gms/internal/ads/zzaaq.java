...
public class zzaaq extends zzaap {
    ...
    public static final void zzr(List<Callable<Void>> list) {
        ...
        try {
            ...
            String.format("class methods got exception: %s", zzabu.zzd(e2));
        }
    }
    ...
    private final synchronized void zzs(zzabr zzabrVar, zzyj zzyjVar) {
        ...
        try {
            ...
            Long l3 = zzh.zza;
            if (l3 != null) {
                zzyjVar.zzh(l3.longValue());
            }
            Long l4 = zzh.zzb;
            if (l4 != null) {
                zzyjVar.zzi(l4.longValue());
            }
            Long l5 = zzh.zzc;
            if (l5 != null) {
                zzyjVar.zzj(l5.longValue());
            }
            if (this.zzp) {
                Long l6 = zzh.zzd;
                if (l6 != null) {
                    zzyjVar.zzv(l6.longValue());
                }
                Long l7 = zzh.zze;
                if (l7 != null) {
                    zzyjVar.zzw(l7.longValue());
                }
            }
        } catch (zzabi unused) {
        }
        ...
        try {
            ...
            Long l8 = zzd.zza;
            if (l8 != null) {
                zza.zza(l8.longValue());
            }
            Long l9 = zzd.zzb;
            if (l9 != null) {
                zza.zzb(l9.longValue());
            }
            zza.zzh(zzd.zzc.longValue());
            if (this.zzp) {
                Long l10 = zzd.zze;
                if (l10 != null) {
                    zza.zzc(l10.longValue());
                }
                Long l11 = zzd.zzd;
                if (l11 != null) {
                    zza.zzf(l11.longValue());
                }
                Long l12 = zzd.zzf;
                if (l12 != null) {
                    zza.zzs(l12.longValue() != 0 ? 2 : 1);
                }
                if (this.zze > 0) {
                    if (zzabu.zzg(this.zzq)) {
                        double d2 = this.zzj;
                        double d3 = this.zze;
                        Double.isNaN(d2);
                        Double.isNaN(d3);
                ...
                Long l14 = zzd.zzj;
                if (l14 != null) {
                    zza.zzi(l14.longValue());
                }
                Long l15 = zzd.zzk;
                if (l15 != null) {
                    zza.zzt(l15.longValue() != 0 ? 2 : 1);
                }
            }
        } catch (zzabi unused2) {
        }
