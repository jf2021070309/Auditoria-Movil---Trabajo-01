...
public final class zzehq {
    ...
    public final void zza(zzfac zzfacVar, zzezz zzezzVar, int i2, @Nullable zzeeg zzeegVar, long j2) {
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzgi)).booleanValue()) {
            zzffb zza = zzffb.zza("adapter_status");
            zza.zzh(zzfacVar);
            zza.zzi(zzezzVar);
            zza.zzc("adapter_l", String.valueOf(j2));
            zza.zzc("sc", Integer.toString(i2));
            if (zzeegVar != null) {
        ...
        zzd2.zzd("adapter_l", String.valueOf(j2));
        zzd2.zzd("sc", Integer.toString(i2));
        if (zzeegVar != null) {
