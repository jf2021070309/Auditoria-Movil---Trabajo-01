...
public final class zzgg extends zzjt<zzgh, zzgg> implements zzld {
    ...
    */
    ...
    public final zzgg zzd(double d2) {
        if (this.zzb) {
            zzaE();
            this.zzb = false;
        }
        zzgh.zzo((zzgh) this.zza, d2);
        return this;
    }

    public final zzgg zze(long j2) {
        if (this.zzb) {
            zzaE();
            this.zzb = false;
        }
        zzgh.zzm((zzgh) this.zza, j2);
        return this;
    }
    ...
    public final zzgg zzg(long j2) {
        if (this.zzb) {
            zzaE();
            this.zzb = false;
        }
        zzgh.zzh((zzgh) this.zza, j2);
        return this;
    }
