...
public final class zzamq {
    ...
    static {
        ...
        zzo = new int[]{0, 7, 14, 9, 28, 27, 18, 21, 56, 63, 54, 49, 36, 35, 42, 45, SyslogConstants.LOG_ALERT, 119, 126, 121, 108, FacebookMediationAdapter.ERROR_NULL_CONTEXT, 98, 101, 72, 79, 70, 65, 84, 83, 90, 93, 224, 231, 238, 233, 252, 251, 242, 245, 216, 223, 214, 209, 196, 195, 202, 205, SyslogConstants.LOG_LOCAL2, 151, 158, 153, 140, 139, 130, 133, SyslogConstants.LOG_LOCAL5, 175, 166, 161, 180, 179, 186, 189, 199, 192, 201, 206, 219, 220, 213, 210, 255, 248, 241, 246, 227, 228, 237, 234, 183, SyslogConstants.LOG_LOCAL6, 185, 190, 171, 172, 165, 162, 143, SyslogConstants.LOG_LOCAL1, 129, 134, 147, 148, 157, 154, 39, 32, 41, 46, 59, 60, 53, 50, 31, 24, 17, 22, 3, 4, 13, 10, 87, 80, 89, 94, 75, 76, 69, 66, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION, 104, 97, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 115, 116, 125, 122, 137, 142, 135, 128, 149, 146, 155, 156, 177, 182, 191, SyslogConstants.LOG_LOCAL7, 173, 170, 163, 164, 249, 254, 247, 240, 229, 226, 235, 236, 193, 198, 207, 200, 221, 218, 211, 212, 105, 110, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 96, 117, 114, 123, 124, 81, 86, 95, 88, 77, 74, 67, 68, 25, 30, 23, 16, 5, 2, 11, 12, 33, 38, 47, 40, 61, 58, 51, 52, 78, 73, 64, 71, 82, 85, 92, 91, 118, 113, SyslogConstants.LOG_CLOCK, 127, 106, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD, 100, 99, 62, 57, 48, 55, 34, 37, 44, 43, 6, 1, 8, 15, 26, 29, 20, 19, 174, 169, SyslogConstants.LOG_LOCAL4, 167, 178, 181, 188, 187, 150, 145, SyslogConstants.LOG_LOCAL3, 159, 138, 141, 132, 131, 222, 217, 208, 215, 194, 197, 204, 203, 230, 225, 232, 239, 250, 253, 244, 243};
    }

    public static long zzA(long j2, long j3, long j4) {
        long j5 = j2 + j3;
        if (((j2 ^ j5) & (j3 ^ j5)) < 0) {
    ...
    public static long zzB(long j2, long j3, long j4) {
        long j5 = j2 - j3;
        if (((j2 ^ j5) & (j3 ^ j2)) < 0) {
    ...
    public static int zzE(long[] jArr, long j2, boolean z, boolean z2) {
        int binarySearch = Arrays.binarySearch(jArr, j2);
        if (binarySearch < 0) {
    ...
    public static long zzH(long j2, long j3, long j4) {
        if (j4 < j3 || j4 % j3 != 0) {
            if (j4 >= j3 || j3 % j4 != 0) {
                double d2 = j2;
                double d3 = j3;
    ...
    public static void zzI(long[] jArr, long j2, long j3) {
        int i2 = 0;
    ...
    public static long zzJ(long j2, float f2) {
        if (f2 == 1.0f) {
            return j2;
        }
        double d2 = j2;
    ...
    public static long zzK(long j2, float f2) {
        if (f2 == 1.0f) {
            return j2;
        }
        double d2 = j2;
    ...
    public static long zzL(int i2, int i3) {
    ...
    public static zzafv zzN(int i2, int i3, int i4) {
    ...
    public static boolean zzP(int i2) {
        return i2 == 3 || i2 == 2 || i2 == 268435456 || i2 == 536870912 || i2 == 805306368 || i2 == 4;
    }

    public static boolean zzQ(int i2) {
    ...
    public static int zzV(byte[] bArr, int i2, int i3, int i4) {
        int i5 = -1;
    ...
    public static int zzW(byte[] bArr, int i2, int i3, int i4) {
        int i5 = 0;
        while (i2 < i3) {
    ...
    public static Point zzaa(Context context) {
        ...
        if (display.getDisplayId() == 0 && zzZ(context)) {
            String zzad = i2 < 28 ? zzad("sys.display-size") : zzad("vendor.display-size");
    ...
    public static long zzab(long j2) {
    ...
    private static String zzad(String str) {
        try {
            ...
            zzaln.zzb("Util", str.length() != 0 ? "Failed to read system property ".concat(str) : new String("Failed to read system property "), e2);
            return null;
        }
    }
    ...
    public static <T> T[] zzf(T[] tArr, int i2) {
        zzakt.zza(i2 <= tArr.length);
    ...
    public static String zzq(String str) {
        ...
        while (true) {
            ...
            if (zza2.startsWith(strArr[i2])) {
                ...
                String valueOf3 = String.valueOf(zza2.substring(strArr[i2].length()));
    ...
    public static String zzr(byte[] bArr, int i2, int i3) {
        return new String(bArr, i2, i3, zzfll.zzc);
    }
    ...
    public static int zzw(int i2, int i3) {
        return ((i2 + i3) - 1) / i3;
    }

    public static int zzx(int i2, int i3, int i4) {
        return Math.max(i3, Math.min(i2, i4));
    }

    public static long zzy(long j2, long j3, long j4) {
        return Math.max(j3, Math.min(j2, j4));
    }

    public static float zzz(float f2, float f3, float f4) {
