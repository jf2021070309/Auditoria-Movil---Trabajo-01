...
public final class zzame {
    ...
    public final void zzi(byte[] bArr, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            byte b3 = (byte) (b2 << i8);
            bArr[i5] = b3;
            bArr[i5] = (byte) (((255 & bArr2[i7]) >> (8 - i8)) | b3);
        }
        int i9 = i3 & 7;
        if (i9 == 0) {
            return;
    ...
    public final void zzl(int i2, int i3) {
        ...
        byte[] bArr = this.zza;
        int i8 = this.zzb;
        byte b2 = (byte) (((65280 >> i6) | ((1 << i7) - 1)) & bArr[i8]);
        bArr[i8] = b2;
        int i9 = 14 - min;
        bArr[i8] = (byte) (b2 | ((i5 >>> i9) << i7));
        int i10 = i8 + 1;
        while (i9 > 8) {
            i9 -= 8;
        ...
        byte[] bArr2 = this.zza;
        byte b3 = (byte) (bArr2[i10] & ((1 << i4) - 1));
        bArr2[i10] = b3;
        bArr2[i10] = (byte) (((i5 & ((1 << i9) - 1)) << (8 - i9)) | b3);
        zzf(14);
        zzm();
    }
}
