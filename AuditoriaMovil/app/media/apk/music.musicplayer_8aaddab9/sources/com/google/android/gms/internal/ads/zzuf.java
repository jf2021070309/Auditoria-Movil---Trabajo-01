...
public final class zzuf {
    ...
    public final int zzb(zznv zznvVar, zzoq zzoqVar, int i2) throws IOException {
        if (i2 <= 0) {
            zze(zznvVar);
            return 0;
        }
        ...
        if (!this.zze) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    int i6 = (i4 * 188) + i3;
                    if (i6 < zzg || i6 >= zze || zzi[i6] != 71) {
                        i5 = 0;
                    } else {
                        i5++;
                        if (i5 == 5) {
                            long zzb = zzup.zzb(zzamfVar, i3, i2);
            ...
            long zze2 = this.zza.zze(this.zzg) - this.zza.zze(j4);
            this.zzh = zze2;
            if (zze2 < 0) {
            ...
            while (true) {
                ...
                if (zzamfVar2.zzi()[zzg2] == 71) {
                    long zzb2 = zzup.zzb(zzamfVar2, zzg2, i2);
