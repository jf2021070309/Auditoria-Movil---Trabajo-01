...
public class PlayCoreMissingSplitsActivity extends Activity implements DialogInterface.OnClickListener {
    ...
    public final void onClick(DialogInterface dialogInterface, int i2) {
        if (i2 == -1) {
            ...
            try {
                startActivity(new Intent("android.intent.action.VIEW").setData(Uri.parse(a.s(new StringBuilder(String.valueOf(packageName).length() + 66), "market://details?id=", packageName, "&referrer=utm_source%3Dplay.core.missingsplits"))).setPackage("com.android.vending"));
            } catch (ActivityNotFoundException e2) {
                String name = getClass().getName();
                StringBuilder w = a.w(39, "UID: [", Process.myUid(), "]  PID: [", Process.myPid());
                w.append("] ");
                ...
                if (Log.isLoggable("PlayCore", 6)) {
                    Log.e("PlayCore", e.b(concat, "Couldn't start missing splits activity for %s", objArr), e2);
                }
            }
        }
        finish();
