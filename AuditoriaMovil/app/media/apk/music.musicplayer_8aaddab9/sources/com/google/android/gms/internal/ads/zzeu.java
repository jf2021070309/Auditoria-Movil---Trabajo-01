...
public final class zzeu {
    ...
    public zzeu(int i2, int i3, float f2, float f3, int i4) {
        this.zza = i2;
        this.zzb = i3;
        this.zzc = f2;
        this.zzd = f3;
    ...
    private final short[] zzg(short[] sArr, int i2, int i3) {
    ...
    private final void zzh(short[] sArr, int i2, int i3) {
        ...
        this.zzl = zzg;
        int i4 = this.zzb;
        System.arraycopy(sArr, i2 * i4, zzg, this.zzm * i4, i4 * i3);
        this.zzm += i3;
    }
    ...
    private final int zzj(short[] sArr, int i2, int i3, int i4) {
        int i5 = i2 * this.zzb;
        int i6 = 1;
        int i7 = 255;
        int i8 = 0;
    ...
    private final void zzk() {
                ...
                while (true) {
                    ...
                    if (i14 > 0) {
                        ...
                        if (this.zzb == i11 && i16 == i11) {
                            i2 = zzj(sArr, i13, this.zzf, this.zzg);
                        } else {
                            zzi(sArr, i13, i16);
                            int zzj = zzj(this.zzi, 0, this.zzf / i16, this.zzg / i16);
                            if (i16 != i11) {
                                int i17 = zzj * i16;
                                int i18 = i16 * 4;
                                int i19 = i17 - i18;
                                ...
                                if (this.zzb == i11) {
                                    i2 = zzj(sArr, i13, i19, i20);
                                } else {
                                    zzi(sArr, i13, i11);
                                    i2 = zzj(this.zzi, 0, i19, i20);
                                }
                            } else {
                                i2 = zzj;
                            }
                        ...
                        if (d2 > 1.0d) {
                            ...
                            short[] zzg = zzg(this.zzl, this.zzm, i4);
                            this.zzl = zzg;
                            int i25 = i4;
                            zzl(i4, this.zzb, zzg, this.zzm, sArr2, i13, sArr2, i13 + i24);
                            this.zzm += i25;
                            i13 = i24 + i25 + i13;
                        } else {
                            int i26 = i24;
                            ...
                            this.zzl = zzg2;
                            int i28 = this.zzb;
                            System.arraycopy(sArr3, i13 * i28, zzg2, this.zzm * i28, i28 * i26);
                            zzl(i3, this.zzb, this.zzl, this.zzm + i26, sArr3, i13 + i26, sArr3, i13);
                            this.zzm += i27;
                            i13 += i3;
                        }
                    }
        ...
        short[] zzg3 = zzg(this.zzn, this.zzo, i33);
        this.zzn = zzg3;
        short[] sArr5 = this.zzl;
        int i34 = this.zzb;
        System.arraycopy(sArr5, i10 * i34, zzg3, this.zzo * i34, i34 * i33);
        this.zzm = i10;
        this.zzo += i33;
        int i35 = 0;
        while (true) {
    ...
    public final void zzb(ShortBuffer shortBuffer) {
        ...
        int i3 = remaining / i2;
        int i4 = i2 * i3;
        short[] zzg = zzg(this.zzj, this.zzk, i3);
        this.zzj = zzg;
        shortBuffer.get(zzg, this.zzk * this.zzb, (i4 + i4) / 2);
        this.zzk += i3;
        zzk();
    }
