...
public final class zzv extends zzcfm {
    ...
    private final zzfsm<String> zzJ(final String str) {
    ...
    public final /* synthetic */ zzfsm zzB(final Uri uri) throws Exception {
    ...
    public final /* synthetic */ zzfsm zzD(final ArrayList arrayList) throws Exception {
    ...
    public final /* synthetic */ ArrayList zzE(List list, IObjectWrapper iObjectWrapper) throws Exception {
        String zzo = this.zzh.zzb() != null ? this.zzh.zzb().zzo(this.zzg, (View) ObjectWrapper.unwrap(iObjectWrapper), null) : "";
