...
public final class zzim extends zzii<Boolean> implements RandomAccess, zzke, zzlj {
    ...
    private zzim(boolean[] zArr, int i2) {
        this.zzb = zArr;
        this.zzc = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzke zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzim(Arrays.copyOf(this.zzb, i2), this.zzc);
        }
