...
public final class zzdoe {
    ...
    public final /* synthetic */ void zzb(final View view, final WindowManager windowManager, final zzcml zzcmlVar, final Map map) {
        ...
        final WindowManager.LayoutParams zzj = com.google.android.gms.ads.internal.util.zzca.zzj();
        zzj.x = zzf3;
        zzj.y = zzf4;
        ...
        if (view.getGlobalVisibleRect(rect)) {
            final int i2 = (("1".equals(str) || "2".equals(str)) ? rect.bottom : rect.top) - zzf4;
            this.zzc = new ViewTreeObserver.OnScrollChangedListener(view, zzcmlVar, str, zzj, i2, windowManager) { // from class: com.google.android.gms.internal.ads.zzdoc
