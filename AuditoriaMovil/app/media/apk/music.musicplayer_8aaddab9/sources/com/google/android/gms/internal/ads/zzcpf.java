...
public final class zzcpf implements zzgla<zzcbu> {
    ...
    public final zzcbu zzb() {
        ...
        zzbug zza2 = com.google.android.gms.ads.internal.zzt.zzp().zza(zza, zzcgz.zza());
        zzbua<JSONObject> zzbuaVar = zzbud.zza;
        zza2.zza("google.afma.request.getAdDictionary", zzbuaVar, zzbuaVar);
        return new zzcbt(zza, com.google.android.gms.ads.internal.zzt.zzp().zza(zza, zzcgz.zza()).zza("google.afma.sdkConstants.getSdkConstants", zzbuaVar, zzbuaVar));
    }
}
