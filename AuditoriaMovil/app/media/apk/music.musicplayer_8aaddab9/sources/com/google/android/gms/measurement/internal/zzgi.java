                ...
                if (zzj == null) {
                    ...
                    try {
                        ...
                        if (zzkxVar == null || zzkxVar.zze == null) {
                            zzkx zzkxVar2 = new zzkx(zzt, "auto", "_lte", zzr.zzs.zzav().currentTimeMillis(), 0L);
                            zzu2.add(zzkxVar2);
                        ...
                        for (int i2 = 0; i2 < zzu2.size(); i2++) {
                            ...
                            zzd2.zzf(zzu2.get(i2).zzc);
                            zzd2.zzg(zzu2.get(i2).zzd);
                            zzr.zzf.zzu().zzv(zzd2, zzu2.get(i2).zze);
                            zzghVarArr[i2] = zzd2.zzaA();
                        }
