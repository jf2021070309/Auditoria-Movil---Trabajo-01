...
public final class zzgfj extends zzgeh<Double> implements RandomAccess, zzggj, zzghp {
    ...
    private zzgfj(double[] dArr, int i2) {
        this.zzb = dArr;
        this.zzc = i2;
    }
    ...
    public final int hashCode() {
        ...
        for (int i3 = 0; i3 < this.zzc; i3++) {
            i2 = (i2 * 31) + zzggk.zze(Double.doubleToLongBits(this.zzb[i3]));
        }
        return i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzggj zze(int i2) {
        if (i2 >= this.zzc) {
            return new zzgfj(Arrays.copyOf(this.zzb, i2), this.zzc);
        }
