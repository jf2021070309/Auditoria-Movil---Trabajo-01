...
public class GoogleApiManager implements Handler.Callback {
    ...
    private long zag = AbstractComponentTracker.LINGERING_TIMEOUT;
    ...
    @GuardedBy("lock")
    private final Set<ApiKey<?>> zar = new c(0);
    private final Set<ApiKey<?>> zas = new c(0);
    ...
    public static Status zaH(ApiKey<?> apiKey, ConnectionResult connectionResult) {
        ...
        return new Status(connectionResult, a.t(new StringBuilder(String.valueOf(zab2).length() + 63 + valueOf.length()), "API: ", zab2, " is not available on this device. Connection failed with: ", valueOf));
    }
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i2) {
            case 1:
                this.zag = true == ((Boolean) message.obj).booleanValue() ? AbstractComponentTracker.LINGERING_TIMEOUT : 300000L;
            ...
            case 5:
                ...
                while (true) {
                    if (it2.hasNext()) {
                        zabq<?> next2 = it2.next();
                        zabqVar = next2.zab() == i3 ? next2 : null;
                    }
                }
                if (zabqVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        ...
                        zabq.zai(zabqVar, new Status(17, a.t(new StringBuilder(String.valueOf(errorString).length() + 69 + String.valueOf(errorMessage).length()), "Error resolution was canceled by the user, original error message: ", errorString, ": ", errorMessage)));
                        break;
                    } else {
            ...
            case 19:
                ...
                break;
            default:
                a.D(31, "Unknown message id: ", i2, "GoogleApiManager");
                return false;
        }
        return true;
    }
