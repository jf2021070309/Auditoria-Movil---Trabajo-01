...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final Dialog zaa(Context context, int i2, zag zagVar, DialogInterface.OnCancelListener onCancelListener) {
        if (i2 == 0) {
            return null;
        }
        ...
        if (i2 == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    mVar.a(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
                } else {
                    mVar.f1978g = pendingIntent;
                }
            } else {
                mVar.v.icon = 17301642;
                mVar.v.tickerText = m.e(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker));
