        ...
        if (this.zzd == null) {
            ...
            if (string != null) {
                try {
                    ...
                    a.F(this.zza.zzs, "Error loading bundle from SharedPreferences. Values will be lost");
                }
            }
            if (this.zzd == null) {
                this.zzd = this.zzc;
            ...
            for (String str2 : bundle.keySet()) {
                ...
                if (obj != null) {
                    try {
                        ...
                        this.zza.zzs.zzay().zzd().zzb("Cannot serialize bundle value to SharedPreferences", e2);
                    }
                }
            }
