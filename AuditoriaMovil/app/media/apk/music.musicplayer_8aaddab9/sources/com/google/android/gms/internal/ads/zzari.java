...
public abstract class zzari extends zzamw {
    ...
    public zzari(int i2, zzark zzarkVar, zzapl zzaplVar, boolean z) {
        super(i2);
        ...
        if (this.zzC == 1) {
            ...
            if (this.zzB == 1) {
                for (int i3 = 0; i3 < this.zzi.zzh.size(); i3++) {
                    this.zzd.zzb.put(this.zzi.zzh.get(i3));
                }
                this.zzB = 2;
            }
            ...
            if (zzA == -5) {
                ...
                try {
                    ...
                    if (zzi) {
                        ...
                        this.zzj.queueSecureInputBuffer(this.zzx, 0, zzb2, j2, 0);
                    } else {
    ...
    public final void zzD(long j2, long j3) throws zzamy {
        boolean zzS;
            ...
            while (true) {
                        ...
                        if (this.zzt) {
                            ...
                            while (true) {
                                if (i2 >= size) {
                                    z = false;
                                    break;
                                } else if (this.zzg.get(i2).longValue() == j4) {
                                    this.zzg.remove(i2);
                                    z = true;
                                    break;
                                } else {
                ...
                if (this.zzq && this.zzE) {
                    try {
                        ...
                        zzS = zzS(j2, j3, mediaCodec, byteBuffer2, i3, bufferInfo3.flags, bufferInfo3.presentationTimeUs, this.zzz);
                    ...
                    zzS = zzS(j2, j3, mediaCodec2, byteBuffer3, i4, bufferInfo4.flags, bufferInfo4.presentationTimeUs, this.zzz);
                }
                if (!zzS) {
                    break;
                }
    ...
    public void zzM(String str, long j2, long j3) {
        throw null;
    }
    ...
    */
    ...
    public abstract boolean zzS(long j2, long j3, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i2, int i3, long j4, boolean z) throws zzamy;
