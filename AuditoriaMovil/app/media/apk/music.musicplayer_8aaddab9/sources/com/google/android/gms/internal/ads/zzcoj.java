...
public abstract class zzcoj implements zzcrz {
    ...
    public static zzcoj zza(Context context, zzbvg zzbvgVar, int i2) {
        zzcoj zzb = zzb(context, i2);
        zzb.zzi().zza(zzbvgVar);
        return zzb;
    }

    @Deprecated
    public static zzcoj zzb(Context context, int i2) {
        synchronized (zzcoj.class) {
            zzcoj zzcojVar = zza;
            return zzcojVar != null ? zzcojVar : zzc(new zzcgz(213806000, i2, true, false), context, new zzcpi());
        }
    }
    ...
    public final zzesq zzA(zzcbj zzcbjVar, int i2) {
        return zzB(new zzetx(zzcbjVar, i2));
    }
