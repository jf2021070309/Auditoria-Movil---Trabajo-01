...
public final class zzcjx implements zzatz {
    ...
    public zzcjx(Context context, zzatz zzatzVar, String str, int i2, zzauo<zzatz> zzauoVar, zzcjw zzcjwVar) {
        this.zzb = context;
        this.zzc = zzatzVar;
        this.zza = zzauoVar;
        this.zzd = zzcjwVar;
    ...
    */
    ...
    public final int zzb(byte[] bArr, int i2, int i3) throws IOException {
        ...
        if (this.zzi) {
            ...
            int read = inputStream != null ? inputStream.read(bArr, i2, i3) : this.zzc.zzb(bArr, i2, i3);
