...
public final class zzegw implements zzegq<zzdmh> {
    ...
    private final zzfsm<zzdmh> zzg(final zzfal zzfalVar, final zzezz zzezzVar, final JSONObject jSONObject) {
        final zzfsm<zzdrh> zzb = this.zzd.zzb();
        final zzfsm<zzdmm> zza = this.zzc.zza(zzfalVar, zzezzVar, jSONObject);
    ...
    public final /* synthetic */ zzfsm zze(zzfal zzfalVar, zzezz zzezzVar, JSONArray jSONArray) throws Exception {
        ...
        if (zzfalVar.zza.zza.zzk > 1) {
            ...
            for (int i2 = 0; i2 < zzfalVar.zza.zza.zzk; i2++) {
                if (i2 < length) {
                    arrayList.add(zzg(zzfalVar, zzezzVar, jSONArray.getJSONObject(i2)));
                } else {
        ...
        return zzfsd.zzj(zzg(zzfalVar, zzezzVar, jSONArray.getJSONObject(0)), zzegu.zza, this.zzb);
    }

    public final /* synthetic */ zzfsm zzf(zzezz zzezzVar, final zzdrh zzdrhVar) throws Exception {
