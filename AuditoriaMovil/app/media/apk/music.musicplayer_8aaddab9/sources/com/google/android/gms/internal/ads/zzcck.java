...
public interface zzcck extends IInterface {
    ...
    void zzk(IObjectWrapper iObjectWrapper, zzccl zzcclVar) throws RemoteException;

    void zzl(IObjectWrapper iObjectWrapper) throws RemoteException;

    void zzm(IObjectWrapper iObjectWrapper, int i2) throws RemoteException;
