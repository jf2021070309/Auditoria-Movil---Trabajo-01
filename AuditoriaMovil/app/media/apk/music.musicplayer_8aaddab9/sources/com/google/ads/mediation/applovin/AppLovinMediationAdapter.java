...
public class AppLovinMediationAdapter extends RtbAdapter implements MediationRewardedAd, AppLovinAdLoadListener {
    ...
    public class a implements AppLovinInitializer.OnInitializeSuccessListener {
        ...
        public final /* synthetic */ HashSet f4501b;

        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ InitializationCompleteCallback f4502c;
        ...
        public a(AppLovinMediationAdapter appLovinMediationAdapter, HashSet hashSet, HashSet hashSet2, InitializationCompleteCallback initializationCompleteCallback) {
            this.a = hashSet;
            this.f4501b = hashSet2;
            this.f4502c = initializationCompleteCallback;
        }

        @Override // com.google.ads.mediation.applovin.AppLovinInitializer.OnInitializeSuccessListener
        public void onInitializeSuccess(String str) {
            this.a.add(str);
            if (this.a.equals(this.f4501b)) {
                this.f4502c.onInitializationSucceeded();
            }
        }
    }
    ...
    public class b implements AppLovinInitializer.OnInitializeSuccessListener {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ MediationAdLoadCallback f4504c;

        public b(Bundle bundle, Context context, MediationAdLoadCallback mediationAdLoadCallback) {
            this.a = bundle;
            this.f4503b = context;
            this.f4504c = mediationAdLoadCallback;
        }

        @Override // com.google.ads.mediation.applovin.AppLovinInitializer.OnInitializeSuccessListener
        public void onInitializeSuccess(String str) {
            AppLovinMediationAdapter.this.mZoneId = AppLovinUtils.retrieveZoneId(this.a);
            AppLovinMediationAdapter.this.mSdk = AppLovinUtils.retrieveSdk(this.a, this.f4503b);
            AppLovinMediationAdapter appLovinMediationAdapter = AppLovinMediationAdapter.this;
            appLovinMediationAdapter.mNetworkExtras = appLovinMediationAdapter.adConfiguration.getMediationExtras();
            AppLovinMediationAdapter.this.mMediationAdLoadCallback = this.f4504c;
    ...
    public class d implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            AdError adError = AppLovinUtils.getAdError(this.a);
    ...
    public void collectSignals(RtbSignalData rtbSignalData, SignalCallbacks signalCallbacks) {
        ...
        if (rtbSignalData.getNetworkExtras() != null) {
            StringBuilder y = e.a.d.a.a.y("Extras for signal collection: ");
            y.append(rtbSignalData.getNetworkExtras());
            ApplovinAdapter.log(4, y.toString());
        }
    ...
    public void initialize(Context context, InitializationCompleteCallback initializationCompleteCallback, List<MediationConfiguration> list) {
        ...
        while (it.hasNext()) {
            AppLovinInitializer.getInstance().initialize(context, (String) it.next(), new a(this, hashSet2, hashSet, initializationCompleteCallback));
        }
    }
