...
public final class zzaxp {
    ...
    public zzaxp(int i2, int i3, int i4) {
        this.zzb = i2;
        i3 = (i3 > 64 || i3 < 0) ? 64 : 64;
        if (i4 <= 0) {
            this.zzd = 1;
    ...
    public final String zza(ArrayList<String> arrayList, ArrayList<zzaxd> arrayList2) {
        ...
        loop0: for (int i2 = 0; i2 < arrayList2.size(); i2++) {
            String[] split = Normalizer.normalize(arrayList.get(arrayList2.get(i2).zze()), Normalizer.Form.NFKC).toLowerCase(Locale.US).split("\n");
            if (split.length != 0) {
