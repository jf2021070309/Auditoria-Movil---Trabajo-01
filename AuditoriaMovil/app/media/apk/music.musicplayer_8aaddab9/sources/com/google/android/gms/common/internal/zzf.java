    ...
    public final boolean zzd() {
        ...
        try {
            ...
            if (!this.zzf.getServiceDescriptor().equals(interfaceDescriptor)) {
                ...
                Log.w("GmsClient", a.t(new StringBuilder(String.valueOf(serviceDescriptor).length() + 34 + String.valueOf(interfaceDescriptor).length()), "service descriptor mismatch: ", serviceDescriptor, " vs. ", interfaceDescriptor));
                return false;
            }
