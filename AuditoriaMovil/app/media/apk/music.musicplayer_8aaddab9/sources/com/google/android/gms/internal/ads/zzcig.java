...
public final class zzcig extends zzcii implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private final void zzC() {
        ...
        try {
            ...
            valueOf.length();
            zzcgt.zzj("Failed to initialize MediaPlayer at ".concat(valueOf), e2);
    ...
    */
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i2, int i3) {
        ...
        com.google.android.gms.ads.internal.util.zzs.zza.post(new zzcic(this, i2, i3));
    }
    ...
    public final void onWindowVisibilityChanged(final int i2) {
        ...
        sb.append(i2);
        com.google.android.gms.ads.internal.util.zze.zza(sb.toString());
        com.google.android.gms.ads.internal.util.zzs.zza.post(new Runnable(this, i2) { // from class: com.google.android.gms.internal.ads.zzchx
    ...
    public final String toString() {
        ...
        return a.s(new StringBuilder(name.length() + 1 + String.valueOf(hexString).length()), name, "@", hexString);
    }
