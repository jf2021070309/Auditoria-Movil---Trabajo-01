    ...
    public static String getXmlAttributeString(String str, String str2, Context context, AttributeSet attributeSet, boolean z, boolean z2, String str3) {
        ...
        if (attributeValue != null && attributeValue.startsWith("@string/") && z) {
            ...
            try {
                ...
                Log.w(str3, a.t(new StringBuilder(attributeValue.length() + String.valueOf(str2).length() + 30), "Could not find resource for ", str2, ": ", attributeValue));
            }
            ...
            if (charSequence != null) {
                ...
                Log.w(str3, a.t(new StringBuilder(obj.length() + String.valueOf(str2).length() + 28), "Resource ", str2, " was not a string: ", obj));
            }
        }
        if (z2 && attributeValue == null) {
            a.N(new StringBuilder(String.valueOf(str2).length() + 33), "Required XML attribute \"", str2, "\" missing", str3);
        }
