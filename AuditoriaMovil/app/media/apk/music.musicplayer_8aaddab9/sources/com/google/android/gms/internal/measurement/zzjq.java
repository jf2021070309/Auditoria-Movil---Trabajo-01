...
public final class zzjq extends zzii<Float> implements RandomAccess, zzke, zzlj {
    ...
    private zzjq(float[] fArr, int i2) {
        this.zzb = fArr;
        this.zzc = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzke zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzjq(Arrays.copyOf(this.zzb, i2), this.zzc);
        }
