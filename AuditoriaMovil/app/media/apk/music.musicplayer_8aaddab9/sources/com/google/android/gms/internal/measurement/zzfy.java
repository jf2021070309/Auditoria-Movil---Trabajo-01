...
public final class zzfy extends zzjx<zzfy, zzfx> implements zzld {
    ...
    public static /* synthetic */ void zzQ(zzfy zzfyVar, long j2) {
    ...
    public static /* synthetic */ void zzS(zzfy zzfyVar, int i2) {
        zzfyVar.zzg |= 2;
        zzfyVar.zzR = i2;
    }

    public static /* synthetic */ void zzT(zzfy zzfyVar, int i2, zzfo zzfoVar) {
        zzfoVar.getClass();
        zzfyVar.zzbI();
        zzfyVar.zzi.set(i2, zzfoVar);
    }
    ...
    public static /* synthetic */ void zzY(zzfy zzfyVar, long j2) {
        zzfyVar.zzg |= 16;
        zzfyVar.zzV = j2;
    }

    public static /* synthetic */ void zzZ(zzfy zzfyVar, long j2) {
        zzfyVar.zzg |= 32;
        zzfyVar.zzW = j2;
    }
    ...
    public static /* synthetic */ void zzaG(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 524288;
        zzfyVar.zzC = j2;
    }

    public static /* synthetic */ void zzaH(zzfy zzfyVar, int i2) {
        zzfyVar.zzf |= 1048576;
        zzfyVar.zzD = i2;
    }
    ...
    public static /* synthetic */ void zzaP(zzfy zzfyVar, int i2) {
        zzfyVar.zzf |= 33554432;
        zzfyVar.zzJ = i2;
    }

    public static /* synthetic */ void zzaQ(zzfy zzfyVar, int i2) {
        zzfyVar.zzf |= 1;
        zzfyVar.zzh = 1;
    }
    ...
    public static /* synthetic */ void zzaS(zzfy zzfyVar, long j2) {
    ...
    public static /* synthetic */ void zzae(zzfy zzfyVar, int i2) {
        zzfyVar.zzbI();
        zzfyVar.zzi.remove(i2);
    }

    public static /* synthetic */ void zzaf(zzfy zzfyVar, int i2, zzgh zzghVar) {
        zzghVar.getClass();
        zzfyVar.zzbJ();
        zzfyVar.zzj.set(i2, zzghVar);
    }
    ...
    public static /* synthetic */ void zzai(zzfy zzfyVar, int i2) {
        zzfyVar.zzbJ();
        zzfyVar.zzj.remove(i2);
    }

    public static /* synthetic */ void zzaj(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 2;
        zzfyVar.zzk = j2;
    }

    public static /* synthetic */ void zzak(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 4;
        zzfyVar.zzl = j2;
    }

    public static /* synthetic */ void zzal(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 8;
        zzfyVar.zzm = j2;
    }

    public static /* synthetic */ void zzam(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 16;
        zzfyVar.zzn = j2;
    }
    ...
    public static /* synthetic */ void zzao(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 32;
        zzfyVar.zzo = j2;
    }
    ...
    public static /* synthetic */ void zzat(zzfy zzfyVar, String str) {
        str.getClass();
        zzfyVar.zzf |= AdRequest.MAX_CONTENT_URL_LENGTH;
        zzfyVar.zzs = str;
    }

    public static /* synthetic */ void zzau(zzfy zzfyVar, int i2) {
        zzfyVar.zzf |= 1024;
        zzfyVar.zzt = i2;
    }
    ...
    public static /* synthetic */ void zzav(zzfy zzfyVar, String str) {
        str.getClass();
        zzfyVar.zzf |= ThrowableProxyConverter.BUILDER_CAPACITY;
        zzfyVar.zzu = str;
    }
    ...
    public static /* synthetic */ void zzax(zzfy zzfyVar, String str) {
        str.getClass();
        zzfyVar.zzf |= Compressor.BUFFER_SIZE;
        zzfyVar.zzw = str;
    }

    public static /* synthetic */ void zzay(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= 16384;
        zzfyVar.zzx = j2;
    }

    public static /* synthetic */ void zzaz(zzfy zzfyVar, long j2) {
        zzfyVar.zzf |= FileUtil.BUF_SIZE;
        zzfyVar.zzy = 46000L;
    }
    ...
    public final boolean zzbn() {
        return (this.zzf & FileUtil.BUF_SIZE) != 0;
    }
    ...
    public final zzfo zzt(int i2) {
        return this.zzi.get(i2);
    }

    public final zzgh zzw(int i2) {
