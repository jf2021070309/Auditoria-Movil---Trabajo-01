...
public final class zaaa extends Button {
    ...
    private static final int zab(int i2, int i3, int i4, int i5) {
        if (i2 != 0) {
            if (i2 != 1) {
                ...
                throw new IllegalStateException(a.R(33, "Unknown color scheme: ", i2));
            }
            return i4;
        }
        return i3;
    ...
    public final void zaa(Resources resources, int i2, int i3) {
        ...
        if (i2 == 0 || i2 == 1) {
            ...
            throw new IllegalStateException(a.R(32, "Unknown button size: ", i2));
        }
        Drawable q0 = c.i.a.q0(resources.getDrawable(zab));
        c.i.a.j0(q0, resources.getColorStateList(R.color.common_google_signin_btn_tint));
        c.i.a.k0(q0, PorterDuff.Mode.SRC_ATOP);
