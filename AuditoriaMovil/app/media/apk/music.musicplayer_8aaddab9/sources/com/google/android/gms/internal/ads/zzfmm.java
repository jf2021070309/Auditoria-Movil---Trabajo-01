...
public class zzfmm<K, V> extends zzfnd<K, V> implements zzfoy<K, V> {
    ...
    @Override // com.google.android.gms.internal.ads.zzfnd
    public final Collection<V> zzb(K k2, Collection<V> collection) {
        return zzj(k2, (List) collection, null);
    }
