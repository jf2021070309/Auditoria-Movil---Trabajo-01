...
public final class zzcki extends zzcis implements zzauo, zzasm, zzavy, zzaoj, zzamz {
    ...
    public final void zzS(zzatz zzatzVar, int i2) {
        this.zzo += i2;
    }
    ...
    */
    public final com.google.android.gms.internal.ads.zzasr zzT(android.net.Uri r11, final java.lang.String r12) {
        /*
            r10 = this;
    ...
    @Override // com.google.android.gms.internal.ads.zzauo
    public final /* bridge */ /* synthetic */ void zzk(Object obj, int i2) {
        this.zzo += i2;
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzavy
    public final void zzn(int i2, int i3, int i4, float f2) {
        zzcir zzcirVar = this.zzn;
        if (zzcirVar != null) {
            zzcirVar.zzc(i2, i3);
        }
    ...
    public final void zzq(Uri[] uriArr, String str, ByteBuffer byteBuffer, boolean z) {
        ...
        if (length == 1) {
            ...
            for (int i2 = 0; i2 < uriArr.length; i2++) {
                zzasrVarArr[i2] = zzT(uriArr[i2], str);
            }
    ...
    public final void zzu(float f2, boolean z) {
        ...
        zzanb zzanbVar = new zzanb(this.zzg, 2, Float.valueOf(f2));
        if (z) {
            this.zzj.zzk(zzanbVar);
        } else {
            this.zzj.zzj(zzanbVar);
