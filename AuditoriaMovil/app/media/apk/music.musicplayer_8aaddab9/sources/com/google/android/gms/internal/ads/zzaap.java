...
public abstract class zzaap implements zzaao {
    public static volatile zzabr zza;
    ...
    */
    ...
    public abstract zzyj zza(Context context, zzyc zzycVar);

    public abstract zzyj zzb(Context context, View view, Activity activity);

    public abstract zzyj zzc(Context context, View view, Activity activity);

    public abstract zzabt zzd(MotionEvent motionEvent) throws zzabi;

    public abstract long zze(StackTraceElement[] stackTraceElementArr) throws zzabi;
    ...
    public final synchronized void zzj(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            Double.isNaN(rawY);
            double d5 = rawY - d4;
            this.zzk += Math.sqrt((d5 * d5) + (d3 * d3));
            this.zzr = rawX;
            this.zzs = rawY;
        }
        ...
        if (action2 != 0) {
            try {
                if (action2 == 1) {
                    ...
                    Long l3 = zzd.zzd;
                    if (l3 != null && zzd.zzg != null) {
                        this.zzi = l3.longValue() + zzd.zzg.longValue() + this.zzi;
                    }
                    if (this.zzq != null && (l2 = zzd.zze) != null && zzd.zzh != null) {
                        this.zzj = l2.longValue() + zzd.zzh.longValue() + this.zzj;
                    }
                } else if (action2 == 3) {
                    this.zzg++;
                }
    ...
    @Override // com.google.android.gms.internal.ads.zzaao
    public final synchronized void zzk(int i2, int i3, int i4) {
        if (this.zzb != null) {
