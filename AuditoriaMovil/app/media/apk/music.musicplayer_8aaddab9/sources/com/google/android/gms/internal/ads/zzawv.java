...
public final class zzawv implements Application.ActivityLifecycleCallbacks {
    ...
    public static /* synthetic */ boolean zzc(zzawv zzawvVar, boolean z) {
        zzawvVar.zzd = false;
        return false;
    }
            ...
            if (activity2 != null) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        com.google.android.gms.ads.internal.zzt.zzg().zzk(e2, "AppActivityTracker.ActivityListener.onActivityDestroyed");
                        zzcgt.zzg("", e2);
                    }
                }
            }
        ...
        synchronized (this.zzc) {
            for (zzaxk zzaxkVar : this.zzg) {
                try {
                    ...
                    com.google.android.gms.ads.internal.zzt.zzg().zzk(e2, "AppActivityTracker.ActivityListener.onActivityPaused");
                    zzcgt.zzg("", e2);
                }
            }
        }
        ...
        synchronized (this.zzc) {
            for (zzaxk zzaxkVar : this.zzg) {
                try {
                    ...
                    com.google.android.gms.ads.internal.zzt.zzg().zzk(e2, "AppActivityTracker.ActivityListener.onActivityResumed");
                    zzcgt.zzg("", e2);
                }
            }
            if (z) {
