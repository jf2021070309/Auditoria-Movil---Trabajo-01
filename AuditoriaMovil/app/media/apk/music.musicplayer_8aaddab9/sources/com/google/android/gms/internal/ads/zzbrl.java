...
public final class zzbrl extends AbstractSafeParcelable {
    ...
    public zzbrl(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) boolean z, @SafeParcelable.Param(id = 3) int i2, @SafeParcelable.Param(id = 4) String str2) {
        this.zza = str;
        this.zzb = z;
        this.zzc = i2;
        this.zzd = str2;
