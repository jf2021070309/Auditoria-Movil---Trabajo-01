...
public final class zzctf implements zzdbc, zzdcq, zzdbw, zzbcv, zzdbs {
    ...
    private final void zzs(final int i2, final int i3) {
        View view;
        if (i2 <= 0 || !((view = this.zzk.get()) == null || view.getHeight() == 0 || view.getWidth() == 0)) {
            zzr();
        } else {
            this.zzd.schedule(new Runnable(this, i2, i3) { // from class: com.google.android.gms.internal.ads.zzcta
    ...
    public final void onAdClicked() {
        ...
        zzfbbVar.zzb(zza, true == com.google.android.gms.ads.internal.util.zzs.zzI(this.zza) ? 2 : 1);
    }
    ...
    public final /* synthetic */ void zzo(final int i2, final int i3) {
        this.zzb.execute(new Runnable(this, i2, i3) { // from class: com.google.android.gms.internal.ads.zzctb
            private final zzctf zza;
            private final int zzb;
            private final int zzc;
