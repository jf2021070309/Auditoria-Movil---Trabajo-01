...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzgVar, List<zzap> list) {
        ...
        int i2 = 0;
        if (ordinal == 3) {
            zzap zzb = zzgVar.zzb((zzap) a.Q(zzbl.ASSIGN, 2, list, 0));
            ...
            if (list.size() % 2 == 0) {
                for (int i3 = 0; i3 < list.size() - 1; i3 += 2) {
                    zzap zzb3 = zzgVar.zzb(list.get(i3));
                    ...
                    zzgVar.zzf(zzb3.zzi(), zzgVar.zzb(list.get(i3 + 1)));
                }
                return zzap.zzf;
            }
            ...
            while (i2 < list.size()) {
                zzapVar = zzgVar.zzb(list.get(i2));
            ...
            zzap zzb4 = zzgVar.zzb((zzap) a.Q(zzbl.GET, 1, list, 0));
            ...
            zzap zzb5 = zzgVar.zzb((zzap) a.Q(zzbl.SET_PROPERTY, 3, list, 0));
            ...
            if (list.size() % 2 == 0) {
                ...
                while (i2 < list.size() - 1) {
                    zzap zzb9 = zzgVar.zzb(list.get(i2));
                    zzap zzb10 = zzgVar.zzb(list.get(i2 + 1));
            ...
            zzap zzb11 = zzgVar.zzb((zzap) a.Q(zzbl.GET_PROPERTY, 2, list, 0));
            ...
            switch (ordinal) {
                case 62:
                    zzap zzb13 = zzgVar.zzb((zzap) a.Q(zzbl.TYPEOF, 1, list, 0));
