...
public final class zzem extends zzdn<Float> implements RandomAccess, zzeu, zzfx {
    ...
    private zzem(float[] fArr, int i2) {
        this.zzb = fArr;
        this.zzc = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzeu zzd(int i2) {
        if (i2 >= this.zzc) {
            return new zzem(Arrays.copyOf(this.zzb, i2), this.zzc);
        }
