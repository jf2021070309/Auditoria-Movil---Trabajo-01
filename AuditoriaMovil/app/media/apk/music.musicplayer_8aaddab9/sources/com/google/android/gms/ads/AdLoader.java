...
public class AdLoader {
    ...
    public static class Builder {
        ...
        public Builder forAdManagerAdView(@RecentlyNonNull OnAdManagerAdViewLoadedListener onAdManagerAdViewLoadedListener, @RecentlyNonNull AdSize... adSizeArr) {
            ...
            try {
                ...
                zzcgt.zzj("Failed to add Google Ad Manager banner ad listener", e2);
            }
            return this;
        }
        ...
        public Builder forCustomFormatAd(@RecentlyNonNull String str, @RecentlyNonNull NativeCustomFormatAd.OnCustomFormatAdLoadedListener onCustomFormatAdLoadedListener, NativeCustomFormatAd.OnCustomClickListener onCustomClickListener) {
            ...
            try {
                ...
                zzcgt.zzj("Failed to add custom format ad listener", e2);
            }
            return this;
        }
        ...
        public Builder forCustomTemplateAd(@RecentlyNonNull String str, @RecentlyNonNull NativeCustomTemplateAd.OnCustomTemplateAdLoadedListener onCustomTemplateAdLoadedListener, NativeCustomTemplateAd.OnCustomClickListener onCustomClickListener) {
            ...
            try {
                ...
                zzcgt.zzj("Failed to add custom template ad listener", e2);
            }
            return this;
        }
        ...
        public Builder forNativeAd(@RecentlyNonNull NativeAd.OnNativeAdLoadedListener onNativeAdLoadedListener) {
            try {
                ...
                zzcgt.zzj("Failed to add google native ad listener", e2);
            }
            return this;
        }
        ...
        public Builder withAdListener(@RecentlyNonNull AdListener adListener) {
            try {
                ...
                zzcgt.zzj("Failed to set AdListener.", e2);
            }
            return this;
        }
        ...
        public Builder withAdManagerAdViewOptions(@RecentlyNonNull AdManagerAdViewOptions adManagerAdViewOptions) {
            try {
                ...
                zzcgt.zzj("Failed to specify Ad Manager banner ad options", e2);
            }
            return this;
        }
    ...
    public boolean isLoading() {
        try {
            ...
            zzcgt.zzj("Failed to check if ad is loading.", e2);
            return false;
        }
    }
    ...
    public void loadAds(@RecentlyNonNull AdRequest adRequest, int i2) {
        try {
            ...
            zzcgt.zzg("Failed to load ads.", e2);
        }
    }
}
