...
public final class zzaoz {
    ...
    private final void zzj(short[] sArr, int i2, int i3) {
        int i4 = this.zze / i3;
        int i5 = this.zzb;
        int i6 = i3 * i5;
        int i7 = i2 * i5;
    ...
    private final int zzk(short[] sArr, int i2, int i3, int i4) {
        int i5 = i2 * this.zzb;
        int i6 = 1;
        int i7 = 255;
        int i8 = 0;
                ...
                while (true) {
                    ...
                    if (i14 > 0) {
                        ...
                        if (this.zzb == i11 && i16 == i11) {
                            i2 = zzk(sArr, i13, this.zzc, this.zzd);
                        } else {
                            zzj(sArr, i13, i16);
                            int zzk = zzk(this.zzf, 0, this.zzc / i16, this.zzd / i16);
                            if (i16 != i11) {
                                int i17 = zzk * i16;
                                int i18 = i16 * 4;
                                int i19 = i17 - i18;
                                ...
                                if (this.zzb == i11) {
                                    i2 = zzk(sArr, i13, i19, i20);
                                } else {
                                    zzj(sArr, i13, i11);
                                    i2 = zzk(this.zzf, 0, i19, i20);
                                }
                            } else {
                                i2 = zzk;
                            }
                        ...
                        if (d2 > 1.0d) {
                            ...
                            zzg(i4);
                            int i25 = i4;
                            zzm(i4, this.zzb, this.zzj, this.zzr, sArr2, i13, sArr2, i13 + i24);
                            this.zzr += i25;
                            i13 = i24 + i25 + i13;
                        } else {
                            int i26 = i24;
                            ...
                            zzm(i3, this.zzb, this.zzj, this.zzr + i26, sArr3, i26 + i13, sArr3, i13);
                            this.zzr += i27;
                            i13 += i3;
                        }
                    }
    ...
    private static void zzm(int i2, int i3, short[] sArr, int i4, short[] sArr2, int i5, short[] sArr3, int i6) {
