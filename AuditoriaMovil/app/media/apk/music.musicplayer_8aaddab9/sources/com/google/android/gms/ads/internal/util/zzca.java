...
public final class zzca {
    public static boolean zza(int i2) {
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzbY)).booleanValue()) {
            return ((Boolean) zzbet.zzc().zzc(zzbjl.zzbZ)).booleanValue() || i2 <= 15299999;
        }
        return true;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:52:0x0175, code lost:
        com.google.android.gms.internal.ads.zzcgt.zzg("Could not log native template signal to JSON", r0);
     */
