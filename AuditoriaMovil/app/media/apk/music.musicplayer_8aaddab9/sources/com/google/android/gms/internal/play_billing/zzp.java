...
public abstract class zzp<E> extends zzm<E> implements List<E>, RandomAccess {
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzp<E> subList(int i2, int i3) {
        zzj.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? (zzp<E>) zzq.zza : new zzo(this, i2, i4);
    }

    @Override // java.util.List
    /* renamed from: zzh */
    public final zzs<E> listIterator(int i2) {
        zzj.zzb(i2, size(), "index");
        return isEmpty() ? (zzs<E>) zza : new zzn(this, i2);
    }
}
