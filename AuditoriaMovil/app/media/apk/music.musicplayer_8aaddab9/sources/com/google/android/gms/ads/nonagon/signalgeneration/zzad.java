...
public final class zzad implements zzgla<zzfsm<zzah>> {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        return this.zza.zzb().zze(zzfem.GENERATE_SIGNALS, ((zzdaj) this.zzc).zzb().zzb()).zzc(((zzag) this.zzb).zzb()).zzh(((Integer) zzbet.zzc().zzc(zzbjl.zzdP)).intValue(), TimeUnit.SECONDS).zzi();
    }
}
