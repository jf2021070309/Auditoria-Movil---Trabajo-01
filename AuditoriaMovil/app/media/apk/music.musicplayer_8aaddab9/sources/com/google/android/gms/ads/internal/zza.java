...
public final class zza {
    ...
    public final zzckm zzc;
    public final zzcdt zzd;
    public final zzbzv zze;
    public final zzbkm zzf;

    public zza(zzckm zzckmVar, zzcij zzcijVar, zzcdt zzcdtVar, zzazf zzazfVar, zzbzv zzbzvVar, zzbkm zzbkmVar, byte[] bArr) {
        this.zzc = zzckmVar;
        this.zza = zzcijVar;
        this.zzd = zzcdtVar;
        this.zzb = zzazfVar;
