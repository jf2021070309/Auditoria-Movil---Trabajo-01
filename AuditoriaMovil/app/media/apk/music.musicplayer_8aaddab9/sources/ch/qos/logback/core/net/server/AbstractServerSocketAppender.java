...
public abstract class AbstractServerSocketAppender<E> extends AppenderBase<E> {
    ...
    public void start() {
        ...
        try {
            ServerRunner<d.a.a.b.b.a.a> createServerRunner = createServerRunner(createServerListener(getServerSocketFactory().createServerSocket(getPort(), getBacklog(), getInetAddress())), getContext().getScheduledExecutorService());
