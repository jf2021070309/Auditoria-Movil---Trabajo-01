...
public class LayoutWrappingEncoder<E> extends EncoderBase<E> {
    ...
    public byte[] encode(E e2) {
        return convertToBytes(this.layout.doLayout(e2));
    }
    ...
    public void start() {
        if (this.immediateFlush != null) {
            if (this.parent instanceof OutputStreamAppender) {
                StringBuilder y = a.y("Setting the \"immediateFlush\" property of the enclosing appender to ");
                y.append(this.immediateFlush);
                addWarn(y.toString());
